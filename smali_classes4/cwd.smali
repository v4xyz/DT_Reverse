...
.method static synthetic a(Lcwd;Ljava/lang/String;Lcom/alibaba/wukong/Callback;Lcom/alibaba/wukong/im/MessageContent$CommonVideoContent;)V
    .locals 0
    .param p0, "x0"    # Lcwd;
    ...
    .prologue
    .line 20
    invoke-direct {p0, p1, p2, p3}, Lcwd;->a(Ljava/lang/String;Lcom/alibaba/wukong/Callback;Lcom/alibaba/wukong/im/MessageContent$CommonVideoContent;)V

    return-void
.end method

.method static synthetic a(Lcwd;Ljava/lang/String;Lcom/alibaba/wukong/Callback;Lcom/alibaba/wukong/im/MessageContent$EncryptCommonVideoContent;)V
    .locals 0
    .param p0, "x0"    # Lcwd;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # Lcom/alibaba/wukong/Callback;
    ...
    .prologue
    .line 20
    invoke-direct {p0, p1, p2, p3}, Lcwd;->a(Ljava/lang/String;Lcom/alibaba/wukong/Callback;Lcom/alibaba/wukong/im/MessageContent$EncryptCommonVideoContent;)V
...
.method private a(Ljava/lang/String;Lcom/alibaba/wukong/Callback;Lcom/alibaba/wukong/im/MessageContent$CommonVideoContent;)V
    ...
    new-instance v3, Lcwd$5;

    move-object/from16 v0, p0

    move-object/from16 v1, p2

    invoke-direct {v3, v0, v1}, Lcwd$5;-><init>(Lcwd;Lcom/alibaba/wukong/Callback;)V
    ...
    .line 158
    :cond_2
    invoke-static/range {p1 .. p1}, Lcwa;->d(Ljava/lang/String;)Lcwh;

    move-result-object v15

    .line 160
    .local v15, "videoInfo":Lcwh;
    ...
    iget-wide v8, v15, Lcwh;->a:J

    iget v10, v15, Lcwh;->b:I

    iget v11, v15, Lcwh;->c:I
    ...
    new-instance v3, Lcwd$7;

    move-object/from16 v0, p0

    move-object/from16 v1, p2

    invoke-direct {v3, v0, v1, v13}, Lcwd$7;-><init>(Lcwd;Lcom/alibaba/wukong/Callback;Lcom/alibaba/wukong/im/MessageContent$CommonVideoContent;)V
...
.method private a(Ljava/lang/String;Lcom/alibaba/wukong/Callback;Lcom/alibaba/wukong/im/MessageContent$EncryptCommonVideoContent;)V
    ...
    new-instance v3, Lcwd$6;

    move-object/from16 v0, p0

    move-object/from16 v1, p2

    invoke-direct {v3, v0, v1}, Lcwd$6;-><init>(Lcwd;Lcom/alibaba/wukong/Callback;)V
    ...
    new-instance v3, Lcwd$8;

    move-object/from16 v0, p0

    move-object/from16 v1, p2

    invoke-direct {v3, v0, v1, v13}, Lcwd$8;-><init>(Lcwd;Lcom/alibaba/wukong/Callback;Lcom/alibaba/wukong/im/MessageContent$EncryptCommonVideoContent;)V
...
.method public final compress(Lcom/alibaba/wukong/im/Message;Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-static {v3}, Lcwa;->c(Ljava/lang/String;)Z
    ...
    .line 27
    invoke-static {v3, v4}, Lcwa;->a(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 29
    invoke-static {v3, v4}, Lcwa;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-direct {p0, v3, p2, v0}, Lcwd;->a(Ljava/lang/String;Lcom/alibaba/wukong/Callback;Lcom/alibaba/wukong/im/MessageContent$CommonVideoContent;)V
    ...
    invoke-virtual {v3, v4, v5}, Lcwg;->a(J)Lcwf;

    move-result-object v2

    .line 35
    .local v2, "videoEncode":Lcwf;
    new-instance v1, Lcwd$1;

    invoke-direct {v1, p0, p1, p2, v0}, Lcwd$1;-><init>(Lcwd;Lcom/alibaba/wukong/im/Message;Lcom/alibaba/wukong/Callback;Lcom/alibaba/wukong/im/MessageContent$CommonVideoContent;)V

    .line 55
    .local v1, "listener":Lbsv;, "Lbsv<Ljava/lang/String;>;"
    if-nez v2, :cond_2

    .line 56
    new-instance v2, Lcwf;

    .end local v2    # "videoEncode":Lcwf;
    invoke-interface {v0}, Lcom/alibaba/wukong/im/MessageContent$CommonVideoContent;->url()Ljava/lang/String;
    ...
    invoke-direct {v2, v3, v4, v5, v1}, Lcwf;-><init>(Ljava/lang/String;JLbsv;)V

    .line 57
    .restart local v2    # "videoEncode":Lcwf;
    invoke-virtual {v2}, Lcwf;->a()V
    ...
    invoke-virtual {v3, v4, v5, v2}, Lcwg;->a(JLcwf;)V

    goto :goto_0

    .line 1038
    :cond_2
    iput-object v1, v2, Lcwf;->d:Lbsv;

    goto :goto_1

    .line 63
    .end local v1    # "listener":Lbsv;, "Lbsv<Ljava/lang/String;>;"
    .end local v2    # "videoEncode":Lcwf;
    :cond_3
    ...
    new-instance v4, Lcwd$2;

    invoke-direct {v4, p0, p2, v0}, Lcwd$2;-><init>(Lcwd;Lcom/alibaba/wukong/Callback;Lcom/alibaba/wukong/im/MessageContent$CommonVideoContent;)V
...
.method public final compressEncryptVideo(Lcom/alibaba/wukong/im/Message;Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-direct {p0, v3, p2, v0}, Lcwd;->a(Ljava/lang/String;Lcom/alibaba/wukong/Callback;Lcom/alibaba/wukong/im/MessageContent$EncryptCommonVideoContent;)V
    ...
    .line 86
    .local v2, "videoEncode":Lcwf;
    new-instance v1, Lcwd$3;

    invoke-direct {v1, p0, p1, p2, v0}, Lcwd$3;-><init>(Lcwd;Lcom/alibaba/wukong/im/Message;Lcom/alibaba/wukong/Callback;Lcom/alibaba/wukong/im/MessageContent$EncryptCommonVideoContent;)V
    ...
    new-instance v4, Lcwd$4;

    invoke-direct {v4, p0, p2, v0}, Lcwd$4;-><init>(Lcwd;Lcom/alibaba/wukong/Callback;Lcom/alibaba/wukong/im/MessageContent$EncryptCommonVideoContent;)V
