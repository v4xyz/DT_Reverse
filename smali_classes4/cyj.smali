...
.method public constructor <init>(Landroid/app/Activity;Lcyl$a;)V
    .locals 3
    .param p1, "activity"    # Landroid/app/Activity;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
    .param p2, "controller"    # Lcyl$a;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
    ...
    iput-object v0, p0, Lcyj;->j:Landroid/view/View;
    ...
    iput-object v0, p0, Lcyj;->n:Ljava/util/List;
    ...
    sget v2, Lcxu$e;->oa_expand_header_banner_first:I

    aput v2, v0, v1

    const/4 v1, 0x1

    sget v2, Lcxu$e;->oa_expand_header_banner_second:I

    aput v2, v0, v1

    const/4 v1, 0x2

    sget v2, Lcxu$e;->oa_expand_header_banner_third:I

    aput v2, v0, v1

    const/4 v1, 0x3

    sget v2, Lcxu$e;->oa_expand_header_banner_fourth:I

    aput v2, v0, v1

    iput-object v0, p0, Lcyj;->p:[I

    .line 89
    iput-object p1, p0, Lcyj;->c:Landroid/app/Activity;

    .line 90
    iput-object p2, p0, Lcyj;->d:Lcyl$a;
    ...
    iput-object v0, p0, Lcyj;->m:Lcom/alibaba/doraemon/image/ImageMagician;

    .line 1331
    new-instance v0, Lcyj$5;

    invoke-direct {v0, p0}, Lcyj$5;-><init>(Lcyj;)V

    iput-object v0, p0, Lcyj;->b:Landroid/content/BroadcastReceiver;
    ...
    .line 1340
    iget-object v1, p0, Lcyj;->c:Landroid/app/Activity;
    ...
    iget-object v2, p0, Lcyj;->b:Landroid/content/BroadcastReceiver;
...
.method static synthetic a(Lcyj;)Ljava/util/List;
    .locals 1
    .param p0, "x0"    # Lcyj;

    .prologue
    .line 56
    iget-object v0, p0, Lcyj;->h:Ljava/util/List;

    return-object v0
.end method

.method static synthetic a(Lcyj;Ljava/util/List;)V
    .locals 14
    .param p0, "x0"    # Lcyj;
    ...
    .line 56
    .line 3138
    iget-object v0, p0, Lcyj;->e:Lcom/alibaba/android/dingtalkbase/widgets/views/CustomViewFlipper;
    ...
    .line 3143
    iget-object v0, p0, Lcyj;->f:Landroid/widget/LinearLayout;

    invoke-virtual {v0, v10}, Landroid/widget/LinearLayout;->setVisibility(I)V

    .line 3144
    iget-object v0, p0, Lcyj;->g:Landroid/view/View;

    invoke-virtual {v0, v10}, Landroid/view/View;->setVisibility(I)V

    .line 3211
    :goto_0
    iget-object v0, p0, Lcyj;->j:Landroid/view/View;
    ...
    .line 3152
    iget-object v0, p0, Lcyj;->n:Ljava/util/List;
    ...
    .line 3155
    iget-object v0, p0, Lcyj;->c:Landroid/app/Activity;

    invoke-static {v0}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v0

    sget v3, Lcxu$f;->fragment_common_oa_expand_header_banner:I
    ...
    .line 3156
    iget-object v3, p0, Lcyj;->n:Ljava/util/List;
    ...
    iput-object v0, p0, Lcyj;->h:Ljava/util/List;
    ...
    .line 3180
    invoke-direct {p0, v1, v2, v3}, Lcyj;->a(Lcom/alibaba/android/oa/model/TeamStatModelObject;Landroid/widget/RelativeLayout;I)Z
    ...
    .line 3183
    invoke-direct {p0, v13, v1, v3}, Lcyj;->a(Lcom/alibaba/android/oa/model/TeamStatModelObject;Landroid/widget/RelativeLayout;I)Z

    goto :goto_5

    .line 3186
    :cond_6
    iget-object v1, p0, Lcyj;->e:Lcom/alibaba/android/dingtalkbase/widgets/views/CustomViewFlipper;
    ...
    .line 3195
    iget-object v1, p0, Lcyj;->f:Landroid/widget/LinearLayout;

    invoke-virtual {v1, v0}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    .line 3196
    iget-object v1, p0, Lcyj;->h:Ljava/util/List;
...
.method private a(Lcom/alibaba/android/oa/model/TeamStatModelObject;Landroid/widget/RelativeLayout;I)Z
    ...
    .line 217
    :cond_0
    sget v2, Lcxu$e;->oa_entry_header_inner_layout:I
    ...
    iget-object v2, v0, Lcyj;->k:Landroid/view/View$OnTouchListener;
    ...
    .line 219
    sget v2, Lcxu$e;->header_banner_item_title:I
    ...
    sget v2, Lcxu$e;->oa_header_banner_item_icon:I
    ...
    sget v2, Lcxu$e;->header_banner_item_desc:I
    ...
    .line 226
    new-instance v2, Lcyj$2;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Lcyj$2;-><init>(Lcyj;)V
    ...
    invoke-virtual {v2, v4, v5, v6}, Lepf;->a(Ljava/lang/String;II)Ljava/lang/String;
    ...
    iget-object v2, v0, Lcyj;->m:Lcom/alibaba/doraemon/image/ImageMagician;
    ...
    new-instance v6, Lcyj$3;

    move-object/from16 v7, p0

    move/from16 v10, p3

    invoke-direct/range {v6 .. v12}, Lcyj$3;-><init>(Lcyj;JILjava/lang/String;Ljava/lang/String;)V
...
.method static synthetic b(Lcyj;)J
    .locals 2
    .param p0, "x0"    # Lcyj;

    .prologue
    .line 56
    iget-wide v0, p0, Lcyj;->o:J

    return-wide v0
.end method

.method static synthetic c(Lcyj;)Landroid/app/Activity;
    .locals 1
    .param p0, "x0"    # Lcyj;
...
.method static synthetic d(Lcyj;)Lcyl$a;
    .locals 1
    .param p0, "x0"    # Lcyj;

    .prologue
    .line 56
    iget-object v0, p0, Lcyj;->d:Lcyl$a;

    return-object v0
.end method

.method static synthetic e(Lcyj;)Lcom/alibaba/android/dingtalkbase/widgets/views/CustomViewFlipper;
    .locals 1
    .param p0, "x0"    # Lcyj;
...
.method static synthetic f(Lcyj;)Landroid/view/GestureDetector;
    .locals 1
    .param p0, "x0"    # Lcyj;

    .prologue
    .line 56
    iget-object v0, p0, Lcyj;->i:Landroid/view/GestureDetector;
...
.method public final a(J)V
    ...
    new-instance v2, Lcyj$4;

    invoke-direct {v2, p0}, Lcyj$4;-><init>(Lcyj;)V

    .line 3050
    iput-wide p1, v1, Lcym;->b:J
    ...
    .line 3053
    iget-wide v4, v1, Lcym;->b:J

    invoke-static {v4, v5}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v3

    iget-wide v4, v1, Lcym;->a:J

    invoke-static {v4, v5}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v4

    new-instance v5, Lcym$1;

    invoke-direct {v5, v1, v2}, Lcym$1;-><init>(Lcym;Lcyl$b;)V

    invoke-interface {v0, v3, v4, v5}, Lcom/alibaba/android/oa/idl/service/SWCommonIService;->getShortcut(Ljava/lang/Long;Ljava/lang/Long;Lfos;)Lczm;
