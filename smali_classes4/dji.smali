...
.field public g:Lcom/alibaba/android/dingtalkbase/widgets/views/label/LabelLayout;
...
.method protected final a(Landroid/view/View;)V
    ...
    iput-object v0, p0, Ldji;->j:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Ldji;->d:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Ldji;->e:Landroid/widget/TextView;

    .line 80
    sget v0, Ldei$f;->tv_owner:I
    ...
    iput-object v0, p0, Ldji;->f:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Ldji;->k:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;

    .line 82
    sget v0, Ldei$f;->label_layout:I
    ...
    iput-object v0, p0, Ldji;->g:Lcom/alibaba/android/dingtalkbase/widgets/views/label/LabelLayout;
    ...
    iput-object v0, p0, Ldji;->h:Landroid/view/View;
    ...
    iput-object v0, p0, Ldji;->i:Landroid/view/View;
    ...
    iput-object v0, p0, Ldji;->b:Landroid/view/View;
...
.method public final a(Lcom/alibaba/android/search/model/BaseModel;Landroid/widget/AbsListView;)V
    ...
    iget-object v4, p0, Ldji;->k:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;
    ...
    :cond_1
    iget-object v4, p0, Ldji;->d:Landroid/widget/TextView;

    invoke-virtual/range {p1 .. p1}, Lcom/alibaba/android/search/model/BaseModel;->getName()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {p0, v4, v5}, Ldji;->a(Landroid/widget/TextView;Ljava/lang/String;)V

    .line 102
    iget-object v4, p0, Ldji;->e:Landroid/widget/TextView;

    iget-object v5, p0, Ldji;->a:Landroid/app/Activity;

    move-object/from16 v0, p1

    invoke-virtual {v0, v5}, Lcom/alibaba/android/search/model/BaseModel;->getDesc(Landroid/app/Activity;)Ljava/lang/String;
    ...
    .line 106
    iget-object v4, p0, Ldji;->f:Landroid/widget/TextView;
    ...
    .line 111
    :goto_1
    iget-object v10, p0, Ldji;->g:Lcom/alibaba/android/dingtalkbase/widgets/views/label/LabelLayout;
    ...
    .line 1166
    iget-object v5, p0, Ldji;->h:Landroid/view/View;
    ...
    .line 1167
    iget-object v5, p0, Ldji;->i:Landroid/view/View;
    ...
    new-instance v6, Ldji$1;

    move-object/from16 v0, p1

    invoke-direct {v6, p0, v0}, Ldji$1;-><init>(Ldji;Lcom/alibaba/android/search/model/BaseModel;)V
    ...
    new-instance v6, Ldji$2;

    move-object/from16 v0, p1

    invoke-direct {v6, p0, v4, v0}, Ldji$2;-><init>(Ldji;Lcom/alibaba/android/dingtalk/userbase/model/UserIdentityObject;Lcom/alibaba/android/search/model/BaseModel;)V
    ...
    .line 109
    iget-object v5, p0, Ldji;->f:Landroid/widget/TextView;

    iget-object v4, p0, Ldji;->a:Landroid/app/Activity;

    if-eqz v4, :cond_5

    iget-object v4, p0, Ldji;->a:Landroid/app/Activity;

    sget v6, Ldei$h;->dt_external_at_incharge:I
    ...
    invoke-static {v4, v8}, Lepj;->a(Landroid/content/Context;F)I
    ...
    iget-object v13, p0, Ldji;->a:Landroid/app/Activity;
    ...
    invoke-static {v13, v14}, Lepj;->a(Landroid/content/Context;F)I
    ...
    .end local v1    # "externalContactModel":Lcom/alibaba/android/search/model/ExternalContactModel;
    :cond_c
    iget-object v4, p0, Ldji;->h:Landroid/view/View;
    ...
    .line 1223
    iget-object v4, p0, Ldji;->i:Landroid/view/View;
