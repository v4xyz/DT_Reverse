...
.method static synthetic a(Ldec;)Lcom/alibaba/android/dingtalkbase/widgets/dialog/DDProgressDialog;
    .locals 1
    .param p0, "x0"    # Ldec;

    .prologue
    .line 65
    iget-object v0, p0, Ldec;->b:Lcom/alibaba/android/dingtalkbase/widgets/dialog/DDProgressDialog;

    return-object v0
.end method

.method static synthetic a(Ldec;Lcom/alibaba/android/dingtalkbase/widgets/dialog/DDProgressDialog;)Lcom/alibaba/android/dingtalkbase/widgets/dialog/DDProgressDialog;
    .locals 0
    .param p0, "x0"    # Ldec;
    ...
    .prologue
    .line 65
    iput-object p1, p0, Ldec;->b:Lcom/alibaba/android/dingtalkbase/widgets/dialog/DDProgressDialog;
...
.method static synthetic a(Ldec;Landroid/app/Activity;Lcom/alibaba/wukong/im/Conversation;Lcom/alibaba/android/dingtalkim/base/IMInterface$SendMessageObject;)V
    .locals 4
    .param p0, "x0"    # Ldec;
    ...
    new-instance v2, Ldec$3;

    invoke-direct {v2, p0, p1}, Ldec$3;-><init>(Ldec;Landroid/app/Activity;)V
    ...
    .line 1215
    invoke-virtual {v1, p2, p3, v0}, Lcom/alibaba/android/dingtalkim/base/IMInterface;->a(Lcom/alibaba/wukong/im/Conversation;Lcom/alibaba/android/dingtalkim/base/IMInterface$SendMessageObject;Lbsv;)V
...
.method public a(Landroid/app/Activity;Landroid/net/Uri;)Ljava/lang/String;
    ...
    .line 360
    :cond_1
    invoke-static {p1, p2}, Ldec;->b(Landroid/app/Activity;Landroid/net/Uri;)Ljava/lang/String;
    :try_end_0
...
.method public a(Landroid/app/Activity;JLcom/alibaba/android/dingtalkim/base/IMInterface$SendMessageObject;)V
    ...
    new-instance v1, Ldec$2;

    invoke-direct {v1, p0, p1, p4}, Ldec$2;-><init>(Ldec;Landroid/app/Activity;Lcom/alibaba/android/dingtalkim/base/IMInterface$SendMessageObject;)V
