...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldww;->a:Ljava/lang/String;
...
.method static synthetic a(Ldww;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Ldww;

    .prologue
    .line 16
    invoke-virtual {p0}, Ldww;->i()Ljava/lang/String;
...
.method static synthetic b(Ldww;)Lcom/alibaba/bee/DBManager;
    .locals 1
    .param p0, "x0"    # Ldww;

    .prologue
    .line 16
    iget-object v0, p0, Ldww;->c:Lcom/alibaba/bee/DBManager;
...
# virtual methods
.method public final a(Leab;)I
    .locals 9
    .param p1, "orgUserNameObject"    # Leab;
    ...
    :try_start_0
    iget-object v4, p0, Ldww;->c:Lcom/alibaba/bee/DBManager;
    ...
    .line 29
    invoke-static {p1}, Leab;->a(Leab;)Lcom/alibaba/android/user/entry/OrgUserNameEntry;
    :try_end_0
    ...
    .line 40
    invoke-static {v2}, Ldww;->a(Lcom/alibaba/bee/SQLiteStatement;)V
...
.method public final a(Ljava/util/List;)I
    ...
    .prologue
    .local p1, "orgUserNameObjectList":Ljava/util/List;, "Ljava/util/List<Leab;>;"
    const/4 v1, 0x0
    ...
    iget-object v1, p0, Ldww;->c:Lcom/alibaba/bee/DBManager;

    invoke-virtual {p0}, Ldww;->i()Ljava/lang/String;

    move-result-object v2

    new-instance v3, Ldww$1;

    invoke-direct {v3, p0, p1, v0}, Ldww$1;-><init>(Ldww;Ljava/util/List;Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public final a(JJ)Leab;
    ...
    .line 109
    invoke-static {v11}, Leab;->a(Lcom/alibaba/android/user/entry/OrgUserNameEntry;)Leab;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final a(JLjava/util/List;)Ljava/util/List;
    ...
    iget-object v1, v0, Ldww;->c:Lcom/alibaba/bee/DBManager;

    invoke-virtual/range {p0 .. p0}, Ldww;->i()Ljava/lang/String;
    ...
    .line 137
    .local v15, "orgUserNameObjects":Ljava/util/List;, "Ljava/util/List<Leab;>;"
    :cond_4
    :goto_3
    :try_start_0
    ...
    .line 140
    invoke-static {v12}, Leab;->a(Lcom/alibaba/android/user/entry/OrgUserNameEntry;)Leab;
    ...
    iget-object v1, v14, Leab;->e:Ljava/lang/String;
    ...
    .end local v14    # "orgUserNameObject":Leab;
    :catch_0
    move-exception v11
    ...
    .end local v13    # "i":I
    .end local v15    # "orgUserNameObjects":Ljava/util/List;, "Ljava/util/List<Leab;>;"
    ...
    .restart local v15    # "orgUserNameObjects":Ljava/util/List;, "Ljava/util/List<Leab;>;"
