...
.method public final a(Landroid/view/View;)V
    ...
    .prologue
    .line 58
    iput-object p1, p0, Ldsy;->b:Landroid/view/View;
    ...
    iput-object v0, p0, Ldsy;->c:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Ldsy;->d:Landroid/view/View;
    ...
    iput-object v0, p0, Ldsy;->a:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Ldsy;->k:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Ldsy;->l:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Ldsy;->m:Landroid/view/View;
...
.method public final a(Lcom/alibaba/android/dingtalk/userbase/model/OrgNodeItemObject;)V
    ...
    .line 1156
    :cond_1
    iget-object v2, p0, Ldsy;->i:Ldsm;

    if-eqz v2, :cond_0

    .line 1157
    iget-object v2, p0, Ldsy;->a:Landroid/widget/CheckBox;
    ...
    invoke-interface {v2, v3, v0}, Ldsm;->a(Ljava/lang/Object;Z)Z

    move-result v2

    .line 1159
    invoke-virtual {p0, v1}, Ldsy;->c(Z)V

    .line 1160
    if-nez v2, :cond_3

    :goto_1
    invoke-virtual {p0, v0}, Ldsy;->d(Z)V
    ...
    :cond_2
    :goto_2
    invoke-virtual {p0, v0}, Ldsy;->b(Z)V
    ...
    invoke-interface {v2, v3}, Ldsm;->a(Ljava/lang/Object;)Z

    move-result v2

    .line 1164
    invoke-virtual {p0, v2}, Ldsy;->c(Z)V

    .line 1165
    invoke-virtual {p0, v2}, Ldsy;->d(Z)V
...
.method public final a(Lcom/alibaba/android/dingtalk/userbase/model/OrgNodeItemObject;ILandroid/view/ViewGroup;)V
    ...
    .line 74
    iget-object v2, p0, Ldsy;->c:Landroid/widget/TextView;
    ...
    .line 80
    :goto_1
    iget-boolean v2, p0, Ldsy;->f:Z

    if-eqz v2, :cond_3

    .line 81
    iget-object v2, p0, Ldsy;->d:Landroid/view/View;
    ...
    invoke-interface {v2, v1}, Ldsm;->c(Ljava/lang/Object;)Z

    move-result v2

    iput-boolean v2, p0, Ldsy;->o:Z

    .line 88
    iget-boolean v2, p0, Ldsy;->o:Z
    ...
    invoke-interface {v2, v1}, Ldsm;->b(Ljava/lang/Object;)Z

    move-result v2

    iput-boolean v2, p0, Ldsy;->n:Z
    ...
    .line 93
    iget-object v2, p0, Ldsy;->m:Landroid/view/View;
    ...
    iget-object v3, p0, Ldsy;->e:Landroid/app/Activity;

    invoke-virtual {v3}, Landroid/app/Activity;->getResources()Landroid/content/res/Resources;

    move-result-object v3

    sget v4, Ldop$d;->trans_black:I
    ...
    new-instance v3, Ldsy$1;

    invoke-direct {v3, p0, p1}, Ldsy$1;-><init>(Ldsy;Lcom/alibaba/android/dingtalk/userbase/model/OrgNodeItemObject;)V

    invoke-virtual {v2, v3}, Landroid/widget/CheckBox;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 122
    iget-object v2, p0, Ldsy;->k:Landroid/widget/LinearLayout;

    new-instance v3, Ldsy$2;

    invoke-direct {v3, p0, p1}, Ldsy$2;-><init>(Ldsy;Lcom/alibaba/android/dingtalk/userbase/model/OrgNodeItemObject;)V
...
.method c(Z)V
    ...
    .line 147
    iget-object v0, p0, Ldsy;->l:Landroid/widget/ImageView;
    ...
    .line 148
    iget-object v0, p0, Ldsy;->k:Landroid/widget/LinearLayout;
...
.method d(Z)V
    ...
    .prologue
    .line 172
    iget-object v0, p0, Ldsy;->a:Landroid/widget/CheckBox;
