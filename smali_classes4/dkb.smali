...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldkb;->a:Ljava/lang/String;
...
.method public getItemViewType(I)I
    ...
    .line 36
    .local v0, "type":I
    iget-object v1, p0, Ldkb;->c:Ljava/util/List;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 49
    invoke-virtual {p0, p1}, Ldkb;->getItemViewType(I)I
    ...
    .line 51
    .local v3, "headerHolder":Ldkb$b;
    const/4 v1, 0x0

    .line 52
    .local v1, "contentHolder":Ldkb$a;
    const/4 v2, 0x0

    .line 54
    .local v2, "footerHolder":Ldkb$c;
    if-nez p2, :cond_4
    ...
    .line 56
    iget-object v8, p0, Ldkb;->d:Landroid/app/Activity;
    ...
    sget v8, Ldjt$i;->layout_conf_record_detail_time_item:I
    ...
    .line 58
    new-instance v3, Ldkb$b;

    .end local v3    # "headerHolder":Ldkb$b;
    invoke-direct {v3, p0, v10}, Ldkb$b;-><init>(Ldkb;B)V

    .line 59
    .restart local v3    # "headerHolder":Ldkb$b;
    sget v8, Ldjt$h;->header_name:I
    ...
    iput-object v8, v3, Ldkb$b;->a:Landroid/widget/TextView;
    ...
    :cond_0
    :goto_0
    iget-object v8, p0, Ldkb;->c:Ljava/util/List;
    ...
    .line 89
    iget-object v8, v3, Ldkb$b;->a:Landroid/widget/TextView;
    ...
    sget v8, Ldjt$i;->layout_conf_record_detail_item:I
    ...
    .line 64
    new-instance v1, Ldkb$a;

    .end local v1    # "contentHolder":Ldkb$a;
    invoke-direct {v1, p0, v10}, Ldkb$a;-><init>(Ldkb;B)V

    .line 65
    .restart local v1    # "contentHolder":Ldkb$a;
    sget v8, Ldjt$h;->tv_status_icon:I
    ...
    iput-object v8, v1, Ldkb$a;->a:Lcom/alibaba/android/dingtalkbase/iconfont/IconFontTextView;

    .line 66
    sget v8, Ldjt$h;->tv_begin_time:I
    ...
    iput-object v8, v1, Ldkb$a;->c:Landroid/widget/TextView;

    .line 67
    sget v8, Ldjt$h;->tv_type:I
    ...
    iput-object v8, v1, Ldkb$a;->b:Landroid/widget/TextView;

    .line 68
    sget v8, Ldjt$h;->tv_duration:I
    ...
    iput-object v8, v1, Ldkb$a;->d:Landroid/widget/TextView;
    ...
    .line 3124
    .restart local v4    # "inflater":Landroid/view/LayoutInflater;
    sget v8, Ldjt$i;->layout_conf_record_detail_header_item:I
    ...
    .line 73
    new-instance v2, Ldkb$c;

    .end local v2    # "footerHolder":Ldkb$c;
    invoke-direct {v2, p0, v10}, Ldkb$c;-><init>(Ldkb;B)V

    .line 74
    .restart local v2    # "footerHolder":Ldkb$c;
    sget v8, Ldjt$h;->header_divider:I

    invoke-virtual {p2, v8}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v8

    iput-object v8, v2, Ldkb$c;->a:Landroid/view/View;
    ...
    .line 3154
    sget v6, Ldjt$k;->icon_dialrecord:I
    ...
    :cond_9
    :goto_2
    iget-object v8, v1, Ldkb$a;->a:Lcom/alibaba/android/dingtalkbase/iconfont/IconFontTextView;
    ...
    sget v9, Ldjt$k;->dt_conference_history_conferencetype_voipoto:I
    ...
    :goto_3
    iget-object v8, v1, Ldkb$a;->b:Landroid/widget/TextView;

    invoke-virtual {v8, v0}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 95
    iget-object v8, v1, Ldkb$a;->c:Landroid/widget/TextView;
    ...
    .line 97
    iget-object v8, v1, Ldkb$a;->d:Landroid/widget/TextView;
    ...
    iget-object v9, p0, Ldkb;->d:Landroid/app/Activity;

    invoke-virtual {v9}, Landroid/app/Activity;->getResources()Landroid/content/res/Resources;

    move-result-object v9

    sget v10, Ldjt$e;->ui_common_alert_text_color:I
    ...
    .line 3160
    :cond_b
    sget v6, Ldjt$k;->icon_callrecord:I
    ...
    sget v9, Ldjt$k;->dt_conference_history_conferencetype_videooto:I
    ...
    sget v9, Ldjt$k;->dt_conference_syscall_histovry_type:I
    ...
    sget v9, Ldjt$k;->dt_conference_bizcall_histovry_type:I
    ...
    sget v9, Ldjt$k;->dt_conference_history_conferencetype_call:I
    ...
    sget v10, Ldjt$e;->ui_common_level3_text_color:I
    ...
    .line 116
    iget-object v8, v2, Ldkb$c;->a:Landroid/view/View;
