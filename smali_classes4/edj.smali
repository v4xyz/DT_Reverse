...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ledj;->f:Ljava/util/HashMap;
...
.method static a()V
    ...
    sput-object v9, Ledj;->e:Ljava/util/Map;
    ...
    invoke-direct {v8, v1, v9}, Ledj;-><init>(II)V

    .line 46
    .local v8, "uploadTask":Ledj;
    sget-object v9, Ledj;->e:Ljava/util/Map;
    ...
    .line 47
    sget-object v9, Ledj;->f:Ljava/util/HashMap;
    ...
    invoke-static {v4, v8, v10, v11}, Laqt;->a(Ljava/util/concurrent/ScheduledFuture;Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;
...
.method static a(II)V
    ...
    .prologue
    .line 70
    sget-object v7, Ledj;->e:Ljava/util/Map;

    monitor-enter v7

    .line 71
    :try_start_0
    sget-object v6, Ledj;->e:Ljava/util/Map;
    ...
    .end local v3    # "uploadTask":Ledj;
    mul-int/lit16 v6, p1, 0x3e8

    invoke-direct {v3, p0, v6}, Ledj;-><init>(II)V

    .line 75
    .restart local v3    # "uploadTask":Ledj;
    sget-object v6, Ledj;->e:Ljava/util/Map;
    ...
    .line 76
    sget-object v6, Ledj;->f:Ljava/util/HashMap;
    ...
    invoke-static {v2, v3, v8, v9}, Laqt;->a(Ljava/util/concurrent/ScheduledFuture;Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-static {v2, v3, v4, v5}, Laqt;->a(Ljava/util/concurrent/ScheduledFuture;Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;
...
.method static b()V
    ...
    .prologue
    .line 57
    sget-object v3, Ledj;->f:Ljava/util/HashMap;
    ...
    sput-object v3, Ledj;->e:Ljava/util/Map;
...
.method static c()V
    ...
    invoke-virtual {v4, v5}, Ledq;->a(I)V
...
.method public final run()V
    ...
    invoke-virtual {v1, v2}, Ledq;->a(I)V

    .line 111
    sget-object v1, Ledj;->e:Ljava/util/Map;
    ...
    iput-wide v2, p0, Ledj;->d:J

    .line 113
    sget-object v1, Ledj;->f:Ljava/util/HashMap;
    ...
    invoke-static {v0, p0, v2, v3}, Laqt;->a(Ljava/util/concurrent/ScheduledFuture;Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;
