...
.method public constructor <init>(Landroid/app/Activity;Ljava/util/List;)V
    ...
    .line 55
    iput-object p1, p0, Lecx;->f:Landroid/app/Activity;

    .line 56
    iput-object p2, p0, Lecx;->a:Ljava/util/List;
...
.method public final getCount()I
    ...
    .prologue
    .line 65
    iget-object v0, p0, Lecx;->a:Ljava/util/List;
...
.method public final getItemViewType(I)I
    ...
    .prologue
    .line 83
    invoke-virtual {p0, p1}, Lecx;->getItem(I)Ljava/lang/Object;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 105
    invoke-virtual {p0, p1}, Lecx;->getItemViewType(I)I

    move-result v3

    .line 106
    .local v3, "type":I
    iget-object v5, p0, Lecx;->f:Landroid/app/Activity;
    ...
    sget v6, Lecs$b;->user_kit_manager_item_add_button_small:I

    invoke-direct {v1, v5, v6}, Ledb;-><init>(Landroid/app/Activity;I)V

    .line 107
    .local v1, "holder":Leda;
    :goto_0
    iget-object v5, p0, Lecx;->b:Lecw;

    invoke-virtual {v1, v5}, Leda;->a(Lecw;)V

    .line 108
    invoke-virtual {v1}, Leda;->a()Landroid/view/View;
    ...
    .end local v3    # "type":I
    :goto_1
    iget-object v5, p0, Lecx;->a:Ljava/util/List;
    ...
    invoke-virtual {v1, v2}, Leda;->a(Lcom/alibaba/android/userkit/usermanager/model/BaseUserManagerModel;)V
    ...
    .line 119
    .local v4, "userItemViewHolder":Lede;
    iget v5, p0, Lecx;->c:I
    ...
    .line 120
    iget-boolean v5, p0, Lecx;->e:Z

    .line 3087
    iput-boolean v5, v4, Lede;->c:Z

    .line 122
    .end local v4    # "userItemViewHolder":Lede;
    :cond_0
    ...
    .line 124
    .local v0, "deptItemViewHolder":Ledd;
    iget v5, p0, Lecx;->c:I
    ...
    .line 128
    .end local v0    # "deptItemViewHolder":Ledd;
    :cond_1
    return-object p2

    .line 2035
    .end local v1    # "holder":Leda;
    ...
    sget v6, Lecs$b;->user_kit_manager_item_add_button_large:I
    ...
    sget v6, Lecs$b;->user_kit_manager_item_delete_button_small:I

    invoke-direct {v1, v5, v6}, Ledc;-><init>(Landroid/app/Activity;I)V
    ...
    sget v6, Lecs$b;->user_kit_manager_item_delete_button_large:I
    ...
    sget v6, Lecs$b;->user_kit_manager_item_user_item_small:I

    invoke-direct {v1, v5, v6}, Lede;-><init>(Landroid/app/Activity;I)V
    ...
    sget v6, Lecs$b;->user_kit_manager_item_user_item_large:I
    ...
    sget v6, Lecs$b;->user_kit_manager_item_dept_item_small:I

    invoke-direct {v1, v5, v6}, Ledd;-><init>(Landroid/app/Activity;I)V
    ...
    sget v6, Lecs$b;->user_kit_manager_item_dept_item_large:I
