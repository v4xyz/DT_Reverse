...
.method public static a(Lfan;[BLandroid/hardware/Camera;I)F
    .locals 9
    .param p0, "faceRecognizer"    # Lfan;
    .param p1, "yuv"    # [B
    ...
    invoke-virtual {v3}, Leff;->f()Landroid/hardware/Camera$Size;
    :try_end_0
    ...
    invoke-interface {p0, p1, v3, v4, p3}, Lfan;->a([BIII)Lfao;

    move-result-object v2

    .line 73
    .local v2, "smileDetectResult":Lfao;
    invoke-virtual {v2}, Lfao;->b()I
    ...
    .end local v2    # "smileDetectResult":Lfao;
    :goto_1
    const/high16 v3, -0x40800000    # -1.0f
    ...
    .restart local v2    # "smileDetectResult":Lfao;
    :cond_2
    invoke-virtual {v2}, Lfao;->a()F
    :try_end_2
...
.method public static declared-synchronized a(Landroid/content/Context;)Lfan;
    .locals 11
    ...
    :try_start_0
    invoke-static {}, Lfam;->a()Lfan;

    move-result-object v1

    .line 32
    .local v1, "faceRecognizer":Lfan;
    if-nez v1, :cond_1
    ...
    .line 49
    .end local v1    # "faceRecognizer":Lfan;
    :cond_0
    :goto_0
    monitor-exit v5
    ...
    .line 37
    .restart local v1    # "faceRecognizer":Lfan;
    :cond_1
    :try_start_1
    ...
    .line 41
    invoke-interface {v1, p0, v2}, Lfan;->a(Landroid/content/Context;Landroid/os/Bundle;)I
    ...
    invoke-interface {v1}, Lfan;->c()Ljava/lang/String;
