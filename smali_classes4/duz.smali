...
.method public constructor <init>(Landroid/app/Activity;Ljava/util/List;)V
    ...
    .line 50
    iput-object p1, p0, Lduz;->c:Landroid/app/Activity;

    .line 51
    iput-object p2, p0, Lduz;->a:Ljava/util/List;

    .line 52
    iget-object v1, p0, Lduz;->a:Ljava/util/List;
    ...
    iput-object v1, p0, Lduz;->a:Ljava/util/List;
    ...
    invoke-virtual {v1}, Lduy;->b()Lcom/alibaba/android/user/contact/orgcreation/models/OrgCreation;
    ...
    iput-object v1, p0, Lduz;->b:Ljava/util/Set;
...
.method static synthetic a(Lduz;)Ljava/util/Set;
    .locals 1
    .param p0, "x0"    # Lduz;
...
.method static synthetic a(Lduz;Ljava/util/Set;)Ljava/util/Set;
    .locals 0
    .param p0, "x0"    # Lduz;
...
.method public final getCount()I
    ...
    .prologue
    .line 71
    iget-object v0, p0, Lduz;->a:Ljava/util/List;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 89
    iget-object v3, p0, Lduz;->c:Landroid/app/Activity;

    invoke-static {v3}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v3

    sget v4, Ldop$h;->item_check_member_grid:I
    ...
    .line 90
    new-instance v1, Lduz$a;

    invoke-direct {v1, p0, v6}, Lduz$a;-><init>(Lduz;B)V

    .line 91
    .local v1, "holder":Lduz$a;
    sget v3, Ldop$g;->iv_member_avatar:I
    ...
    iput-object v3, v1, Lduz$a;->a:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;

    .line 92
    sget v3, Ldop$g;->tv_member_name:I
    ...
    iput-object v3, v1, Lduz$a;->b:Landroid/widget/TextView;

    .line 93
    sget v3, Ldop$g;->iv_member_check_icon:I
    ...
    iput-object v3, v1, Lduz$a;->c:Landroid/widget/ImageView;
    ...
    .line 99
    :goto_0
    iget-object v3, v1, Lduz$a;->a:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;

    invoke-virtual {v3, v6}, Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;->setVisibility(I)V

    .line 100
    iget-object v3, v1, Lduz$a;->b:Landroid/widget/TextView;

    invoke-virtual {v3, v6}, Landroid/widget/TextView;->setVisibility(I)V

    .line 102
    iget-object v4, v1, Lduz$a;->a:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;

    iget-object v3, p0, Lduz;->a:Ljava/util/List;
    ...
    .line 102
    invoke-virtual {v4, v5, v3}, Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, v1, Lduz$a;->b:Landroid/widget/TextView;
    ...
    .line 107
    iget-object v3, p0, Lduz;->b:Ljava/util/Set;
    ...
    .line 108
    iget-object v3, v1, Lduz$a;->c:Landroid/widget/ImageView;

    invoke-virtual {v3, v6}, Landroid/widget/ImageView;->setVisibility(I)V

    .line 113
    :goto_2
    iget-object v0, v1, Lduz$a;->c:Landroid/widget/ImageView;

    .line 114
    .local v0, "checkIcon":Landroid/widget/ImageView;
    new-instance v3, Lduz$1;

    invoke-direct {v3, p0, v2, v0}, Lduz$1;-><init>(Lduz;Lcom/alibaba/android/dingtalk/userbase/model/UserIdentityObject;Landroid/widget/ImageView;)V
    ...
    check-cast v1, Lduz$a;

    .restart local v1    # "holder":Lduz$a;
    goto :goto_0
