...
.method public constructor <init>(Landroid/app/Activity;Ljava/util/ArrayList;)V
    ...
    .line 57
    iput-object p1, p0, Ldqo;->b:Landroid/app/Activity;

    .line 58
    iput-object p2, p0, Ldqo;->a:Ljava/util/ArrayList;
    ...
    iput-boolean v0, p0, Ldqo;->c:Z

    .line 61
    return-void
.end method

.method static synthetic a(Ldqo;)Landroid/app/Activity;
    .locals 1
    .param p0, "x0"    # Ldqo;

    .prologue
    .line 44
    iget-object v0, p0, Ldqo;->b:Landroid/app/Activity;

    return-object v0
.end method

.method static synthetic a(Ldqo;Lcom/alibaba/android/user/channel/model/ChannelApplyObject;)V
    .locals 0
    .param p0, "x0"    # Ldqo;
    ...
    .prologue
    .line 44
    invoke-virtual {p0, p1}, Ldqo;->a(Lcom/alibaba/android/user/channel/model/ChannelApplyObject;)V

    return-void
.end method

.method static synthetic a(Ldqo;Z)Z
    .locals 1
    .param p0, "x0"    # Ldqo;
    .param p1, "x1"    # Z
...
.method static synthetic b(Ldqo;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Ldqo;

    .prologue
    .line 44
    iget-object v0, p0, Ldqo;->a:Ljava/util/ArrayList;
...
.method public a(Lcom/alibaba/android/user/channel/model/ChannelApplyObject;)V
    ...
    new-instance v0, Ldqo$4;

    invoke-direct {v0, p0, p1}, Ldqo$4;-><init>(Ldqo;Lcom/alibaba/android/user/channel/model/ChannelApplyObject;)V
    ...
    invoke-interface {v1, v2, v3, v0}, Lcom/alibaba/android/user/idl/services/ChannelIService;->acceptChannelApply(JLfos;)V
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 82
    new-instance v0, Ldqo$a;

    invoke-direct {v0, p0, v8}, Ldqo$a;-><init>(Ldqo;B)V

    .line 83
    .local v0, "holder":Ldqo$a;
    iget-object v3, p0, Ldqo;->b:Landroid/app/Activity;

    invoke-static {v3}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v3

    sget v4, Ldop$h;->item_channel_apply:I
    ...
    iput-object v3, v0, Ldqo$a;->a:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;
    ...
    iput-object v3, v0, Ldqo$a;->b:Landroid/widget/TextView;

    .line 86
    sget v3, Ldop$g;->tv_mobile:I
    ...
    iput-object v3, v0, Ldqo$a;->c:Landroid/widget/TextView;

    .line 87
    sget v3, Ldop$g;->tv_remark:I
    ...
    iput-object v3, v0, Ldqo$a;->d:Landroid/widget/TextView;
    ...
    iput-object v3, v0, Ldqo$a;->e:Landroid/widget/Button;
    ...
    iput-object v3, v0, Ldqo$a;->f:Landroid/widget/TextView;
    ...
    iput-object v3, v0, Ldqo$a;->g:Landroid/view/View;
    ...
    iput-object v3, v0, Ldqo$a;->h:Landroid/view/View;
    ...
    .line 96
    :goto_0
    iget-object v3, p0, Ldqo;->a:Ljava/util/ArrayList;
    ...
    .line 98
    iget-object v3, v0, Ldqo$a;->f:Landroid/widget/TextView;

    invoke-virtual {v3, v9}, Landroid/widget/TextView;->setVisibility(I)V

    .line 99
    iget-object v3, v0, Ldqo$a;->e:Landroid/widget/Button;
    ...
    iget-object v4, p0, Ldqo;->b:Landroid/app/Activity;
    ...
    new-instance v4, Ldqo$1;

    invoke-direct {v4, p0, v1}, Ldqo$1;-><init>(Ldqo;Lcom/alibaba/android/user/channel/model/ChannelApplyObject;)V

    invoke-virtual {v3, v4}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 147
    iget-object v3, v0, Ldqo$a;->b:Landroid/widget/TextView;
    ...
    .line 148
    iget-object v3, v0, Ldqo$a;->c:Landroid/widget/TextView;
    ...
    .line 149
    iget-object v3, v0, Ldqo$a;->d:Landroid/widget/TextView;
    ...
    sget v5, Ldop$j;->dt_channel_apply_channel_name:I
    ...
    iput-object v3, p0, Ldqo;->d:Ljava/lang/String;
    ...
    iget-object v4, p0, Ldqo;->d:Ljava/lang/String;
    ...
    .line 152
    iget-object v4, v0, Ldqo$a;->b:Landroid/widget/TextView;
    ...
    .line 153
    iget-object v3, v0, Ldqo$a;->a:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;
    ...
    iget-object v6, p0, Ldqo;->d:Ljava/lang/String;
    ...
    .line 158
    :goto_2
    new-instance v3, Ldqo$2;

    invoke-direct {v3, p0, v1, p1}, Ldqo$2;-><init>(Ldqo;Lcom/alibaba/android/user/channel/model/ChannelApplyObject;I)V

    invoke-virtual {p2, v3}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 175
    new-instance v3, Ldqo$3;

    invoke-direct {v3, p0, p1, v1}, Ldqo$3;-><init>(Ldqo;ILcom/alibaba/android/user/channel/model/ChannelApplyObject;)V
    ...
    iget-boolean v3, p0, Ldqo;->c:Z

    if-eqz v3, :cond_8

    .line 221
    iget-object v3, v0, Ldqo$a;->h:Landroid/view/View;
    ...
    check-cast v0, Ldqo$a;

    .restart local v0    # "holder":Ldqo$a;
    goto/16 :goto_0
    ...
    iget-object v5, p0, Ldqo;->d:Ljava/lang/String;
