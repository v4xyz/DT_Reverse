...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ldql;->a:Ldql$a;
    ...
    iput-object v0, p0, Ldql;->b:Lbqw;

    .line 35
    new-instance v0, Ldql$a;

    invoke-direct {v0, p0}, Ldql$a;-><init>(Ldql;)V
...
.method public final a(J)Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;
    ...
    .line 41
    :cond_1
    iget-object v1, p0, Ldql;->a:Ldql$a;

    invoke-virtual {v1, p1, p2}, Ldql$a;->a(J)Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;
    ...
    .line 47
    invoke-virtual {p0, p1, p2}, Ldql;->c(J)Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;
...
.method public final a(Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;)V
    ...
    .prologue
    .line 122
    iget-object v0, p0, Ldql;->a:Ldql$a;

    invoke-virtual {v0, p1}, Ldql$a;->a(Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;)V
...
.method public final a(Ljava/util/List;)V
    ...
    invoke-virtual {v0, p1}, Ldql$a;->a(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v0}, Ldql;->b(Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;)V
    ...
    invoke-virtual {v0}, Ldwo;->c()Ldwp;

    move-result-object v0

    .line 5177
    invoke-interface {v0, p1}, Ldwp;->a(Ljava/util/List;)I
...
.method public final a(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual {v3}, Ldwo;->c()Ldwp;

    move-result-object v3

    .line 100
    invoke-interface {v3, p2}, Ldwp;->c(Ljava/util/List;)Ljava/util/List;
    ...
    :cond_3
    :goto_2
    iget-object v4, p0, Ldql;->a:Ldql$a;

    invoke-virtual {v4, v1}, Ldql$a;->a(Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;)V
...
.method public final a(Ljava/util/List;Ljava/util/List;Z)V
    ...
    .line 72
    invoke-interface {v3, p2}, Ldwp;->b(Ljava/util/List;)Ljava/util/List;
...
.method public final b(J)Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;
    ...
    invoke-virtual {v0, p1, p2}, Ldql$a;->a(J)Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;
...
.method public final b(Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;)V
    ...
    .prologue
    .line 182
    invoke-virtual {p0, p1}, Ldql;->c(Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;)Z
    ...
    invoke-virtual {p0, v0, p1}, Ldql;->a(ILcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;)V
...
.method public final c(J)Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;
    ...
    .line 131
    invoke-interface {v3, p1, p2}, Ldwp;->b(J)Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;
    ...
    invoke-virtual {v2}, Ldwo;->c()Ldwp;

    move-result-object v2

    .line 140
    invoke-interface {v2, v1}, Ldwp;->a(Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;)I
    :try_end_0
    .catch Lcom/laiwang/protocol/media/MediaIdEncodingException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_2
    :goto_1
    iget-object v2, p0, Ldql;->a:Ldql$a;

    invoke-virtual {v2, v1}, Ldql$a;->a(Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;)V

    .line 147
    const/16 v2, 0x65

    invoke-virtual {p0, v2, v1}, Ldql;->a(ILcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;)V
...
.method public c(Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;)Z
    ...
    invoke-virtual {v1, p1}, Ldql$a;->a(Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;)V
    ...
    .line 203
    invoke-interface {v1, p1}, Ldwp;->a(Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;)I
