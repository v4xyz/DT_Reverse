...
# virtual methods
.method public final a(JIZLbsv;)V
    .locals 5
    .param p1, "orgId"    # J
    .param p3, "scope"    # I
    ...
    .prologue
    .line 83
    .local p5, "apiEventListener":Lbsv;, "Lbsv<Lcom/alibaba/android/dingtalk/userbase/model/LabelGroupObjectList;>;"
    new-instance v0, Ldps$1;

    invoke-direct {v0, p0, p5}, Ldps$1;-><init>(Ldps;Lbsv;)V

    .line 91
    .local v0, "handler":Lbtb;, "Lbtb<Lbmx;Lcom/alibaba/android/dingtalk/userbase/model/LabelGroupObjectList;>;"
    ...
    invoke-interface {v1, v2, v3, v4, v0}, Lcom/alibaba/android/user/idl/services/LabelIService;->getLabelGroupModelsWithPermission(Ljava/lang/Long;Ljava/lang/Integer;Ljava/lang/Boolean;Lfos;)V
