...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ldwz;->a(Ljava/util/List;)I
.end annotation
...
.field final synthetic c:Ldwz;


# direct methods
.method constructor <init>(Ldwz;Ljava/util/List;Ljava/util/concurrent/atomic/AtomicInteger;)V
    .locals 0
    .param p1, "this$0"    # Ldwz;

    .prologue
    .line 106
    iput-object p1, p0, Ldwz$1;->c:Ldwz;

    iput-object p2, p0, Ldwz$1;->a:Ljava/util/List;

    iput-object p3, p0, Ldwz$1;->b:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final run()V
    ...
    :try_start_0
    iget-object v4, p0, Ldwz$1;->c:Ldwz;

    invoke-static {v4}, Ldwz;->b(Ldwz;)Lcom/alibaba/bee/DBManager;

    move-result-object v4

    iget-object v5, p0, Ldwz$1;->c:Ldwz;

    invoke-static {v5}, Ldwz;->a(Ldwz;)Ljava/lang/String;
    ...
    .line 112
    iget-object v4, p0, Ldwz$1;->a:Ljava/util/List;
    ...
    .line 118
    iget-object v5, p0, Ldwz$1;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 124
    invoke-static {v3}, Ldwz;->a(Lcom/alibaba/bee/SQLiteStatement;)V
