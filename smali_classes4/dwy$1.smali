...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ldwy;->a(Ljava/util/List;)I
.end annotation
...
.field final synthetic c:Ldwy;


# direct methods
.method constructor <init>(Ldwy;Ljava/util/List;Ljava/util/concurrent/atomic/AtomicInteger;)V
    .locals 0
    .param p1, "this$0"    # Ldwy;

    .prologue
    .line 27
    iput-object p1, p0, Ldwy$1;->c:Ldwy;

    iput-object p2, p0, Ldwy$1;->a:Ljava/util/List;

    iput-object p3, p0, Ldwy$1;->b:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final run()V
    ...
    :try_start_0
    iget-object v3, p0, Ldwy$1;->c:Ldwy;

    invoke-static {v3}, Ldwy;->b(Ldwy;)Lcom/alibaba/bee/DBManager;

    move-result-object v3

    iget-object v4, p0, Ldwy$1;->c:Ldwy;

    invoke-static {v4}, Ldwy;->a(Ldwy;)Ljava/lang/String;
    ...
    .line 33
    iget-object v3, p0, Ldwy$1;->a:Ljava/util/List;
    ...
    .line 42
    iget-object v4, p0, Ldwy$1;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-static {v2}, Ldwy;->a(Lcom/alibaba/bee/SQLiteStatement;)V
