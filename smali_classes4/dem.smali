...
.method public constructor <init>(Landroid/app/Activity;Ljava/lang/String;)V
    ...
    .line 38
    iput-object p2, p0, Ldem;->c:Ljava/lang/String;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 55
    iget-object v3, p0, Ldem;->b:Landroid/app/Activity;

    invoke-static {v3}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v3

    sget v6, Ldei$g;->item_ding_search_sender_result:I
    ...
    invoke-direct {v0, v3, p0, p2}, Ldjc;-><init>(Landroid/app/Activity;Ldem;Landroid/view/View;)V

    .line 57
    .local v0, "holder":Ldjc;
    ...
    iget-object v3, p0, Ldem;->a:Ljava/util/List;
    ...
    iget-object v3, p0, Ldem;->c:Ljava/lang/String;
    ...
    .line 1087
    iget-object v6, v0, Ldjc;->b:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;
    ...
    .line 1105
    invoke-static {v6, v3}, Lbus;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1109
    :cond_1
    iget-object v6, v0, Ldjc;->c:Landroid/widget/TextView;

    iget-object v7, v0, Ldjc;->g:Landroid/app/Activity;

    invoke-static {v7, v3}, Lbus;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    .line 1116
    iget-object v3, v0, Ldjc;->d:Landroid/widget/TextView;

    invoke-virtual {v2}, Lcom/alibaba/android/ding/base/objects/ObjectDing;->N()J

    move-result-wide v6

    invoke-static {v6, v7}, Lbuj;->h(J)Ljava/lang/String;
    ...
    .line 1136
    :goto_3
    iget-object v5, v0, Ldjc;->e:Landroid/widget/TextView;

    invoke-virtual {v5, v3}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 1140
    :cond_4
    iget-object v3, v0, Ldjc;->f:Landroid/view/View;
    ...
    .line 1147
    iget-object v3, v0, Ldjc;->a:Landroid/view/View;

    new-instance v4, Ldjc$1;

    invoke-direct {v4, v0, v2}, Ldjc$1;-><init>(Ldjc;Lcom/alibaba/android/ding/base/objects/ObjectDing;)V
    ...
    :cond_9
    iget-object v8, v0, Ldjc;->b:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;
    ...
    sget v5, Ldei$h;->dt_search_result_type_attachment:I
    ...
    sget v5, Ldei$h;->dt_search_result_type_audio:I
