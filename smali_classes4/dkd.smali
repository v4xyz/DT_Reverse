...
.method private a(Ldkd$a;Z)V
    .locals 3
    .param p1, "viewHolder"    # Ldkd$a;
    ...
    .line 128
    iget-object v0, p1, Ldkd$a;->c:Landroid/widget/TextView;
    ...
    iget-object v1, p0, Ldkd;->d:Landroid/app/Activity;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 50
    iget-object v4, p0, Ldkd;->d:Landroid/app/Activity;
    ...
    sget v4, Ldjt$i;->layout_conf_search_item:I
    ...
    .line 52
    new-instance v2, Ldkd$a;

    invoke-direct {v2, p0, v8}, Ldkd$a;-><init>(Ldkd;B)V

    .line 53
    .local v2, "searchHolder":Ldkd$a;
    sget v4, Ldjt$h;->search_user_avatar:I
    ...
    iput-object v4, v2, Ldkd$a;->a:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;

    .line 54
    sget v4, Ldjt$h;->search_user_name:I
    ...
    iput-object v4, v2, Ldkd$a;->b:Landroid/widget/TextView;

    .line 55
    sget v4, Ldjt$h;->search_user_number:I
    ...
    iput-object v4, v2, Ldkd$a;->c:Landroid/widget/TextView;

    .line 56
    sget v4, Ldjt$h;->search_divider_line:I

    invoke-virtual {p2, v4}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v4

    iput-object v4, v2, Ldkd$a;->d:Landroid/view/View;
    ...
    :goto_0
    iget-object v4, p0, Ldkd;->c:Ljava/util/List;
    ...
    .line 59
    .end local v2    # "searchHolder":Ldkd$a;
    :cond_1
    invoke-virtual {p2}, Landroid/view/View;->getTag()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Ldkd$a;

    .restart local v2    # "searchHolder":Ldkd$a;
    goto :goto_0
    ...
    .line 69
    .local v1, "lastOne":Z
    invoke-virtual {p0}, Ldkd;->getCount()I
    ...
    .line 1086
    invoke-direct {p0, v2, v8}, Ldkd;->a(Ldkd$a;Z)V
    ...
    .line 1094
    :cond_4
    iget-object v6, v2, Ldkd$a;->b:Landroid/widget/TextView;

    invoke-virtual {v6, v4}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 1095
    iget-object v6, v2, Ldkd$a;->a:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;
    ...
    .line 1098
    iget-object v4, v2, Ldkd$a;->c:Landroid/widget/TextView;
    ...
    iget-object v6, p0, Ldkd;->d:Landroid/app/Activity;

    iget-object v7, v5, Lcom/alibaba/android/dingtalk/userbase/model/UserIdentityObject;->mobile:Ljava/lang/String;

    invoke-static {v6, v7}, Lbus;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v2, v4}, Ldkd;->a(Ldkd$a;Z)V
    ...
    .line 1116
    invoke-static {v9, v6}, Lbtf;->b(Landroid/content/Context;F)I
    ...
    invoke-static {v9, v5}, Lbtf;->b(Landroid/content/Context;F)I
    ...
    .line 1122
    :goto_5
    iget-object v5, v2, Ldkd$a;->d:Landroid/view/View;
    ...
    .line 1105
    iget-object v4, v2, Ldkd$a;->a:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;

    sget v5, Ldjt$g;->add_external:I
    ...
    sget v5, Ldjt$k;->dt_conference_add_user_into_extra_contacts:I
    ...
    .line 1107
    iget-object v5, v2, Ldkd$a;->b:Landroid/widget/TextView;
