...
.method static synthetic a(Lduq;)Lblr;
    .locals 1
    .param p0, "x0"    # Lduq;

    .prologue
    .line 34
    iget-object v0, p0, Lduq;->i:Lblr;

    return-object v0
.end method

.method static synthetic b(Lduq;)Lblr;
    .locals 1
    .param p0, "x0"    # Lduq;
...
.method static synthetic c(Lduq;)Lblr;
    .locals 1
    .param p0, "x0"    # Lduq;
...
.method public final a(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lduq;->n:Landroid/widget/CheckBox;
...
.method public final a(Lcom/alibaba/android/dingtalk/userbase/model/OrgNodeItemObject;ILandroid/view/ViewGroup;)V
    ...
    iget-object v4, p0, Lduq;->m:Lcom/alibaba/android/dingtalk/userbase/model/UserIdentityObject;

    invoke-interface {v1, v4}, Lblr;->d(Ljava/lang/Object;)Z

    move-result v1

    iput-boolean v1, p0, Lduq;->q:Z
    ...
    invoke-interface {v1, v4}, Lblr;->c(Ljava/lang/Object;)Z

    move-result v1

    if-nez v1, :cond_1

    iget-object v1, p0, Lduq;->m:Lcom/alibaba/android/dingtalk/userbase/model/UserIdentityObject;
    ...
    invoke-interface {v1, v4}, Lblr;->e(Ljava/lang/Object;)Z

    move-result v1

    iput-boolean v1, p0, Lduq;->p:Z

    .line 68
    :cond_2
    iget-object v1, p0, Lduq;->n:Landroid/widget/CheckBox;
    ...
    sget v2, Ldop$f;->icon_checkbox_unable:I

    invoke-virtual {v1, v2}, Landroid/widget/CheckBox;->setBackgroundResource(I)V

    .line 77
    iget-object v1, p0, Lduq;->k:Landroid/widget/TextView;

    iget-object v2, p0, Lduq;->a:Landroid/app/Activity;
    ...
    iget-object v3, p0, Lduq;->a:Landroid/app/Activity;

    sget v4, Ldop$d;->text_color_black:I

    invoke-static {v3, v4}, Lcw;->c(Landroid/content/Context;I)I
    ...
    iget-boolean v2, p0, Lduq;->q:Z

    invoke-virtual {v1, v2}, Landroid/widget/CheckBox;->setChecked(Z)V

    .line 85
    iget-boolean v1, p0, Lduq;->q:Z
    ...
    sget v2, Ldop$f;->checkbox_pressed:I
    ...
    new-instance v2, Lduq$1;

    invoke-direct {v2, p0, p1}, Lduq$1;-><init>(Lduq;Lcom/alibaba/android/dingtalk/userbase/model/OrgNodeItemObject;)V
    ...
    sget v2, Ldop$f;->checkbox_normal:I
...
.method public final synthetic a(Ljava/lang/Object;I)V
    ...
    .line 1113
    iget-boolean v0, p0, Lduq;->o:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, Lduq;->p:Z
    ...
    .line 1114
    :cond_1
    iget-object v0, p0, Lduq;->m:Lcom/alibaba/android/dingtalk/userbase/model/UserIdentityObject;
    ...
    .line 1125
    iget-object v0, p0, Lduq;->n:Landroid/widget/CheckBox;
...
.method public final bridge synthetic a(Ljava/lang/Object;ILandroid/view/ViewGroup;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lduq;->a(Lcom/alibaba/android/dingtalk/userbase/model/OrgNodeItemObject;ILandroid/view/ViewGroup;)V
...
.method public final d()I
    ...
    .prologue
    .line 47
    sget v0, Ldop$h;->item_new_contact:I
