...
.method static synthetic a(Ldwq;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Ldwq;

    .prologue
    .line 25
    invoke-virtual {p0}, Ldwq;->i()Ljava/lang/String;
...
.method static synthetic b(Ldwq;)Lcom/alibaba/bee/DBManager;
    .locals 1
    .param p0, "x0"    # Ldwq;

    .prologue
    .line 25
    iget-object v0, p0, Ldwq;->c:Lcom/alibaba/bee/DBManager;

    return-object v0
.end method

.method static synthetic c(Ldwq;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Ldwq;
...
.method static synthetic d(Ldwq;)Lcom/alibaba/bee/DBManager;
    .locals 1
    .param p0, "x0"    # Ldwq;
...
.method public final a(Lcom/alibaba/android/dingtalk/userbase/model/CommonContactObject;)I
    ...
    iget-object v2, v0, Ldwq;->c:Lcom/alibaba/bee/DBManager;

    invoke-virtual/range {p0 .. p0}, Ldwq;->i()Ljava/lang/String;
    ...
    .line 124
    invoke-static {v15}, Ldwq;->a(Lcom/alibaba/bee/SQLiteStatement;)V
...
.method public final a(Ljava/util/List;)I
    ...
    iget-object v1, p0, Ldwq;->c:Lcom/alibaba/bee/DBManager;

    invoke-virtual {p0}, Ldwq;->i()Ljava/lang/String;

    move-result-object v2

    new-instance v3, Ldwq$1;

    invoke-direct {v3, p0, p1, v0}, Ldwq$1;-><init>(Ldwq;Ljava/util/List;Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public final a(I)Ljava/util/List;
    ...
    iget-object v10, v0, Ldwq;->c:Lcom/alibaba/bee/DBManager;
    ...
    invoke-interface {v2, v4, v5}, Ldwh;->b(J)Z
    ...
    invoke-interface {v2, v3}, Ldwj;->a(Ljava/lang/String;)Ljava/util/List;
...
.method public final b(Ljava/util/List;)I
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Ljava/util/List",
            "<",
            "Lcom/alibaba/android/user/entry/CommonContactEntry;",
            ">;)I"
        }
    .end annotation
    ...
    .prologue
    .line 186
    .local p1, "contacts":Ljava/util/List;, "Ljava/util/List<Lcom/alibaba/android/user/entry/CommonContactEntry;>;"
    ...
    :try_start_0
    iget-object v4, p0, Ldwq;->c:Lcom/alibaba/bee/DBManager;
    ...
    const-class v7, Lcom/alibaba/android/user/entry/CommonContactEntry;

    const-string/jumbo v8, "tb_common_contact"
    ...
    check-cast v1, Lcom/alibaba/android/user/entry/CommonContactEntry;
    ...
    .line 197
    invoke-virtual {v1, v3}, Lcom/alibaba/android/user/entry/CommonContactEntry;->bindArgs(Lcom/alibaba/bee/SQLiteStatement;)V
    ...
    .line 207
    invoke-static {v3}, Ldwq;->a(Lcom/alibaba/bee/SQLiteStatement;)V

    .line 211
    .end local v0    # "e":Ljava/lang/Exception;
    .end local v3    # "statement":Lcom/alibaba/bee/SQLiteStatement;
    :cond_1
    :goto_1
    ...
    .line 207
    .restart local v3    # "statement":Lcom/alibaba/bee/SQLiteStatement;
    :cond_2
    invoke-static {v3}, Ldwq;->a(Lcom/alibaba/bee/SQLiteStatement;)V
...
.method public final b(I)Ljava/util/List;
    ...
    .line 291
    .local v10, "entries":Ljava/util/List;, "Ljava/util/List<Lcom/alibaba/android/user/entry/CommonContactEntry;>;"
    if-eqz v9, :cond_2
    ...
    .line 295
    .end local v10    # "entries":Ljava/util/List;, "Ljava/util/List<Lcom/alibaba/android/user/entry/CommonContactEntry;>;"
    .local v11, "entries":Ljava/util/List;, "Ljava/util/List<Lcom/alibaba/android/user/entry/CommonContactEntry;>;"
    :cond_0
    :goto_0
    :try_start_1
    invoke-interface {v9}, Landroid/database/Cursor;->moveToNext()Z
    ...
    .line 297
    new-instance v12, Lcom/alibaba/android/user/entry/CommonContactEntry;

    invoke-direct {v12}, Lcom/alibaba/android/user/entry/CommonContactEntry;-><init>()V

    .line 298
    .local v12, "entry":Lcom/alibaba/android/user/entry/CommonContactEntry;
    invoke-virtual {v12, v9}, Lcom/alibaba/android/user/entry/CommonContactEntry;->fillWithCursor(Landroid/database/Cursor;)V

    .line 300
    iget-wide v0, v12, Lcom/alibaba/android/user/entry/CommonContactEntry;->uid:J
    ...
    .line 305
    .end local v12    # "entry":Lcom/alibaba/android/user/entry/CommonContactEntry;
    :catchall_0
    move-exception v0

    move-object v10, v11

    .end local v11    # "entries":Ljava/util/List;, "Ljava/util/List<Lcom/alibaba/android/user/entry/CommonContactEntry;>;"
    .restart local v10    # "entries":Ljava/util/List;, "Ljava/util/List<Lcom/alibaba/android/user/entry/CommonContactEntry;>;"
    :goto_1
    invoke-interface {v9}, Landroid/database/Cursor;->close()V
    ...
    .end local v10    # "entries":Ljava/util/List;, "Ljava/util/List<Lcom/alibaba/android/user/entry/CommonContactEntry;>;"
    .restart local v11    # "entries":Ljava/util/List;, "Ljava/util/List<Lcom/alibaba/android/user/entry/CommonContactEntry;>;"
    :cond_1
    invoke-interface {v9}, Landroid/database/Cursor;->close()V
