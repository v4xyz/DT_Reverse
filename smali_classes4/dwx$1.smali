...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ldwx;->a(Ljava/util/List;J)I
.end annotation
...
.field final synthetic d:Ldwx;


# direct methods
.method constructor <init>(Ldwx;Ljava/util/List;JLjava/util/concurrent/atomic/AtomicInteger;)V
    .locals 1
    .param p1, "this$0"    # Ldwx;

    .prologue
    .line 33
    iput-object p1, p0, Ldwx$1;->d:Ldwx;

    iput-object p2, p0, Ldwx$1;->a:Ljava/util/List;

    iput-wide p3, p0, Ldwx$1;->b:J

    iput-object p5, p0, Ldwx$1;->c:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final run()V
    ...
    :try_start_0
    iget-object v5, p0, Ldwx$1;->d:Ldwx;

    invoke-static {v5}, Ldwx;->b(Ldwx;)Lcom/alibaba/bee/DBManager;

    move-result-object v5

    iget-object v6, p0, Ldwx$1;->d:Ldwx;

    invoke-static {v6}, Ldwx;->a(Ldwx;)Ljava/lang/String;
    ...
    .line 39
    iget-object v5, p0, Ldwx$1;->a:Ljava/util/List;
    ...
    iget-wide v6, p0, Ldwx$1;->b:J

    invoke-direct {v3, v2, v6, v7}, Lcom/alibaba/android/dingtalk/userbase/model/QuotaObject;-><init>(Lboj;J)V
    ...
    .line 45
    iget-object v6, p0, Ldwx$1;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 50
    invoke-static {v4}, Ldwx;->a(Lcom/alibaba/bee/SQLiteStatement;)V
