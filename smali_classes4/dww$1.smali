...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ldww;->a(Ljava/util/List;)I
.end annotation
...
.field final synthetic c:Ldww;


# direct methods
.method constructor <init>(Ldww;Ljava/util/List;Ljava/util/concurrent/atomic/AtomicInteger;)V
    .locals 0
    .param p1, "this$0"    # Ldww;

    .prologue
    .line 49
    iput-object p1, p0, Ldww$1;->c:Ldww;

    iput-object p2, p0, Ldww$1;->a:Ljava/util/List;

    iput-object p3, p0, Ldww$1;->b:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final run()V
    ...
    :try_start_0
    iget-object v4, p0, Ldww$1;->c:Ldww;

    invoke-static {v4}, Ldww;->b(Ldww;)Lcom/alibaba/bee/DBManager;

    move-result-object v4

    iget-object v5, p0, Ldww$1;->c:Ldww;

    invoke-static {v5}, Ldww;->a(Ldww;)Ljava/lang/String;
    ...
    .line 56
    iget-object v4, p0, Ldww$1;->a:Ljava/util/List;
    ...
    .line 57
    .local v2, "object":Leab;
    if-eqz v2, :cond_0

    .line 58
    invoke-static {v2}, Leab;->a(Leab;)Lcom/alibaba/android/user/entry/OrgUserNameEntry;
    ...
    .line 65
    iget-object v5, p0, Ldww$1;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 71
    invoke-static {v3}, Ldww;->a(Lcom/alibaba/bee/SQLiteStatement;)V
