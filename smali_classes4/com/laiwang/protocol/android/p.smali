...
# direct methods
.method public constructor <init>(Lcom/laiwang/protocol/android/Extension;Lcom/laiwang/protocol/android/bo;Lcom/laiwang/protocol/android/bv;Landroid/content/Context;Landroid/app/PendingIntent;Lcom/laiwang/protocol/android/bv;)V
    .locals 0
    ...
    .param p6, "readExecutor"    # Lcom/laiwang/protocol/android/bv;

    .prologue
    .line 40
    invoke-direct {p0, p3, p2, p1, p6}, Lcom/laiwang/protocol/android/n;-><init>(Lcom/laiwang/protocol/android/bv;Lcom/laiwang/protocol/android/bo;Lcom/laiwang/protocol/android/Extension;Lcom/laiwang/protocol/android/bv;)V
...
.method private b(Lcom/laiwang/protocol/android/m;)Lcom/laiwang/protocol/android/be;
    .locals 7
    ...
    .line 294
    iget-object v2, p0, Lcom/laiwang/protocol/android/p;->a:Lcom/laiwang/protocol/android/bg;

    invoke-virtual {v2}, Lcom/laiwang/protocol/android/bg;->b()Lcom/laiwang/protocol/android/be;

    move-result-object v0

    .line 295
    .local v0, "message":Lcom/laiwang/protocol/android/be;
    if-nez v0, :cond_0

    move-object v0, v1

    .line 307
    .end local v0    # "message":Lcom/laiwang/protocol/android/be;
    :goto_0
    return-object v0

    .line 296
    .restart local v0    # "message":Lcom/laiwang/protocol/android/be;
    :cond_0
    ...
    invoke-virtual {v0}, Lcom/laiwang/protocol/android/be;->startLine()Ljava/lang/Object;
    ...
    invoke-virtual {v2, v0}, Lcom/laiwang/protocol/android/bg;->a(Lcom/laiwang/protocol/android/be;)V
    ...
    invoke-virtual {v2, v0}, Lcom/laiwang/protocol/android/bg;->c(Lcom/laiwang/protocol/android/be;)Z
...
# virtual methods
.method public a(Lcom/laiwang/protocol/android/m;J)Lcom/laiwang/protocol/android/be;
    .locals 4
    .param p1, "connection"    # Lcom/laiwang/protocol/android/m;
    .param p2, "timeout"    # J
    ...
    .line 281
    .local v2, "out":Lcom/laiwang/protocol/android/be;
    :try_start_0
    invoke-direct {p0, p1}, Lcom/laiwang/protocol/android/p;->b(Lcom/laiwang/protocol/android/m;)Lcom/laiwang/protocol/android/be;
    ...
    .line 284
    invoke-virtual {p0, p1, p2, p3}, Lcom/laiwang/protocol/android/p;->a(Lcom/laiwang/protocol/android/m;J)Lcom/laiwang/protocol/android/be;
    :try_end_0
...
.method public declared-synchronized a()V
    ...
    iget-object v1, p0, Lcom/laiwang/protocol/android/p;->d:Lcom/laiwang/protocol/android/bv;
    ...
    iget-object v10, p0, Lcom/laiwang/protocol/android/p;->e:Lcom/laiwang/protocol/android/bv;

    invoke-direct/range {v0 .. v10}, Lcom/laiwang/protocol/android/m;-><init>(Lcom/laiwang/protocol/android/bv;Lcom/laiwang/protocol/b;IZZZLandroid/content/Context;Landroid/app/PendingIntent;Lcom/laiwang/protocol/android/Extension;Lcom/laiwang/protocol/android/bv;)V

    iput-object v0, p0, Lcom/laiwang/protocol/android/p;->c:Lcom/laiwang/protocol/android/m;

    .line 324
    iget-object v0, p0, Lcom/laiwang/protocol/android/p;->f:Lcom/laiwang/protocol/android/bo;

    sget-object v1, Lcom/laiwang/protocol/android/ax;->a:Lcom/laiwang/protocol/android/ax;

    invoke-virtual {v0, v1}, Lcom/laiwang/protocol/android/bo;->a(Lcom/laiwang/protocol/android/ax;)Ljava/net/URI;
    ...
    .line 329
    invoke-static {}, Lcom/laiwang/protocol/android/ch;->d()Z
...
.method public declared-synchronized a(Lcom/laiwang/protocol/android/be;)V
    ...
    .line 337
    invoke-super {p0, p1}, Lcom/laiwang/protocol/android/n;->a(Lcom/laiwang/protocol/android/be;)V
    ...
    invoke-virtual {p1, v0}, Lcom/laiwang/protocol/android/be;->hasAttr(Lcom/laiwang/protocol/attribute/AttributeKey;)Z
...
.method public declared-synchronized b(Lcom/laiwang/protocol/android/k;Ljava/lang/Throwable;)V
    ...
    .line 254
    iget-object v4, p0, Lcom/laiwang/protocol/android/p;->a:Lcom/laiwang/protocol/android/bg;

    invoke-virtual {v4}, Lcom/laiwang/protocol/android/bg;->e()V
    ...
    .line 264
    iget-object v5, p0, Lcom/laiwang/protocol/android/p;->d:Lcom/laiwang/protocol/android/bv;

    invoke-virtual {v5, v3}, Lcom/laiwang/protocol/android/bv;->b(Ljava/lang/Runnable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public k(Lcom/laiwang/protocol/android/k;)V
    ...
    .line 88
    :cond_0
    iget-object v0, p0, Lcom/laiwang/protocol/android/p;->d:Lcom/laiwang/protocol/android/bv;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/laiwang/protocol/android/p;->d:Lcom/laiwang/protocol/android/bv;

    instance-of v0, v0, Lcom/laiwang/protocol/android/bu;
    ...
    check-cast v0, Lcom/laiwang/protocol/android/bu;

    invoke-virtual {v0}, Lcom/laiwang/protocol/android/bu;->c()V
