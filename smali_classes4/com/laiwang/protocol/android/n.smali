...
# instance fields
.field protected a:Lcom/laiwang/protocol/android/bg;
...
.field protected d:Lcom/laiwang/protocol/android/bv;

.field protected e:Lcom/laiwang/protocol/android/bv;

.field protected f:Lcom/laiwang/protocol/android/bo;
...
# direct methods
.method public constructor <init>(Lcom/laiwang/protocol/android/bv;Lcom/laiwang/protocol/android/bo;Lcom/laiwang/protocol/android/Extension;Lcom/laiwang/protocol/android/bv;)V
    .locals 2
    .param p1, "ioExecutor"    # Lcom/laiwang/protocol/android/bv;
    .param p2, "scheduleEngine"    # Lcom/laiwang/protocol/android/bo;
    .param p3, "extension"    # Lcom/laiwang/protocol/android/Extension;
    .param p4, "readExecutor"    # Lcom/laiwang/protocol/android/bv;
    ...
    invoke-direct {v0}, Lcom/laiwang/protocol/android/bg;-><init>()V

    iput-object v0, p0, Lcom/laiwang/protocol/android/n;->a:Lcom/laiwang/protocol/android/bg;
    ...
    .line 65
    iput-object p1, p0, Lcom/laiwang/protocol/android/n;->d:Lcom/laiwang/protocol/android/bv;

    .line 66
    iput-object p4, p0, Lcom/laiwang/protocol/android/n;->e:Lcom/laiwang/protocol/android/bv;

    .line 67
    iput-object p2, p0, Lcom/laiwang/protocol/android/n;->f:Lcom/laiwang/protocol/android/bo;
    ...
    .line 70
    invoke-static {v1}, Lcom/laiwang/protocol/android/ch;->b(Landroid/content/Context;)Lcom/laiwang/protocol/network/Network$State;
...
.method private a(Lcom/laiwang/protocol/core/Request;)V
    ...
    :cond_2
    iget-object v1, p0, Lcom/laiwang/protocol/android/n;->a:Lcom/laiwang/protocol/android/bg;

    invoke-virtual {v1, p1}, Lcom/laiwang/protocol/android/bg;->c(Lcom/laiwang/protocol/android/be;)Z
...
.method private a(Lcom/laiwang/protocol/core/Request;Lcom/laiwang/protocol/android/k;Lcom/laiwang/protocol/core/Constants$Status;[B)V
    ...
    check-cast v3, Lcom/laiwang/protocol/android/bv$a;

    .line 313
    .local v3, "timeout":Lcom/laiwang/protocol/android/bv$a;
    if-eqz v3, :cond_0

    .line 314
    iget-object v4, p0, Lcom/laiwang/protocol/android/n;->d:Lcom/laiwang/protocol/android/bv;

    invoke-virtual {v4, v3}, Lcom/laiwang/protocol/android/bv;->b(Ljava/lang/Runnable;)V
    ...
    .line 324
    invoke-static {v2}, Lcom/laiwang/protocol/android/LWP;->onRemoteMessage(Lcom/laiwang/protocol/android/be;)V

    .line 332
    .end local v1    # "id":Ljava/lang/String;
    .end local v2    # "response":Lcom/laiwang/protocol/core/Response;
    .end local v3    # "timeout":Lcom/laiwang/protocol/android/bv$a;
    :cond_2
    :goto_0
    return-void
    ...
    .restart local v3    # "timeout":Lcom/laiwang/protocol/android/bv$a;
    :cond_3
...
.method private a(Ljava/net/URI;)V
    ...
    .line 393
    iget-object v2, p0, Lcom/laiwang/protocol/android/n;->f:Lcom/laiwang/protocol/android/bo;
    ...
    :goto_0
    invoke-virtual {v2, p1, v0}, Lcom/laiwang/protocol/android/bo;->b(Ljava/net/URI;Z)V
...
# virtual methods
.method protected abstract a(Lcom/laiwang/protocol/android/m;J)Lcom/laiwang/protocol/android/be;
.end method
...
.method public a(Lcom/laiwang/protocol/android/be;)V
    .locals 8
    .param p1, "message"    # Lcom/laiwang/protocol/android/be;
    ...
    invoke-virtual {v1, v5, v6}, Lcom/laiwang/protocol/core/Request;->header(Ljava/lang/String;Ljava/lang/String;)Lcom/laiwang/protocol/android/be;
    ...
    :cond_2
    iget-object v5, p0, Lcom/laiwang/protocol/android/n;->a:Lcom/laiwang/protocol/android/bg;

    invoke-virtual {v5, p1}, Lcom/laiwang/protocol/android/bg;->a(Lcom/laiwang/protocol/android/be;)V
    ...
    .end local p1    # "message":Lcom/laiwang/protocol/android/be;
    ...
    .line 139
    .local v4, "task":Lcom/laiwang/protocol/android/bv$a;
    iget-object v5, p0, Lcom/laiwang/protocol/android/n;->d:Lcom/laiwang/protocol/android/bv;

    invoke-virtual {v5, v4}, Lcom/laiwang/protocol/android/bv;->a(Lcom/laiwang/protocol/android/bv$a;)V
    ...
    .line 143
    .end local v4    # "task":Lcom/laiwang/protocol/android/bv$a;
    :cond_3
    :goto_1
    return-void
    ...
    .restart local p1    # "message":Lcom/laiwang/protocol/android/be;
    :cond_4
...
.method public a(Lcom/laiwang/protocol/android/be;Lcom/laiwang/protocol/android/m;)V
    .locals 4
    .param p1, "message"    # Lcom/laiwang/protocol/android/be;
    ...
    invoke-virtual {p1, v1}, Lcom/laiwang/protocol/android/be;->attr(Lcom/laiwang/protocol/attribute/AttributeKey;)Lcom/laiwang/protocol/attribute/Attribute;
...
.method public a(Lcom/laiwang/protocol/android/k;)V
    ...
    invoke-virtual {p0, v2, v4, v5}, Lcom/laiwang/protocol/android/n;->a(Lcom/laiwang/protocol/android/m;J)Lcom/laiwang/protocol/android/be;

    move-result-object v1

    .line 362
    .local v1, "req":Lcom/laiwang/protocol/android/be;
    if-eqz v1, :cond_0
    ...
    invoke-virtual {v1}, Lcom/laiwang/protocol/android/be;->getId()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lcom/laiwang/protocol/android/m;->a(Lcom/laiwang/protocol/android/be;)V

    .line 366
    check-cast p1, Lcom/laiwang/protocol/android/m;

    .end local p1    # "connection":Lcom/laiwang/protocol/android/k;
    invoke-virtual {p0, v1, p1}, Lcom/laiwang/protocol/android/n;->a(Lcom/laiwang/protocol/android/be;Lcom/laiwang/protocol/android/m;)V
...
.method protected declared-synchronized a(Lcom/laiwang/protocol/android/m;)V
    ...
    invoke-virtual {v5, v2}, Lcom/laiwang/protocol/android/bg;->a(Lcom/laiwang/protocol/android/be;)V
...
.method public a(Lcom/laiwang/protocol/android/m;Lcom/laiwang/protocol/android/be;)V
    .locals 13
    .param p1, "connection"    # Lcom/laiwang/protocol/android/m;
    .param p2, "message"    # Lcom/laiwang/protocol/android/be;
    ...
    invoke-virtual {p2, v9}, Lcom/laiwang/protocol/android/be;->header(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lcom/laiwang/protocol/android/be;->getId()Ljava/lang/String;
    ...
    .end local p2    # "message":Lcom/laiwang/protocol/android/be;
    ...
    .restart local p2    # "message":Lcom/laiwang/protocol/android/be;
    :cond_2
    iget-object v9, p0, Lcom/laiwang/protocol/android/n;->b:Ljava/util/Map;
    ...
    check-cast v8, Lcom/laiwang/protocol/android/bv$a;

    .line 209
    .local v8, "timeout":Lcom/laiwang/protocol/android/bv$a;
    if-eqz v8, :cond_4

    .line 210
    iget-object v9, p0, Lcom/laiwang/protocol/android/n;->d:Lcom/laiwang/protocol/android/bv;

    invoke-virtual {v9, v8}, Lcom/laiwang/protocol/android/bv;->b(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v9, v10}, Lcom/laiwang/protocol/android/bv;->a(Lcom/laiwang/protocol/android/bv$a;)V
    ...
    .line 220
    invoke-static {v7}, Lcom/laiwang/protocol/android/LWP;->onRemoteMessage(Lcom/laiwang/protocol/android/be;)V
    ...
    .end local v6    # "request":Lcom/laiwang/protocol/core/Request;
    .end local v7    # "response":Lcom/laiwang/protocol/core/Response;
    .end local v8    # "timeout":Lcom/laiwang/protocol/android/bv$a;
    :cond_8
    invoke-static {}, Lcom/laiwang/protocol/android/IdleService;->getInstance()Lcom/laiwang/protocol/android/IdleService;
    ...
    .line 266
    invoke-static {v6}, Lcom/laiwang/protocol/android/LWP;->onRemoteMessage(Lcom/laiwang/protocol/android/be;)V
...
.method public a(Ljava/io/IOException;)V
    ...
    .line 161
    iget-object v0, p0, Lcom/laiwang/protocol/android/n;->a:Lcom/laiwang/protocol/android/bg;

    invoke-virtual {v0}, Lcom/laiwang/protocol/android/bg;->a()V
...
.method protected a(Lcom/laiwang/protocol/core/Request;Lcom/laiwang/protocol/android/k;)Z
    ...
    .line 84
    iget-object v2, p0, Lcom/laiwang/protocol/android/n;->a:Lcom/laiwang/protocol/android/bg;

    invoke-virtual {v2, p1}, Lcom/laiwang/protocol/android/bg;->b(Lcom/laiwang/protocol/android/be;)Z
...
.method public c()Z
    ...
    invoke-virtual {v0}, Lcom/laiwang/protocol/android/bg;->c()Z
...
.method public f(Lcom/laiwang/protocol/android/k;)V
    ...
    invoke-virtual {v0}, Lcom/laiwang/protocol/android/bg;->d()V
    ...
    .line 457
    iget-object v1, p0, Lcom/laiwang/protocol/android/n;->f:Lcom/laiwang/protocol/android/bo;
    ...
    :goto_0
    invoke-virtual {v1, v2, v0}, Lcom/laiwang/protocol/android/bo;->a(Ljava/net/URI;Z)V
...
.method public l(Lcom/laiwang/protocol/android/k;)V
    ...
    .line 463
    iget-object v0, p0, Lcom/laiwang/protocol/android/n;->f:Lcom/laiwang/protocol/android/bo;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/laiwang/protocol/android/bo;->a(Z)V
...
.method public m(Lcom/laiwang/protocol/android/k;)V
    ...
    :goto_0
    invoke-virtual {v1, v2, v0}, Lcom/laiwang/protocol/android/bo;->c(Ljava/net/URI;Z)V

    .line 470
    iget-object v0, p0, Lcom/laiwang/protocol/android/n;->f:Lcom/laiwang/protocol/android/bo;

    invoke-virtual {v0}, Lcom/laiwang/protocol/android/bo;->a()Z
