...
.field private mClientManager:Lfxa;

.field private mMessageHandler:Lfxe;
...
.method private onResult(Landroid/content/Context;Lcom/taobao/accs/data/Message;I)V
    ...
    .prologue
    .line 224
    iget-object v0, p0, Lcom/taobao/accs/internal/ACCSManagerImpl;->mMessageHandler:Lfxe;

    if-nez v0, :cond_0

    .line 225
    invoke-static {p1}, Lfxe;->a(Landroid/content/Context;)Lfxe;

    move-result-object v0

    iput-object v0, p0, Lcom/taobao/accs/internal/ACCSManagerImpl;->mMessageHandler:Lfxe;

    .line 227
    :cond_0
    iget-object v0, p0, Lcom/taobao/accs/internal/ACCSManagerImpl;->mMessageHandler:Lfxe;

    invoke-virtual {v0, p2, p3}, Lfxe;->a(Lcom/taobao/accs/data/Message;I)V
...
.method private sendAppNotBind(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 680
    invoke-static {p1, v0}, Lfxf;->a(Landroid/content/Context;Landroid/content/Intent;)V
...
.method private sendControlMessage(Landroid/content/Context;Lcom/taobao/accs/data/Message;IZ)V
    ...
    .line 176
    invoke-static {p1, v7}, Lfxj;->a(Landroid/content/Context;I)Lfxj;

    move-result-object v0

    .line 177
    .local v0, "connection":Lfxj;
    ...
    .line 184
    :cond_1
    iget-object v2, p0, Lcom/taobao/accs/internal/ACCSManagerImpl;->mClientManager:Lfxa;

    if-nez v2, :cond_2

    .line 185
    invoke-static {p1}, Lfxa;->a(Landroid/content/Context;)Lfxa;

    move-result-object v2

    iput-object v2, p0, Lcom/taobao/accs/internal/ACCSManagerImpl;->mClientManager:Lfxa;
    ...
    .line 217
    invoke-virtual {v0, p2, v7}, Lfxj;->b(Lcom/taobao/accs/data/Message;Z)V
    ...
    invoke-virtual {v2, v3}, Lfxa;->c(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v3}, Lfxa;->d(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v3, v4}, Lfxa;->a(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private startChannelService(Landroid/content/Context;)V
    ...
    invoke-static {v1, v2, v3, v4}, Lfxc;->a(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    :try_end_0
...
# virtual methods
.method public bindApp(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lfwp;)V
    .locals 6
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "appKey"    # Ljava/lang/String;
    .param p3, "ttid"    # Ljava/lang/String;
    .param p4, "appCallback"    # Lfwp;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/taobao/accs/internal/ACCSManagerImpl;->bindApp(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lfwp;)V

    .line 62
    return-void
.end method

.method public bindApp(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lfwp;)V
    .locals 9
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "appKey"    # Ljava/lang/String;
    .param p3, "appSecret"    # Ljava/lang/String;
    .param p4, "ttid"    # Ljava/lang/String;
    .param p5, "appCallback"    # Lfwp;
    ...
    .line 93
    :cond_6
    invoke-static {p1}, Lfxb;->a(Landroid/content/Context;)Lfxb;

    move-result-object v6

    invoke-virtual {v6, p5}, Lfxb;->a(Lfwp;)V
    ...
    invoke-virtual {v6, p3}, Lfxb;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v6}, Lfxb;->d()Landroid/content/pm/PackageInfo;
    ...
    new-instance v7, Lfyc$a;

    invoke-direct {v7}, Lfyc$a;-><init>()V

    invoke-static {v6, v7}, Lfyc;->a([Ljava/lang/String;Lcom/taobao/orange/OrangeConfigListenerV1;)V

    .line 129
    invoke-static {}, Lfyc;->c()V
    :try_end_1
...
.method public cancel(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p1, v1}, Lfxj;->a(Landroid/content/Context;I)Lfxj;

    move-result-object v0

    .line 731
    .local v0, "connection":Lfxj;
    invoke-virtual {v0, p2}, Lfxj;->a(Ljava/lang/String;)Z
...
.method public getChannelState()Ljava/util/Map;
    ...
    invoke-static {}, Lfxb;->a()Landroid/content/Context;

    move-result-object v5

    const/4 v6, 0x0

    invoke-static {v5, v6}, Lfxj;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
...
.method public getUserUnit()Ljava/lang/String;
    ...
    invoke-static {v0}, Lfxb;->a(Landroid/content/Context;)Lfxb;

    move-result-object v3

    invoke-virtual {v3}, Lfxb;->c()Ljava/lang/String;
    ...
    invoke-interface {v2, v3, v4}, Ljl;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v0, v2}, Lfxj;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
...
.method public registerDataListener(Landroid/content/Context;Ljava/lang/String;Lfwv;)V
    .locals 1
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "serviceId"    # Ljava/lang/String;
    .param p3, "listener"    # Lfwv;
    ...
    invoke-virtual {v0, p2, p3}, Lfxb;->a(Ljava/lang/String;Lfwv;)V
...
.method public registerSerivce(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 2168
    :cond_1
    iget-object v0, v0, Lfxb;->l:Ljava/util/Map;
...
.method public sendBusinessAck(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;SLjava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {v0, v3}, Lfxj;->a(Landroid/content/Context;I)Lfxj;

    move-result-object v0

    invoke-virtual {v0, v7, v3}, Lfxj;->b(Lcom/taobao/accs/data/Message;Z)V
...
.method public sendData(Landroid/content/Context;Lcom/taobao/accs/ACCSManager$AccsRequest;)Ljava/lang/String;
    ...
    invoke-static {v6, v7, v8, v9, v10}, Lfxw;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5, v6, v7, v8, v9}, Lfxw;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v5}, Lfxj;->a(Landroid/content/Context;I)Lfxj;

    move-result-object v1

    .line 426
    .local v1, "connection":Lfxj;
    ...
    invoke-virtual {v1, v3, v5}, Lfxj;->b(Lcom/taobao/accs/data/Message;Z)V
    :try_end_5
...
.method public sendPushResponse(Landroid/content/Context;Lcom/taobao/accs/ACCSManager$AccsRequest;Lcom/taobao/accs/base/TaoBaseService$ExtraInfo;)Ljava/lang/String;
    ...
    invoke-static {v8, v9, v10, v11, v12}, Lfxw;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v8, v9, v10}, Lfxw;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 542
    invoke-static {p1}, Lfxg;->a(Landroid/content/Context;)Lfxg$a;

    move-result-object v8

    iget-object v5, v8, Lfxg$a;->a:Ljava/lang/String;
    ...
    invoke-static {p1}, Lfxj;->b(Landroid/content/Context;)Ljava/lang/String;
...
.method public sendRequest(Landroid/content/Context;Lcom/taobao/accs/ACCSManager$AccsRequest;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {v7, v8, v9, v10, v11}, Lfxw;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 482
    .local v2, "connection":Lfxj;
    invoke-virtual {v2}, Lfxj;->a()V
    ...
    invoke-virtual {v2, v4, v7}, Lfxj;->b(Lcom/taobao/accs/data/Message;Z)V
    :try_end_5
    .catch Ljava/lang/Throwable; {:try_start_5 .. :try_end_5} :catch_0
...
.method public setLoginInfo(Landroid/content/Context;Lfwr;)V
    .locals 1
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "loginInfoImpl"    # Lfwr;
...
.method public setMode(Landroid/content/Context;I)V
    ...
    invoke-virtual {v1, v2}, Lfxa;->e(Ljava/lang/String;)V
...
.method public startInAppConnection(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lfwp;)V
    .locals 6
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "appKey"    # Ljava/lang/String;
    .param p3, "ttid"    # Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/taobao/accs/internal/ACCSManagerImpl;->startInAppConnection(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lfwp;)V

    .line 699
    return-void
.end method

.method public startInAppConnection(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lfwp;)V
    .locals 5
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "appKey"    # Ljava/lang/String;
    .param p3, "appSecret"    # Ljava/lang/String;
    ...
    invoke-virtual {v1, p5}, Lfxb;->a(Lfwp;)V
    ...
    invoke-virtual {v1, p3}, Lfxb;->a(Ljava/lang/String;)V
...
.method public unRegisterDataListener(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 2190
    iget-object v0, v0, Lfxb;->m:Ljava/util/Map;
