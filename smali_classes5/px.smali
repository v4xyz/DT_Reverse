...
.method protected constructor <init>()V
    ...
    iput-object v0, p0, Lpx;->i:Ljava/util/List;
    ...
    iput-object v0, p0, Lpx;->k:Ljava/util/ArrayList;

    .line 74
    iput-boolean v2, p0, Lpx;->h:Z
...
.method public constructor <init>(Ljava/lang/String;J)V
    ...
    invoke-direct/range {v1 .. v6}, Lpt;-><init>(JLcom/alibaba/alimei/framework/task/AutoTryTaskPolicy$AutoTryNetwork;Lcom/alibaba/alimei/framework/task/AutoTryTaskPolicy$AutoTryFailure;Ljava/lang/String;)V
    ...
    .line 70
    iput-object v6, p0, Lpx;->i:Ljava/util/List;
...
.method static synthetic a(Lpx;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lpx;

    .prologue
    .line 22
    iget-object v0, p0, Lpx;->k:Ljava/util/ArrayList;

    return-object v0
.end method

.method static synthetic a(Lpx;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lpx;
...
.method static synthetic a(Lpx;Ljava/util/List;)Ljava/util/List;
    .locals 1
    .param p0, "x0"    # Lpx;
...
.method static synthetic a(Lpx;Lcom/alibaba/alimei/restfulapi/service/RpcCallback;)V
    .locals 0
    .param p0, "x0"    # Lpx;
    ...
    .prologue
    .line 22
    invoke-direct {p0, p1}, Lpx;->b(Lcom/alibaba/alimei/restfulapi/service/RpcCallback;)V

    return-void
.end method

.method static synthetic b(Lpx;)I
    .locals 1
    .param p0, "x0"    # Lpx;
...
.method private b(Lcom/alibaba/alimei/restfulapi/service/RpcCallback;)V
    ...
    iget-object v3, p0, Lpx;->k:Ljava/util/ArrayList;
    ...
    .line 155
    iget-object v3, p0, Lpx;->i:Ljava/util/List;
    ...
    .line 157
    invoke-virtual {p0, v2}, Lpx;->a(Lcom/alibaba/alimei/sdk/db/mail/entry/MessageSync;)V
    ...
    .line 167
    :cond_1
    invoke-virtual {p0, p1}, Lpx;->a(Lcom/alibaba/alimei/restfulapi/service/RpcCallback;)V
...
.method protected final b()Z
    ...
    iput-object v2, p0, Lpx;->i:Ljava/util/List;

    .line 83
    iget-object v2, p0, Lpx;->k:Ljava/util/ArrayList;

    invoke-virtual {v2}, Ljava/util/ArrayList;->clear()V

    .line 85
    invoke-virtual {p0}, Lpx;->a()Z
    ...
    iput-object v1, p0, Lpx;->d:Lcom/alibaba/alimei/sdk/datasource/MessageDatasource;

    .line 90
    invoke-virtual {p0}, Lpx;->e()Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lpx;->i:Ljava/util/List;

    .line 92
    iget-object v1, p0, Lpx;->i:Ljava/util/List;
    ...
    invoke-static {v1}, Labd;->b(Ljava/lang/String;)I
    ...
    .line 100
    new-instance v0, Lpx$1;

    invoke-direct {v0, p0}, Lpx$1;-><init>(Lpx;)V
    ...
    invoke-direct {p0, v0}, Lpx;->b(Lcom/alibaba/alimei/restfulapi/service/RpcCallback;)V
