...
.method public final a([BLjava/lang/reflect/Type;)Ljava/lang/Object;
    ...
    invoke-direct {v3, v1, v4}, Lfph;-><init>(Ljava/io/InputStream;I)V

    invoke-direct {v2, v3}, Lfol;-><init>(Lfpg;)V
    ...
    invoke-static {p2, v3}, Lfoj;->a(Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_1
...
.method public final a(Ljava/lang/Object;Z)[B
    ...
    .line 73
    .end local v4    # "packWriter":Lfom;
    .local v5, "packWriter":Lfom;
    if-nez p2, :cond_0
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v5, p1}, Lfom;->a(Ljava/lang/Object;)V
    ...
    .end local v5    # "packWriter":Lfom;
    .restart local v4    # "packWriter":Lfom;
    :goto_2
    if-eqz v4, :cond_3

    .line 91
    :try_start_4
    invoke-virtual {v4}, Lfom;->a()V
    :try_end_4
    ...
    .restart local v5    # "packWriter":Lfom;
    :cond_4
    :try_start_5
    ...
    invoke-virtual {v5, v0}, Lfom;->a(Ljava/lang/Object;)V
    :try_end_5
...
.method public final a([B[Ljava/lang/reflect/Type;)[Ljava/lang/Object;
    ...
    invoke-direct {v4, v1, v5}, Lfph;-><init>(Ljava/io/InputStream;I)V
    ...
    invoke-static {p2, v4}, Lfoj;->a([Ljava/lang/reflect/Type;[Ljava/lang/Object;)[Ljava/lang/Object;
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
