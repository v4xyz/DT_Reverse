...
.method public final a([BLjava/lang/reflect/Type;)Ljava/lang/Object;
    ...
    invoke-static {p1, p2, v0}, Leja;->parseObject([BLjava/lang/reflect/Type;[Lcom/alibaba/fastjson/parser/Feature;)Ljava/lang/Object;
...
.method public final a(Ljava/lang/Object;Z)[B
    ...
    invoke-virtual {v1, v3, v4}, Lelx;->a(Lcom/alibaba/fastjson/serializer/SerializerFeature;Z)V
    ...
    .line 53
    .end local v0    # "jsonWriter":Lelx;
    .local v1, "jsonWriter":Lelx;
    :try_start_1
    ...
    invoke-virtual {v2, p1}, Lelm;->c(Ljava/lang/Object;)V
    ...
    .line 57
    .end local v1    # "jsonWriter":Lelx;
    .end local v2    # "serializer":Lelm;
    .restart local v0    # "jsonWriter":Lelx;
    :catchall_0
    move-exception v3
    ...
    .line 57
    .end local v0    # "jsonWriter":Lelx;
    .restart local v1    # "jsonWriter":Lelx;
    :catchall_1
    move-exception v3
...
.method public final a([B[Ljava/lang/reflect/Type;)[Ljava/lang/Object;
    ...
    invoke-static {v1, p2}, Leja;->parseArray(Ljava/lang/String;[Ljava/lang/reflect/Type;)Ljava/util/List;
