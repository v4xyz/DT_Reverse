...
.method public a(Lcom/alibaba/doraemon/image/ImageInputStream;Ljava/lang/String;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    invoke-static {p2}, Lepq;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 44
    :cond_0
    invoke-virtual {p0, p1, p2}, Lenp;->b(Lcom/alibaba/doraemon/image/ImageInputStream;Ljava/lang/String;)Landroid/graphics/Bitmap;
...
.method public a(II)Lenv;
    ...
    invoke-direct {v0, p1, p2}, Lenv;-><init>(II)V
...
.method protected b(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, v3, v0, v6}, Lemr;->a(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    ...
    .line 141
    :cond_2
    sget-object v6, Lenp;->a:Ljava/lang/String;
...
.method protected final b(Lcom/alibaba/doraemon/image/ImageInputStream;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iput-boolean v6, v2, Lemr$a;->inJustDecodeBounds:Z

    .line 61
    iput-object p2, v2, Lemr$a;->a:Ljava/lang/String;

    .line 62
    invoke-static {p1, v2}, Lemr;->a(Ljava/io/InputStream;Lemr$a;)Landroid/graphics/Bitmap;

    .line 65
    iget v6, v2, Lemr$a;->outWidth:I

    iget v7, v2, Lemr$a;->outHeight:I

    invoke-virtual {p0, v6, v7}, Lenp;->a(II)Lenv;
    ...
    iput v6, v2, Lemr$a;->b:I

    .line 70
    iget v6, v3, Lenv;->b:I

    iput v6, v2, Lemr$a;->c:I
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0, v4}, Lenp;->b(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;

    move-result-object v4

    .line 86
    invoke-virtual {p0, v4}, Lenp;->a(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
