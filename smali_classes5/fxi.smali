...
.field private mDataListener:Lfwv;

.field private mElectionResult:Lfxg$a;
...
.method static constructor <clinit>()V
    ...
    .line 52
    sput v0, Lfxi;->electionPackCount:I

    .line 54
    sput-boolean v0, Lfxi;->isPing:Z
...
.method public constructor <init>(Landroid/app/Service;)V
    ...
    .line 44
    iput-boolean v1, p0, Lfxi;->isElectioning:Z

    .line 46
    const/4 v0, 0x1

    iput-boolean v0, p0, Lfxi;->resultBack:Z

    .line 48
    iput-object v2, p0, Lfxi;->packMap:Ljava/util/Map;

    .line 56
    iput-object v2, p0, Lfxi;->mBaseService:Landroid/app/Service;

    .line 357
    new-instance v0, Lfxi$1;

    invoke-direct {v0, p0}, Lfxi$1;-><init>(Lfxi;)V

    iput-object v0, p0, Lfxi;->mDataListener:Lfwv;

    .line 591
    iput-boolean v1, p0, Lfxi;->isReportComplete:Z

    .line 592
    iput-boolean v1, p0, Lfxi;->isHandleServerElection:Z

    .line 82
    iput-object p1, p0, Lfxi;->mBaseService:Landroid/app/Service;
    ...
    iput-object v0, p0, Lfxi;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lfxi;->packMap:Ljava/util/Map;
    ...
    iput-object v0, p0, Lfxi;->mThreadPool:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method static synthetic access$000(Lfxi;[BI)V
    .locals 0
    .param p0, "x0"    # Lfxi;
    .param p1, "x1"    # [B
    .param p2, "x2"    # I
    ...
    .prologue
    .line 37
    invoke-direct {p0, p1, p2}, Lfxi;->handleServerElectionResult([BI)V

    return-void
.end method

.method static synthetic access$100(Lfxi;)Ljava/util/concurrent/ScheduledFuture;
    .locals 1
    .param p0, "x0"    # Lfxi;

    .prologue
    .line 37
    iget-object v0, p0, Lfxi;->mServerElecionTask:Ljava/util/concurrent/ScheduledFuture;
...
.method static synthetic access$200()Z
    ...
    .prologue
    .line 37
    sget-boolean v0, Lfxi;->isPing:Z

    return v0
.end method

.method static synthetic access$300(Lfxi;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lfxi;

    .prologue
    .line 37
    iget-object v0, p0, Lfxi;->mContext:Landroid/content/Context;

    return-object v0
.end method

.method static synthetic access$400(Lfxi;Landroid/content/Context;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lfxi;
    ...
    .prologue
    .line 37
    invoke-direct {p0, p1, p2}, Lfxi;->selectAppToElection(Landroid/content/Context;Ljava/lang/String;)V

    return-void
.end method

.method static synthetic access$500(Lfxi;)Z
    .locals 1
    .param p0, "x0"    # Lfxi;

    .prologue
    .line 37
    iget-boolean v0, p0, Lfxi;->resultBack:Z

    return v0
.end method

.method static synthetic access$600(Lfxi;)Ljava/util/Map;
    .locals 1
    .param p0, "x0"    # Lfxi;

    .prologue
    .line 37
    iget-object v0, p0, Lfxi;->packMap:Ljava/util/Map;

    return-object v0
.end method

.method static synthetic access$700(Lfxi;)V
    .locals 0
    .param p0, "x0"    # Lfxi;

    .prologue
    .line 37
    invoke-direct {p0}, Lfxi;->onReportComplete()V
...
.method private handleResult(Ljava/lang/String;)V
    ...
    .line 707
    :try_start_0
    iget-object v4, p0, Lfxi;->mElectionResult:Lfxg$a;

    if-nez v4, :cond_0

    .line 708
    iget-object v4, p0, Lfxi;->mContext:Landroid/content/Context;

    invoke-static {v4}, Lfxg;->a(Landroid/content/Context;)Lfxg$a;

    move-result-object v4

    iput-object v4, p0, Lfxi;->mElectionResult:Lfxg$a;

    .line 710
    :cond_0
    iget-object v4, p0, Lfxi;->mElectionResult:Lfxg$a;

    iput-object p1, v4, Lfxg$a;->a:Ljava/lang/String;

    .line 711
    iget-object v4, p0, Lfxi;->mElectionResult:Lfxg$a;

    iget v5, v4, Lfxg$a;->b:I

    add-int/lit8 v5, v5, 0x1

    iput v5, v4, Lfxg$a;->b:I

    .line 712
    iget-object v4, p0, Lfxi;->mContext:Landroid/content/Context;

    iget-object v5, p0, Lfxi;->mElectionResult:Lfxg$a;

    invoke-static {v4, v5}, Lfxg;->a(Landroid/content/Context;Lfxg$a;)V
    ...
    iget-object v8, p0, Lfxi;->packMap:Ljava/util/Map;
    ...
    .line 714
    iget-object v4, p0, Lfxi;->packMap:Ljava/util/Map;
    ...
    invoke-static {}, Lfxg;->c()Ljava/lang/String;
...
.method private handleServerElectionResult([BI)V
    ...
    .line 649
    iget-boolean v8, p0, Lfxi;->isHandleServerElection:Z
    ...
    .line 653
    :cond_1
    iput-boolean v7, p0, Lfxi;->isHandleServerElection:Z
    ...
    .line 663
    :cond_3
    iget-object v8, p0, Lfxi;->mServerElectionMonitor:Lcom/taobao/accs/ut/monitor/ElectionRateMonitor;
    ...
    .line 693
    invoke-direct {p0}, Lfxi;->localElection()Ljava/lang/String;

    move-result-object v0

    .line 695
    :cond_5
    invoke-direct {p0, v0}, Lfxi;->handleResult(Ljava/lang/String;)V
    ...
    iget-object v7, p0, Lfxi;->mServerElectionMonitor:Lcom/taobao/accs/ut/monitor/ElectionRateMonitor;

    invoke-interface {v6, v7}, Lhv;->a(Lanet/channel/statist/StatObject;)V
    ...
    .line 677
    iget-object v8, p0, Lfxi;->mContext:Landroid/content/Context;

    invoke-static {v8, p1}, Lfxg;->a(Landroid/content/Context;[B)V
    :try_end_1
    .catch Ljava/lang/Throwable; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-static {v8}, Lfxg;->c(Landroid/content/Context;)V
    :try_end_3
    ...
    .line 696
    iget-object v9, p0, Lfxi;->mServerElectionMonitor:Lcom/taobao/accs/ut/monitor/ElectionRateMonitor;
...
.method private localElection()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v6, p0, Lfxi;->packMap:Ljava/util/Map;
    ...
    .line 307
    iget-object v6, p0, Lfxi;->mContext:Landroid/content/Context;

    iget-object v7, p0, Lfxi;->packMap:Ljava/util/Map;

    invoke-static {v6, v7}, Lfxg;->a(Landroid/content/Context;Ljava/util/Map;)Ljava/lang/String;
    ...
    .line 319
    iget-object v6, p0, Lfxi;->mLocalElectionMonitor:Lcom/taobao/accs/ut/monitor/ElectionRateMonitor;
    ...
    iget-object v5, p0, Lfxi;->mLocalElectionMonitor:Lcom/taobao/accs/ut/monitor/ElectionRateMonitor;

    invoke-interface {v4, v5}, Lhv;->a(Lanet/channel/statist/StatObject;)V
    ...
    iget-object v7, p0, Lfxi;->mLocalElectionMonitor:Lcom/taobao/accs/ut/monitor/ElectionRateMonitor;
...
.method private onReportComplete()V
    ...
    .line 599
    :try_start_0
    iget-object v2, p0, Lfxi;->mReportTimeOutTask:Ljava/util/concurrent/ScheduledFuture;
    ...
    iput-object v2, p0, Lfxi;->mReportTimeOutTask:Ljava/util/concurrent/ScheduledFuture;

    .line 603
    :cond_0
    iget-boolean v2, p0, Lfxi;->isReportComplete:Z
    ...
    .line 643
    iput-boolean v3, p0, Lfxi;->isElectioning:Z
    ...
    :try_start_1
    iput-boolean v2, p0, Lfxi;->isReportComplete:Z
    ...
    .line 610
    iget-object v2, p0, Lfxi;->packMap:Ljava/util/Map;
    ...
    iget-object v5, p0, Lfxi;->mContext:Landroid/content/Context;
    ...
    iget-object v2, p0, Lfxi;->mLocalElectionMonitor:Lcom/taobao/accs/ut/monitor/ElectionRateMonitor;
    ...
    iget-object v4, p0, Lfxi;->mLocalElectionMonitor:Lcom/taobao/accs/ut/monitor/ElectionRateMonitor;

    invoke-interface {v2, v4}, Lhv;->a(Lanet/channel/statist/StatObject;)V
    ...
    invoke-direct {p0, v2}, Lfxi;->serverElection(Ljava/util/Map;)V

    .line 626
    const/4 v2, 0x0

    iput-boolean v2, p0, Lfxi;->isHandleServerElection:Z

    .line 627
    iget-object v2, p0, Lfxi;->mThreadPool:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    new-instance v4, Lfxi$5;

    invoke-direct {v4, p0}, Lfxi$5;-><init>(Lfxi;)V
    ...
    iput-object v2, p0, Lfxi;->mServerElecionTask:Ljava/util/concurrent/ScheduledFuture;
    :try_end_2
...
.method private selectAppToElection(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 462
    invoke-static {p1}, Lfxg;->d(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 464
    sput-boolean v6, Lfxg;->c:Z

    .line 465
    iput-boolean v6, p0, Lfxi;->resultBack:Z
    ...
    .line 478
    :goto_0
    iget-object v2, p0, Lfxi;->mSelectAppTimeOutTask:Ljava/util/concurrent/ScheduledFuture;
    ...
    iput-object v2, p0, Lfxi;->mSelectAppTimeOutTask:Ljava/util/concurrent/ScheduledFuture;

    .line 482
    :cond_0
    iget-object v2, p0, Lfxi;->mThreadPool:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    new-instance v3, Lfxi$3;

    invoke-direct {v3, p0, p1}, Lfxi$3;-><init>(Lfxi;Landroid/content/Context;)V
...
.method private serverElection(Ljava/util/Map;)V
    ...
    iput-object v2, p0, Lfxi;->mServerElectionMonitor:Lcom/taobao/accs/ut/monitor/ElectionRateMonitor;

    .line 338
    :try_start_0
    iget-object v2, p0, Lfxi;->mServerElectionMonitor:Lcom/taobao/accs/ut/monitor/ElectionRateMonitor;
    ...
    iget-object v3, p0, Lfxi;->mLocalElectionMonitor:Lcom/taobao/accs/ut/monitor/ElectionRateMonitor;
    ...
    .line 342
    :cond_0
    iget-object v2, p0, Lfxi;->mContext:Landroid/content/Context;

    invoke-static {v2}, Lfxb;->a(Landroid/content/Context;)Lfxb;

    move-result-object v2

    const-string/jumbo v3, "accs_election"

    iget-object v4, p0, Lfxi;->mDataListener:Lfwv;

    invoke-virtual {v2, v3, v4}, Lfxb;->a(Ljava/lang/String;Lfwv;)V
    ...
    iget-object v3, p0, Lfxi;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v0, v2, v3}, Lfxi;->onHostStartCommand(Landroid/content/Intent;II)I
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method private tryElection(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v4, v5}, Lfxi;->selectAppToElection(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iget-object v0, v4, Lfxg$a;->a:Ljava/lang/String;
    ...
    .line 425
    :try_start_3
    iget-object v4, p0, Lfxi;->mThreadPool:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    new-instance v5, Lfxi$2;

    invoke-direct {v5, p0, v0}, Lfxi$2;-><init>(Lfxi;Ljava/lang/String;)V
    ...
    iget-object v5, p0, Lfxi;->mThreadPool:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    new-instance v6, Lfxi$2;

    invoke-direct {v6, p0, v0}, Lfxi$2;-><init>(Lfxi;Ljava/lang/String;)V
    ...
    .line 446
    invoke-virtual {p0}, Lfxi;->onVotedHost()V
    :try_end_5
...
.method public onDestroy()V
    ...
    .line 293
    iput-object v3, p0, Lfxi;->mContext:Landroid/content/Context;

    .line 294
    iput-object v3, p0, Lfxi;->mBaseService:Landroid/app/Service;
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    iget-object v0, v0, Lfxi;->mContext:Landroid/content/Context;
    ...
    invoke-static/range {v25 .. v25}, Lfxg;->a(Landroid/content/Context;)Lfxg$a;

    move-result-object v11

    .line 115
    .local v11, "electionResult":Lfxg$a;
    iget-object v0, v11, Lfxg$a;->a:Ljava/lang/String;
    ...
    invoke-static/range {v26 .. v26}, Lfxg;->d(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v0, v11}, Lfxg;->a(Landroid/content/Context;Lfxg$a;)V
    ...
    invoke-virtual {v0, v1, v2}, Lfxi;->startElection(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0

    .line 241
    .end local v11    # "electionResult":Lfxg$a;
    ...
    invoke-static/range {v25 .. v25}, Lfxb;->a(Landroid/content/Context;)Lfxb;

    move-result-object v25

    move-object/from16 v0, v25

    invoke-virtual {v0, v7}, Lfxb;->a(Ljava/lang/String;)V
    ...
    .restart local v11    # "electionResult":Lfxg$a;
    ...
    .line 135
    :pswitch_0
    invoke-direct/range {p0 .. p1}, Lfxi;->tryElection(Landroid/content/Intent;)V
    ...
    invoke-static {v0, v1, v12}, Lfxg;->a(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    iget-boolean v0, v0, Lfxi;->isElectioning:Z
    ...
    sget v25, Lfxi;->electionPackCount:I

    add-int/lit8 v25, v25, -0x1

    sput v25, Lfxi;->electionPackCount:I
    ...
    iget-object v0, v0, Lfxi;->packMap:Ljava/util/Map;
    ...
    sget v29, Lfxi;->electionPackCount:I
    ...
    .line 172
    invoke-direct/range {p0 .. p0}, Lfxi;->onReportComplete()V
    ...
    iput-boolean v0, v1, Lfxi;->resultBack:Z

    .line 181
    move-object/from16 v0, p0

    iget-object v0, v0, Lfxi;->mSelectAppTimeOutTask:Ljava/util/concurrent/ScheduledFuture;
    ...
    iput-object v0, v1, Lfxi;->mSelectAppTimeOutTask:Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lfxw;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;D)V
    ...
    invoke-static/range {v25 .. v25}, Lfxg;->b(Landroid/content/Context;)Lfxg$a;
    ...
    .line 192
    invoke-virtual/range {p0 .. p0}, Lfxi;->onVotedHost()V
    ...
    invoke-virtual {v0, v1}, Lfxi;->stopSelf(Z)V
    ...
    iget-object v0, v0, Lfxg$a;->a:Ljava/lang/String;
    ...
    sput-boolean v25, Lfxi;->isPing:Z
    :try_end_2
    .catch Ljava/lang/Throwable; {:try_start_2 .. :try_end_2} :catch_0
    ...
    iget-object v10, v0, Lfxg$a;->a:Ljava/lang/String;
    ...
    .line 269
    invoke-virtual/range {p0 .. p3}, Lfxi;->onHostStartCommand(Landroid/content/Intent;II)I
...
.method public startElection(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iget-boolean v10, v0, Lfxi;->isElectioning:Z
    ...
    .line 517
    :cond_1
    invoke-static/range {p1 .. p1}, Lfxg;->a(Landroid/content/Context;)Lfxg$a;

    move-result-object v10

    move-object/from16 v0, p0

    iput-object v10, v0, Lfxi;->mElectionResult:Lfxg$a;

    .line 518
    move-object/from16 v0, p0

    iget-object v10, v0, Lfxi;->mElectionResult:Lfxg$a;

    iget v10, v10, Lfxg$a;->b:I
    ...
    iget-object v14, v0, Lfxi;->mElectionResult:Lfxg$a;

    iget v14, v14, Lfxg$a;->b:I
    ...
    invoke-static {v10, v11, v12, v14, v15}, Lfxw;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;D)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-boolean v10, v0, Lfxi;->isElectioning:Z

    .line 581
    move-object/from16 v0, p0

    iget-object v10, v0, Lfxi;->mLocalElectionMonitor:Lcom/taobao/accs/ut/monitor/ElectionRateMonitor;
    ...
    iput-object v10, v0, Lfxi;->mLocalElectionMonitor:Lcom/taobao/accs/ut/monitor/ElectionRateMonitor;
    ...
    invoke-static {v10, v11, v0, v12, v13}, Lfxw;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;D)V
    ...
    sput v10, Lfxi;->electionPackCount:I
    ...
    .line 566
    sget v10, Lfxi;->electionPackCount:I
    ...
    iput-boolean v10, v0, Lfxi;->isReportComplete:Z

    .line 569
    move-object/from16 v0, p0

    iget-object v10, v0, Lfxi;->mThreadPool:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    new-instance v11, Lfxi$4;

    move-object/from16 v0, p0

    invoke-direct {v11, v0}, Lfxi$4;-><init>(Lfxi;)V
    ...
    iput-object v10, v0, Lfxi;->mReportTimeOutTask:Ljava/util/concurrent/ScheduledFuture;
    :try_end_1
    .catch Ljava/lang/Throwable; {:try_start_1 .. :try_end_1} :catch_0
...
.method public stopSelf(Z)V
    ...
    .line 738
    iget-object v0, p0, Lfxi;->mBaseService:Landroid/app/Service;
