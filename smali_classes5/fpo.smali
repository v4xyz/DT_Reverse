...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lfpo;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object v0, p0, Lfpo;->g:Ljava/util/Map;
    ...
    iput-object v0, p0, Lfpo;->j:Ljava/nio/ByteBuffer;
...
.method public final a([BLjava/util/List;)V
    ...
    .prologue
    .line 27
    .local p2, "outs":Ljava/util/List;, "Ljava/util/List<Lfpq;>;"
    const/16 v4, 0xfe9
    ...
    iget-object v11, v0, Lfpo;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v11, v0, Lfpo;->c:Lfpx;

    move-object/from16 v0, p0

    iget v12, v0, Lfpo;->d:I

    invoke-static {v11, v12, v2}, Lfpw;->a(Lfpx;I[B)Lfpq;
    ...
    .line 48
    iget-object v11, v6, Lfpq;->f:Lcom/laiwang/lws/protocol/Attributes;
    ...
    .line 1189
    invoke-static {v13}, Lfpy;->a(Ljava/nio/ByteBuffer;)[B
    ...
    invoke-virtual {v6, v11}, Lfpq;->a(I)V
    ...
    invoke-static {v11, v12, v0}, Lfpw;->a(Lfpx;I[B)Lfpq;

    move-result-object v6

    .line 56
    .restart local v6    # "data":Lfpq;
    move-object/from16 v0, p0
...
.method public final a(Lfpq;)[B
    ...
    .line 71
    iget-object v8, p1, Lfpq;->a:[B

    invoke-static {v8}, Lfpy;->b([B)I

    move-result v1

    .line 72
    .local v1, "checkSum":I
    invoke-virtual {p1}, Lfpq;->d()I
    ...
    .line 82
    iget-object v8, p1, Lfpq;->f:Lcom/laiwang/lws/protocol/Attributes;
    ...
    .line 86
    iget-object v8, p0, Lfpo;->g:Ljava/util/Map;
    ...
    .end local v2    # "chunk":Lfpn;
    iget-wide v8, v3, Lcom/laiwang/lws/protocol/Attributes$b;->b:J

    long-to-int v8, v8

    invoke-direct {v2, v8}, Lfpn;-><init>(I)V

    .line 89
    .restart local v2    # "chunk":Lfpn;
    iget-object v8, p0, Lfpo;->g:Ljava/util/Map;
    ...
    .line 2021
    :cond_5
    iget-object v9, v2, Lfpn;->b:Ljava/nio/ByteBuffer;

    invoke-virtual {v9, v8}, Ljava/nio/ByteBuffer;->put([B)Ljava/nio/ByteBuffer;

    .line 2026
    iget-object v8, v2, Lfpn;->b:Ljava/nio/ByteBuffer;
    ...
    .line 95
    iget-object v7, p0, Lfpo;->g:Ljava/util/Map;
    ...
    :cond_6
    iget-object v7, v2, Lfpn;->b:Ljava/nio/ByteBuffer;
    ...
    invoke-static {v7}, Lfpy;->a(Ljava/nio/ByteBuffer;)[B
