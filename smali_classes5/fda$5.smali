...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lfda;->combineForward(Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Lcom/alibaba/wukong/Callback;)V
.end annotation
...
.field final synthetic e:Lfda;


# direct methods
.method constructor <init>(Lfda;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)V
    .locals 1
    ...
    iput-object p1, p0, Lfda$5;->e:Lfda;

    iput-object p5, p0, Lfda$5;->a:Ljava/util/List;

    iput-object p6, p0, Lfda$5;->b:Ljava/lang/String;

    iput-object p7, p0, Lfda$5;->c:Ljava/util/Map;

    iput-object p8, p0, Lfda$5;->d:Ljava/util/Map;
...
.method public final onAfterRpc(Lfbl$b;)Lfbl$b;
    ...
    iget-object v3, p0, Lfda$5;->b:Ljava/lang/String;
    ...
    invoke-virtual {v2, v3, v1}, Lfby;->b(Ljava/lang/String;Lcom/alibaba/wukong/im/message/MessageImpl;)Z
    :try_end_0
...
.method public final synthetic onExecuteRpc(Ljava/lang/Object;Lcom/alibaba/wukong/Callback;)V
    ...
    iget-object v0, p0, Lfda$5;->a:Ljava/util/List;
    ...
    iget-object v2, p0, Lfda$5;->b:Ljava/lang/String;

    iget-object v3, p0, Lfda$5;->c:Ljava/util/Map;

    iget-object v4, p0, Lfda$5;->d:Ljava/util/Map;

    move-object v5, p2

    invoke-virtual/range {v0 .. v5}, Lfcz;->a(Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Lcom/alibaba/wukong/Callback;)V
