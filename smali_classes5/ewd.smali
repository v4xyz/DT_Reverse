...
.method private static a(Lorg/json/JSONObject;)Ljava/util/Map;
    ...
    .line 194
    .local v2, "map":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lewe;>;"
    ...
    invoke-static {v4}, Lewe;->a(Ljava/lang/String;)Lewe;

    move-result-object v3

    .line 199
    .local v3, "uidTokenWrapper":Lewe;
    if-eqz v3, :cond_0
    ...
    .end local v3    # "uidTokenWrapper":Lewe;
...
.method private a()V
    ...
    invoke-static {v2}, Lewd;->a(Lorg/json/JSONObject;)Ljava/util/Map;

    move-result-object v3

    .line 157
    .local v3, "map":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lewe;>;"
    iget-object v4, p0, Lewd;->a:Ljava/util/Map;
    ...
    .end local v3    # "map":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lewe;>;"
    :goto_1
    const-string/jumbo v4, "safeTunnel"

    const-string/jumbo v5, "restoreCommonDomains="

    iget-object v6, p0, Lewd;->a:Ljava/util/Map;
...
.method private static b(Lesq;)Ljava/lang/String;
    .locals 5
    .param p0, "cookieModel"    # Lesq;
    ...
    .line 238
    iget-object v3, p0, Lesq;->d:Ljava/lang/String;
    ...
    .line 241
    iget-object v3, p0, Lesq;->c:Ljava/lang/String;
    ...
    .line 244
    iget-object v3, p0, Lesq;->b:Ljava/lang/String;

    invoke-virtual {v1, v3}, Lcom/alibaba/doraemon/performance/DDStringBuilder;->append(Ljava/lang/String;)Lcom/alibaba/doraemon/performance/DDStringBuilder;

    .line 245
    iget-object v3, p0, Lesq;->e:Ljava/lang/Boolean;
    ...
    .line 249
    :cond_2
    iget-object v3, p0, Lesq;->f:Ljava/lang/Boolean;
...
.method a(Lesq;)Lewe;
    ...
    .line 212
    iget-object v7, p1, Lesq;->b:Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p1}, Lewd;->b(Lesq;)Ljava/lang/String;
    ...
    invoke-direct {v6, v5, v2, v3}, Lewe;-><init>(Ljava/lang/String;J)V

    .line 222
    .local v6, "uidTokenWrapper":Lewe;
    return-object v6

    .line 215
    .end local v2    # "expireTime":J
    .end local v5    # "uidTokenCookie":Ljava/lang/String;
    .end local v6    # "uidTokenWrapper":Lewe;
    :catch_0
    move-exception v1
...
.method public final a(Ljava/lang/String;Lewc$a;)V
    .locals 12
    .param p1, "url"    # Ljava/lang/String;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    .param p2, "callback"    # Lewc$a;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    ...
    .line 61
    invoke-static {p1, v4, v5, v6}, Lewd;->a(Ljava/lang/String;JZ)V

    .line 62
    invoke-interface {p2, v0}, Lewc$a;->onSuccess(Ljava/lang/String;)V
    ...
    :cond_1
    iget-object v1, p0, Lewd;->a:Ljava/util/Map;
    ...
    .line 1083
    iget-object v1, v1, Lewe;->a:Ljava/lang/String;
    ...
    invoke-interface {p2, v1, v2}, Lewc$a;->onFail(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v1, Lewd$1;

    move-object v2, p0

    move-object v6, p2

    invoke-direct/range {v1 .. v6}, Lewd$1;-><init>(Lewd;Landroid/net/Uri;JLewc$a;)V

    invoke-interface {v7, v8, v1}, Lcom/alibaba/lightapp/runtime/idl/CookiesIService;->getAuthorizeCookie(Ljava/lang/String;Lfos;)V
