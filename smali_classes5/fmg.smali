...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfmg;->a:Ljava/nio/charset/Charset;
...
.method private static a(Lcom/dingtalk/cryptokit/Algorithm;[B)Lfmh;
    .locals 4
    ...
    .line 4022
    .local v0, "builder":Lfmi;
    iput-object p0, v0, Lfmi;->a:Lcom/dingtalk/cryptokit/Algorithm;

    .line 4030
    iput-object p1, v0, Lfmi;->b:[B
    ...
    .line 279
    .local v1, "cryptor":Lfmh;
    return-object v1

    .line 270
    .end local v1    # "cryptor":Lfmh;
    :catch_0
    move-exception v2
...
.method public static a(Lcom/dingtalk/cryptokit/Algorithm;[BLjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2}, Lfmg;->b(Lcom/dingtalk/cryptokit/Algorithm;[BLjava/lang/String;)[B

    move-result-object v1

    sget-object v2, Lfmg;->a:Ljava/nio/charset/Charset;
...
.method public static a(Ljava/lang/String;[BILjava/lang/String;)Ljava/lang/String;
    ...
    .line 3027
    invoke-static {v0, p1, v2}, Lfmg;->a(Lcom/dingtalk/cryptokit/Algorithm;[B[B)[B
...
.method public static a(Lcom/dingtalk/cryptokit/Algorithm;[BILjava/io/InputStream;Ljava/io/OutputStream;[B)Z
    ...
    .prologue
    .line 128
    invoke-static {p0, p1}, Lfmg;->a(Lcom/dingtalk/cryptokit/Algorithm;[B)Lfmh;

    move-result-object v0

    .line 131
    .local v0, "cryptor":Lfmh;
    :try_start_0
    ...
    invoke-interface/range {v0 .. v5}, Lfmh;->a(IILjava/io/InputStream;Ljava/io/OutputStream;[B)Z
    :try_end_0
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_1
...
.method public static a(Lcom/dingtalk/cryptokit/Algorithm;[BLjava/io/InputStream;Ljava/io/OutputStream;[B)Z
    ...
    .local v0, "cryptor":Lfmh;
    :try_start_0
    invoke-interface {v0, p2, p3, p4}, Lfmh;->a(Ljava/io/InputStream;Ljava/io/OutputStream;[B)Z
    :try_end_0
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_1
...
.method private static a(Lcom/dingtalk/cryptokit/Algorithm;[B[B)[B
    ...
    .local v1, "cryptor":Lfmh;
    :try_start_1
    invoke-interface {v1, p2}, Lfmh;->a([B)[B
    :try_end_1
...
.method private static b(Lcom/dingtalk/cryptokit/Algorithm;[BLjava/lang/String;)[B
    ...
    invoke-static {v1}, Lfmj;->a([C)[B

    move-result-object v1

    invoke-static {p0, p1, v1}, Lfmg;->b(Lcom/dingtalk/cryptokit/Algorithm;[B[B)[B
    :try_end_0
...
.method private static b(Lcom/dingtalk/cryptokit/Algorithm;[B[B)[B
    ...
    .local v1, "cryptor":Lfmh;
    :try_start_1
    invoke-interface {v1, p2}, Lfmh;->b([B)[B
    :try_end_1
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_1 .. :try_end_1} :catch_2
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_3
