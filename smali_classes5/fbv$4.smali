...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lfbv;->moveConversations(Ljava/util/List;JLcom/alibaba/wukong/Callback;)V
.end annotation
...
# direct methods
.method constructor <init>(Lfbv;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;Ljava/util/List;J)V
    .locals 2
    ...
    iput-object p1, p0, Lfbv$4;->c:Lfbv;

    iput-object p5, p0, Lfbv$4;->a:Ljava/util/List;

    iput-wide p6, p0, Lfbv$4;->b:J
...
.method public final onAfterRpc(Lfbl$b;)Lfbl$b;
    ...
    .prologue
    .line 195
    .local p1, "rpcResult":Lfbl$b;, "Lfbl<Ljava/lang/Void;Ljava/util/List<Ljava/lang/String;>;>.b;"
    if-eqz p1, :cond_0
    ...
    iget-object v3, p0, Lfbv$4;->a:Ljava/util/List;

    iget-object v1, p1, Lfbl$b;->d:Ljava/lang/Object;

    check-cast v1, Ljava/util/List;

    iget-wide v4, p0, Lfbv$4;->b:J

    invoke-virtual {v2, v3, v1, v4, v5}, Lfby;->a(Ljava/util/List;Ljava/util/List;J)Ljava/util/List;

    move-result-object v0

    .line 197
    .local v0, "localNotExist":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    invoke-static {v0}, Lfbw;->a(Ljava/util/List;)V
...
.method public final synthetic onExecuteRpc(Ljava/lang/Object;Lcom/alibaba/wukong/Callback;)V
    ...
    iget-object v1, p0, Lfbv$4;->a:Ljava/util/List;

    iget-wide v2, p0, Lfbv$4;->b:J
    ...
    .line 2097
    :cond_2
    new-instance v4, Lfbu$3;

    invoke-direct {v4, v0, p2}, Lfbu$3;-><init>(Lfbu;Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-interface {v0, v1, v2, v4}, Lcom/alibaba/wukong/idl/im/client/IDLCategoryService;->moveConversation(Ljava/util/List;Ljava/lang/Long;Lfos;)V
