...
.method private static a(Lemr$a;)Landroid/graphics/BitmapFactory$Options;
    .locals 3
    .param p0, "opt"    # Lemr$a;
    ...
    invoke-static {p0}, Lepl;->a(Lemr$a;)I
    ...
    .line 83
    iget-object v1, p0, Lemr$a;->inPreferredConfig:Landroid/graphics/Bitmap$Config;
...
# virtual methods
.method public final a(Ljava/io/InputStream;Lemr$a;)Landroid/graphics/Bitmap;
    .locals 9
    ...
    .line 120
    :cond_0
    invoke-static {p2}, Leoy;->a(Lemr$a;)Landroid/graphics/BitmapFactory$Options;
    ...
    :try_start_0
    invoke-static {p1, v1}, Leoy;->a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 131
    sget-object v6, Leoy;->a:Ljava/lang/String;
    ...
    invoke-static {v6, v7, v4}, Lepq;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    goto :goto_2
.end method

.method public final a([BILemr$a;)Landroid/graphics/Bitmap;
    .locals 11
    .param p1, "bytes"    # [B
    .param p2, "len"    # I
    .param p3, "opt"    # Lemr$a;
    ...
    .line 94
    :cond_0
    invoke-static {p3}, Leoy;->a(Lemr$a;)Landroid/graphics/BitmapFactory$Options;
    ...
    .local v0, "bitmap":Landroid/graphics/Bitmap;
    :try_start_0
    invoke-static {p1, p2, v1}, Leoy;->a([BILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
