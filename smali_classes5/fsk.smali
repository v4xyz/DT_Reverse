...
.method constructor <init>(IILjava/net/Proxy;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lfsk;-><init>(IILjava/net/Proxy;Z)V
...
.method constructor <init>(IILjava/net/Proxy;Z)V
    ...
    invoke-direct/range {v0 .. v5}, Lfsk;-><init>(IILjava/net/Proxy;ZB)V
...
.method private constructor <init>(IILjava/net/Proxy;ZB)V
    ...
    iput-wide v0, p0, Lfsk;->c:J

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lfsk;->d:J

    new-instance v0, Lfsk$1;

    invoke-direct {v0, p0}, Lfsk$1;-><init>(Lfsk;)V

    iput-object v0, p0, Lfsk;->l:Ljavax/net/ssl/HostnameVerifier;

    iput p1, p0, Lfsk;->e:I

    iput p2, p0, Lfsk;->f:I

    iput-object p3, p0, Lfsk;->i:Ljava/net/Proxy;

    iput-boolean p4, p0, Lfsk;->g:Z

    iput-object v2, p0, Lfsk;->k:Lfsh$a;
    ...
    iput-object v0, p0, Lfsk;->j:Ljava/lang/String;
    :try_end_0
    ...
    iput-object v0, p0, Lfsk;->h:Ljavax/net/ssl/SSLContext;
    :try_end_1
...
.method private a(Ljava/net/HttpURLConnection;)Lfsn;
    .locals 10
    ...
    iget-object v4, p0, Lfsk;->j:Ljava/lang/String;
    ...
    :cond_6
    sget-object v5, Lfsk;->a:Lfsl;

    if-eqz v5, :cond_7

    sget-object v5, Lfsk;->a:Lfsl;

    invoke-interface {v5}, Lfsl;->a()V
    ...
    iput-object v7, v5, Lfsn;->a:[B

    iput-object v6, v5, Lfsn;->b:Ljava/util/Map;

    iget-object v6, p0, Lfsk;->j:Ljava/lang/String;

    iput-object v6, v5, Lfsn;->c:Ljava/lang/String;

    iput-object v0, v5, Lfsn;->d:Ljava/lang/String;
    :try_end_b
    ...
    invoke-static {v4, v5, v6}, Lfuy;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v4, v5}, Lfuy;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v4, v6}, Lfuy;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
...
.method private a(Ljava/util/Map;Ljava/net/HttpURLConnection;)V
    ...
    iget-object v1, p0, Lfsk;->j:Ljava/lang/String;
...
# virtual methods
.method final a(Ljava/lang/String;Ljava/util/Map;[B)Lfsn;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, v0}, Lfsk;->a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/net/HttpURLConnection;
    ...
    :cond_0
    invoke-direct {p0, v1}, Lfsk;->a(Ljava/net/HttpURLConnection;)Lfsn;
    :try_end_0
...
.method a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/net/HttpURLConnection;
    ...
    invoke-static {}, Lfup;->b()V

    new-instance v0, Ljava/net/URL;

    invoke-direct {v0, p1}, Ljava/net/URL;-><init>(Ljava/lang/String;)V

    iget-object v1, p0, Lfsk;->i:Ljava/net/Proxy;
    ...
    iget-object v2, p0, Lfsk;->h:Ljavax/net/ssl/SSLContext;
    ...
    iget-object v2, p0, Lfsk;->l:Ljavax/net/ssl/HostnameVerifier;
    ...
    :cond_0
    invoke-direct {p0, p2, v0}, Lfsk;->a(Ljava/util/Map;Ljava/net/HttpURLConnection;)V
