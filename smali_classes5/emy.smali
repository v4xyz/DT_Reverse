...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Lcom/alibaba/laiwang/photokit/browser/EncryptPhotoObjectsFetcher;)V
    ...
    invoke-direct {p0, p1}, Lemx;-><init>(Landroid/content/Context;)V

    .line 36
    iput-object p2, p0, Lemy;->f:Ljava/util/List;

    .line 37
    iput-object p3, p0, Lemy;->g:Lcom/alibaba/laiwang/photokit/browser/EncryptPhotoObjectsFetcher;
...
.method protected final b()V
    ...
    .prologue
    .line 44
    iget-object v3, p0, Lemy;->f:Ljava/util/List;
    ...
    iget-object v3, p0, Lemy;->g:Lcom/alibaba/laiwang/photokit/browser/EncryptPhotoObjectsFetcher;
    ...
    invoke-virtual {p0, v6, v7}, Lemy;->a(J)Ljava/lang/String;

    move-result-object v2

    .line 50
    .local v2, "tmp":Ljava/lang/String;
    iget-object v3, p0, Lemy;->a:Ljava/util/TreeMap;
    ...
    .line 51
    iget-object v5, p0, Lemy;->a:Ljava/util/TreeMap;
...
.method public final getCount()I
    ...
    .prologue
    .line 62
    iget-object v0, p0, Lemy;->f:Ljava/util/List;
...
.method public final getItem(I)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lemy;->f:Ljava/util/List;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 91
    new-instance v12, Lemx$c;

    move-object/from16 v0, p0

    invoke-direct {v12, v0}, Lemx$c;-><init>(Lemx;)V

    .line 92
    .local v12, "holder":Lemx$c;
    move-object/from16 v0, p0

    iget-object v2, v0, Lemy;->b:Landroid/view/LayoutInflater;

    sget v3, Lfga$d;->pic_list_item:I
    ...
    iput-object v2, v12, Lemx$c;->a:Landroid/widget/ImageView;
    ...
    .line 99
    :goto_1
    iget-object v2, v12, Lemx$c;->a:Landroid/widget/ImageView;
    ...
    .line 102
    .local v11, "finalHolder":Lemx$c;
    move-object/from16 v0, p0

    iget-object v2, v0, Lemy;->f:Ljava/util/List;
    ...
    iget-object v2, v0, Lemy;->g:Lcom/alibaba/laiwang/photokit/browser/EncryptPhotoObjectsFetcher;
    ...
    new-instance v3, Lemy$1;

    move-object/from16 v0, p0

    invoke-direct {v3, v0, v11}, Lemy$1;-><init>(Lemy;Lemx$c;)V
    ...
    :cond_2
    :goto_2
    sget v2, Lfga$c;->tag_item_data:I
    ...
    .line 96
    .end local v10    # "convertView":Landroid/view/View;
    .end local v11    # "finalHolder":Lemx$c;
    .end local v12    # "holder":Lemx$c;
    .restart local p2    # "convertView":Landroid/view/View;
    :cond_4
    ...
    check-cast v12, Lemx$c;

    .restart local v12    # "holder":Lemx$c;
    goto :goto_1

    .line 141
    .restart local v11    # "finalHolder":Lemx$c;
    ...
    iget-object v2, v0, Lemy;->d:Lcom/alibaba/doraemon/image/ImageMagician;

    iget-object v3, v12, Lemx$c;->a:Landroid/widget/ImageView;

    move-object/from16 v0, v16

    iget-object v4, v0, Lcom/alibaba/laiwang/photokit/browser/PhotoObject;->url:Ljava/lang/String;

    invoke-static {v4}, Lemy;->a(Ljava/lang/String;)Ljava/lang/String;
