...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    .line 93
    invoke-direct {p0}, Linfo/monitorenter/cpdetector/io/JarArchive;->parseTree()Lglr;
    ...
    .line 96
    invoke-virtual {p0, v0, p0}, Linfo/monitorenter/cpdetector/io/JarArchive;->buildTree(Lglr;Linfo/monitorenter/cpdetector/io/JarArchive;)V

    .line 97
    return-void
.end method

.method private getSearchPath(Lglr;)Ljava/lang/String;
    .locals 6
    .param p1, "node"    # Lglr;
    ...
    invoke-interface {p1, v2}, Lglr;->b(Ljava/util/List;)V
...
.method private parseTree()Lglr;
    ...
    invoke-direct {v2, v4}, Lgls;-><init>(Ljava/lang/Object;)V

    .line 126
    .local v2, "newnode":Lglr;
    invoke-interface {v3, v2}, Lglr;->b(Lglr;)Z
    ...
    .end local v2    # "newnode":Lglr;
    .end local v3    # "oldnode":Lglr;
...
# virtual methods
.method protected buildTree(Lglr;Linfo/monitorenter/cpdetector/io/JarArchive;)V
    .locals 9
    .param p1, "node"    # Lglr;
    ...
    .prologue
    .line 135
    invoke-interface {p1}, Lglr;->b()Ljava/util/List;
    ...
    .line 143
    .local v1, "childNode":Lglr;
    invoke-direct {p0, v1}, Linfo/monitorenter/cpdetector/io/JarArchive;->getSearchPath(Lglr;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, p0}, Linfo/monitorenter/cpdetector/io/JarArchive$JarElement;->buildTree(Lglr;Linfo/monitorenter/cpdetector/io/JarArchive;)V
