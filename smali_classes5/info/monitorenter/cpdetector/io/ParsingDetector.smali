...
.method public detectCodepage(Ljava/io/InputStream;I)Ljava/nio/charset/Charset;
    ...
    invoke-direct {v5, p1, p2}, Lglt;-><init>(Ljava/io/InputStream;I)V
    ...
    invoke-direct {v4, v7}, Lglp;-><init>(Ljava/io/Reader;)V

    .line 141
    .local v4, "lexer":Lglp;
    new-instance v6, Lglq;

    invoke-direct {v6, v4}, Lglq;-><init>(Lnk;)V

    .line 142
    .local v6, "parser":Lglq;
    invoke-virtual {v6}, Lglq;->b()Ljava/lang/String;
    :try_end_0
    ...
    .line 172
    .end local v4    # "lexer":Lglp;
    .end local v6    # "parser":Lglq;
    :cond_1
    :goto_0
    return-object v1

    .line 150
    .restart local v4    # "lexer":Lglp;
    .restart local v6    # "parser":Lglq;
    :catch_0
    move-exception v7

    :try_start_2
    invoke-static {v2}, Lglo;->a(Ljava/lang/String;)Ljava/nio/charset/Charset;
