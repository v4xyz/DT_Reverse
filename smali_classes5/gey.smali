...
.method public static a(Ljava/io/PrintStream;[BLjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lgez;->a([B)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p2}, Lgez;->a(Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p3}, Lgez;->a(Ljava/lang/String;)Z
    ...
    const-string/jumbo v1, "MM-dd kk:mm:ss"
