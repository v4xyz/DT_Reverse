...
# direct methods
.method public constructor <init>(Llb;Lma;)V
    .locals 3
    .param p1, "listener"    # Llb;
    .param p2, "config"    # Lma;
    ...
    .line 25
    iput-object v2, p0, Llz;->c:Llj;

    .line 26
    const/4 v1, 0x0

    iput-boolean v1, p0, Llz;->d:Z

    .line 27
    iput-object v2, p0, Llz;->e:Lma;

    .line 30
    iput-object p1, p0, Llz;->f:Llb;

    .line 31
    iput-object p2, p0, Llz;->e:Lma;

    .line 33
    if-eqz p1, :cond_0

    :try_start_0
    invoke-interface {p1}, Llb;->a()B
...
.method private a(Ljava/lang/Runnable;)V
    ...
    .local v0, "hashCode":I
    :goto_0
    invoke-static {v0, p1}, Lly;->a(ILjava/lang/Runnable;)V
    ...
    iget-object v3, p0, Llz;->b:Ljava/lang/String;
...
# virtual methods
.method public final a(IILhw;)V
    .locals 6
    .param p1, "index"    # I
    .param p2, "total"    # I
    .param p3, "byteArray"    # Lhw;
    ...
    .prologue
    .line 62
    iget-object v1, p0, Llz;->f:Llb;

    if-eqz v1, :cond_0

    .line 63
    iget-object v5, p0, Llz;->f:Llb;

    .line 64
    .local v5, "l":Llb;
    new-instance v0, Llz$2;
    ...
    invoke-direct/range {v0 .. v5}, Llz$2;-><init>(Llz;ILhw;ILlb;)V

    .line 100
    .local v0, "callback":Ljava/lang/Runnable;
    invoke-direct {p0, v0}, Llz;->a(Ljava/lang/Runnable;)V
...
.method public final a(ILjava/util/Map;)V
    ...
    iget-object v4, p0, Llz;->b:Ljava/lang/String;
    ...
    .line 47
    .local v1, "l":Llb;
    new-instance v0, Llz$1;

    invoke-direct {v0, p0, v1, p1, p2}, Llz$1;-><init>(Llz;Llb;ILjava/util/Map;)V
...
.method public final a(Lanetwork/channel/aidl/DefaultFinishEvent;)V
    ...
    .line 110
    .local v1, "l":Llb;
    new-instance v0, Llz$3;

    invoke-direct {v0, p0, p1, v1}, Llz$3;-><init>(Llz;Lanetwork/channel/aidl/DefaultFinishEvent;Llb;)V
