...
.method public final addMessageChangeListener(Lcom/alibaba/wukong/im/MessageChangeListener;)V
    ...
    .prologue
    .line 64
    invoke-static {p1}, Lfcv;->a(Lcom/alibaba/wukong/im/MessageChangeListener;)V
...
.method public final addMessageListener(Lcom/alibaba/wukong/im/MessageListener;)V
    ...
    .prologue
    .line 54
    invoke-static {p1}, Lfcv;->a(Lcom/alibaba/wukong/im/MessageListener;)V
...
.method public final combineForward(Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lfda;->combineForward(Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Lcom/alibaba/wukong/Callback;)V
...
.method public final combineForward(Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-direct/range {v0 .. v8}, Lfda$5;-><init>(Lfda;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)V

    .line 332
    invoke-virtual {v0}, Lfda$5;->start()V
...
.method public final forwardMessages(Lcom/alibaba/wukong/im/Conversation;Ljava/util/List;Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-direct/range {v0 .. v6}, Lfda$3;-><init>(Lfda;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;Ljava/util/List;Ljava/lang/String;)V

    .line 218
    invoke-virtual {v0}, Lfda$3;->start()V
...
.method public final forwardWithTransformBatch(Ljava/util/List;Ljava/lang/String;Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-direct/range {v0 .. v6}, Lfda$4;-><init>(Lfda;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;Ljava/util/List;Ljava/lang/String;)V

    .line 273
    invoke-virtual {v0}, Lfda$4;->start()V
...
.method public final listAtMeMessages(JILcom/alibaba/wukong/Callback;)V
    ...
    .line 402
    new-instance v1, Lfda$7;

    new-instance v3, Lfbm$a;

    invoke-direct {v3, p4}, Lfbm$a;-><init>(Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-direct/range {v1 .. v8}, Lfda$7;-><init>(Lfda;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;JI)V

    .line 408
    invoke-virtual {v1}, Lfda$7;->start()V
...
.method public final querySecretMsgReadStatus(Ljava/util/List;Lcom/alibaba/wukong/Callback;)V
    ...
    .line 10754
    :cond_2
    new-instance v2, Lfcz$10;

    invoke-direct {v2, v0, p2}, Lfcz$10;-><init>(Lfcz;Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-interface {v0, v1, v2}, Lcom/alibaba/wukong/idl/im/client/IDLMessageService;->querySecretMsgReadStatus(Ljava/util/List;Lfos;)V
...
.method public final varargs removeLocalMessages(Lcom/alibaba/wukong/Callback;Ljava/lang/String;[Ljava/lang/Long;)V
    ...
    invoke-direct/range {v0 .. v7}, Lfda$2;-><init>(Lfda;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;[Ljava/lang/Long;Ljava/lang/String;Lcom/alibaba/wukong/Callback;)V

    .line 151
    invoke-virtual {v0}, Lfda$2;->start()V
    :try_end_3
...
.method public final removeMessageChangeListener(Lcom/alibaba/wukong/im/MessageChangeListener;)V
    ...
    .prologue
    .line 69
    invoke-static {p1}, Lfcv;->b(Lcom/alibaba/wukong/im/MessageChangeListener;)V
...
.method public final removeMessageListener(Lcom/alibaba/wukong/im/MessageListener;)V
    ...
    .prologue
    .line 59
    invoke-static {p1}, Lfcv;->b(Lcom/alibaba/wukong/im/MessageListener;)V
...
.method public final varargs removeMessages(Lcom/alibaba/wukong/Callback;Ljava/lang/String;[Ljava/lang/Long;)V
    ...
    invoke-direct/range {v0 .. v7}, Lfda$1;-><init>(Lfda;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;[Ljava/lang/Long;Ljava/lang/String;Ljava/util/List;)V

    .line 120
    invoke-virtual {v0}, Lfda$1;->start()V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method public final updateMsgAllRead(Ljava/lang/String;Ljava/util/List;Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-direct/range {v0 .. v6}, Lfda$6;-><init>(Lfda;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;Ljava/util/List;Ljava/lang/String;)V

    .line 384
    invoke-virtual {v0}, Lfda$6;->start()V
