...
.method public constructor <init>()V
    ...
    invoke-virtual {p0, p0, v0}, Llc$a;->attachInterface(Landroid/os/IInterface;Ljava/lang/String;)V
...
.method public static a(Landroid/os/IBinder;)Llc;
    ...
    invoke-direct {v0, p0}, Llc$a$a;-><init>(Landroid/os/IBinder;)V
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :goto_1
    invoke-virtual {p0, v0}, Llc$a;->a(Lanetwork/channel/aidl/ParcelableRequest;)Lanetwork/channel/aidl/NetworkResponse;
    ...
    .local v1, "_arg1":Llb;
    :goto_4
    invoke-virtual {p0, v0, v1}, Llc$a;->a(Lanetwork/channel/aidl/ParcelableRequest;Llb;)Lkz;

    move-result-object v2

    .line 81
    .local v2, "_result":Lkz;
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V

    .line 82
    if-eqz v2, :cond_2

    invoke-interface {v2}, Lkz;->asBinder()Landroid/os/IBinder;
    ...
    .line 76
    .end local v0    # "_arg0":Lanetwork/channel/aidl/ParcelableRequest;
    .end local v1    # "_arg1":Llb;
    .end local v2    # "_result":Lkz;
    :cond_3
    const/4 v0, 0x0
    ...
    invoke-direct {v1, v6}, Llb$a$a;-><init>(Landroid/os/IBinder;)V
    ...
    .restart local v0    # "_arg0":Lanetwork/channel/aidl/ParcelableRequest;
    :goto_5
    invoke-virtual {p0, v0}, Llc$a;->b(Lanetwork/channel/aidl/ParcelableRequest;)Lkw;

    move-result-object v2

    .line 96
    .local v2, "_result":Lkw;
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V

    .line 97
    if-eqz v2, :cond_6

    invoke-interface {v2}, Lkw;->asBinder()Landroid/os/IBinder;
