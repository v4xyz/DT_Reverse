...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfvm;->a:Landroid/net/Uri;
...
.method public static a(Landroid/content/Context;)Lfvm$a;
    .locals 5
    ...
    .line 128
    invoke-static {p0}, Lfvm;->b(Landroid/content/Context;)Lfvm$a;

    move-result-object v0

    .line 129
    .local v0, "winfo":Lfvm$a;
    if-nez v0, :cond_1
    ...
    .line 1253
    .end local v0    # "winfo":Lfvm$a;
    :cond_1
    :goto_0
    return-object v0

    .line 1242
    .restart local v0    # "winfo":Lfvm$a;
    :cond_2
    ...
    .line 1251
    invoke-static {p0, v1}, Lfvm;->c(Landroid/content/Context;Ljava/lang/String;)Lfvm$a;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)Lfvm$a;
    .locals 3
    .param p0, "context"    # Landroid/content/Context;
    ...
    .line 107
    :cond_2
    invoke-static {p0, p1}, Lfvm;->c(Landroid/content/Context;Ljava/lang/String;)Lfvm$a;

    move-result-object v0

    .line 108
    .local v0, "info":Lfvm$a;
    if-nez v0, :cond_1
    ...
    iget-object v2, v0, Lfvm$a;->a:Ljava/lang/String;
...
.method private static b(Landroid/content/Context;)Lfvm$a;
    .locals 15
    .param p0, "context"    # Landroid/content/Context;
    ...
    :try_start_0
    sget-object v1, Lfvm;->a:Landroid/net/Uri;
    ...
    invoke-static {p0, v9}, Lfvm;->b(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 209
    new-instance v13, Lfvm$a;

    invoke-direct {v13}, Lfvm$a;-><init>()V

    .line 210
    .local v13, "winfo":Lfvm$a;
    iput-object v9, v13, Lfvm$a;->a:Ljava/lang/String;

    .line 211
    iput v12, v13, Lfvm$a;->b:I
    :try_end_3
...
.method public static b(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {v6}, Lfwk;->a([B)Ljava/lang/String;
...
.method private static c(Landroid/content/Context;Ljava/lang/String;)Lfvm$a;
    .locals 13
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "packageName"    # Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lfvm;->b(Landroid/content/Context;Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    new-instance v8, Lfvm$a;

    invoke-direct {v8}, Lfvm$a;-><init>()V

    .line 296
    .local v8, "winfo":Lfvm$a;
    iput-object p1, v8, Lfvm$a;->a:Ljava/lang/String;

    .line 297
    iput v6, v8, Lfvm$a;->b:I
    :try_end_5
    ...
    invoke-static {v10, v11}, Lfwj;->c(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_b
