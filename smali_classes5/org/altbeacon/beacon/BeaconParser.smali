...
.method private calculateLayoutSize()I
    ...
    .line 816
    :cond_4
    iget-object v3, p0, Lorg/altbeacon/beacon/BeaconParser;->mServiceUuidEndOffset:Ljava/lang/Integer;
...
.method protected fromScanData([BILandroid/bluetooth/BluetoothDevice;Lorg/altbeacon/beacon/Beacon;)Lorg/altbeacon/beacon/Beacon;
    ...
    .line 422
    .local v20, "parseFailed":Z
    const/16 v23, 0x0

    .line 423
    .local v23, "pduToParse":Lorg/altbeacon/bluetooth/Pdu;
    const/16 v26, 0x0

    .line 424
    .local v26, "startByte":I
    new-instance v15, Ljava/util/ArrayList;

    invoke-direct {v15}, Ljava/util/ArrayList;-><init>()V

    .line 425
    .local v15, "identifiers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lorg/altbeacon/beacon/Identifier;>;"
    ...
    check-cast v22, Lorg/altbeacon/bluetooth/Pdu;

    .line 428
    .local v22, "pdu":Lorg/altbeacon/bluetooth/Pdu;
    invoke-virtual/range {v22 .. v22}, Lorg/altbeacon/bluetooth/Pdu;->getType()B
    ...
    const-string/jumbo v30, "Processing pdu type %02X: %s with startIndex: %d, endIndex: %d"
    ...
    .line 442
    .end local v22    # "pdu":Lorg/altbeacon/bluetooth/Pdu;
    :cond_2
    if-nez v23, :cond_6
    ...
    const-string/jumbo v30, "No PDUs to process in this packet."
    ...
    .line 437
    .restart local v22    # "pdu":Lorg/altbeacon/bluetooth/Pdu;
    :cond_5
    invoke-static {}, Lorg/altbeacon/beacon/logging/LogManager;->isVerboseLoggingEnabled()Z
    ...
    invoke-static {v0, v1, v2}, Lorg/altbeacon/beacon/BeaconParser;->longToByteArray(JI)[B

    move-result-object v28

    .line 451
    .local v28, "typeCodeBytes":[B
    ...
    invoke-static {v0, v1, v2, v3}, Lorg/altbeacon/beacon/BeaconParser;->longToByteArray(JIZ)[B
    ...
    const-string/jumbo v30, "This is not a matching Beacon advertisement. (Was expecting %s.  The bytes I see are: %s"
    ...
    const-string/jumbo v31, "Expanding buffer because it is too short to parse: "
    ...
    const-string/jumbo v31, "Need to truncate identifier by "
    ...
    .line 518
    .local v14, "identifier":Lorg/altbeacon/beacon/Identifier;
    invoke-virtual {v15, v14}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 508
    .end local v14    # "identifier":Lorg/altbeacon/beacon/Identifier;
    :cond_e
    :goto_7
    ...
    const-string/jumbo v30, "This is not a matching Beacon advertisement. Was expecting %s at offset %d and %s at offset %d.  The bytes I see are: %s"
    ...
    const-string/jumbo v30, "This is a recognized beacon advertisement -- %s seen"
    ...
    const-string/jumbo v30, "Bytes are: %s"
    ...
    const-string/jumbo v31, "Cannot parse identifier "
    ...
    const-string/jumbo v31, " because PDU is too short.  endIndex: "
    ...
    const-string/jumbo v31, " PDU endIndex: "
    ...
    .line 528
    .restart local v14    # "identifier":Lorg/altbeacon/beacon/Identifier;
    invoke-virtual {v15, v14}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
    ...
    const-string/jumbo v31, "Cannot parse data field "
    ...
    const-string/jumbo v31, ".  Setting value to 0"
    ...
    invoke-direct/range {v29 .. v31}, Ljava/lang/Long;-><init>(J)V
    ...
    const-string/jumbo v31, "Cannot parse power field because PDU is too short.  endIndex: "
    ...
    .line 557
    .local v24, "powerString":Ljava/lang/String;
    ...
    .end local v24    # "powerString":Ljava/lang/String;
    .end local v27    # "txPower":I
    :catch_1
    move-exception v29
    ...
    .end local v11    # "endIndex":I
    .end local v12    # "i":I
    .end local v21    # "patternFound":Z
    .end local v25    # "serviceUuidBytes":[B
    .end local v28    # "typeCodeBytes":[B
    :cond_1a
    move-object/from16 v0, p0
    ...
    .line 586
    .local v18, "manufacturerString":Ljava/lang/String;
    invoke-static/range {v18 .. v18}, Ljava/lang/Integer;->parseInt(Ljava/lang/String;)I

    move-result v17

    .line 588
    .local v17, "manufacturer":I
    const/16 v16, 0x0
    ...
    iput-object v15, v0, Lorg/altbeacon/beacon/Beacon;->mIdentifiers:Ljava/util/List;
...
.method public setBeaconLayout(Ljava/lang/String;)Lorg/altbeacon/beacon/BeaconParser;
    ...
    const-string/jumbo v15, "Parsing beacon layout: "
    ...
    .line 172
    .local v12, "terms":[Ljava/lang/String;
    const/4 v14, 0x0
    ...
    iput-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mExtraFrame:Ljava/lang/Boolean;
    ...
    .line 177
    .local v4, "found":Z
    sget-object v14, Lorg/altbeacon/beacon/BeaconParser;->I_PATTERN:Ljava/util/regex/Pattern;
    ...
    .line 184
    .local v8, "littleEndian":Ljava/lang/Boolean;
    move-object/from16 v0, p0
    ...
    .line 186
    .local v13, "variableLength":Ljava/lang/Boolean;
    move-object/from16 v0, p0
    ...
    iget-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mIdentifierStartOffsets:Ljava/util/List;
    ...
    iget-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mIdentifierEndOffsets:Ljava/util/List;
    ...
    .end local v8    # "littleEndian":Ljava/lang/Boolean;
    .end local v10    # "startOffset":I
    .end local v13    # "variableLength":Ljava/lang/Boolean;
    :catch_0
    move-exception v14

    new-instance v14, Lorg/altbeacon/beacon/BeaconParser$BeaconLayoutException;

    new-instance v15, Ljava/lang/StringBuilder;

    const-string/jumbo v16, "Cannot parse integer byte offset in term: "
    ...
    invoke-direct {v14, v15}, Lorg/altbeacon/beacon/BeaconParser$BeaconLayoutException;-><init>(Ljava/lang/String;)V

    throw v14

    .line 193
    :cond_0
    sget-object v14, Lorg/altbeacon/beacon/BeaconParser;->D_PATTERN:Ljava/util/regex/Pattern;
    ...
    .line 200
    .restart local v8    # "littleEndian":Ljava/lang/Boolean;
    move-object/from16 v0, p0
    ...
    iget-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mDataEndOffsets:Ljava/util/List;
    ...
    .line 207
    :cond_1
    sget-object v14, Lorg/altbeacon/beacon/BeaconParser;->P_PATTERN:Ljava/util/regex/Pattern;
    ...
    iput-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mDBmCorrection:Ljava/lang/Integer;
    ...
    iput-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mPowerStartOffset:Ljava/lang/Integer;
    ...
    iput-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mPowerEndOffset:Ljava/lang/Integer;
    :try_end_2
    ...
    const-string/jumbo v16, "Cannot parse integer power byte offset in term: "
    ...
    .line 224
    :cond_3
    sget-object v14, Lorg/altbeacon/beacon/BeaconParser;->M_PATTERN:Ljava/util/regex/Pattern;
    ...
    iput-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mMatchingBeaconTypeCodeStartOffset:Ljava/lang/Integer;
    ...
    iput-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mMatchingBeaconTypeCodeEndOffset:Ljava/lang/Integer;
    :try_end_3
    ...
    iput-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mMatchingBeaconTypeCode:Ljava/lang/Long;
    :try_end_4
    ...
    const-string/jumbo v16, "Cannot parse beacon type code: "
    ...
    const-string/jumbo v16, " in term: "
    ...
    .line 243
    :cond_4
    sget-object v14, Lorg/altbeacon/beacon/BeaconParser;->S_PATTERN:Ljava/util/regex/Pattern;
    ...
    iput-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mServiceUuidStartOffset:Ljava/lang/Integer;
    ...
    iput-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mServiceUuidEndOffset:Ljava/lang/Integer;
    :try_end_5
    ...
    .line 256
    .restart local v5    # "hexString":Ljava/lang/String;
    :try_start_6
    new-instance v14, Ljava/lang/StringBuilder;
    ...
    iput-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mServiceUuid:Ljava/lang/Long;
    :try_end_6
    ...
    const-string/jumbo v16, "Cannot parse serviceUuid: "
    ...
    .line 262
    :cond_5
    sget-object v14, Lorg/altbeacon/beacon/BeaconParser;->X_PATTERN:Ljava/util/regex/Pattern;
    ...
    .line 269
    const-string/jumbo v14, "BeaconParser"

    const-string/jumbo v15, "cannot parse term %s"
    ...
    invoke-static/range {v14 .. v16}, Lorg/altbeacon/beacon/logging/LogManager;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string/jumbo v16, "Cannot parse beacon layout term: "
    ...
    .end local v11    # "term":Ljava/lang/String;
    :cond_8
    move-object/from16 v0, p0
    ...
    const-string/jumbo v15, "You must supply at least one identifier offset with a prefix of \'i\'"
    ...
    iget-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mPowerStartOffset:Ljava/lang/Integer;

    if-eqz v14, :cond_b

    move-object/from16 v0, p0

    iget-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mPowerEndOffset:Ljava/lang/Integer;
    ...
    const-string/jumbo v15, "You must supply a power byte offset with a prefix of \'p\'"
    ...
    const-string/jumbo v15, "You must supply a matching beacon type expression with a prefix of \'m\'"
    ...
    iput-object v14, v0, Lorg/altbeacon/beacon/BeaconParser;->mLayoutSize:Ljava/lang/Integer;
