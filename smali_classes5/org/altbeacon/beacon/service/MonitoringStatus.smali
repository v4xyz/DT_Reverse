...
.method private regionsMatchingTo(Lorg/altbeacon/beacon/Beacon;)Ljava/util/List;
    ...
    .line 157
    .local v1, "matched":Ljava/util/List;, "Ljava/util/List<Lorg/altbeacon/beacon/Region;>;"
...
.method public declared-synchronized addRegion(Lorg/altbeacon/beacon/Region;Lorg/altbeacon/beacon/service/Callback;)V
    ...
    const-string/jumbo v4, "Replacing region with unique identifier "
    ...
    const-string/jumbo v4, "Old definition: "
    ...
    const-string/jumbo v4, "New definition: "
    ...
    const-string/jumbo v3, "clearing state"
    ...
    new-instance v3, Lorg/altbeacon/beacon/service/RegionMonitoringState;

    invoke-direct {v3, p2}, Lorg/altbeacon/beacon/service/RegionMonitoringState;-><init>(Lorg/altbeacon/beacon/service/Callback;)V
...
.method protected restoreMonitoringStatus()V
    ...
    :try_start_0
    iget-object v8, p0, Lorg/altbeacon/beacon/service/MonitoringStatus;->mContext:Landroid/content/Context;

    const-string/jumbo v9, "org.altbeacon.beacon.service.monitoring_status_state"
    ...
    .line 218
    .local v3, "obj":Ljava/util/Map;, "Ljava/util/Map<Lorg/altbeacon/beacon/Region;Lorg/altbeacon/beacon/service/RegionMonitoringState;>;"
    sget-object v8, Lorg/altbeacon/beacon/service/MonitoringStatus;->TAG:Ljava/lang/String;

    new-instance v9, Ljava/lang/StringBuilder;

    const-string/jumbo v10, "Restored region monitoring state for "
    ...
    const-string/jumbo v10, " regions."
    ...
    .line 220
    .local v6, "region":Lorg/altbeacon/beacon/Region;
    sget-object v8, Lorg/altbeacon/beacon/service/MonitoringStatus;->TAG:Ljava/lang/String;
    ...
    .line 236
    .end local v1    # "i$":Ljava/util/Iterator;
    .end local v3    # "obj":Ljava/util/Map;, "Ljava/util/Map<Lorg/altbeacon/beacon/Region;Lorg/altbeacon/beacon/service/RegionMonitoringState;>;"
    .end local v6    # "region":Lorg/altbeacon/beacon/Region;
    :catch_0
    move-exception v8
    ...
    :goto_2
    :try_start_2
    instance-of v8, v0, Ljava/io/InvalidClassException;
    ...
    const-string/jumbo v9, "Serialized Monitoring State has wrong class. Just ignoring saved state..."
    ...
    .end local v4    # "objectInputStream":Ljava/io/ObjectInputStream;
    .restart local v1    # "i$":Ljava/util/Iterator;
    .restart local v3    # "obj":Ljava/util/Map;, "Ljava/util/Map<Lorg/altbeacon/beacon/Region;Lorg/altbeacon/beacon/service/RegionMonitoringState;>;"
    ...
    .line 228
    .local v7, "regionMonitoringState":Lorg/altbeacon/beacon/service/RegionMonitoringState;
    ...
    .end local v1    # "i$":Ljava/util/Iterator;
    .end local v3    # "obj":Ljava/util/Map;, "Ljava/util/Map<Lorg/altbeacon/beacon/Region;Lorg/altbeacon/beacon/service/RegionMonitoringState;>;"
    .end local v7    # "regionMonitoringState":Lorg/altbeacon/beacon/service/RegionMonitoringState;
    :catch_1
    move-exception v8
    ...
    .restart local v5    # "objectInputStream":Ljava/io/ObjectInputStream;
    :cond_4
    iget-object v8, p0, Lorg/altbeacon/beacon/service/MonitoringStatus;->mRegionsStatesMap:Ljava/util/Map;
    ...
    const-string/jumbo v9, "Deserialization exception, message: %s"
...
.method public declared-synchronized updateNewlyInsideInRegionsContaining(Lorg/altbeacon/beacon/Beacon;)V
    ...
    .line 116
    .local v1, "matchingRegions":Ljava/util/List;, "Ljava/util/List<Lorg/altbeacon/beacon/Region;>;"
    const/4 v2, 0x0

    .line 117
    .local v2, "needsMonitoringStateSaving":Z
    ...
    .line 119
    .local v4, "state":Lorg/altbeacon/beacon/service/RegionMonitoringState;
    if-eqz v4, :cond_0

    invoke-virtual {v4}, Lorg/altbeacon/beacon/service/RegionMonitoringState;->markInside()Z
    ...
    invoke-direct {v8, v9, v3}, Lorg/altbeacon/beacon/service/MonitoringData;-><init>(ZLorg/altbeacon/beacon/Region;)V
    ...
    .end local v1    # "matchingRegions":Ljava/util/List;, "Ljava/util/List<Lorg/altbeacon/beacon/Region;>;"
    .end local v2    # "needsMonitoringStateSaving":Z
    .end local v3    # "region":Lorg/altbeacon/beacon/Region;
    .end local v4    # "state":Lorg/altbeacon/beacon/service/RegionMonitoringState;
    :catchall_0
    move-exception v5
    ...
    .restart local v1    # "matchingRegions":Ljava/util/List;, "Ljava/util/List<Lorg/altbeacon/beacon/Region;>;"
    .restart local v2    # "needsMonitoringStateSaving":Z
    :cond_1
    if-eqz v2, :cond_2
    ...
    invoke-virtual {p0, v6, v7}, Lorg/altbeacon/beacon/service/MonitoringStatus;->updateMonitoringStatusTime(J)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
