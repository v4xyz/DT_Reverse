...
.method public onCycleEnd()V
    ...
    invoke-static {v2}, Lorg/altbeacon/beacon/service/BeaconService;->access$200(Lorg/altbeacon/beacon/service/BeaconService;)Lorg/altbeacon/beacon/service/MonitoringStatus;

    move-result-object v2

    invoke-virtual {v2}, Lorg/altbeacon/beacon/service/MonitoringStatus;->updateNewlyOutside()V

    .line 360
    iget-object v2, p0, Lorg/altbeacon/beacon/service/BeaconService$1;->this$0:Lorg/altbeacon/beacon/service/BeaconService;

    invoke-static {v2}, Lorg/altbeacon/beacon/service/BeaconService;->access$300(Lorg/altbeacon/beacon/service/BeaconService;)V

    .line 362
    iget-object v2, p0, Lorg/altbeacon/beacon/service/BeaconService$1;->this$0:Lorg/altbeacon/beacon/service/BeaconService;

    invoke-static {v2}, Lorg/altbeacon/beacon/service/BeaconService;->access$400(Lorg/altbeacon/beacon/service/BeaconService;)Ljava/util/List;
    ...
    const-string/jumbo v3, "Simulated scan data is deprecated and will be removed in a future release. Please use the new BeaconSimulator interface instead."
    ...
    invoke-virtual {v2}, Lorg/altbeacon/beacon/service/BeaconService;->getApplicationInfo()Landroid/content/pm/ApplicationInfo;
    ...
    const-string/jumbo v3, "Simulated scan data provided, but ignored because we are not running in debug mode.  Please remove simulated scan data for production."
    ...
    invoke-interface {v2}, Lorg/altbeacon/beacon/simulator/BeaconSimulator;->getBeacons()Ljava/util/List;
    ...
    const-string/jumbo v3, "Beacon simulations provided, but ignored because we are not running in debug mode.  Please remove beacon simulations for production."
    ...
    const-string/jumbo v3, "getBeacons is returning null. No simulated beacons to report."
