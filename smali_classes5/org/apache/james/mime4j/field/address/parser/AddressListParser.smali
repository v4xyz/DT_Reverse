...
.method public constructor <init>(Ljava/io/Reader;)V
    ...
    iput-object v1, p0, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->a:Lgto;
    ...
    invoke-direct {v1, p1, v5, v5}, Lgtq;-><init>(Ljava/io/Reader;II)V

    iput-object v1, p0, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->c:Lgtq;

    .line 786
    new-instance v1, Lgtk;

    iget-object v2, p0, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->c:Lgtq;

    invoke-direct {v1, v2}, Lgtk;-><init>(Lgtq;)V

    iput-object v1, p0, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->b:Lgtk;
...
.method private a(Lgtp;)V
    ...
    iput-object v0, p1, Lgtr;->a:Lorg/apache/james/mime4j/field/address/parser/Token;
...
.method private b()V
    ...
    invoke-direct {v2, v6}, Lgsz;-><init>(I)V

    .line 102
    .local v2, "jjtn000":Lgsz;
    const/4 v0, 0x1

    .line 103
    .local v0, "jjtc000":Z
    iget-object v3, p0, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->a:Lgto;

    invoke-virtual {v3, v2}, Lgto;->a(Lgtp;)V

    .line 104
    invoke-direct {p0, v2}, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->a(Lgtp;)V
    ...
    invoke-virtual {v3, v2, v6}, Lgto;->a(Lgtp;Z)V

    .line 155
    invoke-direct {p0, v2}, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->b(Lgtp;)V
    ...
    .line 154
    iget-object v4, p0, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->a:Lgto;

    invoke-virtual {v4, v2, v6}, Lgto;->a(Lgtp;Z)V
...
.method private b(Lgtp;)V
    ...
    iput-object v0, p1, Lgtr;->b:Lorg/apache/james/mime4j/field/address/parser/Token;
...
.method private c(I)Lorg/apache/james/mime4j/field/address/parser/Token;
    ...
    iget-object v5, p0, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->b:Lgtk;

    invoke-virtual {v5}, Lgtk;->a()Lorg/apache/james/mime4j/field/address/parser/Token;
    ...
    sget-object v6, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->d_:[Ljava/lang/String;
...
.method private c()V
    ...
    invoke-direct {v2, v3}, Lgsy;-><init>(I)V

    .line 163
    .local v2, "jjtn000":Lgsy;
    const/4 v0, 0x1
    ...
    invoke-virtual {v3, v2, v5}, Lgto;->a(Lgtp;Z)V
    ...
    invoke-virtual {v4, v2, v5}, Lgto;->a(Lgtp;Z)V
    ...
    invoke-direct {v6, v3}, Lgtc;-><init>(I)V

    .line 2299
    iget-object v3, p0, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->a:Lgto;

    invoke-virtual {v3, v6}, Lgto;->a(Lgtp;)V

    .line 2300
    invoke-direct {p0, v6}, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->a(Lgtp;)V
    :try_end_3
    .catch Ljava/lang/Throwable; {:try_start_3 .. :try_end_3} :catch_0
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    invoke-virtual {v3, v6, v4}, Lgto;->a(Lgtp;Z)V

    .line 2353
    invoke-direct {p0, v6}, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->b(Lgtp;)V
    :try_end_5
    ...
    invoke-virtual {v4, v6, v7}, Lgto;->a(Lgtp;Z)V
...
.method private d()V
    ...
    invoke-direct {v2, v3}, Lgte;-><init>(I)V

    .line 221
    .local v2, "jjtn000":Lgte;
    const/4 v0, 0x1
    ...
    invoke-direct {v6, v3}, Lgtf;-><init>(I)V
...
.method private d(I)Z
    ...
    iget-object v3, p0, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->b:Lgtk;

    invoke-virtual {v3}, Lgtk;->a()Lorg/apache/james/mime4j/field/address/parser/Token;
...
.method private e()V
    ...
    invoke-direct {v2, v3}, Lgta;-><init>(I)V

    .line 361
    .local v2, "jjtn000":Lgta;
    const/4 v0, 0x1
    ...
    invoke-direct {v6, v3}, Lgth;-><init>(I)V
...
.method private f()V
    ...
    invoke-direct {v0, v1}, Lgtg;-><init>(I)V

    .line 460
    .local v0, "jjtn000":Lgtg;
    iget-object v1, p0, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->a:Lgto;

    invoke-virtual {v1, v0}, Lgto;->a(Lgtp;)V

    .line 461
    invoke-direct {p0, v0}, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->a(Lgtp;)V
    ...
    .line 489
    iget-object v2, p0, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->a:Lgto;

    invoke-virtual {v2, v0, v4}, Lgto;->a(Lgtp;Z)V

    .line 490
    invoke-direct {p0, v0}, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->b(Lgtp;)V
    ...
    invoke-virtual {v1, v0, v4}, Lgto;->a(Lgtp;Z)V
...
.method private g()V
    ...
    invoke-direct {v2, v3}, Lgsx;-><init>(I)V

    .line 498
    .local v2, "jjtn000":Lgsx;
    const/4 v0, 0x1
    ...
    invoke-direct {v5, v3}, Lgtd;-><init>(I)V

    .line 3531
    iget-object v3, p0, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->a:Lgto;

    invoke-virtual {v3, v5}, Lgto;->a(Lgtp;)V

    .line 3532
    invoke-direct {p0, v5}, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->a(Lgtp;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v4, v5, v6}, Lgto;->a(Lgtp;Z)V

    .line 3584
    invoke-direct {p0, v5}, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->b(Lgtp;)V
    ...
    invoke-virtual {v4, v2, v9}, Lgto;->a(Lgtp;Z)V
    ...
    invoke-virtual {v3, v5, v4}, Lgto;->a(Lgtp;Z)V
    ...
    invoke-virtual {v3, v2, v9}, Lgto;->a(Lgtp;Z)V
...
.method private h()V
    ...
    invoke-direct {v0, v2}, Lgtb;-><init>(I)V

    .line 593
    .local v0, "jjtn000":Lgtb;
    iget-object v2, p0, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->a:Lgto;

    invoke-virtual {v2, v0}, Lgto;->a(Lgtp;)V
    ...
    invoke-virtual {v3, v0, v6}, Lgto;->a(Lgtp;Z)V
    ...
    invoke-virtual {v2, v0, v6}, Lgto;->a(Lgtp;Z)V
...
.method private l()I
    ...
    iget-object v1, p0, Lorg/apache/james/mime4j/field/address/parser/AddressListParser;->b:Lgtk;

    invoke-virtual {v1}, Lgtk;->a()Lorg/apache/james/mime4j/field/address/parser/Token;
...
.method public final a()Lgsz;
    ...
    .line 2038
    iget-object v1, v1, Lgto;->a:Ljava/util/List;
