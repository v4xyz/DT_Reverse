...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfoy;->a:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static a(Ljava/lang/Class;)Lfoy$a;
    .locals 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 17
    sget-object v9, Lfoy;->a:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v9, p0}, Ljava/util/concurrent/ConcurrentHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lfoy$a;

    .line 18
    .local v6, "meta":Lfoy$a;
    if-eqz v6, :cond_0

    move-object v7, v6

    .line 48
    .end local v6    # "meta":Lfoy$a;
    ...
    .line 24
    .local v2, "fieldArray":Ljava/util/List;, "Ljava/util/List<Lfow;>;"
    array-length v12, v4
    ...
    .line 29
    .local v3, "fieldInfo":Lfow;
    iput-object v1, v3, Lfow;->a:Ljava/lang/reflect/Field;
    ...
    iput-object v9, v3, Lfow;->c:Ljava/lang/Class;
    ...
    iput-object v9, v3, Lfow;->d:Ljava/lang/reflect/Type;

    .line 34
    invoke-interface {v2, v3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 24
    .end local v3    # "fieldInfo":Lfow;
    :cond_1
    ...
    :cond_6
    new-instance v6, Lfoy$a;

    .end local v6    # "meta":Lfoy$a;
    invoke-direct {v6, p0, v2, v0, v10}, Lfoy$a;-><init>(Ljava/lang/Class;Ljava/util/List;ZB)V
