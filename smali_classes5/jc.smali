...
.method private static a(Lanet/channel/request/Request;)Ljava/net/HttpURLConnection;
    ...
    .line 208
    iget-object v6, v8, Lkh;->a:Ljava/net/Proxy;
    ...
    .line 21025
    iget-object v12, v8, Lkh;->b:Ljava/lang/String;
    ...
    iget-object v13, v8, Lkh;->c:Ljava/lang/String;
    ...
    .line 21268
    invoke-static {}, Lkg;->a()Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 21272
    :cond_a
    invoke-static {}, Lkg;->b()Ljavax/net/ssl/HostnameVerifier;
    ...
    .line 21275
    sget-object v11, Lkg;->c:Ljavax/net/ssl/HostnameVerifier;
    ...
    .line 21277
    :cond_c
    new-instance v11, Ljc$1;

    invoke-direct {v11, p0}, Ljc$1;-><init>(Lanet/channel/request/Request;)V
...
.method public static a(Lanet/channel/request/Request;Lhq;)Ljc$a;
    .locals 19
    .param p0, "request"    # Lanet/channel/request/Request;
    .param p1, "requestCb"    # Lhq;
    ...
    invoke-static {v0, v4, v1, v6, v7}, Ljc;->a(Lanet/channel/request/Request;Ljc$a;Lhq;ILjava/lang/Throwable;)V
    ...
    .line 78
    :cond_5
    invoke-static/range {p0 .. p0}, Ljc;->a(Lanet/channel/request/Request;)Ljava/net/HttpURLConnection;
    ...
    invoke-static {v6}, Lkf;->a(Ljava/util/Map;)Ljava/util/Map;

    move-result-object v6

    iput-object v6, v4, Ljc$a;->c:Ljava/util/Map;
    ...
    iget-object v11, v4, Ljc$a;->c:Ljava/util/Map;
    ...
    .line 86
    iget v6, v4, Ljc$a;->a:I

    iget-object v7, v4, Ljc$a;->c:Ljava/util/Map;

    move-object/from16 v0, p0

    invoke-static {v0, v6, v7}, Lkf;->a(Lanet/channel/request/Request;ILjava/util/Map;)Z
    :try_end_3
    ...
    invoke-static {v0, v4, v1, v6, v3}, Ljc;->a(Lanet/channel/request/Request;Ljc$a;Lhq;ILjava/lang/Throwable;)V
    ...
    invoke-interface {v0, v6, v7}, Lhq;->a(ILjava/util/Map;)V
    ...
    :cond_c
    :try_start_12
    iget-object v6, v4, Ljc$a;->c:Ljava/util/Map;

    invoke-static {v6}, Lkf;->b(Ljava/util/Map;)Z
    ...
    invoke-virtual {v6, v7, v8}, Lir;->a(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v6}, Lkf;->c(Ljava/util/Map;)I
    ...
    .line 9024
    :try_start_25
    sget-object v7, Lhx$a;->a:Lhx;

    .line 7356
    const/16 v11, 0x800

    invoke-virtual {v7, v11}, Lhx;->a(I)Lhw;

    move-result-object v7

    .line 7358
    :cond_14
    invoke-virtual {v7, v6}, Lhw;->a(Ljava/io/InputStream;)I
    ...
    .line 7365
    invoke-virtual {v7, v9}, Lhw;->a(Ljava/io/OutputStream;)V
    ...
    invoke-interface {v0, v7, v11}, Lhq;->a(Lhw;Z)V
    ...
    .line 7389
    iget-object v8, v4, Ljc$a;->c:Ljava/util/Map;
    ...
    invoke-interface {v0, v7, v8}, Lhq;->a(ILjava/util/Map;)V

    .line 7394
    iget-object v7, v4, Ljc$a;->b:[B

    invoke-static {v7}, Lhw;->a([B)Lhw;
    ...
    invoke-interface {v0, v7, v8}, Lhq;->a(Lhw;Z)V
    :try_end_25
...
.method private static a(Lanet/channel/request/Request;Ljc$a;Lhq;ILjava/lang/Throwable;)V
    .locals 8
    .param p0, "request"    # Lanet/channel/request/Request;
    .param p1, "response"    # Ljc$a;
    .param p2, "requestCb"    # Lhq;
    .param p3, "errCode"    # I
    .param p4, "e"    # Ljava/lang/Throwable;

    .prologue
    .line 176
    invoke-static {p3}, Lkd;->a(I)Ljava/lang/String;
    ...
    invoke-interface {p2, p3, v0, v2}, Lhq;->a(ILjava/lang/String;Lanet/channel/statist/RequestStatistic;)V
    ...
    invoke-interface {v2, v1}, Lhv;->a(Lanet/channel/statist/StatObject;)V
