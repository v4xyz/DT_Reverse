...
.method public constructor <init>(Lfsm;)V
    ...
    invoke-direct {p0, p1, v0}, Lfsj;-><init>(Lfsm;B)V

    return-void
.end method

.method private constructor <init>(Lfsm;B)V
    .locals 4
    ...
    iput-object p1, p0, Lfsj;->b:Lfsm;

    iget-object v0, p1, Lfsm;->e:Ljava/net/Proxy;
    ...
    iget-object v2, p0, Lfsj;->b:Lfsm;

    iget v2, v2, Lfsm;->c:I

    iget-object v3, p0, Lfsj;->b:Lfsm;

    iget v3, v3, Lfsm;->d:I

    invoke-direct {v1, v2, v3, v0}, Lfsk;-><init>(IILjava/net/Proxy;)V

    iput-object v1, p0, Lfsj;->a:Lfsk;
...
# virtual methods
.method public final a(Lfsj$a;)V
    .locals 12
    ...
    .line 0
    iget-object v5, p0, Lfsj;->a:Lfsk;

    iget-object v1, p0, Lfsj;->b:Lfsm;

    invoke-virtual {v1}, Lfsm;->c()Ljava/lang/String;

    move-result-object v1

    iget-object v4, p0, Lfsj;->b:Lfsm;

    invoke-virtual {v4}, Lfsm;->b()Ljava/util/Map;

    move-result-object v4

    iget-object v6, p0, Lfsj;->b:Lfsm;

    invoke-virtual {v6}, Lfsm;->a()Ljava/util/Map;
    ...
    :try_start_0
    invoke-static {v6}, Lfsk;->a(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-virtual {v5, v1, v4, v6}, Lfsk;->a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/net/HttpURLConnection;
    :try_end_0
    ...
    invoke-interface {p1}, Lfsj$a;->a()V
    ...
    invoke-interface {p1, v2, v6, v7}, Lfsj$a;->a([BJ)V
    ...
    invoke-interface {p1, v4, v6, v7}, Lfsj$a;->a([BJ)V
    :try_end_6
    ...
    :cond_a
    :try_start_9
    iget-boolean v2, v5, Lfsk;->b:Z

    invoke-interface {p1}, Lfsj$a;->b()V
    :try_end_9
