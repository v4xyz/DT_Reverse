...
.method protected final a(Ljava/util/List;)Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual {v2}, Lfsf;->close()V
    :try_end_1
    ...
    sget-object v0, Lfsg;->a:Ljava/nio/charset/Charset;

    invoke-direct {v2, v3, v0}, Lfsf;-><init>(Ljava/io/InputStream;Ljava/nio/charset/Charset;)V
    :try_end_4
    ...
    :goto_3
    :try_start_5
    invoke-virtual {v2}, Lfsf;->a()Ljava/lang/String;
    ...
    invoke-direct {p0}, Lfra;->c()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lfuu;->d()[Ljava/lang/String;

    move-result-object v7

    invoke-static {v7, v4}, Lfra;->a([Ljava/lang/String;Ljava/lang/String;)Z

    move-result v7

    iput-boolean v7, p0, Lfra;->g:Z

    iget-boolean v7, p0, Lfra;->g:Z

    if-eqz v7, :cond_a

    .line 2000
    iput-object v0, p0, Lfrd;->a:Lfuu;
    ...
    invoke-static {v0, v6, v7}, Lfuy;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
...
.method protected final a(Landroid/content/Context;)Z
    ...
    sget-boolean v2, Lfra;->d:Z

    if-eqz v2, :cond_3

    sput-boolean v1, Lfra;->d:Z
    ...
    invoke-virtual {v5, v1}, Lfrp;->c(Z)V
