...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lhr;->a:Ljava/util/Map;
    ...
    iput-object v0, p0, Lhr;->b:Ljava/util/concurrent/locks/ReentrantReadWriteLock;

    .line 34
    iget-object v0, p0, Lhr;->b:Ljava/util/concurrent/locks/ReentrantReadWriteLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantReadWriteLock;->readLock()Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;

    move-result-object v0

    iput-object v0, p0, Lhr;->c:Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;
    ...
    iput-object v0, p0, Lhr;->d:Ljava/util/concurrent/locks/ReentrantReadWriteLock$WriteLock;
...
# virtual methods
.method public final a(Lhs;Lanet/channel/entity/ConnType$TypeLevel;)Lanet/channel/Session;
    .locals 13
    .param p1, "key"    # Lhs;
    ...
    iget-object v8, p0, Lhr;->c:Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;

    invoke-virtual {v8}, Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;->lock()V

    .line 173
    :try_start_0
    iget-object v8, p0, Lhr;->a:Ljava/util/Map;
    ...
    :cond_4
    iget-object v3, p1, Lhs;->a:Ljava/lang/String;
    ...
    invoke-interface {v7, v2}, Lhv;->a(Lanet/channel/statist/StatObject;)V
    :try_end_1
    ...
    :cond_7
    iget-object v7, p0, Lhr;->c:Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;
...
.method public final a()Ljava/util/List;
    ...
    .line 212
    .local v0, "infos":Ljava/util/List;, "Ljava/util/List<Lhs;>;"
    iget-object v2, p0, Lhr;->c:Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;

    invoke-virtual {v2}, Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;->lock()V

    .line 214
    :try_start_0
    iget-object v2, p0, Lhr;->a:Ljava/util/Map;
    ...
    .line 222
    .end local v0    # "infos":Ljava/util/List;, "Ljava/util/List<Lhs;>;"
    .local v1, "infos":Ljava/lang/Object;, "Ljava/util/List<Lhs;>;"
    :goto_0
    return-object v1

    .line 218
    .end local v1    # "infos":Ljava/lang/Object;, "Ljava/util/List<Lhs;>;"
    .restart local v0    # "infos":Ljava/util/List;, "Ljava/util/List<Lhs;>;"
    :cond_0
    :try_start_1
    ...
    .line 222
    .restart local v1    # "infos":Ljava/lang/Object;, "Ljava/util/List<Lhs;>;"
    goto :goto_0
    ...
    iget-object v3, p0, Lhr;->c:Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;
...
.method public final a(Lanet/channel/entity/ConnType;)Ljava/util/List;
    ...
    iget-object v6, p0, Lhr;->c:Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;

    invoke-virtual {v6}, Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;->lock()V

    .line 122
    :try_start_0
    iget-object v6, p0, Lhr;->a:Ljava/util/Map;
...
.method public final a(Lhs;)Ljava/util/List;
    .locals 3
    .param p1, "info"    # Lhs;
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .prologue
    .line 105
    iget-object v1, p0, Lhr;->c:Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;

    invoke-virtual {v1}, Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;->lock()V

    .line 107
    :try_start_0
    iget-object v1, p0, Lhr;->a:Ljava/util/Map;
...
.method public final a(Ljava/lang/String;)Ljava/util/List;
    ...
    .prologue
    .line 100
    invoke-static {p1}, Lhs;->a(Ljava/lang/String;)Lhs;

    move-result-object v0

    .line 101
    .local v0, "key":Lhs;
    invoke-virtual {p0, v0}, Lhr;->a(Lhs;)Ljava/util/List;
...
.method public final a(Lhs;Lanet/channel/Session;)V
    .locals 3
    .param p1, "info"    # Lhs;
    ...
    .line 1084
    iget-object v1, p1, Lhs;->a:Ljava/lang/String;
    ...
    .line 59
    :cond_1
    iget-object v1, p0, Lhr;->d:Ljava/util/concurrent/locks/ReentrantReadWriteLock$WriteLock;
    ...
    iget-object v2, p0, Lhr;->d:Ljava/util/concurrent/locks/ReentrantReadWriteLock$WriteLock;
...
.method public final b(Lhs;Lanet/channel/Session;)V
    .locals 3
    .param p1, "info"    # Lhs;
    .param p2, "conn"    # Lanet/channel/Session;
...
.method public final c(Lhs;Lanet/channel/Session;)Z
    .locals 4
    .param p1, "request"    # Lhs;
