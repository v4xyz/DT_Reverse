...
.method public static a(Lfpv;)Ljava/nio/ByteBuffer;
    .locals 7
    .param p0, "in"    # Lfpv;

    .prologue
    .line 13
    invoke-virtual {p0}, Lfpv;->b()[B
    ...
    iget-object v6, p0, Lfpv;->f:Lcom/laiwang/lws/protocol/Attributes;

    invoke-virtual {v6}, Lcom/laiwang/lws/protocol/Attributes;->b()I

    move-result v6

    invoke-direct {v0, v4, v3, v5, v6}, Lfpr;-><init>(IIII)V
...
.method public static a(Lfpx;Ljava/nio/ByteBuffer;Ljava/util/List;)V
    .locals 11
    ...
    .prologue
    .local p2, "out":Ljava/util/List;, "Ljava/util/List<Lfpv;>;"
    const/4 v10, 0x4
    ...
    invoke-static {v2, v5, v9}, Lfpy;->b([BII)S
    ...
    .line 2047
    invoke-static {v2, v9, v9}, Lfpy;->b([BII)S
    ...
    invoke-direct {v1, v8, v6, v5, v7}, Lfpr;-><init>(IIII)V
    ...
    invoke-direct {v4, p0, v6}, Lfpt;-><init>(Lfpx;I)V

    .line 36
    .local v4, "packet":Lfpv;
    :goto_1
    invoke-virtual {p1}, Ljava/nio/ByteBuffer;->asReadOnlyBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {v4, v3, v5}, Lfpv;->a([BI)V
    ...
    .end local v3    # "p":[B
    .end local v4    # "packet":Lfpv;
    :pswitch_1
    new-instance v4, Lfps;

    invoke-direct {v4, p0, v6}, Lfps;-><init>(Lfpx;I)V
    ...
    invoke-direct {v4, p0, v6}, Lfpq;-><init>(Lfpx;I)V
    ...
    invoke-direct {v4, p0, v6}, Lfpp;-><init>(Lfpx;I)V
    ...
    .restart local v4    # "packet":Lfpv;
    :cond_2
    invoke-virtual {v4, v3}, Lfpv;->a([B)V
