...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    .line 55
    iput-object v1, p0, Lfvz;->c:Lfvm$a;

    .line 58
    const/4 v0, 0x1

    iput-boolean v0, p0, Lfvz;->d:Z

    .line 64
    iput-object v1, p0, Lfvz;->e:Landroid/app/Dialog;

    .line 73
    iput-object p1, p0, Lfvz;->a:Landroid/content/Context;

    .line 74
    iput-object p2, p0, Lfvz;->b:Ljava/lang/String;

    .line 75
    iput-boolean p3, p0, Lfvz;->d:Z

    .line 78
    iget-object v0, p0, Lfvz;->a:Landroid/content/Context;

    invoke-static {v0}, Lfvm;->a(Landroid/content/Context;)Lfvm$a;

    move-result-object v0

    iput-object v0, p0, Lfvz;->c:Lfvm$a;

    .line 79
    iget-object v0, p0, Lfvz;->c:Lfvm$a;
    ...
    iget-object v1, p0, Lfvz;->c:Lfvm$a;

    invoke-virtual {v1}, Lfvm$a;->toString()Ljava/lang/String;

    move-result-object v1

    invoke-static {v0, v1}, Lfwj;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-static {p0, v0}, Lfwn;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-static {v3}, Lfwk;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lfwj;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static a(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    invoke-static {v3, v4}, Lfwj;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lfwk;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method private a(Z)Z
    ...
    .line 338
    iget-object v0, p0, Lfvz;->e:Landroid/app/Dialog;

    if-nez v0, :cond_2

    .line 339
    iget-object v4, p0, Lfvz;->a:Landroid/content/Context;
    ...
    invoke-static {v6}, Lfwn;->a(Landroid/content/Context;)Z
    ...
    invoke-direct {v3, v4}, Lfvy$1;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v2, v5}, Lfvy$2;-><init>(Lfvq;)V
    ...
    .line 339
    iput-object v0, p0, Lfvz;->e:Landroid/app/Dialog;
    ...
    iget v0, v0, Lfvm$a;->b:I

    invoke-static {v0}, Lfvm;->a(I)Z
    ...
    iget-object v1, v1, Lfvm$a;->a:Ljava/lang/String;

    invoke-static {v0, v1}, Lfvm;->b(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public final a(Landroid/content/Intent;Lfvr$a;)Z
    .locals 8
    .param p1, "intent"    # Landroid/content/Intent;
    .param p2, "handler"    # Lfvr$a;
    ...
    invoke-static {v5, v6}, Lfwj;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5, v6}, Lfwj;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 178
    :cond_2
    iget-object v5, p0, Lfvz;->a:Landroid/content/Context;

    invoke-static {v5, v1}, Lfvm;->b(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-direct {v3, v4}, Lfvv;-><init>(Landroid/os/Bundle;)V

    .line 184
    .local v3, "data":Lfvv;
    invoke-interface {p2, v3}, Lfvr$a;->onResponse(Lfvp;)V
...
.method public final a(Lfvo;)Z
    .locals 6
    .param p1, "request"    # Lfvo;
    ...
    invoke-direct {p0, v3}, Lfvz;->a(Z)Z
    :try_end_0
    ...
    iget-object v3, p0, Lfvz;->c:Lfvm$a;

    iget-object v3, v3, Lfvm$a;->a:Ljava/lang/String;

    invoke-direct {v0, v3}, Lfvx;-><init>(Ljava/lang/String;)V

    .line 279
    .local v0, "checkHandler":Lfvx;
    iget-object v3, p0, Lfvz;->a:Landroid/content/Context;

    invoke-virtual {p1, v3, v0}, Lfvo;->a(Landroid/content/Context;Lfvx;)Z
    ...
    invoke-virtual {p1, v1}, Lfvo;->a(Landroid/os/Bundle;)V

    .line 287
    iget-object v2, p0, Lfvz;->a:Landroid/content/Context;

    check-cast v2, Landroid/app/Activity;

    const-string/jumbo v3, "com.sina.weibo.sdk.action.ACTION_WEIBO_ACTIVITY"

    iget-object v4, p0, Lfvz;->c:Lfvm$a;

    iget-object v4, v4, Lfvm$a;->a:Ljava/lang/String;

    iget-object v5, p0, Lfvz;->b:Ljava/lang/String;

    invoke-static {v2, v3, v4, v5, v1}, Lfvz;->a(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    .line 275
    .end local v0    # "checkHandler":Lfvx;
...
.method public final a(Lfvp;)Z
    .locals 5
    .param p1, "response"    # Lfvp;
    ...
    .prologue
    .line 304
    iget-object v1, p0, Lfvz;->a:Landroid/content/Context;

    new-instance v2, Lfvx;

    invoke-direct {v2}, Lfvx;-><init>()V

    invoke-virtual {p1, v1, v2}, Lfvp;->a(Landroid/content/Context;Lfvx;)Z
    ...
    invoke-virtual {p1, v0}, Lfvp;->a(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, Lfvz;->b:Ljava/lang/String;

    iget-object v4, p1, Lfvp;->d:Ljava/lang/String;

    invoke-static {v1, v2, v3, v4, v0}, Lfvz;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public final c()Z
    ...
    invoke-direct {p0, v0}, Lfvz;->a(Z)Z
    ...
    iget-object v2, p0, Lfvz;->b:Ljava/lang/String;

    invoke-static {v0, v1, v2, v3, v3}, Lfvz;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
