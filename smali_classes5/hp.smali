...
.method public static a()V
    ...
    invoke-interface {v7}, Ljl;->d()Ljava/util/Map;

    move-result-object v1

    .line 61
    .local v1, "hr":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljk;>;"
    if-eqz v1, :cond_0
    ...
    .line 67
    .local v0, "e":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Ljk;>;"
    ...
    .line 68
    .local v6, "value":Ljk;
    invoke-interface {v6}, Ljk;->getHRStrategy()Ljava/lang/String;
    ...
    :cond_3
    invoke-interface {v6}, Ljk;->getLastHRTime()J

    move-result-wide v8

    sub-long v8, v4, v8

    invoke-interface {v6}, Ljk;->getHRInterval()J
    ...
    invoke-interface {v6}, Ljk;->getHrNum()I
    ...
    invoke-interface {v8, v7}, Ljl;->b(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 1195
    new-instance v14, Lhy;

    invoke-interface {v8}, Ljj;->getConnType()Lanet/channel/entity/ConnType;
    ...
    :goto_1
    invoke-static {v10, v7}, Ljr;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v14, v10, v15, v8}, Lhy;-><init>(Ljava/lang/String;Ljava/lang/String;Ljj;)V
    ...
    invoke-direct {v8, v13, v14}, Ljd;-><init>(Landroid/content/Context;Lhy;)V
    ...
    new-instance v13, Lhp$1;

    invoke-direct {v13, v14, v15}, Lhp$1;-><init>(J)V

    invoke-virtual {v8, v10, v13}, Lanet/channel/Session;->a(ILic;)V
    ...
    invoke-direct {v8, v13, v14}, Lja;-><init>(Landroid/content/Context;Lhy;)V
    ...
    invoke-direct {v8, v13, v14}, Lje;-><init>(Landroid/content/Context;Lhy;)V
...
.method static synthetic a(Lanet/channel/Session;)V
    ...
    invoke-virtual {v0, v1}, Lhr;->a(Ljava/lang/String;)Ljava/util/List;
...
.method static synthetic a(Lid;Lib;)V
    .locals 1
    .param p0, "x0"    # Lid;
    .param p1, "x1"    # Lib;
    ...
    .line 3179
    iget-object v0, p1, Lib;->e:Ljava/lang/String;

    iput-object v0, p0, Lid;->e:Ljava/lang/String;
