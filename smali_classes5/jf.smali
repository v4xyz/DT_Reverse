...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lhy;Lanet/channel/entity/ConnType;)V
    .locals 5
    ...
    .line 76
    invoke-direct {p0, p1, p2, p3}, Lanet/channel/Session;-><init>(Landroid/content/Context;Lhy;Lanet/channel/entity/ConnType;)V

    .line 62
    iput-boolean v4, p0, Ljf;->t:Z

    .line 65
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Ljf;->v:J
    ...
    iput-object v0, p0, Ljf;->r:Lorg/android/spdy/SpdyAgent;

    .line 1286
    iget-object v0, p0, Ljf;->r:Lorg/android/spdy/SpdyAgent;
...
.method static synthetic a(Ljf;Lanet/channel/entity/EventType;Lib;)V
    .locals 1
    .param p0, "x0"    # Ljf;
    ...
    invoke-virtual {p0, p1, v0}, Ljf;->a(Lanet/channel/entity/EventType;Lib;)V
...
.method static synthetic b(Ljf;)Ljava/lang/String;
    ...
    .prologue
    .line 58
    iget-object v0, p0, Ljf;->o:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic b(Ljf;Lanet/channel/entity/EventType;Lib;)V
    .locals 1
    .param p0, "x0"    # Ljf;
    .param p1, "x1"    # Lanet/channel/entity/EventType;
    .param p2, "x2"    # Lib;
...
.method static synthetic c(Ljf;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Ljf;
...
.method static synthetic d(Ljf;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Ljf;
...
.method static synthetic e(Ljf;)I
    .locals 1
    .param p0, "x0"    # Ljf;
...
.method static synthetic f(Ljf;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Ljf;
...
.method static synthetic g(Ljf;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Ljf;
...
# virtual methods
.method public a(Lanet/channel/request/Request;Lhq;)Liu;
    .locals 20
    ...
    iget-object v6, v0, Ljf;->g:Lanet/channel/entity/ConnType;
    ...
    iget-object v6, v0, Ljf;->e:Ljava/lang/String;
    ...
    invoke-static {v7}, Lkd;->a(I)Ljava/lang/String;
    ...
    invoke-interface {v0, v6, v7, v1}, Lhq;->a(ILjava/lang/String;Lanet/channel/statist/RequestStatistic;)V

    :cond_2
    move-object v15, v14

    .line 151
    .end local v14    # "ret":Liu;
    ...
    .restart local v14    # "ret":Liu;
    :cond_3
    new-instance v16, Lanet/channel/statist/RequestStatistic;

    move-object/from16 v0, p0

    iget-object v6, v0, Ljf;->d:Ljava/lang/String;
    ...
    iget-object v6, v0, Ljf;->s:Lorg/android/spdy/SpdySession;

    if-eqz v6, :cond_7

    invoke-virtual/range {p0 .. p0}, Ljf;->d()Z
    ...
    invoke-direct {v7, v0, v1, v2}, Ljf$a;-><init>(Ljf;Lanet/channel/request/Request;Lhq;)V
    ...
    invoke-direct {v15, v6, v0, v7}, Liw;-><init>(Lorg/android/spdy/SpdySession;ILjava/lang/String;)V
    :try_end_0
    ...
    iget-object v6, v0, Ljf;->k:Lanet/channel/statist/SessionStatistic;
    ...
    invoke-interface {v0, v6, v7, v8}, Lhq;->a(ILjava/lang/String;Lanet/channel/statist/RequestStatistic;)V
    :try_end_2
    ...
    iget-object v8, v0, Ljf;->o:Ljava/lang/String;
    ...
    invoke-direct {v11, v6, v7, v8, v9}, Lia;-><init>(Lanet/channel/entity/EventType;ZILjava/lang/String;)V
    ...
    invoke-virtual {v0, v6, v11}, Ljf;->a(Lanet/channel/Session$Status;Lib;)V

    .line 145
    .end local v11    # "event":Lia;
    :cond_9
    const/16 v6, -0x12c
    ...
    invoke-static {v7, v8}, Lkd;->a(ILjava/lang/String;)Ljava/lang/String;
...
.method protected final a()V
    ...
    .line 168
    iget-object v1, p0, Ljf;->i:Lanet/channel/Session$Status;
    ...
    :cond_1
    :try_start_0
    iget-object v1, p0, Ljf;->r:Lorg/android/spdy/SpdyAgent;
    ...
    iget-object v3, p0, Ljf;->o:Ljava/lang/String;
    ...
    iget-object v7, p0, Ljf;->c:Ljava/lang/String;
    ...
    iget-object v8, p0, Ljf;->e:Ljava/lang/String;
    ...
    iget-object v7, p0, Ljf;->g:Lanet/channel/entity/ConnType;
    ...
    .line 179
    iget-object v1, p0, Ljf;->g:Lanet/channel/entity/ConnType;
    ...
    iput-object v1, p0, Ljf;->s:Lorg/android/spdy/SpdySession;

    .line 182
    iget-object v1, p0, Ljf;->s:Lorg/android/spdy/SpdySession;
    ...
    invoke-direct {v2, v3}, Lhz;-><init>(Lanet/channel/entity/EventType;)V

    invoke-virtual {p0, v1, v2}, Ljf;->a(Lanet/channel/Session$Status;Lib;)V

    .line 185
    invoke-virtual {p0}, Ljf;->m()V
    :try_end_0
    ...
    invoke-virtual {p0, v1, v12}, Ljf;->a(Lanet/channel/Session$Status;Lib;)V
    ...
    iput-wide v2, p0, Ljf;->u:J

    .line 194
    iget-object v2, p0, Ljf;->k:Lanet/channel/statist/SessionStatistic;
    ...
    .line 195
    iget-object v1, p0, Ljf;->k:Lanet/channel/statist/SessionStatistic;
...
.method public b()V
    ...
    iget-object v2, p0, Ljf;->o:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v1}, Ljf;->a(Lanet/channel/Session$Status;Lib;)V

    .line 214
    :try_start_0
    iget-object v0, p0, Ljf;->s:Lorg/android/spdy/SpdySession;
...
.method public final c(Z)V
    ...
    invoke-virtual {p0, v1, v2}, Ljf;->a(Lanet/channel/entity/EventType;Lib;)V
...
.method public final d()Z
    ...
    .prologue
    .line 275
    iget-object v0, p0, Ljf;->i:Lanet/channel/Session$Status;
...
.method public spdyPingRecvCallback(Lorg/android/spdy/SpdySession;JLjava/lang/Object;)V
    ...
    invoke-virtual {p0, v0, v1}, Ljf;->a(Lanet/channel/entity/EventType;Lib;)V
...
.method public spdySessionCloseCallback(Lorg/android/spdy/SpdySession;Ljava/lang/Object;Lorg/android/spdy/SuperviseConnectInfo;I)V
    ...
    iget-object v5, p0, Ljf;->o:Ljava/lang/String;
    ...
    :cond_0
    :goto_0
    iget-object v3, p0, Ljf;->k:Lanet/channel/statist/SessionStatistic;
    ...
    invoke-direct {v2, v3, v9, p4, v1}, Lia;-><init>(Lanet/channel/entity/EventType;ZILjava/lang/String;)V

    .line 380
    .local v2, "event":Lia;
    sget-object v3, Lanet/channel/Session$Status;->DISCONNECTED:Lanet/channel/Session$Status;

    invoke-virtual {p0, v3, v2}, Ljf;->a(Lanet/channel/Session$Status;Lib;)V
    ...
    iget-object v4, p0, Ljf;->k:Lanet/channel/statist/SessionStatistic;
    ...
    invoke-virtual {v4}, Lanet/channel/statist/SessionStatistic;->getAlarmObject()Ljg;

    move-result-object v4

    invoke-interface {v3, v4}, Lhv;->a(Ljg;)V
...
.method public spdySessionConnectCB(Lorg/android/spdy/SpdySession;Lorg/android/spdy/SuperviseConnectInfo;)V
    ...
    invoke-direct {v0, v1}, Lhz;-><init>(Lanet/channel/entity/EventType;)V
    ...
    invoke-virtual {p0, v1, v0}, Ljf;->a(Lanet/channel/Session$Status;Lib;)V
...
.method public spdySessionFailedError(Lorg/android/spdy/SpdySession;ILjava/lang/Object;)V
    ...
    invoke-direct {v2, v3, p2, v4}, Lib;-><init>(Lanet/channel/entity/EventType;ILjava/lang/String;)V
    ...
    invoke-virtual {v2}, Lanet/channel/statist/SessionStatistic;->getAlarmObject()Ljg;

    move-result-object v2

    invoke-interface {v1, v2}, Lhv;->a(Ljg;)V
