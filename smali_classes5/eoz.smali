...
.method private b(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 170
    invoke-virtual {p0, p1, p2}, Leoz;->a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;

    move-result-object v0

    .line 171
    invoke-virtual {p0, v0}, Leoz;->a(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .line 173
    :cond_3
    sget-object v2, Leoz;->a:Ljava/lang/String;
    ...
    invoke-static {v2, v3, v4}, Lepq;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private b([BILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 58
    invoke-virtual {p0, p1, p2, p3}, Leoz;->a([BILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method private static b(Ljava/io/InputStream;Lemr$a;)Lcom/alibaba/doraemon/image/memory/PooledByteBuffer;
    .locals 9
    .param p0, "inputStream"    # Ljava/io/InputStream;
    .param p1, "options"    # Lemr$a;
    ...
    :try_start_0
    invoke-static {p1}, Lepl;->b(Lemr$a;)F
    ...
    :try_start_1
    sget-object v4, Leoz;->a:Ljava/lang/String;
    ...
    iget-object v8, p1, Lemr$a;->a:Ljava/lang/String;

    invoke-static {v8}, Lepq;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    aput-object v8, v6, v7

    invoke-static {v4, v5, v6}, Lepq;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public a(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2, v3}, Lepq;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public a(Ljava/io/InputStream;Lemr$a;)Landroid/graphics/Bitmap;
    .locals 13
    .param p1, "is"    # Ljava/io/InputStream;
    .param p2, "opt"    # Lemr$a;
    ...
    .local v1, "bytes":[B
    :try_start_0
    invoke-static {p1, p2}, Leoz;->b(Ljava/io/InputStream;Lemr$a;)Lcom/alibaba/doraemon/image/memory/PooledByteBuffer;
    ...
    iget-object v8, p2, Lemr$a;->inPreferredConfig:Landroid/graphics/Bitmap$Config;

    invoke-static {v7, v8}, Leoz;->a(ILandroid/graphics/Bitmap$Config;)Landroid/graphics/BitmapFactory$Options;
    ...
    invoke-direct {p0, v1, v7, v4}, Leoz;->b([BILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 131
    invoke-virtual {p0, v1, v6, p2}, Leoz;->a([BILemr$a;)Landroid/graphics/Bitmap;
    ...
    iget-object v7, p2, Lemr$a;->e:Lcom/alibaba/laiwang/photokit/imageformat/ImageFormat;
    ...
    .line 135
    invoke-static {v1}, Lfnf;->b([B)Landroid/graphics/Bitmap;
    :try_end_1
    ...
    .line 150
    invoke-static {p2}, Lepl;->a(Lemr$a;)I

    move-result v3

    .line 151
    .local v3, "inSampleSize":I
    iget-object v7, p2, Lemr$a;->inPreferredConfig:Landroid/graphics/Bitmap$Config;

    invoke-static {v3, v7}, Leoz;->a(ILandroid/graphics/Bitmap$Config;)Landroid/graphics/BitmapFactory$Options;

    move-result-object v4

    .line 154
    .restart local v4    # "options":Landroid/graphics/BitmapFactory$Options;
    invoke-direct {p0, p1, v4}, Leoz;->b(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    iget-object v10, p2, Lemr$a;->e:Lcom/alibaba/laiwang/photokit/imageformat/ImageFormat;
    ...
    .line 1165
    :cond_7
    iget v10, p2, Lemr$a;->d:I

    if-ne v10, v8, :cond_8

    .line 1166
    invoke-static {p2}, Lepl;->b(Lemr$a;)F
    ...
    .line 113
    :try_start_2
    sget-object v7, Leoz;->a:Ljava/lang/String;
    ...
    iget-object v12, p2, Lemr$a;->a:Ljava/lang/String;

    invoke-static {v12}, Lepq;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v12

    aput-object v12, v10, v11

    invoke-static {v7, v8, v10}, Lepq;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v11, p2, Lemr$a;->a:Ljava/lang/String;

    invoke-static {v11}, Lepq;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v11

    aput-object v11, v9, v10

    invoke-static {v7, v8, v9}, Lepq;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public a([BILemr$a;)Landroid/graphics/Bitmap;
    .locals 4
    .param p1, "bytes"    # [B
    .param p2, "len"    # I
    .param p3, "opt"    # Lemr$a;
    ...
    .prologue
    .line 37
    invoke-static {p3}, Lepl;->a(Lemr$a;)I

    move-result v0

    .line 38
    .local v0, "inSampleSize":I
    iget-object v3, p3, Lemr$a;->inPreferredConfig:Landroid/graphics/Bitmap$Config;

    invoke-static {v0, v3}, Leoz;->a(ILandroid/graphics/Bitmap$Config;)Landroid/graphics/BitmapFactory$Options;

    move-result-object v1

    .line 41
    .local v1, "options":Landroid/graphics/BitmapFactory$Options;
    invoke-direct {p0, p1, p2, v1}, Leoz;->b([BILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    iget-object v3, p3, Lemr$a;->e:Lcom/alibaba/laiwang/photokit/imageformat/ImageFormat;
    ...
    .line 45
    invoke-static {p1}, Lfnf;->b([B)Landroid/graphics/Bitmap;
