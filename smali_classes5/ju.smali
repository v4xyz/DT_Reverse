...
.method public static a(Ljava/util/Map;Ljj;ILjava/lang/StringBuilder;)I
    .locals 20
    .param p1, "connStrategy"    # Ljj;
    .param p2, "retry"    # I
    ...
    invoke-static {v7, v9}, Lkl;->a(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 171
    invoke-interface/range {p1 .. p1}, Ljj;->getIp()Ljava/lang/String;

    move-result-object v3

    invoke-interface/range {p1 .. p1}, Ljj;->getPort()I
    ...
    invoke-static {v4, v3}, Ljc;->a(Lanet/channel/request/Request;Lhq;)Ljc$a;

    move-result-object v17

    .line 176
    .local v17, "response":Ljc$a;
    ...
    invoke-direct/range {v16 .. v16}, Lif;-><init>()V
    ...
    iput-object v3, v0, Lif;->a:Ljava/lang/String;
    ...
    iput-object v3, v0, Lif;->b:Ljava/lang/String;
    ...
    iput-object v3, v0, Lif;->c:Ljava/lang/String;
    ...
    invoke-interface {v3, v0}, Lig;->a(Lif;)V

    .line 193
    move-object/from16 v0, v17

    iget v3, v0, Ljc$a;->a:I
    ...
    invoke-static/range {v2 .. v7}, Lju;->a(Ljava/lang/String;Ljava/lang/String;Lanet/channel/request/Request;IILjava/lang/StringBuilder;)V
    ...
    .line 259
    .end local v16    # "flow":Lif;
    .end local v17    # "response":Ljc$a;
    :goto_1
    return v6

    .line 180
    .restart local v17    # "response":Ljc$a;
    :cond_3
    ...
    invoke-static/range {v7 .. v12}, Lju;->a(Ljava/lang/String;Ljava/lang/String;Lanet/channel/request/Request;IILjava/lang/StringBuilder;)V
    ...
    .restart local v16    # "flow":Lif;
    .restart local v17    # "response":Ljc$a;
    :cond_5
    :try_start_1
    move-object/from16 v0, v17

    iget v0, v0, Ljc$a;->a:I
    ...
    iget-object v11, v0, Ljc$a;->c:Ljava/util/Map;
    ...
    iget-object v3, v0, Ljc$a;->c:Ljava/util/Map;

    const-string/jumbo v5, "x-am-code"

    invoke-static {v3, v5}, Lkf;->a(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v3, v0, Ljc$a;->b:[B

    invoke-static {v3}, Lju;->a([B)Ljava/lang/String;
    ...
    .line 236
    :cond_f
    invoke-static {v13}, Ljx;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 243
    :cond_10
    invoke-static {v13}, Lju;->a(Ljava/lang/String;)Z
...
.method private static a([B)Ljava/lang/String;
    ...
    :try_start_1
    sget-object v4, Lhx$a;->a:Lhx;

    .line 267
    const/16 v5, 0x400

    invoke-virtual {v4, v5}, Lhx;->a(I)Lhw;
    ...
    :goto_0
    invoke-virtual {v1, v3}, Lhw;->a(Ljava/io/InputStream;)I
    ...
    .line 269
    invoke-virtual {v1, v0}, Lhw;->a(Ljava/io/OutputStream;)V
    :try_end_1
...
.method static a()Ljava/util/List;
    ...
    .line 85
    .local v1, "connStrategyList":Ljava/util/List;, "Ljava/util/List<Ljj;>;"
    ...
    .line 89
    .local v4, "iterator":Ljava/util/ListIterator;, "Ljava/util/ListIterator<Ljj;>;"
    :cond_0
    :goto_0
    ...
    .line 104
    .end local v3    # "i":I
    .end local v4    # "iterator":Ljava/util/ListIterator;, "Ljava/util/ListIterator<Ljj;>;"
...
.method private static a(Ljava/lang/String;)Z
    ...
    invoke-direct {v4, v5, v6}, Ljv;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v3, v4}, Ljy;->a(Ljv;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v4, v2, v7}, Ljv;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v5, v6, v1}, Ljv;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v4, v5}, Ljy;->a(Ljv;)V
    :try_end_1
