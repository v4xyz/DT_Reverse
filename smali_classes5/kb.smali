...
.field private static volatile c:Lka;
...
.method public static a(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;
    ...
    .prologue
    .line 35
    invoke-static {}, Lkb;->b()Ljava/util/concurrent/ScheduledExecutorService;
...
.method public static a(Ljava/lang/Runnable;I)Ljava/util/concurrent/Future;
    ...
    invoke-direct {v0, p0, p1}, Ljz;-><init>(Ljava/lang/Runnable;I)V

    .line 47
    .local v0, "dispatcherTask":Ljz;
    invoke-static {}, Lkb;->c()Ljava/util/concurrent/ThreadPoolExecutor;
...
.method static a()Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    .prologue
    .line 75
    sget-object v0, Lkb;->b:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    new-instance v8, Lkb$a;

    const-string/jumbo v0, "AWCN Worker"

    invoke-direct {v8, v0}, Lkb$a;-><init>(Ljava/lang/String;)V

    invoke-direct/range {v1 .. v8}, Ljava/util/concurrent/ThreadPoolExecutor;-><init>(IIJLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/BlockingQueue;Ljava/util/concurrent/ThreadFactory;)V

    sput-object v1, Lkb;->b:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method private static b()Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .prologue
    .line 52
    sget-object v0, Lkb;->a:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v3, v4}, Lkb$a;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v2, v3}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sput-object v0, Lkb;->a:Ljava/util/concurrent/ScheduledExecutorService;
...
.method private static c()Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    invoke-direct/range {v1 .. v8}, Lka;-><init>(IIJLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/BlockingQueue;Ljava/util/concurrent/ThreadFactory;)V

    sput-object v1, Lkb;->c:Lka;
