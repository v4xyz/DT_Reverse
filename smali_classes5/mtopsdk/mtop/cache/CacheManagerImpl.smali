...
.method public constructor <init>(Lms;)V
    ...
    iput-object v0, p0, Lmtopsdk/mtop/cache/CacheManagerImpl;->cache:Lms;

    .line 58
    if-eqz p1, :cond_0

    .line 59
    iput-object p1, p0, Lmtopsdk/mtop/cache/CacheManagerImpl;->cache:Lms;
    ...
    invoke-virtual {v0}, Lmtopsdk/mtop/global/SDKConfig;->getGlobalCacheImpl()Lms;
...
.method private handleCacheValidation(Lanetwork/network/cache/RpcCache;)Lanetwork/network/cache/RpcCache;
    ...
    invoke-static {}, Lgqm;->c()Ljava/lang/String;
...
.method public getCache(Ljava/lang/String;Ljava/lang/String;)Lanetwork/network/cache/RpcCache;
    ...
    .prologue
    .line 134
    iget-object v1, p0, Lmtopsdk/mtop/cache/CacheManagerImpl;->cache:Lms;
    ...
    invoke-interface {v1}, Lms;->a()Lanetwork/network/cache/RpcCache;
...
.method public getCacheKey(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {}, Lgqm;->b()Ljava/lang/String;
...
.method public getCacheKey(Lmtopsdk/mtop/domain/MtopRequest;Lmtopsdk/mtop/common/MtopNetworkProp;Ljava/net/URL;Ljava/util/List;)Ljava/lang/String;
    ...
    .prologue
    .line 266
    .local p4, "originalParams":Ljava/util/List;, "Ljava/util/List<Lkt;>;"
    if-eqz p1, :cond_0
    ...
    .line 302
    .local v5, "clonedParams":Ljava/util/List;, "Ljava/util/List<Lkt;>;"
    ...
    invoke-interface {v10}, Lkt;->getKey()Ljava/lang/String;
    ...
    invoke-direct {v15, v0, v7}, Lmc;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public getCacheKey(Lmtopsdk/mtop/intf/MtopBuilder;)Ljava/lang/String;
    ...
    invoke-interface {v4, v2, v1}, Lmtopsdk/mtop/transform/MtopTransform;->convertNetworkRequest(Lmtopsdk/mtop/MtopProxy;Ljava/util/Map;)Lku;

    move-result-object v3

    .line 255
    .local v3, "request":Lku;
    if-eqz v3, :cond_0
    ...
    invoke-interface {v3}, Lku;->b()Ljava/net/URL;

    move-result-object v6

    invoke-interface {v3}, Lku;->g()Ljava/util/List;
...
.method public isNeedReadCache(Lku;Lmtopsdk/mtop/common/MtopListener;)Z
    .locals 9
    ...
    .line 85
    .local v3, "headers":[Lkn;
    :try_start_0
    const-string/jumbo v7, "cache-control"

    invoke-interface {p1, v7}, Lku;->a(Ljava/lang/String;)[Lkn;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {v2}, Lkn;->b()Ljava/lang/String;
    ...
    .line 86
    .end local v0    # "arr$":[Lkn;
    .end local v2    # "header":Lkn;
    .end local v4    # "i$":I
    .end local v5    # "len$":I
    :catch_0
    move-exception v1
...
.method public putCache(Ljava/lang/String;Ljava/lang/String;Lmtopsdk/mtop/domain/MtopResponse;)Z
    ...
    iget-object v15, v0, Lmtopsdk/mtop/cache/CacheManagerImpl;->cache:Lms;
