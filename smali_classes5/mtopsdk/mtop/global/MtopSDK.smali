...
.method static synthetic access$000(Landroid/content/Context;Lgqi;Ljava/lang/String;)V
    .locals 0
    ...
    .prologue
    .line 31
    invoke-static {p0, p1, p2}, Lmtopsdk/mtop/global/MtopSDK;->executeInitCoreTask(Landroid/content/Context;Lgqi;Ljava/lang/String;)V
...
.method private static executeInitCoreTask(Landroid/content/Context;Lgqi;Ljava/lang/String;)V
    .locals 7
    ...
    .line 124
    invoke-static {p0}, Lgqm;->a(Landroid/content/Context;)V
    ...
    invoke-direct {v1}, Lgqj;-><init>()V

    .end local p1    # "sign":Lgqi;
    .local v1, "sign":Lgqi;
    move-object p1, v1

    .line 132
    .end local v1    # "sign":Lgqi;
    .restart local p1    # "sign":Lgqi;
    :cond_3
    sget-object v2, Lmtopsdk/mtop/global/MtopSDK;->sdkConfig:Lmtopsdk/mtop/global/SDKConfig;
    ...
    invoke-interface {p1, p0, v2}, Lgqi;->a(Landroid/content/Context;I)V

    .line 133
    sget-object v2, Lmtopsdk/mtop/global/MtopSDK;->sdkConfig:Lmtopsdk/mtop/global/SDKConfig;

    invoke-virtual {v2, p1}, Lmtopsdk/mtop/global/SDKConfig;->setGlobalSign(Lgqi;)Lmtopsdk/mtop/global/SDKConfig;

    .line 134
    sget-object v2, Lmtopsdk/mtop/global/MtopSDK;->sdkConfig:Lmtopsdk/mtop/global/SDKConfig;

    new-instance v4, Lgqi$a;
    ...
    invoke-direct {v4, v5, v6}, Lgqi$a;-><init>(ILjava/lang/String;)V

    invoke-interface {p1, v4}, Lgqi;->a(Lgqi$a;)Ljava/lang/String;
...
.method public static declared-synchronized init(Landroid/content/Context;)V
    ...
    :try_start_0
    invoke-static {p0, v1, v2}, Lmtopsdk/mtop/global/MtopSDK;->init(Landroid/content/Context;Lgqi;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized init(Landroid/content/Context;Lgqi;Ljava/lang/String;)V
    .locals 6
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "sign"    # Lgqi;
    .param p2, "ttid"    # Ljava/lang/String;
    ...
    invoke-direct {v0, p0, p1, p2}, Lmtopsdk/mtop/global/MtopSDK$1;-><init>(Landroid/content/Context;Lgqi;Ljava/lang/String;)V
...
.method public static declared-synchronized init(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, v0, p1}, Lmtopsdk/mtop/global/MtopSDK;->init(Landroid/content/Context;Lgqi;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static reInitISign(Lmtopsdk/mtop/domain/EnvModeEnum;)V
    ...
    invoke-virtual {v1}, Lmtopsdk/mtop/global/SDKConfig;->getGlobalSign()Lgqi;
    ...
    invoke-interface {v1, v2, v0}, Lgqi;->a(Landroid/content/Context;I)V
    ...
    invoke-virtual {v2}, Lmtopsdk/mtop/global/SDKConfig;->getGlobalSign()Lgqi;

    move-result-object v2

    new-instance v3, Lgqi$a;

    const/4 v4, 0x0

    invoke-direct {v3, v0, v4}, Lgqi$a;-><init>(ILjava/lang/String;)V

    invoke-interface {v2, v3}, Lgqi;->a(Lgqi$a;)Ljava/lang/String;
