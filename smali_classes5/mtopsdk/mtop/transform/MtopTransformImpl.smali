...
.method public constructor <init>()V
    ...
    invoke-direct {v0, v1}, Lmtopsdk/mtop/cache/CacheManagerImpl;-><init>(Lms;)V
...
.method private getNetworkInstance(Lmtopsdk/mtop/MtopProxy;Lku;)Lkp;
    .locals 8
    .param p1, "mtopProxy"    # Lmtopsdk/mtop/MtopProxy;
    .param p2, "request"    # Lku;
    ...
    invoke-direct {v2, v1}, Lmd;-><init>(Landroid/content/Context;)V

    .line 246
    .local v2, "network":Lkp;
    ...
    invoke-interface {p2, v5}, Lku;->b(Z)V

    move-object v3, v2

    .line 258
    .end local v2    # "network":Lkp;
    ...
    invoke-direct {v2, v1}, Llv;-><init>(Landroid/content/Context;)V

    .line 255
    .restart local v2    # "network":Lkp;
    sget-object v5, Lmtopsdk/common/util/TBSdkLog$LogEnable;->InfoEnable:Lmtopsdk/common/util/TBSdkLog$LogEnable;
...
.method private initResponseSource(Lmtopsdk/mtop/MtopProxy;Lku;ZLjava/lang/String;)Lmtopsdk/mtop/domain/ResponseSource;
    .locals 7
    .param p1, "mtopProxy"    # Lmtopsdk/mtop/MtopProxy;
    .param p2, "request"    # Lku;
    .param p3, "isAsync"    # Z
    ...
    invoke-direct {v3, p1, p2, v4}, Lmtopsdk/mtop/domain/ResponseSource;-><init>(Lmtopsdk/mtop/MtopProxy;Lku;Lmtopsdk/mtop/cache/CacheManager;)V
    ...
    invoke-interface {v4, p2, v5}, Lmtopsdk/mtop/cache/CacheManager;->isNeedReadCache(Lku;Lmtopsdk/mtop/common/MtopListener;)Z
...
.method public asyncTransform(Lmtopsdk/mtop/MtopProxy;Ljava/util/Map;Landroid/os/Handler;)Lmtopsdk/mtop/common/ApiID;
    ...
    invoke-virtual/range {p0 .. p2}, Lmtopsdk/mtop/transform/MtopTransformImpl;->convertNetworkRequest(Lmtopsdk/mtop/MtopProxy;Ljava/util/Map;)Lku;

    move-result-object v10

    .line 120
    .local v10, "request":Lku;
    const/4 v12, 0x0
    ...
    invoke-direct {v0, v1, v10, v14, v13}, Lmtopsdk/mtop/transform/MtopTransformImpl;->initResponseSource(Lmtopsdk/mtop/MtopProxy;Lku;ZLjava/lang/String;)Lmtopsdk/mtop/domain/ResponseSource;
    ...
    .line 156
    .local v6, "future":Ljava/util/concurrent/Future;, "Ljava/util/concurrent/Future<Lkv;>;"
    :try_start_0
    move-object/from16 v0, p1
    ...
    invoke-direct {v0, v1, v10}, Lmtopsdk/mtop/transform/MtopTransformImpl;->getNetworkInstance(Lmtopsdk/mtop/MtopProxy;Lku;)Lkp;
    ...
    invoke-interface {v14, v10, v15, v0, v7}, Lkp;->a(Lku;Ljava/lang/Object;Landroid/os/Handler;Lks;)Ljava/util/concurrent/Future;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public convertNetworkRequest(Lmtopsdk/mtop/MtopProxy;Ljava/util/Map;)Lku;
    .locals 2
    .param p1, "proxy"    # Lmtopsdk/mtop/MtopProxy;
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    invoke-interface {v0, p1, p2}, Lmtopsdk/mtop/transform/converter/INetworkConverter;->convert(Lmtopsdk/mtop/MtopProxy;Ljava/util/Map;)Lku;

    move-result-object v1

    .line 172
    .local v1, "request":Lku;
    goto :goto_0
.end method
...
.method public syncTransform(Lmtopsdk/mtop/MtopProxy;Ljava/util/Map;)Lmtopsdk/mtop/domain/MtopResponse;
    ...
    invoke-interface {v14, v10}, Lkp;->a(Lku;)Lkv;
    ...
    invoke-interface {v11}, Lkv;->getStatisticData()Lanetwork/channel/statist/StatisticData;
    ...
    invoke-static {v11, v14, v0}, Lmtopsdk/mtop/common/MtopNetworkResultParser;->parseNetworkRlt(Lkv;Lmtopsdk/mtop/domain/MtopResponse;Lmtopsdk/mtop/MtopProxy;)Lmtopsdk/mtop/domain/MtopResponse;
