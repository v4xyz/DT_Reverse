...
.method protected applyRequestBasicProperty(Lku;Lmtopsdk/mtop/common/MtopNetworkProp;)V
    .locals 1
    ...
    invoke-interface {p1, v0}, Lku;->b(I)V

    .line 52
    iget v0, p2, Lmtopsdk/mtop/common/MtopNetworkProp;->socketTimeout:I

    invoke-interface {p1, v0}, Lku;->c(I)V
    ...
    invoke-interface {p1, v0}, Lku;->a(I)V
    ...
    invoke-interface {p1, v0}, Lku;->a(Z)V

    .line 58
    iget v0, p2, Lmtopsdk/mtop/common/MtopNetworkProp;->bizId:I

    invoke-interface {p1, v0}, Lku;->d(I)V

    .line 59
    return-void
.end method

.method public abstract convert(Lmtopsdk/mtop/MtopProxy;Ljava/util/Map;)Lku;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lmtopsdk/mtop/MtopProxy;",
...
.method protected createRequestHeaders(Ljava/util/Map;)Ljava/util/List;
    ...
    .line 73
    .local v2, "headers":Ljava/util/List;, "Ljava/util/List<Lkn;>;"
    ...
    invoke-direct {v1, v4, v5}, Llx;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method protected createRequestParams(Ljava/util/Map;)Ljava/util/List;
    ...
    .line 94
    .local v3, "params":Ljava/util/List;, "Ljava/util/List<Lkt;>;"
    invoke-interface {p1}, Ljava/util/Map;->entrySet()Ljava/util/Set;
