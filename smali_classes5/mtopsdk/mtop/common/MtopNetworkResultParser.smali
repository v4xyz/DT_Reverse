...
.method public static parseNetworkRlt(Lkv;Lmtopsdk/mtop/domain/MtopResponse;Lmtopsdk/mtop/MtopProxy;)Lmtopsdk/mtop/domain/MtopResponse;
    .locals 6
    .param p0, "result"    # Lkv;
    ...
    invoke-interface {p0}, Lkv;->getStatusCode()I

    move-result v3

    invoke-interface {p0}, Lkv;->getConnHeadFields()Ljava/util/Map;

    move-result-object v4

    invoke-interface {p0}, Lkv;->getBytedata()[B
