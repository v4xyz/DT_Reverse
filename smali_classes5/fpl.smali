...
.method public constructor <init>(Ljava/lang/String;[BLjava/lang/String;Lcom/laiwang/lws/protocol/LwsSession;)V
    ...
    .line 25
    iput-object p2, p0, Lfpl;->k:[B

    .line 26
    iput-object p3, p0, Lfpl;->l:Ljava/lang/String;
...
.method public final a()Lfps;
    ...
    .prologue
    .line 33
    iget-object v2, p0, Lfpl;->a:Ljava/lang/String;

    invoke-static {v2}, Lfpy;->a(Ljava/lang/String;)Z
    ...
    iput-object v2, p0, Lfpl;->c:Lfpx;

    .line 36
    :try_start_0
    iget-object v2, p0, Lfpl;->c:Lfpx;

    iget-object v3, p0, Lfpl;->k:[B
    ...
    iput-object v4, v2, Lfpx;->d:Ljava/security/Signature;

    .line 2070
    iget-object v4, v2, Lfpx;->d:Ljava/security/Signature;
    ...
    iput-object v4, v2, Lfpx;->a:Ljavax/crypto/Cipher;

    .line 2073
    iget-object v2, v2, Lfpx;->a:Ljavax/crypto/Cipher;
    ...
    invoke-direct {v1, v2, v3}, Lfps;-><init>(Lfpx;I)V

    .line 43
    .local v1, "request":Lfps;
    iget-object v2, p0, Lfpl;->b:Lcom/laiwang/lws/protocol/LwsSession;
    ...
    .line 3037
    iget-object v3, v1, Lfps;->f:Lcom/laiwang/lws/protocol/Attributes;
    ...
    .line 46
    iget-object v2, p0, Lfpl;->l:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lfps;->a(Ljava/lang/String;)V

    .line 48
    :try_start_1
    iget-object v2, p0, Lfpl;->c:Lfpx;

    iget-object v3, p0, Lfpl;->b:Lcom/laiwang/lws/protocol/LwsSession;

    invoke-virtual {v3}, Lcom/laiwang/lws/protocol/LwsSession;->getAesKey()[B

    move-result-object v3

    invoke-virtual {v2, v3}, Lfpx;->c([B)V
    :try_end_1
    ...
    invoke-virtual {v1, v2, v3}, Lfps;->a(II)V
    ...
    iput-object v3, v2, Lfpx;->e:[B

    .line 3098
    iget-object v3, v2, Lfpx;->e:[B
    ...
    .line 3102
    iget-object v2, v2, Lfpx;->e:[B

    .line 59
    invoke-virtual {v1, v2}, Lfps;->c([B)V
...
.method public final a(Ljava/nio/ByteBuffer;Ljava/util/List;Lfpu;)V
    .locals 14
    .param p1, "buffer"    # Ljava/nio/ByteBuffer;
    .param p3, "listener"    # Lfpu;
    ...
    iget-object v8, p0, Lfpl;->j:Ljava/nio/ByteBuffer;
    ...
    .line 130
    .local v7, "packets":Ljava/util/List;, "Ljava/util/List<Lfpv;>;"
    iget-object v8, p0, Lfpl;->c:Lfpx;

    iget-object v9, p0, Lfpl;->j:Ljava/nio/ByteBuffer;

    invoke-static {v8, v9, v7}, Lfpm;->a(Lfpx;Ljava/nio/ByteBuffer;Ljava/util/List;)V
    ...
    .line 133
    .local v6, "packet":Lfpv;
    instance-of v8, v6, Lfpq;
    ...
    .line 140
    :try_start_0
    invoke-virtual {p0, v2}, Lfpl;->a(Lfpq;)[B
    :try_end_0
    ...
    invoke-interface {v0, v8}, Lfpu;->onFailed(Ljava/lang/String;)V

    .line 166
    .end local v2    # "data":Lfpq;
    .end local v6    # "packet":Lfpv;
    :goto_1
    return-void

    .line 148
    .restart local v6    # "packet":Lfpv;
    :cond_1
    instance-of v8, v6, Lfpp;
    ...
    .line 150
    .local v1, "controlRequest":Lfpp;
    invoke-virtual {v1}, Lfpp;->a()[B
    ...
    invoke-interface {v0, v3}, Lfpu;->onControl([B)V

    goto :goto_0

    .line 7027
    :cond_2
    iget-object v8, v1, Lfpp;->f:Lcom/laiwang/lws/protocol/Attributes;
    ...
    .line 154
    invoke-interface/range {p3 .. p3}, Lfpu;->onPing()V
    ...
    .line 156
    invoke-interface/range {p3 .. p3}, Lfpu;->onPong()V
    ...
    .line 158
    .end local v1    # "controlRequest":Lfpp;
    .end local v3    # "extraData":[B
    :cond_6
    instance-of v8, v6, Lfpt;
    ...
    .line 8025
    .end local v6    # "packet":Lfpv;
    iget-object v8, v6, Lfpt;->f:Lcom/laiwang/lws/protocol/Attributes;
    ...
    iput-object v8, p0, Lfpl;->b:Lcom/laiwang/lws/protocol/LwsSession;
    ...
    .line 7089
    invoke-interface/range {p3 .. p3}, Lfpu;->refreshSession()V
    ...
    .line 7097
    :cond_8
    iget-object v8, p0, Lfpl;->b:Lcom/laiwang/lws/protocol/LwsSession;
    ...
    iget-object v10, p0, Lfpl;->c:Lfpx;

    .line 8102
    iget-object v10, v10, Lfpx;->e:[B

    .line 7100
    invoke-virtual {v6}, Lfpt;->e()[B

    move-result-object v11

    .line 9033
    iget-object v12, v8, Lfpx;->d:Ljava/security/Signature;

    invoke-virtual {v12, v10}, Ljava/security/Signature;->update([B)V

    .line 9034
    iget-object v8, v8, Lfpx;->d:Ljava/security/Signature;
    ...
    .line 7112
    iget-object v11, v6, Lfpt;->f:Lcom/laiwang/lws/protocol/Attributes;
    ...
    iget-object v12, p0, Lfpl;->c:Lfpx;

    .line 10102
    iget-object v12, v12, Lfpx;->e:[B

    .line 7116
    iget v13, p0, Lfpl;->d:I

    invoke-direct {v11, v10, v12, v8, v13}, Lcom/laiwang/lws/protocol/LwsSession;-><init>([B[BII)V

    iput-object v11, p0, Lfpl;->b:Lcom/laiwang/lws/protocol/LwsSession;
    ...
    .line 7120
    invoke-interface/range {p3 .. p3}, Lfpu;->reAuth()V
    ...
    .line 7123
    :cond_d
    invoke-interface/range {p3 .. p3}, Lfpu;->onHandshakeDone()V
...
.method public final b()Lfpp;
    ...
    iget-object v1, p0, Lfpl;->c:Lfpx;

    iget v2, p0, Lfpl;->d:I

    invoke-direct {v0, v1, v2}, Lfpp;-><init>(Lfpx;I)V

    .line 5019
    .local v0, "control":Lfpp;
    iget-object v1, v0, Lfpp;->f:Lcom/laiwang/lws/protocol/Attributes;
...
.method public final d()Lfpx;
    .locals 1

    .prologue
    .line 177
    iget-object v0, p0, Lfpl;->c:Lfpx;
