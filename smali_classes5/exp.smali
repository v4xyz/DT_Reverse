...
.method public static a([B)Ljava/lang/String;
    ...
    .line 1255
    invoke-static {p0}, Lexp;->b([B)Ljava/lang/String;
...
.method private static a([BIII)Ljava/lang/String;
    ...
    .line 932
    invoke-static {p0, v1, p2, v1}, Lexp;->b([BIII)[B
...
.method private static a([BII[BII)[B
    ...
    .line 1475
    sget-object v0, Lexp;->f:[B

    goto :goto_0

    .line 1477
    :cond_2
    sget-object v0, Lexp;->b:[B
...
.method static synthetic a([B[BII)[B
    ...
    .line 2522
    invoke-static/range {v0 .. v5}, Lexp;->a([BII[BII)[B
...
.method private static b([B)Ljava/lang/String;
    ...
    invoke-static {p0, v2, v3, v4}, Lexp;->a([BIII)Ljava/lang/String;
    :try_end_0
...
.method private static final b(I)[B
    ...
    .line 491
    sget-object v0, Lexp;->g:[B

    goto :goto_0

    .line 493
    :cond_1
    sget-object v0, Lexp;->c:[B
...
.method private static b([BIII)[B
    ...
    :try_start_1
    new-instance v11, Lexp$a;

    or-int/lit8 v4, p3, 0x1

    invoke-direct {v11, v13, v4}, Lexp$a;-><init>(Ljava/io/OutputStream;I)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_7
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    .line 1028
    .end local v10    # "b64os":Lexp$a;
    .local v11, "b64os":Lexp$a;
    :try_start_2
    ...
    :goto_0
    :try_start_5
    invoke-virtual {v11}, Lexp$a;->close()V
    :try_end_5
    ...
    .line 1033
    .restart local v10    # "b64os":Lexp$a;
    ...
    :goto_6
    :try_start_9
    invoke-virtual {v10}, Lexp$a;->close()V
    :try_end_9
    ...
    invoke-static/range {v4 .. v9}, Lexp;->a([BII[BII)[B
    ...
    .end local v20    # "len2":I
    .end local v21    # "lineLength":I
    .restart local v11    # "b64os":Lexp$a;
