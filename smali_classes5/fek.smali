...
.method static synthetic a(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/concurrent/atomic/AtomicInteger;)Z
    ...
    .prologue
    .line 32
    invoke-static {p0, p1, p2, p3}, Lfek;->b(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/concurrent/atomic/AtomicInteger;)Z
...
.method static a(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Lcom/alibaba/wukong/im/MessageListener$DataType;)Z
    ...
    check-cast v14, Lcom/alibaba/wukong/im/message/MessageImpl;
    ...
    invoke-virtual {v2, v10, v6, v7}, Lfcs;->a(Ljava/lang/String;J)Lcom/alibaba/wukong/im/message/MessageImpl;
    ...
    invoke-virtual {v2, v10, v0, v5}, Lfcs;->a(Ljava/lang/String;Ljava/util/Collection;Z)Ljava/util/ArrayList;
    :try_end_1
    ...
    invoke-static {v2, v0}, Lfcv;->a(Ljava/util/ArrayList;Lcom/alibaba/wukong/im/MessageListener$DataType;)V
    ...
    invoke-static {v8, v0, v1, v11}, Lfek;->b(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/concurrent/atomic/AtomicInteger;)Z
    ...
    .line 5030
    invoke-static/range {v23 .. v23}, Lfaz;->a(Lfbb;)V
    ...
    invoke-virtual {v2, v15}, Lfby;->a(Ljava/util/Map;)V
    ...
    invoke-virtual {v2, v13, v0}, Lfby;->a(Ljava/util/Map;Ljava/util/Map;)Z
    ...
    invoke-virtual {v5, v10, v2, v6}, Lfcs;->a(Ljava/lang/String;Ljava/util/Collection;Z)Ljava/util/ArrayList;
    :try_end_5
    ...
    invoke-virtual {v2}, Lfbx;->h()Ljava/util/concurrent/Executor;

    move-result-object v25

    new-instance v2, Lfek$1;
    ...
    invoke-direct/range {v2 .. v7}, Lfek$1;-><init>(Ljava/util/Set;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Lcom/alibaba/wukong/im/MessageListener$DataType;)V
...
.method private static b(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/concurrent/atomic/AtomicInteger;)Z
    ...
    invoke-static {v3}, Lfct;->b(Lcom/alibaba/wukong/im/message/MessageImpl;)Z
