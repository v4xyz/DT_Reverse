...
.method constructor <init>(Lflv;Lflr;Z)V
    ...
    .line 53
    iput-object p2, p0, Lflw;->a:Lflr;

    .line 54
    iput-boolean p3, p0, Lflw;->d:Z
...
.method protected final decodeLoop(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;
    ...
    .line 67
    .local v0, "b":B
    iget-boolean v2, p0, Lflw;->e:Z

    if-eqz v2, :cond_b

    .line 68
    iget-byte v2, p0, Lflw;->c:B

    if-ne v0, v2, :cond_4

    .line 69
    invoke-direct {p0}, Lflw;->a()Z
    ...
    .line 70
    invoke-static {p1}, Lflw;->b(Ljava/nio/ByteBuffer;)Ljava/nio/charset/CoderResult;
    ...
    .line 73
    invoke-static {p1}, Lflw;->a(Ljava/nio/ByteBuffer;)Ljava/nio/charset/CoderResult;
    ...
    .line 77
    :goto_2
    invoke-direct {p0}, Lflw;->b()V

    .line 85
    :cond_2
    iput-boolean v7, p0, Lflw;->h:Z

    goto :goto_0

    .line 76
    :cond_3
    iput-boolean v6, p0, Lflw;->i:Z
    ...
    .line 88
    iput-boolean v6, p0, Lflw;->e:Z

    .line 89
    iget-boolean v2, p0, Lflw;->i:Z

    if-eqz v2, :cond_c

    iget-boolean v2, p0, Lflw;->d:Z
