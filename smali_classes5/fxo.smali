...
# static fields
.field private static volatile c:Lfxo;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfxo;->e:Ljava/util/concurrent/locks/Lock;
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;I)V
    ...
    iput-object v0, p0, Lfxo;->b:Ljava/util/LinkedList;

    .line 64
    iput-object p1, p0, Lfxo;->d:Landroid/content/Context;

    .line 65
    return-void
.end method

.method public static a(Landroid/content/Context;)Lfxo;
    .locals 5
    .param p0, "context"    # Landroid/content/Context;

    .prologue
    .line 52
    sget-object v0, Lfxo;->c:Lfxo;
    ...
    invoke-direct {v0, p0, v2, v3, v4}, Lfxo;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;I)V
...
.method public final a(Z)Ljava/util/List;
    ...
    :try_start_1
    invoke-virtual/range {p0 .. p0}, Lfxo;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_1
...
.method public declared-synchronized a(Ljava/lang/String;[Ljava/lang/Object;Z)V
    ...
    :try_start_0
    iget-object v3, p0, Lfxo;->b:Ljava/util/LinkedList;

    new-instance v4, Lfxo$a;

    const/4 v5, 0x0

    invoke-direct {v4, p0, p1, p2, v5}, Lfxo$a;-><init>(Lfxo;Ljava/lang/String;[Ljava/lang/Object;B)V
    ...
    .line 191
    invoke-virtual {p0}, Lfxo;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    ...
    check-cast v2, Lfxo$a;

    .line 202
    .local v2, "sObject":Lfxo$a;
    iget-object v3, v2, Lfxo$a;->b:[Ljava/lang/Object;

    if-eqz v3, :cond_2

    .line 203
    iget-object v3, v2, Lfxo$a;->a:Ljava/lang/String;

    iget-object v4, v2, Lfxo$a;->b:[Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, v3, v4}, Lfxo;->onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    .line 205
    .restart local v0    # "db":Landroid/database/sqlite/SQLiteDatabase;
    .restart local v2    # "sObject":Lfxo$a;
    :cond_2
    :try_start_4
    iget-object v3, v2, Lfxo$a;->a:Ljava/lang/String;
...
.method public getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v0, v1}, Lfxv;->a(Ljava/lang/String;I)Z
...
.method public final onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 78
    :try_start_0
    sget-object v0, Lfxo;->e:Ljava/util/concurrent/locks/Lock;
    ...
    sget-object v1, Lfxo;->e:Ljava/util/concurrent/locks/Lock;
...
.method public final onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    .line 99
    invoke-virtual {p0, p1}, Lfxo;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
