...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    .line 48
    iput-object p1, p0, Leqv;->d:Landroid/app/Activity;

    .line 49
    iget-object v0, p0, Leqv;->d:Landroid/app/Activity;
...
.method public final a(Lcom/alibaba/lightapp/runtime/fragment/BaseRuntimeFragment;Ljava/lang/String;Lcom/alibaba/lightapp/runtime/plugin/delegate/NavModel$NavAnimInfo;)Z
    ...
    iget-object v2, v0, Leqv;->b:Leqv$a;
    ...
    sget v2, Leqg$g;->viewpager_transition_root:I
    ...
    .line 81
    .local v17, "r":Landroid/widget/FrameLayout;
    if-nez v17, :cond_2
    ...
    .end local v17    # "r":Landroid/widget/FrameLayout;
    check-cast v17, Landroid/widget/FrameLayout;

    .line 84
    .restart local v17    # "r":Landroid/widget/FrameLayout;
    :cond_2
    if-nez v17, :cond_3
    ...
    iput-boolean v2, v0, Leqv;->c:Z

    .line 107
    move-object/from16 v0, p0

    iget-object v2, v0, Leqv;->d:Landroid/app/Activity;
    ...
    invoke-virtual {v6, v0}, Landroid/widget/FrameLayout;->getLocationInWindow([I)V
    ...
    invoke-static {v0, v2, v15, v1, v14}, Leqv;->a(Landroid/view/View;IIII)Landroid/graphics/Bitmap;
    ...
    invoke-direct/range {v2 .. v7}, Leqv$1;-><init>(Leqv;Ljava/lang/String;Lcom/alibaba/lightapp/runtime/plugin/delegate/NavModel$NavAnimInfo;Landroid/widget/FrameLayout;Lcom/alibaba/lightapp/runtime/view/TransitionSnapshot;)V

    invoke-virtual {v12, v2}, Landroid/animation/AnimatorSet;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 197
    new-instance v2, Leqv$2;

    move-object/from16 v0, p0

    invoke-direct {v2, v0, v12}, Leqv$2;-><init>(Leqv;Landroid/animation/AnimatorSet;)V
