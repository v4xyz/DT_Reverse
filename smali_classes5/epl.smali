...
.method public static a(Lemr$a;)I
    .locals 12
    .param p0, "options"    # Lemr$a;
    ...
    .line 37
    iget v3, p0, Lemr$a;->outWidth:I

    if-lez v3, :cond_0

    iget v3, p0, Lemr$a;->outHeight:I
    ...
    iget v3, p0, Lemr$a;->c:I

    if-eqz v3, :cond_2

    iget v3, p0, Lemr$a;->b:I
    ...
    .local v1, "ratio":F
    :goto_0
    iget-object v3, p0, Lemr$a;->e:Lcom/alibaba/laiwang/photokit/imageformat/ImageFormat;
...
.method public static b(Lemr$a;)F
    .locals 11
    .param p0, "options"    # Lemr$a;
