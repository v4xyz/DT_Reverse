...
.method public constructor <init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    iput-object p2, p0, Lhcp$b;->a:Ljava/math/BigInteger;
    ...
    :cond_0
    iput-object p1, p0, Lhcp$b;->b:Ljava/math/BigInteger;
...
.method private static a(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)[Ljava/math/BigInteger;
    ...
    sget-object v4, Lhcn;->g:Ljava/math/BigInteger;

    sget-object v3, Lhcn;->h:Ljava/math/BigInteger;

    sget-object v2, Lhcn;->g:Ljava/math/BigInteger;

    sget-object v1, Lhcn;->g:Ljava/math/BigInteger;
...
.method public final a(Lhcp;)Lhcp;
    ...
    iget-object v1, p0, Lhcp$b;->b:Ljava/math/BigInteger;

    iget-object v2, p0, Lhcp$b;->a:Ljava/math/BigInteger;
    ...
    iget-object v3, p0, Lhcp$b;->b:Ljava/math/BigInteger;

    invoke-virtual {v2, v3}, Ljava/math/BigInteger;->mod(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v2

    invoke-direct {v0, v1, v2}, Lhcp$b;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public final a()Ljava/math/BigInteger;
    ...
    iget-object v0, p0, Lhcp$b;->a:Ljava/math/BigInteger;
...
.method public final b()I
    ...
    iget-object v0, p0, Lhcp$b;->b:Ljava/math/BigInteger;
...
.method public final c()Lhcp;
    ...
    iget-object v3, p0, Lhcp$b;->a:Ljava/math/BigInteger;
...
.method public final e()Lhcp;
    ...
    iget-object v2, p0, Lhcp$b;->b:Ljava/math/BigInteger;

    iget-object v3, p0, Lhcp$b;->a:Ljava/math/BigInteger;

    iget-object v4, p0, Lhcp$b;->b:Ljava/math/BigInteger;

    invoke-virtual {v4, v6}, Ljava/math/BigInteger;->shiftRight(I)Ljava/math/BigInteger;

    move-result-object v4

    sget-object v5, Lhcn;->g:Ljava/math/BigInteger;

    invoke-virtual {v4, v5}, Ljava/math/BigInteger;->add(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v4

    iget-object v5, p0, Lhcp$b;->b:Ljava/math/BigInteger;

    invoke-virtual {v3, v4, v5}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v3

    invoke-direct {v0, v2, v3}, Lhcp$b;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    iget-object v5, p0, Lhcp$b;->a:Ljava/math/BigInteger;

    invoke-virtual {v5, v6}, Ljava/math/BigInteger;->shiftLeft(I)Ljava/math/BigInteger;

    move-result-object v0

    iget-object v6, p0, Lhcp$b;->b:Ljava/math/BigInteger;
    ...
    iget-object v8, p0, Lhcp$b;->b:Ljava/math/BigInteger;
    ...
    iget-object v9, p0, Lhcp$b;->b:Ljava/math/BigInteger;
    ...
    invoke-static {v8, v0, v5, v4}, Lhcp$b;->a(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)[Ljava/math/BigInteger;
    ...
    iget-object v10, p0, Lhcp$b;->b:Ljava/math/BigInteger;
    ...
    invoke-direct {v0, v2, v1}, Lhcp$b;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    goto/16 :goto_0

    :cond_6
    sget-object v0, Lhcn;->g:Ljava/math/BigInteger;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    :cond_2
    check-cast p1, Lhcp$b;

    iget-object v2, p0, Lhcp$b;->b:Ljava/math/BigInteger;

    iget-object v3, p1, Lhcp$b;->b:Ljava/math/BigInteger;
    ...
    iget-object v3, p1, Lhcp$b;->a:Ljava/math/BigInteger;
...
.method public final hashCode()I
    ...
    iget-object v1, p0, Lhcp$b;->a:Ljava/math/BigInteger;
