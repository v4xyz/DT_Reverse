...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpj;->c:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method protected constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v1, p0, Lpj;->b:Ljava/util/concurrent/BlockingQueue;
...
.method private a(Ljava/util/concurrent/BlockingQueue;Ljava/lang/String;Lwa;Ljava/lang/Runnable;Z)V
    .locals 8
    ...
    .prologue
    .line 80
    .local p1, "queue":Ljava/util/concurrent/BlockingQueue;, "Ljava/util/concurrent/BlockingQueue<Lpj$a;>;"
    iget-object v5, p0, Lpj;->a:Ljava/lang/String;
    ...
    invoke-static {v5, v6}, Labd;->c(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 86
    .local v0, "command":Lpj$a;
    iput-object p3, v0, Lpj$a;->b:Lwa;

    .line 87
    iput-object p4, v0, Lpj$a;->a:Ljava/lang/Runnable;

    .line 88
    iput-object p2, v0, Lpj$a;->c:Ljava/lang/String;

    .line 89
    iput-boolean p5, v0, Lpj$a;->d:Z
    ...
    invoke-static {v5, v6, v1}, Labd;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
# virtual methods
.method protected final a(Ljava/lang/String;Lwa;Ljava/lang/Runnable;)V
    .locals 6
    ...
    .prologue
    .line 71
    iget-object v1, p0, Lpj;->b:Ljava/util/concurrent/BlockingQueue;
    ...
    invoke-direct/range {v0 .. v5}, Lpj;->a(Ljava/util/concurrent/BlockingQueue;Ljava/lang/String;Lwa;Ljava/lang/Runnable;Z)V
...
.method public final b()V
    ...
    .line 67
    iget-object v0, p0, Lpj;->b:Ljava/util/concurrent/BlockingQueue;
...
.method protected final b(Ljava/lang/String;Lwa;Ljava/lang/Runnable;)V
    .locals 6
    .param p1, "description"    # Ljava/lang/String;
    .param p2, "listener"    # Lwa;
    .param p3, "runnable"    # Ljava/lang/Runnable;
...
.method public run()V
    ...
    :try_start_0
    iget-object v3, p0, Lpj;->b:Ljava/util/concurrent/BlockingQueue;
    ...
    iput-boolean v3, p0, Lpj;->d:Z

    .line 45
    iget-object v1, v0, Lpj$a;->c:Ljava/lang/String;

    .line 46
    iget-object v4, p0, Lpj;->a:Ljava/lang/String;
    ...
    invoke-static {v4, v3}, Labd;->c(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_1

    .line 49
    :try_start_1
    iget-object v3, v0, Lpj$a;->a:Ljava/lang/Runnable;
    ...
    :cond_0
    :goto_2
    iput-boolean v7, p0, Lpj;->d:Z

    goto :goto_0

    .line 46
    .restart local v0    # "command":Lpj$a;
    :cond_1
    :try_start_2
    ...
    invoke-static {v3, v4, v2}, Labd;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    invoke-static {v3, v4}, Laax;->a(Ljava/lang/String;Ljava/lang/String;)V
