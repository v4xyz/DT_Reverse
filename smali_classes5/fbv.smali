...
# static fields
.field private static volatile a:Lfbv;
...
# virtual methods
.method public addCategoryChangeListener(Lfbr;)V
    .locals 0
    .param p1, "listener"    # Lfbr;
    ...
    .line 378
    :cond_0
    invoke-static {p1}, Lfbt;->a(Lfbr;)V
...
.method public adjustCategoryOrder(Ljava/util/List;Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-virtual {v1}, Lfbx;->e()Ljava/util/concurrent/Executor;
    ...
    invoke-direct/range {v0 .. v5}, Lfbv$6;-><init>(Lfbv;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;Ljava/util/List;)V

    .line 284
    invoke-virtual {v0}, Lfbv$6;->start()V
    :try_end_2
...
.method public createCategory(Ljava/lang/String;Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-direct/range {v0 .. v5}, Lfbv$1;-><init>(Lfbv;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;Ljava/lang/String;)V

    .line 84
    invoke-virtual {v0}, Lfbv$1;->start()V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public deleteCategory(JLcom/alibaba/wukong/Callback;)V
    ...
    invoke-virtual {v2}, Lfbx;->e()Ljava/util/concurrent/Executor;
    ...
    invoke-direct/range {v1 .. v7}, Lfbv$2;-><init>(Lfbv;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;J)V

    .line 121
    invoke-virtual {v1}, Lfbv$2;->start()V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public getCategoryById(JLcom/alibaba/wukong/Callback;)V
    ...
    invoke-direct/range {v1 .. v7}, Lfbv$3;-><init>(Lfbv;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;J)V

    .line 165
    invoke-virtual {v1}, Lfbv$3;->start()V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public listCategorys(Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-direct {v0, p0, p1, v1, v2}, Lfbv$5;-><init>(Lfbv;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;)V

    .line 244
    invoke-virtual {v0}, Lfbv$5;->start()V
...
.method public listConversationByCategoryId(JLjava/util/List;Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-direct/range {v1 .. v8}, Lfbv$8;-><init>(Lfbv;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;JLjava/util/List;)V

    .line 367
    invoke-virtual {v1}, Lfbv$8;->start()V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public modifyCategory(Lcom/alibaba/wukong/im/category/CategoryObject;Lcom/alibaba/wukong/Callback;)V
    ...
    invoke-direct/range {v0 .. v5}, Lfbv$7;-><init>(Lfbv;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;Lcom/alibaba/wukong/im/category/CategoryObject;)V

    .line 319
    invoke-virtual {v0}, Lfbv$7;->start()V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public moveConversations(Ljava/util/List;JLcom/alibaba/wukong/Callback;)V
    ...
    invoke-direct/range {v0 .. v7}, Lfbv$4;-><init>(Lfbv;Lcom/alibaba/wukong/Callback;ZLjava/util/concurrent/Executor;Ljava/util/List;J)V

    .line 201
    invoke-virtual {v0}, Lfbv$4;->start()V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public removeCategoryChangeListener(Lfbr;)V
    .locals 0
    .param p1, "listener"    # Lfbr;
    ...
    .line 387
    :cond_0
    invoke-static {p1}, Lfbt;->b(Lfbr;)V
