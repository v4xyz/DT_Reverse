...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhs;->d:Ljava/util/Map;
...
.method private constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lhs;->f:Ljava/lang/Object;
...
.method public static a(Ljava/lang/String;)Lhs;
    .locals 8
    ...
    .line 66
    sget-object v2, Lhs;->d:Ljava/util/Map;

    monitor-enter v2

    .line 67
    :try_start_0
    sget-object v1, Lhs;->d:Ljava/util/Map;
    ...
    .end local v0    # "info":Lhs;
    invoke-direct {v0, p0}, Lhs;-><init>(Ljava/lang/String;)V

    .line 70
    .restart local v0    # "info":Lhs;
    sget-object v1, Lhs;->d:Ljava/util/Map;
...
.method private a(Lanet/channel/entity/ConnType$TypeLevel;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 3084
    .local v3, "strategies":Ljava/util/List;, "Ljava/util/List<Ljj;>;"
    :try_start_0
    iget-object v6, p0, Lhs;->a:Ljava/lang/String;

    .line 306
    invoke-static {v6}, Lkl;->a(Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-interface {v6, v7}, Ljl;->b(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 316
    .local v2, "iterator":Ljava/util/ListIterator;, "Ljava/util/ListIterator<Ljj;>;"
    :cond_1
    :goto_1
    ...
    .line 318
    .local v4, "strategy":Ljj;
    invoke-interface {v4}, Ljj;->getConnType()Lanet/channel/entity/ConnType;
    ...
    .end local v2    # "iterator":Ljava/util/ListIterator;, "Ljava/util/ListIterator<Ljj;>;"
    .end local v4    # "strategy":Ljj;
    :catch_0
    move-exception v5
...
.method private a(Landroid/content/Context;Lhy;Lhs$c;Ljava/lang/String;)V
    .locals 6
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "info"    # Lhy;
    .param p3, "connCb"    # Lhs$c;
    ...
    invoke-direct {v1, p1, p2}, Lja;-><init>(Landroid/content/Context;Lhy;)V

    iput-object v1, p0, Lhs;->c:Lanet/channel/Session;
    ...
    .line 4084
    iget-object v5, p0, Lhs;->a:Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lhy;->a()Ljava/lang/String;
    ...
    iget-object v5, p0, Lhs;->c:Lanet/channel/Session;
    ...
    .line 368
    iget-object v1, p0, Lhs;->c:Lanet/channel/Session;
    ...
    new-instance v5, Lhs$1;

    invoke-direct {v5, p0, p3, v2, v3}, Lhs$1;-><init>(Lhs;Lhs$c;J)V

    invoke-virtual {v1, v4, v5}, Lanet/channel/Session;->a(ILic;)V
    ...
    new-instance v3, Lhs$2;

    invoke-direct {v3, p0, v1}, Lhs$2;-><init>(Lhs;Lanet/channel/Session;)V

    invoke-virtual {v1, v2, v3}, Lanet/channel/Session;->a(ILic;)V
    ...
    invoke-direct {v1, p1, p2}, Lje;-><init>(Landroid/content/Context;Lhy;)V
    ...
    invoke-direct {v1, p1, p2}, Ljd;-><init>(Landroid/content/Context;Lhy;)V
...
.method protected static a(Lanet/channel/Session;ILjava/lang/String;)V
    ...
    invoke-static {v4}, Ljr;->c(Ljava/lang/String;)Z
    ...
    invoke-static {v5}, Ljr;->a(Ljava/lang/String;)Z
...
.method protected static a(Lhs;)V
    .locals 2
    .param p0, "info"    # Lhs;
    ...
    .line 79
    :try_start_0
    sget-object v0, Lhs;->d:Ljava/util/Map;
...
.method static synthetic a(Lhs;Landroid/content/Context;Lhy;Lhs$c;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lhs;
    ...
    .prologue
    .line 48
    invoke-direct {p0, p1, p2, p3, p4}, Lhs;->a(Landroid/content/Context;Lhy;Lhs$c;Ljava/lang/String;)V

    return-void
.end method

.method static synthetic a(Lhs;Z)V
    .locals 1
    .param p0, "x0"    # Lhs;
    .param p1, "x1"    # Z
    ...
    invoke-direct {p0, v0}, Lhs;->b(Z)V

    return-void
.end method

.method static synthetic b(Lhs;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lhs;
...
.method private b(Z)V
    ...
    .line 90
    iget-object v0, p0, Lhs;->e:Ljava/util/concurrent/Future;
    ...
    .line 92
    iput-object v2, p0, Lhs;->e:Ljava/util/concurrent/Future;

    .line 94
    :cond_0
    iput-object v2, p0, Lhs;->c:Lanet/channel/Session;
...
.method protected final a()V
    ...
    .line 478
    iget-object v1, p0, Lhs;->f:Ljava/lang/Object;
...
.method public final a(J)V
    ...
    .line 459
    :cond_0
    iget-object v5, p0, Lhs;->f:Ljava/lang/Object;
    ...
    .line 466
    iget-object v4, p0, Lhs;->f:Ljava/lang/Object;
...
.method public final declared-synchronized a(Landroid/content/Context;Lanet/channel/entity/ConnType$TypeLevel;Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v0, v1}, Lhr;->a(Lhs;Lanet/channel/entity/ConnType$TypeLevel;)Lanet/channel/Session;
    ...
    iget-object v14, v0, Lhs;->a:Ljava/lang/String;
    ...
    invoke-direct {v0, v10}, Lhs;->b(Z)V

    .line 141
    new-instance v10, Lhs$b;

    move-object/from16 v0, p0

    move-object/from16 v1, p3

    invoke-direct {v10, v0, v1}, Lhs$b;-><init>(Lhs;Ljava/lang/String;)V

    const-wide/16 v12, 0x2d

    sget-object v11, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-static {v10, v12, v13, v11}, Lkb;->a(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/Future;

    move-result-object v10

    move-object/from16 v0, p0

    iput-object v10, v0, Lhs;->e:Ljava/util/concurrent/Future;
    ...
    invoke-direct {v10, v0}, Lanet/channel/NoNetworkException;-><init>(Lhs;)V
    ...
    invoke-direct {v0, v1, v2}, Lhs;->a(Lanet/channel/entity/ConnType$TypeLevel;Ljava/lang/String;)Ljava/util/List;

    move-result-object v9

    .line 152
    .local v9, "strategyList":Ljava/util/List;, "Ljava/util/List<Ljj;>;"
    ...
    invoke-direct {v10, v0}, Lanet/channel/NoAvailStrategyException;-><init>(Lhs;)V
    ...
    .line 161
    .local v6, "iterator":Ljava/util/ListIterator;, "Ljava/util/ListIterator<Ljj;>;"
    :cond_6
    :goto_1
    ...
    .line 163
    .local v8, "strategy":Ljj;
    move-object/from16 v0, p0

    iget-object v10, v0, Lhs;->a:Ljava/lang/String;

    invoke-interface {v8}, Ljj;->getIp()Ljava/lang/String;

    move-result-object v11

    invoke-interface {v8}, Ljj;->getPort()I

    move-result v12

    invoke-static {v10, v11, v12}, Ljd;->a(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    .line 1337
    .end local v6    # "iterator":Ljava/util/ListIterator;, "Ljava/util/ListIterator<Ljj;>;"
    :cond_8
    invoke-interface {v9}, Ljava/util/List;->isEmpty()Z
    ...
    .line 176
    .local v5, "connInfoList":Ljava/util/List;, "Ljava/util/List<Lhy;>;"
    :cond_9
    const/4 v10, 0x0
    ...
    .line 177
    .local v4, "connInfo":Lhy;
    new-instance v10, Lhs$a;

    move-object/from16 v0, p0

    move-object/from16 v1, p1

    invoke-direct {v10, v0, v1, v5, v4}, Lhs$a;-><init>(Lhs;Landroid/content/Context;Ljava/util/List;Lhy;)V

    .line 2086
    iget-object v11, v4, Lhy;->c:Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v4, v10, v11}, Lhs;->a(Landroid/content/Context;Lhy;Lhs$c;Ljava/lang/String;)V
    :try_end_3
    ...
    .line 1340
    .end local v5    # "connInfoList":Ljava/util/List;, "Ljava/util/List<Lhy;>;"
    :cond_a
    ...
    .line 1344
    invoke-interface {v10}, Ljj;->getRetryTimes()I
    ...
    iget-object v0, v0, Lhs;->a:Ljava/lang/String;
    ...
    invoke-direct {v15, v0, v1, v10}, Lhy;-><init>(Ljava/lang/String;Ljava/lang/String;Ljj;)V

    .line 1348
    iput v11, v15, Lhy;->d:I

    .line 1349
    iput v14, v15, Lhy;->e:I
...
.method protected final a(Z)V
    ...
    iget-object v8, p0, Lhs;->a:Ljava/lang/String;
    ...
    .line 5038
    sget-object v3, Lhr$a;->a:Lhr;

    .line 426
    invoke-virtual {v3, p0}, Lhr;->a(Lhs;)Ljava/util/List;
...
.method public final b(Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lhs;->a:Ljava/lang/String;
    ...
    .line 439
    invoke-virtual {p0, v6}, Lhs;->a(Z)V
