...
function appendHTML() {
  var html = '<div class="qqmail_loadall" style="display: none;">' +
    ...
    '<div id="qqmailLoadingAllContent" style="display:none;line-height:32px;margin-top:-10px;"><Image style="width:32px;height:32px;" src="file:///android_asset/other/icon_recorder_loading.gif" /></div>' +
    '</div>' +
