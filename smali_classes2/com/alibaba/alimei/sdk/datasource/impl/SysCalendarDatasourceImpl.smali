...
.method private getAttendeeUri()Landroid/net/Uri;
    ...
    .prologue
    .line 805
    sget-object v0, Lais;->e:Landroid/net/Uri;
...
.method private getCalendarUri()Landroid/net/Uri;
    ...
    .prologue
    .line 778
    sget-object v0, Lais;->a:Landroid/net/Uri;
...
.method private getEventUri()Landroid/net/Uri;
    ...
    .prologue
    .line 814
    sget-object v0, Lais;->b:Landroid/net/Uri;
...
.method private getInstanceUri()Landroid/net/Uri;
    ...
    .prologue
    .line 787
    sget-object v0, Lais;->c:Landroid/net/Uri;
...
.method private getReminderUri()Landroid/net/Uri;
    ...
    .prologue
    .line 796
    sget-object v0, Lais;->d:Landroid/net/Uri;
...
.method public addEvent(JLcom/alibaba/alimei/sdk/model/EventDetailModel;)V
    ...
    invoke-static/range {v17 .. v17}, Labh;->d(Ljava/lang/String;)I
    :try_end_0
    ...
    invoke-static {v0, v8}, Labh;->d(Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method public loadEventDetail(JJJ)Lcom/alibaba/alimei/sdk/model/EventDetailModel;
    ...
    sget-object v4, Lais;->g:[Ljava/lang/String;
...
.method public querySystemCalendar(J)Lcom/alibaba/alimei/sdk/model/calendar/CalendarModel;
    ...
    invoke-static {v0, v9}, Labh;->d(Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public querySystemCalendar()Ljava/util/List;
    ...
    invoke-static {v0, v10}, Labh;->d(Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public querySystemEvents(II)Ljava/util/List;
    ...
    sget-object v4, Lais;->f:[Ljava/lang/String;
...
.method public updateEvent(Lcom/alibaba/alimei/sdk/model/EventDetailModel;Lcom/alibaba/alimei/sdk/model/EventDetailModel;I)V
    ...
    invoke-direct {v13}, Laif;-><init>()V

    .line 519
    .local v13, "durationParser":Laif;
    :try_start_0
    invoke-virtual {v13, v14}, Laif;->a(Ljava/lang/String;)V
    ...
    .line 529
    .end local v13    # "durationParser":Laif;
    ...
    invoke-static/range {v37 .. v37}, Labh;->d(Ljava/lang/String;)I
    :try_end_1
    ...
    invoke-static {v0, v15}, Labh;->d(Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method public updatePastEvents(Lcom/alibaba/alimei/sdk/model/EventDetailModel;Landroid/content/ContentValues;J)Ljava/lang/String;
    ...
    invoke-direct {v5, v8, v9, v0, v1}, Laih;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    .line 946
    .local v5, "recurSet":Laih;
    new-instance v3, Laig;

    invoke-direct {v3}, Laig;-><init>()V

    .local v3, "recurProc":Laig;
    move-wide/from16 v8, p3

    .line 949
    :try_start_0
    invoke-virtual/range {v3 .. v9}, Laig;->a(Landroid/text/format/Time;Laih;JJ)[J
    :try_end_0
    .catch Lcom/alibaba/alimei/sdk/calendar/common/DateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 1000
    .end local v3    # "recurProc":Laig;
    .end local v5    # "recurSet":Laih;
...
.method public updateSystemCalVisible(Ljava/util/List;)Z
    ...
    invoke-static {v11}, Labh;->d(Ljava/lang/String;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Landroid/content/OperationApplicationException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    invoke-static {v11, v3}, Labh;->d(Ljava/lang/String;Ljava/lang/Throwable;)I
