...
.method public final onChanged(Ljava/lang/Class;Lcom/alibaba/alimei/framework/datasource/DataGroupModel;)V
    ...
    .line 72
    :cond_1
    invoke-static {v0}, Lcom/alibaba/alimei/sdk/lookup/MailContactService;->a(Lcom/alibaba/alimei/sdk/lookup/MailContactService;)Lakr;

    move-result-object v3

    .line 2112
    invoke-static {}, Lake;->a()J

    move-result-wide v4

    .line 2113
    iget-wide v6, v3, Lakr;->e:J
    ...
    :cond_2
    :goto_1
    iput-wide v4, v3, Lakr;->e:J

    .line 3100
    iget-object v1, v3, Lakr;->f:Lakr$a;
    ...
    invoke-direct {v1, v3, v2}, Lakr$a;-><init>(Lakr;B)V

    iput-object v1, v3, Lakr;->f:Lakr$a;

    .line 1137
    iget-object v1, v3, Lakr;->a:Ljava/util/Timer;

    iget-object v2, v3, Lakr;->f:Lakr$a;
