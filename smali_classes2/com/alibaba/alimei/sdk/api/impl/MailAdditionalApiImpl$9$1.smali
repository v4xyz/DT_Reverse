...
# direct methods
.method constructor <init>(Lcom/alibaba/alimei/sdk/api/impl/MailAdditionalApiImpl$9;Lcom/alibaba/alimei/framework/model/UserAccountModel;Lcom/alibaba/alimei/framework/api/ApiResult;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/alibaba/alimei/sdk/api/impl/MailAdditionalApiImpl$9$1;->val$apiResult:Lcom/alibaba/alimei/framework/api/ApiResult;
...
.method public onSuccess(Lcom/alibaba/alimei/restfulapi/service/RpcCallback$Void;)V
    ...
    iget-object v0, v0, Lcom/alibaba/alimei/sdk/api/impl/MailAdditionalApiImpl$9;->val$mailServerIds:Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/alibaba/alimei/sdk/api/impl/MailAdditionalApiImpl$9$1;->val$account:Lcom/alibaba/alimei/framework/model/UserAccountModel;

    invoke-virtual {v2}, Lcom/alibaba/alimei/framework/model/UserAccountModel;->getId()J

    move-result-wide v2

    iget-object v4, p0, Lcom/alibaba/alimei/sdk/api/impl/MailAdditionalApiImpl$9$1;->val$account:Lcom/alibaba/alimei/framework/model/UserAccountModel;

    iget-object v4, v4, Lcom/alibaba/alimei/framework/model/UserAccountModel;->accountName:Ljava/lang/String;

    iget-object v6, p0, Lcom/alibaba/alimei/sdk/api/impl/MailAdditionalApiImpl$9$1;->this$1:Lcom/alibaba/alimei/sdk/api/impl/MailAdditionalApiImpl$9;

    iget-object v6, v6, Lcom/alibaba/alimei/sdk/api/impl/MailAdditionalApiImpl$9;->val$tags:Ljava/util/List;
