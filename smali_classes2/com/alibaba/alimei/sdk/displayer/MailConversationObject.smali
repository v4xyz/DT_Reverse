...
.field private favoriteMailMap:Lem;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lem",
            "<",
...
.field private hasAttachmenteMailMap:Lem;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lem",
            "<",
...
.field private hasQuickReplyDraft:Lem;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lem",
            "<",
...
.field private hasResourceAttachmenteMailMap:Lem;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lem",
            "<",
...
.field private final itemIdMap:Lem;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lem",
            "<",
...
.field private reminderMailMap:Lem;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lem",
            "<",
...
.field private unreadMailMap:Lem;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lem",
            "<",
...
.method public constructor <init>(Ljava/lang/String;Lcom/alibaba/alimei/sdk/model/MailSnippetModel;)V
    ...
    .line 36
    iput-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->unreadMailMap:Lem;

    .line 37
    iput-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->favoriteMailMap:Lem;

    .line 38
    iput-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasAttachmenteMailMap:Lem;

    .line 39
    iput-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasResourceAttachmenteMailMap:Lem;

    .line 40
    iput-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->reminderMailMap:Lem;

    .line 41
    iput-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasQuickReplyDraft:Lem;
    ...
    iput-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->itemIdMap:Lem;
    ...
    .line 52
    iget-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->itemIdMap:Lem;

    invoke-virtual {p2}, Lcom/alibaba/alimei/sdk/model/MailSnippetModel;->getId()J

    move-result-wide v2

    invoke-virtual {v0, v2, v3, p2}, Lem;->b(JLjava/lang/Object;)V
...
.method private addOrRemove(ZJLem;)V
    .locals 2
    .param p1, "isAdd"    # Z
    .param p2, "mailId"    # J
    .annotation system Ldalvik/annotation/Signature;
    ...
    .prologue
    .line 215
    .local p4, "sparseMap":Lem;, "Lem<Ljava/lang/Boolean;>;"
    if-eqz p4, :cond_0
    ...
    invoke-virtual {p4, p2, p3, v0}, Lem;->b(JLjava/lang/Object;)V
    ...
    .line 219
    :cond_1
    invoke-virtual {p4, p2, p3}, Lem;->c(J)V

    goto :goto_0
.end method

.method private clearMap(Lem;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private handleConversationStatus(Lcom/alibaba/alimei/sdk/model/MailSnippetModel;)V
    ...
    iget-object v3, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->unreadMailMap:Lem;

    invoke-direct {p0, v2, v0, v1, v3}, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->addOrRemove(ZJLem;)V
    ...
    .line 173
    iget-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->favoriteMailMap:Lem;
    ...
    iput-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->favoriteMailMap:Lem;

    .line 177
    :cond_0
    iget-boolean v2, p1, Lcom/alibaba/alimei/sdk/model/MailSnippetModel;->isFavorite:Z

    iget-object v3, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->favoriteMailMap:Lem;
    ...
    .line 181
    iget-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasAttachmenteMailMap:Lem;
    ...
    iput-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasAttachmenteMailMap:Lem;

    .line 185
    :cond_1
    iget-boolean v2, p1, Lcom/alibaba/alimei/sdk/model/MailSnippetModel;->hasAttachment:Z

    iget-object v3, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasAttachmenteMailMap:Lem;
    ...
    .line 189
    iget-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasResourceAttachmenteMailMap:Lem;
    ...
    iput-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasResourceAttachmenteMailMap:Lem;

    .line 193
    :cond_2
    iget-boolean v2, p1, Lcom/alibaba/alimei/sdk/model/MailSnippetModel;->hasResourceAttachment:Z

    iget-object v3, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasResourceAttachmenteMailMap:Lem;
    ...
    .line 197
    iget-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->reminderMailMap:Lem;
    ...
    iput-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->reminderMailMap:Lem;

    .line 201
    :cond_3
    iget-boolean v2, p1, Lcom/alibaba/alimei/sdk/model/MailSnippetModel;->isReminder:Z

    iget-object v3, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->reminderMailMap:Lem;
    ...
    .line 205
    iget-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasQuickReplyDraft:Lem;
    ...
    iput-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasQuickReplyDraft:Lem;
    ...
    invoke-virtual {v2, v0, v1, v3}, Lem;->b(JLjava/lang/Object;)V
    ...
    .line 165
    :cond_6
    iget-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->unreadMailMap:Lem;
    ...
    iput-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->unreadMailMap:Lem;
    ...
    invoke-virtual {v2, v0, v1}, Lem;->c(J)V
...
.method private hasAttachmentMail()Z
    ...
    .line 137
    iget-object v1, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasAttachmenteMailMap:Lem;
...
.method private hasFavoriteMail()Z
    ...
    .line 126
    iget-object v1, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->favoriteMailMap:Lem;
...
.method private hasReminderMail()Z
    ...
    .line 115
    iget-object v1, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->reminderMailMap:Lem;
...
.method private hasResourceAttachmentMail()Z
    ...
    .line 144
    iget-object v1, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasResourceAttachmenteMailMap:Lem;
...
.method private hasUnreadMail()Z
    ...
    .line 104
    iget-object v1, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->unreadMailMap:Lem;
...
.method private quickReplyDraftLocalId()J
    ...
    .prologue
    .line 151
    iget-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasQuickReplyDraft:Lem;
...
.method private removeConversationStatus(Ljava/lang/Long;)V
    ...
    invoke-direct {p0, v3, v0, v1, v2}, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->addOrRemove(ZJLem;)V
    ...
    invoke-virtual {v0, v2, v3}, Lem;->c(J)V
...
.method public addConversationItem(Lcom/alibaba/alimei/sdk/model/MailSnippetModel;)V
    ...
    iget-object v5, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->itemIdMap:Lem;

    invoke-virtual {v0}, Ljava/lang/Long;->longValue()J

    move-result-wide v6

    invoke-virtual {v5, v6, v7}, Lem;->a(J)Ljava/lang/Object;
    ...
    invoke-virtual {v5, v6, v7, p1}, Lem;->b(JLjava/lang/Object;)V
    ...
    invoke-virtual {v5, v6, v7, v2}, Lem;->b(JLjava/lang/Object;)V
...
.method public clearAllConversationItems()V
    ...
    invoke-direct {p0, v0}, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->clearMap(Lem;)V

    .line 470
    iget-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasAttachmenteMailMap:Lem;

    invoke-direct {p0, v0}, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->clearMap(Lem;)V

    .line 471
    iget-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->hasResourceAttachmenteMailMap:Lem;

    invoke-direct {p0, v0}, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->clearMap(Lem;)V

    .line 472
    iget-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->unreadMailMap:Lem;

    invoke-direct {p0, v0}, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->clearMap(Lem;)V

    .line 473
    iget-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->favoriteMailMap:Lem;

    invoke-direct {p0, v0}, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->clearMap(Lem;)V

    .line 474
    iget-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->reminderMailMap:Lem;
...
.method public deleteConversationItem(Lcom/alibaba/alimei/sdk/model/MailSnippetModel;)Z
    ...
    .line 240
    iget-object v6, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->itemIdMap:Lem;
    ...
    invoke-virtual {v6, v8, v9}, Lem;->c(J)V
...
.method public updateConversationItem(Lcom/alibaba/alimei/sdk/model/MailSnippetModel;)V
    ...
    .line 416
    iget-object v3, p0, Lcom/alibaba/alimei/sdk/displayer/MailConversationObject;->itemIdMap:Lem;

    invoke-virtual {v1}, Lcom/alibaba/alimei/sdk/model/MailSnippetModel;->getId()J

    move-result-wide v4

    invoke-virtual {v3, v4, v5}, Lem;->c(J)V
    ...
    invoke-virtual {v3, v4, v5, p1}, Lem;->b(JLjava/lang/Object;)V
