...
.method protected add(ZLjava/util/List;Ljava/util/List;)V
    ...
    .line 172
    .local v0, "data":Laat;, "TT;"
    const/4 v4, 0x0

    invoke-virtual {p0, p2, v0, v4}, Lcom/alibaba/alimei/sdk/displayer/Displayer;->addSingleData(Ljava/util/List;Laat;Z)Z
...
.method protected varargs add(ZLjava/util/List;[Laat;)V
    .locals 6
    .param p1, "isClear"    # Z
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method protected addSingleData(Ljava/util/List;Laat;Z)Z
    .locals 2
    ...
    .local p2, "data":Laat;, "TT;"
    invoke-interface {p2}, Laat;->getId()J
...
.method protected abstract executeLoad()V
.end method
...
.method protected find(Ljava/util/List;J)I
    ...
    .line 322
    .local v0, "data":Laat;, "TT;"
    invoke-interface {v0}, Laat;->getId()J
    :try_end_0
...
.method public getData(Ljava/util/List;J)Laat;
    .locals 4
    .param p2, "dataId"    # J
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method protected varargs update(Ljava/util/List;[Laat;)V
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 202
    .local v1, "data":Laat;, "TT;"
    invoke-interface {v1}, Laat;->getId()J
...
.method protected updateSingleData(Ljava/util/List;Laat;Z)Z
    .locals 6
    .param p3, "isNotifyChanged"    # Z
    .annotation system Ldalvik/annotation/Signature;
        value = {
