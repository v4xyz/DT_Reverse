...
.field private mLocalDataListener:Laam;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Laam",
            "<",
...
.field private mServerListener:Laam;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Laam",
            "<",
...
.method constructor <init>(Ljava/lang/String;)V
    ...
    .line 631
    iput-object v1, p0, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;->mLocalDataListener:Laam;

    .line 691
    iput-object v1, p0, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;->mServerListener:Laam;
...
.method private addedMails(Ljava/util/List;Z)Z
    ...
    invoke-static {v4}, Labh;->i(Ljava/lang/String;)I
...
.method private buildTimeDivierList(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v0, v1, v4, v5}, Lakg;->a(JJ)Z
...
.method private checkAddDivider(Lcom/alibaba/alimei/sdk/model/MailSnippetModel;)V
    ...
    invoke-static {v2, v3}, Lakg;->a(J)J
...
.method private checkDividerAfterRemoveMail(Lcom/alibaba/alimei/sdk/model/MailSnippetModel;)V
    ...
    invoke-static {v4, v5, v6, v7}, Lakg;->a(JJ)Z
...
.method private checkRemoveDivider(Lcom/alibaba/alimei/sdk/model/MailSnippetModel;)V
    ...
    invoke-static {v6, v7}, Lakg;->a(J)J
    ...
    invoke-static {v6, v7, v4, v5}, Lakg;->a(JJ)Z
...
# virtual methods
.method public varargs addMailTag(ZLjava/lang/String;Laam;[Ljava/lang/String;)V
    .locals 5
    .param p1, "withRelationConversations"    # Z
    ...
    invoke-interface {v3, v0, p2, v4}, Lcom/alibaba/alimei/sdk/api/MailAdditionalApi;->addMailTags(Ljava/util/List;Ljava/lang/String;Laam;)V
...
.method public declared-synchronized changeCalendarStatus(Ljava/lang/String;Ljava/lang/String;ILaam;)V
    .locals 5
    ...
    invoke-direct {v1, p0, p4, p1, p3}, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer$2;-><init>(Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;Laam;Ljava/lang/String;I)V
...
.method public varargs declared-synchronized changeMailFavorite(ZZLaam;[Ljava/lang/String;)V
    .locals 9
    .param p1, "withRelationConversations"    # Z
    ...
    invoke-interface {p3, v6}, Laam;->onSuccess(Ljava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v6}, Lahw;->d(Ljava/lang/String;)Lcom/alibaba/alimei/sdk/api/MailApi;

    move-result-object v6

    const/4 v7, 0x0

    invoke-interface {v6, p2, v7, v5}, Lcom/alibaba/alimei/sdk/api/MailApi;->changeMailFavorite(ZLaam;[Ljava/lang/String;)V
...
.method public varargs declared-synchronized changeMailReadStatus(ZZLaam;[Ljava/lang/String;)V
    ...
    invoke-interface {v6, p2, v7, v5}, Lcom/alibaba/alimei/sdk/api/MailApi;->changeMailReadStatus(ZLaam;[Ljava/lang/String;)V
...
.method public varargs declared-synchronized changeMailReminder(ZZLaam;[Ljava/lang/String;)V
    .locals 9
    .param p1, "withRelationConversations"    # Z
    ...
    invoke-interface {v6, p2, p3, v5}, Lcom/alibaba/alimei/sdk/api/MailApi;->changeMailReminder(ZLaam;[Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method protected declared-synchronized executeLoad()V
    ...
    .line 637
    :cond_0
    iget-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;->mContentObserver:Laaf;

    if-nez v2, :cond_1

    .line 638
    invoke-virtual {p0}, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;->getObserver()Laaf;

    move-result-object v2

    iput-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;->mContentObserver:Laaf;

    .line 639
    const-class v2, Lcom/alibaba/alimei/sdk/model/MailGroupModel;

    iget-object v3, p0, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;->mContentObserver:Laaf;

    invoke-static {v2, v3}, Lahw;->a(Ljava/lang/Class;Laaf;)V
    ...
    :cond_2
    :try_start_1
    iget-object v1, p0, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;->mLocalDataListener:Laam;
    ...
    .line 679
    .restart local v1    # "listener":Laam;, "Laam<Ljava/util/List<Lcom/alibaba/alimei/sdk/model/MailSnippetModel;>;>;"
    iput-object v1, p0, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;->mLocalDataListener:Laam;
    ...
    invoke-interface {v2, v1}, Lcom/alibaba/alimei/sdk/api/MailApi;->queryAllLocalRecentReadMails(Laam;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-interface {v2, v4, v5, v1}, Lcom/alibaba/alimei/sdk/api/MailApi;->queryAllLocalMails(JLaam;)V
    :try_end_2
...
.method public loadMoreHistoryMail(Laam;)V
    ...
    invoke-interface {p1, v0}, Laam;->onSuccess(Ljava/lang/Object;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer$3;-><init>(Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;Laam;)V

    goto :goto_0
.end method

.method public varargs declared-synchronized moveMailToNewFolder(ZLcom/alibaba/alimei/sdk/model/FolderModel;Laam;[Ljava/lang/String;)V
    .locals 6
    .param p1, "withRelationConversations"    # Z
    ...
    invoke-interface {v2, v4, v5, v3, v1}, Lcom/alibaba/alimei/sdk/api/MailApi;->moveMailToNewFolder(JLaam;[Ljava/lang/String;)V
    ...
    invoke-interface {p3, v2}, Laam;->onSuccess(Ljava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected onRelease()V
    ...
    .line 612
    iget-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;->mContentObserver:Laaf;
    ...
    iget-object v1, p0, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;->mContentObserver:Laaf;
    ...
    .line 620
    :cond_1
    iget-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;->mServerListener:Laam;

    if-eqz v0, :cond_2

    .line 621
    iput-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;->mServerListener:Laam;

    .line 623
    :cond_2
    iget-object v0, p0, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;->mLocalDataListener:Laam;

    if-eqz v0, :cond_3

    .line 624
    iput-object v2, p0, Lcom/alibaba/alimei/sdk/displayer/MailDisplayer;->mLocalDataListener:Laam;
...
.method public queryLocalMail(ILaam;)V
    .locals 1
    .param p1, "size"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    invoke-interface {v0, p1, p2}, Lcom/alibaba/alimei/sdk/api/MailApi;->queryLocalMails(ILaam;)V
...
.method public varargs removeMailTag(ZLjava/lang/String;Laam;[Ljava/lang/String;)V
    .locals 5
    .param p1, "withRelationConversations"    # Z
    .param p2, "tag"    # Ljava/lang/String;
    .param p4, "mailServerIds"    # [Ljava/lang/String;
    ...
    invoke-interface {v3, v0, p2, v4}, Lcom/alibaba/alimei/sdk/api/MailAdditionalApi;->removeMailTags(Ljava/util/List;Ljava/lang/String;Laam;)V
