...
.method public static buildAutoTryTask(Lcom/alibaba/alimei/framework/db/AutoTryTaskEntry;)Laaz;
    .locals 13
    ...
    .line 4070
    :goto_2
    iput-object v7, v3, Laaz;->u:Lcom/alibaba/alimei/framework/task/AutoTryTaskPolicy$AutoTryFailure;
    ...
    .line 5062
    :goto_4
    iput-object v6, v3, Laaz;->t:Lcom/alibaba/alimei/framework/task/AutoTryTaskPolicy$AutoTryNetwork;

    .line 121
    iget-object v6, p0, Lcom/alibaba/alimei/framework/db/AutoTryTaskEntry;->referenceid:Ljava/lang/String;

    .line 5082
    iput-object v6, v3, Laaz;->v:Ljava/lang/String;
...
.method public static buildTaskEntry(Ljava/lang/String;Laaz;)Lcom/alibaba/alimei/framework/db/AutoTryTaskEntry;
    .locals 4
    ...
    .line 92
    invoke-static {p1}, Lcom/alibaba/alimei/framework/db/AutoTryTaskDatasource;->getTaskFullName(Laaz;)Ljava/lang/String;
    ...
    .line 1058
    iget-object v1, p1, Laaz;->t:Lcom/alibaba/alimei/framework/task/AutoTryTaskPolicy$AutoTryNetwork;
    ...
    .line 1066
    iget-object v1, p1, Laaz;->u:Lcom/alibaba/alimei/framework/task/AutoTryTaskPolicy$AutoTryFailure;
    ...
    .line 2078
    iget-object v1, p1, Laaz;->v:Ljava/lang/String;
    ...
    .line 97
    invoke-virtual {p1}, Laaz;->d()Ljava/lang/String;
...
.method private static final getTaskFullName(Laaz;)Ljava/lang/String;
    .locals 1
    .param p0, "task"    # Laaz;
...
.method public static final declared-synchronized handleAutoTryTaskStatus(ZLjava/lang/String;Laaz;)V
    .locals 16
    ...
    .line 154
    invoke-virtual/range {p2 .. p2}, Laaz;->b_()I
    ...
    iget-object v4, v0, Laaz;->u:Lcom/alibaba/alimei/framework/task/AutoTryTaskPolicy$AutoTryFailure;
    ...
    invoke-static/range {p2 .. p2}, Lcom/alibaba/alimei/framework/db/AutoTryTaskDatasource;->getTaskFullName(Laaz;)Ljava/lang/String;
    ...
    .line 181
    invoke-static/range {p1 .. p2}, Lcom/alibaba/alimei/framework/db/AutoTryTaskDatasource;->buildTaskEntry(Ljava/lang/String;Laaz;)Lcom/alibaba/alimei/framework/db/AutoTryTaskEntry;
    ...
    iget-object v11, v0, Laaz;->t:Lcom/alibaba/alimei/framework/task/AutoTryTaskPolicy$AutoTryNetwork;
    ...
    invoke-virtual/range {p2 .. p2}, Laaz;->d()Ljava/lang/String;
...
.method public static queryAllShouldTryTask(J)Ljava/util/Map;
    ...
    .line 60
    .local v5, "tasks":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Laaz;>;"
    ...
    invoke-static {v2}, Lcom/alibaba/alimei/framework/db/AutoTryTaskDatasource;->buildAutoTryTask(Lcom/alibaba/alimei/framework/db/AutoTryTaskEntry;)Laaz;
