...
.method private getContentObservers(Ljava/lang/Class;Z)Ljava/util/ArrayList;
    ...
    .line 95
    .local v0, "observers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Laaf;>;"
    if-eqz p2, :cond_0
    ...
    .end local v0    # "observers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Laaf;>;"
    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    .line 98
    .restart local v0    # "observers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Laaf;>;"
    iget-object v1, p0, Lcom/alibaba/alimei/framework/datasource/FrameworkDatasourceCenter;->mAllObservers:Ljava/util/HashMap;
...
.method public postContentChanged(Ljava/lang/Class;Lcom/alibaba/alimei/framework/datasource/DataGroupModel;)V
    ...
    .line 51
    .local v2, "observers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Laaf;>;"
    if-eqz v2, :cond_0
    ...
    .line 53
    .local v0, "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Laaf;>;"
    :goto_0
    ...
    .line 55
    .local v1, "observer":Laaf;
    invoke-interface {v1, p1, p2}, Laaf;->onChanged(Ljava/lang/Class;Lcom/alibaba/alimei/framework/datasource/DataGroupModel;)V

    goto :goto_0

    .line 58
    .end local v0    # "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Laaf;>;"
    .end local v1    # "observer":Laaf;
    :cond_0
    return-void
.end method
