...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarBaseMonthViewPager;->setInitialCalender(Lbru;)V
.end annotation
...
.method public final instantiateItem(Landroid/view/ViewGroup;I)Ljava/lang/Object;
    ...
    invoke-static {v4}, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarBaseMonthViewPager;->g(Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarBaseMonthViewPager;)Lbxo;

    move-result-object v4

    invoke-virtual {v2, v4}, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarMonthView;->setICalendarDayViewAdapter(Lbxo;)V
    ...
    invoke-static {v4}, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarBaseMonthViewPager;->h(Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarBaseMonthViewPager;)Lbru;
    ...
    invoke-static {v5}, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarBaseMonthViewPager;->h(Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarBaseMonthViewPager;)Lbru;
    ...
    invoke-static {v6}, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarBaseMonthViewPager;->h(Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarBaseMonthViewPager;)Lbru;
    ...
    .line 243
    invoke-static {v4, v5}, Lbvu;->a(II)Ljava/util/List;

    move-result-object v0

    .line 247
    .local v0, "instantiateBeansOfOneMonth":Ljava/util/List;, "Ljava/util/List<Lbru;>;"
    invoke-virtual {v1, v7}, Ljava/util/Calendar;->get(I)I

    move-result v4

    .line 2139
    iput v4, v2, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarMonthView;->a:I

    .line 2140
    iget-object v4, v2, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarMonthView;->b:Ljava/util/List;
    ...
    .line 2144
    :cond_1
    invoke-virtual {v2}, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarMonthView;->getInitialSelectedBean()Lbru;

    move-result-object v4

    const/4 v5, 0x0

    invoke-virtual {v2, v4, v5}, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarMonthView;->a(Lbru;Z)V
    ...
    .line 1223
    .end local v0    # "instantiateBeansOfOneMonth":Ljava/util/List;, "Ljava/util/List<Lbru;>;"
