...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekViewPager;->setInitialCalender(Lbru;)V
.end annotation
...
.method public final instantiateItem(Landroid/view/ViewGroup;I)Ljava/lang/Object;
    ...
    invoke-static {v3}, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekViewPager;->h(Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekViewPager;)Lbxo;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekView;->setICalendarDayViewAdapter(Lbxo;)V
    ...
    invoke-static {v3}, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekViewPager;->i(Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekViewPager;)Lbru;
    ...
    invoke-static {v4}, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekViewPager;->i(Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekViewPager;)Lbru;
    ...
    invoke-static {v5}, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekViewPager;->i(Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekViewPager;)Lbru;
    ...
    .line 230
    invoke-static {v3, v4, v5}, Lbvu;->a(III)Ljava/util/List;

    move-result-object v0

    .line 235
    .local v0, "instantiateBeansOfOneWeek":Ljava/util/List;, "Ljava/util/List<Lbru;>;"
    iget-object v3, p0, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekViewPager$3;->a:Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekViewPager;

    invoke-static {v3}, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekViewPager;->b(Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekViewPager;)Lbru;

    move-result-object v3

    invoke-virtual {v2, v0, v3}, Lcom/alibaba/android/dingtalkbase/widgets/views/calendar2/CalendarWeekView;->a(Ljava/util/List;Lbru;)V
    ...
    .line 1211
    .end local v0    # "instantiateBeansOfOneWeek":Ljava/util/List;, "Ljava/util/List<Lbru;>;"
