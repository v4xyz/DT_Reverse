...
.method public doLogic(Landroid/app/Activity;[Ljava/lang/Object;)V
    ...
    .line 20
    invoke-static/range {p1 .. p1}, Lbtf;->a(Landroid/app/Activity;)Z
    ...
    invoke-virtual {v3, v0, v1}, Lcpf;->e(J)Lcom/alibaba/android/dingtalkim/models/EmotionPackageObject;
    ...
    .line 1081
    invoke-virtual/range {v2 .. v7}, Lckm;->a(Lcom/alibaba/android/dingtalkim/models/EmotionPackageObject;Ljava/lang/String;Ljava/lang/String;Lcom/alibaba/wukong/im/Conversation;Lckm$a;)V
    ...
    sget v9, Lbyz$g;->dialog_share_emotion_package:I
    ...
    .line 1086
    sget v8, Lbyz$f;->iv_emotion_thumbnail:I
    ...
    .line 1087
    sget v9, Lbyz$f;->tv_emotion_package_desc:I
    ...
    .line 1088
    sget v10, Lbyz$f;->edit_extra_message:I
    ...
    invoke-virtual {v0, v8}, Lbwt$a;->setTitle(Ljava/lang/CharSequence;)Landroid/support/v7/app/AlertDialog$Builder;

    .line 1095
    move-object/from16 v0, v18

    invoke-virtual {v0, v11}, Lbwt$a;->setView(Landroid/view/View;)Landroid/support/v7/app/AlertDialog$Builder;
    ...
    sget v9, Lbyz$h;->cancel:I

    invoke-virtual {v8, v9}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v8

    new-instance v9, Lckm$2;

    invoke-direct {v9, v2, v7}, Lckm$2;-><init>(Lckm;Lckm$a;)V
    ...
    sget v9, Lbyz$h;->dt_im_emotion_share_emotion_package_send:I

    invoke-virtual {v8, v9}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v19

    new-instance v8, Lckm$3;
    ...
    invoke-direct/range {v8 .. v14}, Lckm$3;-><init>(Lckm;Landroid/widget/EditText;Lcom/alibaba/android/dingtalkim/models/EmotionPackageObject;Ljava/lang/String;Lcom/alibaba/wukong/im/Conversation;Lckm$a;)V

    move-object/from16 v0, v18

    move-object/from16 v1, v19

    invoke-virtual {v0, v1, v8}, Lbwt$a;->setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/AlertDialog$Builder;
    ...
    .line 1110
    invoke-virtual/range {v18 .. v18}, Lbwt$a;->create()Landroid/support/v7/app/AlertDialog;

    move-result-object v2

    .line 1111
    invoke-virtual/range {v18 .. v18}, Lbwt$a;->show()Landroid/support/v7/app/AlertDialog;
