...
.method public static fromIdl(Lcsh;)Lcom/alibaba/android/dingtalkim/models/TopicVersionObject;
    .locals 6
    .param p0, "model"    # Lcsh;
    ...
    iget-object v1, p0, Lcsh;->a:Ljava/lang/Long;
    ...
    .line 30
    iget-object v1, p0, Lcsh;->b:Ljava/lang/Long;
...
.method public static fromIdlList(Ljava/util/List;)Ljava/util/List;
    ...
    .prologue
    .line 35
    .local p0, "modelList":Ljava/util/List;, "Ljava/util/List<Lcsh;>;"
    if-eqz p0, :cond_0
    ...
    .line 40
    .local v0, "model":Lcsh;
    invoke-static {v0}, Lcom/alibaba/android/dingtalkim/models/TopicVersionObject;->fromIdl(Lcsh;)Lcom/alibaba/android/dingtalkim/models/TopicVersionObject;
...
.method public static toIdl(Lcom/alibaba/android/dingtalkim/models/TopicVersionObject;)Lcsh;
    .locals 4
    ...
    iput-object v1, v0, Lcsh;->a:Ljava/lang/Long;
    ...
    iput-object v1, v0, Lcsh;->b:Ljava/lang/Long;
...
.method public static toIdlList(Ljava/util/List;)Ljava/util/List;
    ...
    .line 63
    .local v1, "modelList":Ljava/util/List;, "Ljava/util/List<Lcsh;>;"
    invoke-interface {p0}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    invoke-static {v2}, Lcom/alibaba/android/dingtalkim/models/TopicVersionObject;->toIdl(Lcom/alibaba/android/dingtalkim/models/TopicVersionObject;)Lcsh;
