...
.field private p:Lcom/aliaba/android/dingtalk/redpackets/base/models/LuckyTimeRedPacketsPlanDo;

.field private q:Lcng;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->r:Landroid/view/View$OnClickListener;
...
.method static synthetic a(Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;)Landroid/widget/TextView;
    ...
    .prologue
    .line 28
    iget-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->j:Landroid/widget/TextView;
...
.method private a()V
    ...
    .prologue
    .line 185
    iget-boolean v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->n:Z
...
.method static synthetic c(Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;)Lcng;
    .locals 1
    .param p0, "x0"    # Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;

    .prologue
    .line 28
    iget-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->q:Lcng;
...
.method static synthetic d(Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;)Landroid/view/View;
    ...
    .prologue
    .line 28
    iget-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->k:Landroid/view/View;
...
.method static synthetic e(Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;)Lcom/aliaba/android/dingtalk/redpackets/base/models/LuckyTimeRedPacketsPlanDo;
    ...
    .prologue
    .line 28
    iget-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->p:Lcom/aliaba/android/dingtalk/redpackets/base/models/LuckyTimeRedPacketsPlanDo;
...
.method static synthetic f(Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;)Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;
    ...
    .prologue
    .line 28
    iget-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->b:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;
...
.method static synthetic g(Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;)Landroid/widget/TextView;
    ...
    .prologue
    .line 28
    iget-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->c:Landroid/widget/TextView;
...
.method public display(Ljava/lang/Object;)V
    ...
    .end local p1    # "data":Ljava/lang/Object;
    iput-object p1, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->p:Lcom/aliaba/android/dingtalk/redpackets/base/models/LuckyTimeRedPacketsPlanDo;

    .line 1199
    sget v0, Lbyz$f;->lucky_time_banner_root:I

    invoke-virtual {p0, v0}, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->findViewById(I)Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->a:Landroid/view/View;

    .line 1200
    iget-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->a:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->b:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;
    ...
    iput-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->c:Landroid/widget/TextView;

    .line 1202
    iget-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->a:Landroid/view/View;

    sget v1, Lbyz$f;->alert:I
    ...
    iget-object v1, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->r:Landroid/view/View$OnClickListener;
    ...
    sget v1, Lbyz$f;->time:I

    invoke-virtual {v0, v1}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->d:Landroid/view/View;

    .line 1205
    iget-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->a:Landroid/view/View;

    sget v1, Lbyz$f;->time_text1:I
    ...
    iput-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->e:Landroid/widget/TextView;

    .line 1206
    iget-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->a:Landroid/view/View;

    sget v1, Lbyz$f;->time_text2:I
    ...
    sget v1, Lbyz$f;->pick:I

    invoke-virtual {v0, v1}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->k:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->l:Landroid/widget/TextView;

    .line 1213
    iget-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->a:Landroid/view/View;

    sget v1, Lbyz$f;->lucky_text:I
    ...
    iget-object v1, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->p:Lcom/aliaba/android/dingtalk/redpackets/base/models/LuckyTimeRedPacketsPlanDo;

    invoke-direct {v0, p0, v1}, Lcng;-><init>(Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;Lcom/aliaba/android/dingtalk/redpackets/base/models/LuckyTimeRedPacketsPlanDo;)V

    iput-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->q:Lcng;
    ...
    invoke-virtual {v0, p0}, Lcom/alibaba/android/dingtalkim/activities/ChatMsgBaseActivity;->a(Lcne$a;)V
...
.method public getLayout()I
    ...
    .prologue
    .line 82
    sget v0, Lbyz$g;->lucky_time_banner:I
...
.method public removeFromParent()V
    ...
    invoke-virtual {v0, p0}, Lcom/alibaba/android/dingtalkim/activities/ChatMsgBaseActivity;->b(Lcne$a;)V
...
.method public updateAlert(Z)V
    ...
    .prologue
    .line 194
    iput-boolean p1, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->o:Z
...
.method public updateAll(Lcom/aliaba/android/dingtalk/redpackets/base/models/LuckyTimeRedPacketsPlanDo;)V
    ...
    .line 1221
    invoke-static {v3, v6, v0}, Lbtl;->a(Ljava/lang/Object;Ljava/lang/Class;Landroid/app/Activity;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lbsv;

    invoke-virtual {v2, v4, v5, v0}, Lcom/alibaba/android/dingtalk/userbase/ContactInterface;->a(JLbsv;)V
    ...
    invoke-virtual {v2, v0, v1}, Lbtt;->d(Ljava/lang/String;Z)Z
    ...
    .line 113
    iget-object v0, p0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->m:Landroid/widget/TextView;
...
.method public updateTime(Lcom/aliaba/android/dingtalk/redpackets/base/models/LuckyTimeRedPacketsPlanDo;)V
    ...
    iget-object v0, v0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->a:Landroid/view/View;
    ...
    iget-object v0, v0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->d:Landroid/view/View;
    ...
    iget-object v0, v0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->k:Landroid/view/View;
    ...
    iget-object v0, v0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->p:Lcom/aliaba/android/dingtalk/redpackets/base/models/LuckyTimeRedPacketsPlanDo;
    ...
    iget-object v0, v0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->l:Landroid/widget/TextView;
    ...
    sget v19, Lbyz$h;->dt_red_envelop_pick_countdown_close:I
    ...
    iput-boolean v0, v1, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->n:Z
    ...
    iget-object v0, v0, Lcom/alibaba/android/dingtalkim/views/LuckyTimeBannerView;->e:Landroid/widget/TextView;

    move-object/from16 v17, v0

    sget v18, Lbyz$h;->dt_red_envelop_ready_remind:I
    ...
    sget v18, Lbyz$e;->lucky_time_banner_time_bg:I
    ...
    sget v18, Lbyz$h;->dt_red_envelop_first_time_unit_minute:I
    ...
    sget v18, Lbyz$h;->dt_red_envelop_remind_pick_second:I
    ...
    sget v18, Lbyz$h;->dt_red_envelop_today:I
    ...
    sget v18, Lbyz$h;->dt_red_envelop_first_time_unit_hour:I
    ...
    sget v18, Lbyz$h;->dt_red_envelop_remind_space_pick:I
    ...
    sget v18, Lbyz$h;->dt_red_envelop_tomorrow:I
