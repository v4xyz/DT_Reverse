...
.method public static fromIdl(Lbjd;)Lcom/alibaba/android/dingtalk/live/rpc/model/AnchorObject;
    .locals 4
    .param p0, "model"    # Lbjd;
    ...
    iget-object v1, p0, Lbjd;->a:Ljava/lang/Long;
...
.method public static fromIdl(Ljava/util/List;)Ljava/util/List;
    ...
    .prologue
    .line 33
    .local p0, "models":Ljava/util/List;, "Ljava/util/List<Lbjd;>;"
    if-nez p0, :cond_1
    ...
    .line 39
    .local v0, "model":Lbjd;
    invoke-static {v0}, Lcom/alibaba/android/dingtalk/live/rpc/model/AnchorObject;->fromIdl(Lbjd;)Lcom/alibaba/android/dingtalk/live/rpc/model/AnchorObject;
...
.method public static toIdl(Lcom/alibaba/android/dingtalk/live/rpc/model/AnchorObject;)Lbjd;
    .locals 4
    ...
    iput-object v1, v0, Lbjd;->a:Ljava/lang/Long;
...
.method public static toIdl(Ljava/util/List;)Ljava/util/List;
    ...
    .line 65
    .local v1, "models":Ljava/util/List;, "Ljava/util/List<Lbjd;>;"
    invoke-interface {p0}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    invoke-static {v2}, Lcom/alibaba/android/dingtalk/live/rpc/model/AnchorObject;->toIdl(Lcom/alibaba/android/dingtalk/live/rpc/model/AnchorObject;)Lbjd;
