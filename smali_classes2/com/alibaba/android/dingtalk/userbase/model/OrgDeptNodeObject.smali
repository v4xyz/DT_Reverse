...
.method public static fromIDLModel(Lbnj;)Lcom/alibaba/android/dingtalk/userbase/model/OrgDeptNodeObject;
    .locals 8
    .param p0, "model"    # Lbnj;
    ...
    iget-object v5, p0, Lbnj;->a:Ljava/lang/Long;

    .line 1044
    const-wide/16 v6, 0x0

    invoke-static {v5, v6, v7}, Lbug;->a(Ljava/lang/Long;J)J
    ...
    .line 55
    iget-object v5, p0, Lbnj;->b:Ljava/lang/String;
    ...
    .line 60
    .local v3, "subDeptModel":Lbnj;
    if-eqz v3, :cond_2

    .line 63
    invoke-static {v3}, Lcom/alibaba/android/dingtalk/userbase/model/OrgDeptNodeObject;->fromIDLModel(Lbnj;)Lcom/alibaba/android/dingtalk/userbase/model/OrgDeptNodeObject;
...
.method public static fromIDLModelList(Ljava/util/List;)Ljava/util/List;
    ...
    .prologue
    .line 85
    .local p0, "modelList":Ljava/util/List;, "Ljava/util/List<Lbnj;>;"
    if-nez p0, :cond_1
    ...
    .line 94
    invoke-static {v0}, Lcom/alibaba/android/dingtalk/userbase/model/OrgDeptNodeObject;->fromIDLModel(Lbnj;)Lcom/alibaba/android/dingtalk/userbase/model/OrgDeptNodeObject;
...
.method public static toIDLModel(Lcom/alibaba/android/dingtalk/userbase/model/OrgDeptNodeObject;)Lbnj;
    .locals 8
    ...
    invoke-direct {v2}, Lbnj;-><init>()V

    .line 108
    .local v2, "orgDeptNodeModel":Lbnj;
    ...
    iput-object v5, v2, Lbnj;->c:Ljava/util/List;
    ...
    .line 117
    invoke-static {v4}, Lcom/alibaba/android/dingtalk/userbase/model/OrgDeptNodeObject;->toIDLModel(Lcom/alibaba/android/dingtalk/userbase/model/OrgDeptNodeObject;)Lbnj;

    move-result-object v3

    .line 118
    .local v3, "subDeptModel":Lbnj;
    iget-object v6, v2, Lbnj;->c:Ljava/util/List;
    ...
    iput-object v5, v2, Lbnj;->d:Ljava/util/List;
    ...
    .line 129
    invoke-static {v1}, Lcom/alibaba/android/dingtalk/userbase/model/OrgMemberObject;->toIDLModel(Lcom/alibaba/android/dingtalk/userbase/model/OrgMemberObject;)Lbnw;

    move-result-object v0

    .line 130
    .local v0, "memberModel":Lbnw;
    iget-object v6, v2, Lbnj;->d:Ljava/util/List;
...
.method public static toIDLModelList(Ljava/util/List;)Ljava/util/List;
    ...
    .line 144
    .local v0, "nodeModels":Ljava/util/List;, "Ljava/util/List<Lbnj;>;"
    invoke-interface {p0}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    .line 149
    invoke-static {v2}, Lcom/alibaba/android/dingtalk/userbase/model/OrgDeptNodeObject;->toIDLModel(Lcom/alibaba/android/dingtalk/userbase/model/OrgDeptNodeObject;)Lbnj;

    move-result-object v1

    .line 150
    .local v1, "orgDeptNodeModel":Lbnj;
