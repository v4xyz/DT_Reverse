...
.method public static fromIdl(Ldfo;)Lcom/alibaba/android/search/model/idl/objects/PushGroupObject;
    .locals 2
    .param p0, "model"    # Ldfo;
    ...
    .line 30
    iget-object v1, p0, Ldfo;->c:Ldfi;

    invoke-static {v1}, Lcom/alibaba/android/search/model/idl/objects/GroupIntimacyPushObject;->fromIdl(Ldfi;)Lcom/alibaba/android/search/model/idl/objects/GroupIntimacyPushObject;
...
.method public static fromIdlList(Ljava/util/List;)Ljava/util/List;
    ...
    .prologue
    .line 35
    .local p0, "modelList":Ljava/util/List;, "Ljava/util/List<Ldfo;>;"
    if-eqz p0, :cond_0
    ...
    .line 40
    .local v0, "model":Ldfo;
    invoke-static {v0}, Lcom/alibaba/android/search/model/idl/objects/PushGroupObject;->fromIdl(Ldfo;)Lcom/alibaba/android/search/model/idl/objects/PushGroupObject;
