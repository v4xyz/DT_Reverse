...
.method public static fromIdl(Ldfq;)Lcom/alibaba/android/search/model/idl/objects/PushUserObject;
    .locals 2
    .param p0, "model"    # Ldfq;
    ...
    .line 29
    iget-object v1, p0, Ldfq;->b:Ljava/lang/String;

    iput-object v1, v0, Lcom/alibaba/android/search/model/idl/objects/PushUserObject;->dataType:Ljava/lang/String;

    .line 30
    iget-object v1, p0, Ldfq;->c:Ldfy;

    invoke-static {v1}, Lcom/alibaba/android/search/model/idl/objects/UserIntimacyPushObject;->fromIdl(Ldfy;)Lcom/alibaba/android/search/model/idl/objects/UserIntimacyPushObject;
...
.method public static fromIdlList(Ljava/util/List;)Ljava/util/List;
    ...
    .prologue
    .line 35
    .local p0, "modelList":Ljava/util/List;, "Ljava/util/List<Ldfq;>;"
    if-eqz p0, :cond_0
    ...
    .line 40
    .local v0, "model":Ldfq;
    invoke-static {v0}, Lcom/alibaba/android/search/model/idl/objects/PushUserObject;->fromIdl(Ldfq;)Lcom/alibaba/android/search/model/idl/objects/PushUserObject;
