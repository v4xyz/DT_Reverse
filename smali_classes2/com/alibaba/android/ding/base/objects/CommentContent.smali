...
.method public constructor <init>(Laxb;)V
    ...
    .line 40
    iget-object v0, p1, Laxb;->a:Ljava/lang/Integer;
    ...
    .line 43
    :cond_0
    iget-object v0, p1, Laxb;->d:Ljava/util/Map;
...
.method public static a(Ljava/lang/String;)Lcom/alibaba/android/ding/base/objects/CommentContent;
    ...
    .line 82
    .local v1, "commentText":Lawu;
    sget-object v6, Lcom/alibaba/android/ding/base/objects/CommentContent$CommentContentType;->Text:Lcom/alibaba/android/ding/base/objects/CommentContent$CommentContentType;

    iput-object v6, v1, Lawu;->f:Lcom/alibaba/android/ding/base/objects/CommentContent$CommentContentType;
    ...
    invoke-static {v6}, Lbuf;->e(Ljava/lang/String;)Ljava/util/Map;

    move-result-object v6

    iput-object v6, v1, Lawu;->g:Ljava/util/Map;
    ...
    iput-object v6, v1, Lawu;->a:Ljava/lang/String;
    :try_end_0
    ...
    .line 88
    .local v0, "commentAudio":Lawt;
    sget-object v6, Lcom/alibaba/android/ding/base/objects/CommentContent$CommentContentType;->Text:Lcom/alibaba/android/ding/base/objects/CommentContent$CommentContentType;

    iput-object v6, v0, Lawt;->f:Lcom/alibaba/android/ding/base/objects/CommentContent$CommentContentType;
    ...
    iput-object v6, v0, Lawt;->g:Ljava/util/Map;
    ...
    iput-object v6, v0, Lawt;->a:Ljava/lang/String;
    ...
    invoke-static {v6}, Lbuf;->c(Ljava/lang/String;)Ljava/util/List;

    move-result-object v6

    iput-object v6, v0, Lawt;->c:Ljava/util/List;
    :try_end_1
...
.method public static a(Lcom/alibaba/android/ding/base/objects/CommentContent;)Ljava/lang/String;
    ...
    :cond_0
    instance-of v4, p0, Lawu;

    if-nez v4, :cond_1

    instance-of v4, p0, Lawt;
    ...
    invoke-static {v5}, Lbuf;->a(Ljava/util/Map;)Ljava/lang/String;
    ...
    .end local p0    # "commentContent":Lcom/alibaba/android/ding/base/objects/CommentContent;
    iget-object v5, p0, Lawu;->a:Ljava/lang/String;
    ...
    iget-object v4, v4, Lawt;->a:Ljava/lang/String;
    ...
    .end local p0    # "commentContent":Lcom/alibaba/android/ding/base/objects/CommentContent;
    iget-object v5, p0, Lawt;->c:Ljava/util/List;

    invoke-static {v5}, Lbuf;->b(Ljava/util/List;)Ljava/lang/String;
