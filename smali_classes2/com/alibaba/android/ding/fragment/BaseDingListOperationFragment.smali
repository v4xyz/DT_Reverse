...
.method static synthetic a(Lcom/alibaba/android/ding/fragment/BaseDingListOperationFragment;JLjava/util/List;ILcom/alibaba/android/ding/base/objects/ObjectDing$TypeNotification;Lbsv;)V
    .locals 3
    ...
    invoke-direct {v0, p0, p6}, Lcom/alibaba/android/ding/fragment/BaseDingListOperationFragment$2;-><init>(Lcom/alibaba/android/ding/fragment/BaseDingListOperationFragment;Lbsv;)V
...
# virtual methods
.method protected final a(JILjava/util/List;ILbsv;)V
    .locals 9
    .param p1, "dingId"    # J
    ...
    .local p6, "listener":Lbsv;, "Lbsv<Lcom/alibaba/android/ding/data/object/RemindAgainResultObject;>;"
    ...
    invoke-direct {v7, v0}, Lbwt$a;-><init>(Landroid/content/Context;)V

    .line 35
    .local v7, "builder":Lbwt$a;
    invoke-virtual {v7, p5}, Lbwt$a;->setTitle(I)Landroid/support/v7/app/AlertDialog$Builder;

    .line 36
    sget v8, Lavo$b;->ding_remind_type:I
    ...
    invoke-direct/range {v0 .. v6}, Lcom/alibaba/android/ding/fragment/BaseDingListOperationFragment$1;-><init>(Lcom/alibaba/android/ding/fragment/BaseDingListOperationFragment;JLjava/util/List;ILbsv;)V

    invoke-virtual {v7, v8, v0}, Lbwt$a;->setItems(ILandroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/AlertDialog$Builder;

    .line 51
    const/4 v0, 0x1

    invoke-virtual {v7, v0}, Lbwt$a;->b(Z)Lbwt$a;
