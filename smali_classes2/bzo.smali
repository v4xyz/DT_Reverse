...
.field public b:Lbzo$a;

.field public c:Lbzo$b;
...
.method public constructor <init>(Landroid/app/Activity;Ljava/util/ArrayList;)V
    ...
    .line 66
    iput-object p1, p0, Lbzo;->d:Landroid/app/Activity;

    .line 67
    iput-object p2, p0, Lbzo;->a:Ljava/util/ArrayList;

    .line 68
    new-instance v0, Lbzo$a;

    invoke-direct {v0, p0}, Lbzo$a;-><init>(Lbzo;)V

    iput-object v0, p0, Lbzo;->b:Lbzo$a;

    .line 69
    return-void
.end method

.method static synthetic a(Lbzo;Lbzo$b;)Lbzo$b;
    .locals 0
    .param p0, "x0"    # Lbzo;
    .param p1, "x1"    # Lbzo$b;
    ...
    .prologue
    .line 52
    iput-object p1, p0, Lbzo;->c:Lbzo$b;

    return-object p1
.end method

.method static synthetic a(Lbzo;Lcom/alibaba/android/dingtalkim/channelsource/model/ChannelOrgModel;)V
    .locals 3
    .param p0, "x0"    # Lbzo;
    ...
    iget-object v1, p0, Lbzo;->d:Landroid/app/Activity;
    ...
    new-instance v2, Lbzo$4;

    invoke-direct {v2, p0, p1}, Lbzo$4;-><init>(Lbzo;Lcom/alibaba/android/dingtalkim/channelsource/model/ChannelOrgModel;)V
    ...
    .line 1234
    :cond_1
    invoke-virtual {p0, p1}, Lbzo;->a(Lcom/alibaba/android/dingtalkim/channelsource/model/ChannelOrgModel;)V

    goto :goto_0
.end method

.method static synthetic a(Lbzo;Lcom/alibaba/android/dingtalkim/models/ChannelRequestModel;)V
    .locals 4
    .param p0, "x0"    # Lbzo;
    ...
    .line 1206
    new-instance v1, Lbzo$3;

    invoke-direct {v1, p0, p1}, Lbzo$3;-><init>(Lbzo;Lcom/alibaba/android/dingtalkim/models/ChannelRequestModel;)V

    .line 1219
    iget-object v2, p1, Lcom/alibaba/android/dingtalkim/models/ChannelRequestModel;->a:Lboc;
    ...
    invoke-interface {v0, v2, v3, v1}, Lcom/alibaba/android/dingtalkim/models/idl/service/ChannelIService;->acceptChannelRequest(JLfos;)V

    .line 52
    return-void
.end method

.method static synthetic a(Lbzo;)Z
    .locals 3
    .param p0, "x0"    # Lbzo;
    ...
    .line 52
    .line 1190
    iget-object v0, p0, Lbzo;->a:Ljava/util/ArrayList;
...
.method static synthetic b(Lbzo;)Lbzo$b;
    .locals 1
    .param p0, "x0"    # Lbzo;

    .prologue
    .line 52
    iget-object v0, p0, Lbzo;->c:Lbzo$b;

    return-object v0
.end method

.method static synthetic c(Lbzo;)Lbzo$a;
    .locals 1
    .param p0, "x0"    # Lbzo;

    .prologue
    .line 52
    iget-object v0, p0, Lbzo;->b:Lbzo$a;
...
.method public a(Lcom/alibaba/android/dingtalkim/channelsource/model/ChannelOrgModel;)V
    ...
    iget-object v4, p0, Lbzo;->d:Landroid/app/Activity;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 90
    new-instance v0, Lbzo$c;

    invoke-direct {v0, p0, v6}, Lbzo$c;-><init>(Lbzo;B)V

    .line 91
    .local v0, "holder":Lbzo$c;
    iget-object v2, p0, Lbzo;->d:Landroid/app/Activity;

    invoke-static {v2}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v2

    sget v3, Lbyz$g;->item_channel:I
    ...
    iput-object v2, v0, Lbzo$c;->a:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;

    .line 93
    sget v2, Lbyz$f;->iv_org_auth:I
    ...
    iput-object v2, v0, Lbzo$c;->c:Landroid/widget/ImageView;

    .line 94
    sget v2, Lbyz$f;->name:I
    ...
    iput-object v2, v0, Lbzo$c;->b:Landroid/widget/TextView;

    .line 95
    sget v2, Lbyz$f;->tv_desc:I
    ...
    iput-object v2, v0, Lbzo$c;->d:Landroid/widget/TextView;

    .line 96
    sget v2, Lbyz$f;->btn_attention:I
    ...
    iput-object v2, v0, Lbzo$c;->e:Landroid/widget/Button;

    .line 97
    sget v2, Lbyz$f;->tv_attented:I
    ...
    iput-object v2, v0, Lbzo$c;->f:Landroid/widget/TextView;

    .line 98
    sget v2, Lbyz$f;->progress_bar:I
    ...
    iput-object v2, v0, Lbzo$c;->g:Landroid/widget/ProgressBar;
    ...
    .line 103
    :goto_0
    iget-object v2, p0, Lbzo;->a:Ljava/util/ArrayList;
    ...
    iget-object v2, v0, Lbzo$c;->a:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;

    iget-object v3, v1, Lcom/alibaba/android/dingtalkim/models/ChannelRequestModel;->a:Lboc;

    iget-object v3, v3, Lboc;->b:Ljava/lang/String;

    iget-object v4, v1, Lcom/alibaba/android/dingtalkim/models/ChannelRequestModel;->a:Lboc;

    iget-object v4, v4, Lboc;->c:Ljava/lang/String;
    ...
    .line 105
    iget-object v2, v0, Lbzo$c;->b:Landroid/widget/TextView;
    ...
    .line 106
    iget-object v2, v0, Lbzo$c;->d:Landroid/widget/TextView;
    ...
    .line 108
    iget-object v2, v1, Lcom/alibaba/android/dingtalkim/models/ChannelRequestModel;->a:Lboc;

    iget-object v2, v2, Lboc;->f:Ljava/lang/Integer;
    ...
    .line 109
    iget-object v2, v0, Lbzo$c;->c:Landroid/widget/ImageView;
    ...
    .line 115
    iget-object v2, v0, Lbzo$c;->e:Landroid/widget/Button;

    invoke-virtual {v2, v6}, Landroid/widget/Button;->setVisibility(I)V

    .line 116
    iget-object v2, v0, Lbzo$c;->f:Landroid/widget/TextView;

    invoke-virtual {v2, v5}, Landroid/widget/TextView;->setVisibility(I)V

    .line 117
    iget-object v2, v0, Lbzo$c;->g:Landroid/widget/ProgressBar;
    ...
    new-instance v3, Lbzo$1;

    invoke-direct {v3, p0, v1}, Lbzo$1;-><init>(Lbzo;Lcom/alibaba/android/dingtalkim/models/ChannelRequestModel;)V

    invoke-virtual {v2, v3}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 142
    new-instance v2, Lbzo$2;

    invoke-direct {v2, p0, v1}, Lbzo$2;-><init>(Lbzo;Lcom/alibaba/android/dingtalkim/models/ChannelRequestModel;)V
    ...
    check-cast v0, Lbzo$c;

    .restart local v0    # "holder":Lbzo$c;
    goto :goto_0
