...
# static fields
.field private static volatile b:Lclt;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lclt;->c:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lclt;->d:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lclt;->e:Landroid/util/SparseArray;

    .line 39
    iget-object v0, p0, Lclt;->e:Landroid/util/SparseArray;
...
.method static synthetic a(Lclt;)Ljava/util/HashMap;
    .locals 1
    .param p0, "x0"    # Lclt;

    .prologue
    .line 24
    iget-object v0, p0, Lclt;->c:Ljava/util/HashMap;

    return-object v0
.end method

.method static synthetic a(Lclt;Lclw;Ljava/util/ArrayList;I)V
    .locals 0
    .param p0, "x0"    # Lclt;
    .param p1, "x1"    # Lclw;
    ...
    .prologue
    .line 24
    invoke-direct {p0, p1, p2, p3}, Lclt;->a(Lclw;Ljava/util/ArrayList;I)V

    return-void
.end method

.method private a(Lclw;Ljava/util/ArrayList;I)V
    .locals 9
    .param p1, "params"    # Lclw;
    .param p3, "index"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 106
    .line 1151
    iget-object v0, p1, Lclw;->c:Ljava/lang/Object;
    ...
    .line 1155
    iget-object v0, p1, Lclw;->d:Lcom/alibaba/wukong/Callback;
    ...
    iget-object v0, p1, Lclw;->b:Lcom/alibaba/wukong/im/Conversation;
    ...
    .line 114
    .local v8, "singleParams":Lclz;
    :goto_3
    new-instance v0, Lclt$1;
    ...
    invoke-direct/range {v0 .. v6}, Lclt$1;-><init>(Lclt;Ljava/util/ArrayList;Lcom/alibaba/android/dingtalkim/imtools/forward/ForwardType;Lcom/alibaba/wukong/im/Message;Lclw;I)V

    .line 3040
    iput-object v0, v8, Lcly;->d:Lcom/alibaba/wukong/Callback;
    ...
    .line 141
    iput-object v7, v8, Lclz;->c:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v8}, Lcmf;->a(Lcly;)V

    goto :goto_2

    .line 2045
    .end local v7    # "result":Lcom/alibaba/wukong/im/Message;
    .end local v8    # "singleParams":Lclz;
    :cond_4
    iget-object v0, p1, Lclw;->c:Ljava/lang/Object;
    ...
    iget-object v1, p1, Lclw;->a:Landroid/app/Activity;

    iget-object v2, p1, Lclw;->b:Lcom/alibaba/wukong/im/Conversation;

    invoke-direct {v8, v1, v2, v0}, Lclz;-><init>(Landroid/app/Activity;Lcom/alibaba/wukong/im/Conversation;Lcom/alibaba/wukong/im/Message;)V

    goto :goto_3

    .line 147
    .restart local v8    # "singleParams":Lclz;
    :cond_5
    iget-object v0, p0, Lclt;->e:Landroid/util/SparseArray;
...
.method public final a(Ljava/util/ArrayList;)V
    ...
    .prologue
    .line 62
    .local p1, "paramsList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lclw;>;"
    if-eqz p1, :cond_0
    ...
    .line 64
    iget-object v0, p0, Lclt;->d:Ljava/util/ArrayList;

    invoke-virtual {v0, p1}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    .line 67
    :cond_0
    invoke-virtual {p0}, Lclt;->c()V
...
.method protected final c()V
    ...
    .line 72
    iget-object v3, p0, Lclt;->d:Ljava/util/ArrayList;
    ...
    .line 76
    :cond_1
    iget-boolean v3, p0, Lclt;->a:Z

    if-nez v3, :cond_0

    .line 82
    iput-boolean v5, p0, Lclt;->a:Z
    ...
    .line 85
    .local v1, "params":Lclw;
    invoke-virtual {v1}, Lclw;->b()Z
    ...
    .line 86
    iget-object v3, v1, Lclw;->d:Lcom/alibaba/wukong/Callback;
    ...
    .line 1028
    iget-object v3, v1, Lclw;->c:Ljava/lang/Object;
    ...
    .line 1029
    iget-object v7, v1, Lclw;->b:Lcom/alibaba/wukong/im/Conversation;
    ...
    .line 95
    :cond_5
    iget-object v3, p0, Lclt;->e:Landroid/util/SparseArray;
    ...
    invoke-virtual {v3, v1}, Lcmf;->a(Lcly;)V
    ...
    invoke-direct {p0, v1, v2, v4}, Lclt;->a(Lclw;Ljava/util/ArrayList;I)V
