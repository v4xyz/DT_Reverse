...
.method public static a(Landroid/content/ContentResolver;Ljava/lang/String;JLandroid/location/Location;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;[B[I)Landroid/net/Uri;
    ...
    .line 218
    :goto_0
    invoke-static {v4}, Lflg;->a(Ljava/io/Closeable;)V
    ...
    .restart local v3    # "outputStream":Ljava/io/OutputStream;
    :goto_2
    invoke-static {v3}, Lflg;->a(Ljava/io/Closeable;)V
...
.method public static a(Landroid/content/ContentResolver;Landroid/net/Uri;I)Lflk;
    .locals 6
    .param p0, "cr"    # Landroid/content/ContentResolver;
    ...
    invoke-static {p0, v2, v4, v3, v5}, Lcom/android/camera/ImageManager;->a(Landroid/content/ContentResolver;Lcom/android/camera/ImageManager$DataLocation;IILjava/lang/String;)Lflk;
    ...
    .line 2429
    invoke-static {p0, v2}, Lcom/android/camera/ImageManager;->a(Landroid/content/ContentResolver;Lcom/android/camera/ImageManager$ImageListParam;)Lflk;
    ...
    invoke-static {p0, v2, v3, v3, v0}, Lcom/android/camera/ImageManager;->a(Landroid/content/ContentResolver;Lcom/android/camera/ImageManager$DataLocation;IILjava/lang/String;)Lflk;
...
.method private static a(Landroid/content/ContentResolver;Lcom/android/camera/ImageManager$DataLocation;IILjava/lang/String;)Lflk;
    .locals 2
    .param p0, "cr"    # Landroid/content/ContentResolver;
    ...
    invoke-static {p0, v0}, Lcom/android/camera/ImageManager;->a(Landroid/content/ContentResolver;Lcom/android/camera/ImageManager$ImageListParam;)Lflk;
...
.method private static a(Landroid/content/ContentResolver;Lcom/android/camera/ImageManager$ImageListParam;)Lflk;
    .locals 14
    .param p0, "cr"    # Landroid/content/ContentResolver;
    ...
    invoke-direct {v6, p0, v8}, Lflp;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    .line 294
    .local v5, "l":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lfli;>;"
    if-eqz v1, :cond_3
    ...
    invoke-direct {v12, p0, v13, v9, v0}, Lflm;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;ILjava/lang/String;)V
    ...
    .line 309
    .local v4, "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Lfli;>;"
    :cond_6
    :goto_2
    ...
    .line 2101
    .local v10, "sublist":Lfli;
    invoke-virtual {v10}, Lfli;->b()I
    ...
    .end local v4    # "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Lfli;>;"
    .end local v5    # "l":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lfli;>;"
    .end local v10    # "sublist":Lfli;
    :cond_7
    ...
    .restart local v4    # "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Lfli;>;"
    .restart local v5    # "l":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lfli;>;"
    .restart local v10    # "sublist":Lfli;
    :cond_9
    const/4 v12, 0x0
    ...
    invoke-direct {v11, v12, v9}, Lfln;-><init>([Lflk;I)V
