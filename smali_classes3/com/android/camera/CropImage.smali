...
.field private s:Lflk;

.field private t:Lflj;
...
.method static synthetic a(Lcom/android/camera/CropImage;)V
    ...
    new-instance v5, Lflg$a;

    invoke-direct {v5, p0, v3, v1, v2}, Lflg$a;-><init>(Lcom/android/camera/MonitoredActivity;Ljava/lang/Runnable;Lcom/alibaba/android/dingtalkbase/widgets/dialog/DDProgressDialog;Landroid/os/Handler;)V
...
.method static synthetic b(Lcom/android/camera/CropImage;Landroid/graphics/Bitmap;)V
    ...
    .line 3366
    :cond_0
    invoke-static {v0}, Lflg;->a(Ljava/io/Closeable;)V
    ...
    :goto_3
    invoke-static {v1}, Lflg;->a(Ljava/io/Closeable;)V
    ...
    iget-object v2, p0, Lcom/android/camera/CropImage;->t:Lflj;

    invoke-interface {v2}, Lflj;->a()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/camera/CropImage;->t:Lflj;

    .line 3405
    invoke-interface {v1}, Lflj;->d()Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {v3, v2, v5}, Lcom/android/camera/ImageManager;->a(Landroid/content/ContentResolver;Landroid/net/Uri;I)Lflk;

    move-result-object v3

    iput-object v3, p0, Lcom/android/camera/CropImage;->s:Lflk;

    .line 1169
    iget-object v3, p0, Lcom/android/camera/CropImage;->s:Lflk;

    invoke-interface {v3, v2}, Lflk;->a(Landroid/net/Uri;)Lflj;

    move-result-object v2

    iput-object v2, p0, Lcom/android/camera/CropImage;->t:Lflj;
    ...
    invoke-interface {v2}, Lflj;->f()I

    move-result v2

    iget-object v3, p0, Lcom/android/camera/CropImage;->t:Lflj;

    invoke-interface {v3}, Lflj;->e()I
    ...
    invoke-interface {v2, v5}, Lflj;->a(Z)Landroid/graphics/Bitmap;
    ...
    invoke-interface {v2, v6, v3, v5, v7}, Lflj;->a(IIZZ)Landroid/graphics/Bitmap;
    ...
    .line 1195
    invoke-interface {v2, v6, v8}, Lflj;->a(II)Landroid/graphics/Bitmap;
...
.method protected onDestroy()V
    ...
    .prologue
    .line 445
    iget-object v0, p0, Lcom/android/camera/CropImage;->s:Lflk;
