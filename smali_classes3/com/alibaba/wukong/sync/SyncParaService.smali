...
.method private declared-synchronized select()V
    ...
    check-cast v0, Lcom/alibaba/wukong/auth/aw;

    .line 67
    .local v0, "task":Lcom/alibaba/wukong/auth/aw;
    if-nez v0, :cond_1
    ...
    .line 60
    .end local v0    # "task":Lcom/alibaba/wukong/auth/aw;
    .end local v1    # "trace":Lfbb;
    :catchall_0
    move-exception v2
    ...
    .line 71
    .restart local v0    # "task":Lcom/alibaba/wukong/auth/aw;
    .restart local v1    # "trace":Lfbb;
    :cond_1
    :try_start_5
    sget-object v2, Lcom/alibaba/wukong/sync/SyncParaService;->mRunningTasks:Ljava/util/concurrent/BlockingQueue;
    ...
    .line 72
    invoke-virtual {v0}, Lcom/alibaba/wukong/auth/aw;->run()V
    :try_end_5
...
.method public declared-synchronized startTask(Lcom/alibaba/wukong/auth/ab;Lcom/laiwang/idl/client/push/ReceiverMessageHandler$a;)V
    .locals 5
    ...
    invoke-static {p2, v3}, Lfbc;->a(Lcom/laiwang/idl/client/push/ReceiverMessageHandler$a;Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    invoke-direct {v0, p1, p2}, Lcom/alibaba/wukong/auth/aw;-><init>(Lcom/alibaba/wukong/auth/ab;Lcom/laiwang/idl/client/push/ReceiverMessageHandler$a;)V

    .line 46
    .local v0, "newTask":Lcom/alibaba/wukong/auth/aw;
    sget-object v3, Lcom/alibaba/wukong/sync/SyncParaService;->mWaitingTasks:Ljava/util/concurrent/BlockingQueue;
    ...
    .line 37
    .end local v0    # "newTask":Lcom/alibaba/wukong/auth/aw;
    .end local v1    # "ret":Z
    .end local v2    # "trace":Lfbb;
    :catchall_0
    move-exception v3
    ...
    .line 53
    .restart local v0    # "newTask":Lcom/alibaba/wukong/auth/aw;
    .restart local v1    # "ret":Z
    .restart local v2    # "trace":Lfbb;
    :cond_1
    :try_start_5
    invoke-direct {p0}, Lcom/alibaba/wukong/sync/SyncParaService;->select()V
    :try_end_5
