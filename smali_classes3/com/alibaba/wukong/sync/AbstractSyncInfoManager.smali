...
.field private volatile mSyncInfo:Lcom/alibaba/wukong/auth/as;
...
.method public abstract createTask(Lcom/alibaba/wukong/auth/as;)Lcom/alibaba/wukong/sync/AbstractSyncDownTask;
.end method
...
.method public declared-synchronized getSyncInfo()Lcom/alibaba/wukong/auth/as;
    .locals 8
    ...
    :try_start_0
    iget-object v2, p0, Lcom/alibaba/wukong/sync/AbstractSyncInfoManager;->mSyncInfo:Lcom/alibaba/wukong/auth/as;
    ...
    invoke-virtual {v2}, Lcom/alibaba/wukong/auth/as;->q()Lcom/alibaba/wukong/auth/as;
    :try_end_0
    ...
    .line 47
    :cond_4
    new-instance v1, Lcom/alibaba/wukong/auth/as;

    invoke-direct {v1}, Lcom/alibaba/wukong/auth/as;-><init>()V
    ...
    iput-wide v2, v1, Lcom/alibaba/wukong/auth/as;->aX:J
    ...
    iput-wide v2, v1, Lcom/alibaba/wukong/auth/as;->aY:J
    ...
    iput-wide v2, v1, Lcom/alibaba/wukong/auth/as;->aZ:J
    ...
    iput-wide v2, v1, Lcom/alibaba/wukong/auth/as;->ba:J
    ...
    iput-object v2, v1, Lcom/alibaba/wukong/auth/as;->bb:Ljava/lang/String;
    ...
    iput-object v2, v1, Lcom/alibaba/wukong/auth/as;->bc:Ljava/lang/String;

    .line 55
    iput-object v1, p0, Lcom/alibaba/wukong/sync/AbstractSyncInfoManager;->mSyncInfo:Lcom/alibaba/wukong/auth/as;

    .line 56
    iget-wide v2, v1, Lcom/alibaba/wukong/auth/as;->aX:J

    cmp-long v2, v2, v6

    if-nez v2, :cond_0

    iget-wide v2, v1, Lcom/alibaba/wukong/auth/as;->ba:J
...
.method public declared-synchronized reset()V
    ...
    iput-object v0, p0, Lcom/alibaba/wukong/sync/AbstractSyncInfoManager;->mSyncInfo:Lcom/alibaba/wukong/auth/as;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized updateSyncInfo(Lcom/alibaba/wukong/auth/as;)Z
    .locals 6
    ...
    iget-wide v4, p1, Lcom/alibaba/wukong/auth/as;->aX:J
    ...
    iget-wide v4, p1, Lcom/alibaba/wukong/auth/as;->aY:J
    ...
    iget-wide v4, p1, Lcom/alibaba/wukong/auth/as;->aZ:J
    ...
    iget-wide v4, p1, Lcom/alibaba/wukong/auth/as;->ba:J

    invoke-interface {v0, v2, v4, v5}, Landroid/content/SharedPreferences$Editor;->putLong(Ljava/lang/String;J)Landroid/content/SharedPreferences$Editor;

    .line 78
    iget-object v2, p1, Lcom/alibaba/wukong/auth/as;->bb:Ljava/lang/String;
    ...
    iget-object v3, p1, Lcom/alibaba/wukong/auth/as;->bb:Ljava/lang/String;
    ...
    iput-object v2, p1, Lcom/alibaba/wukong/auth/as;->bc:Ljava/lang/String;

    .line 85
    iput-object p1, p0, Lcom/alibaba/wukong/sync/AbstractSyncInfoManager;->mSyncInfo:Lcom/alibaba/wukong/auth/as;
    ...
    iget-object v2, v2, Lcom/alibaba/wukong/auth/as;->bb:Ljava/lang/String;
    ...
    iput-object v2, p1, Lcom/alibaba/wukong/auth/as;->bb:Ljava/lang/String;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
