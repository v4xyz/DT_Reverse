.class Lcom/alibaba/wukong/auth/ba$1;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/alibaba/wukong/auth/ba;
.end annotation
...
# instance fields
.field final synthetic bD:Lcom/alibaba/wukong/auth/ba;

.field volatile progress:I


# direct methods
.method constructor <init>(Lcom/alibaba/wukong/auth/ba;)V
    .locals 1
    .param p1, "this$0"    # Lcom/alibaba/wukong/auth/ba;

    .prologue
    .line 31
    iput-object p1, p0, Lcom/alibaba/wukong/auth/ba$1;->bD:Lcom/alibaba/wukong/auth/ba;
    ...
    iput v0, p0, Lcom/alibaba/wukong/auth/ba$1;->progress:I
...
.method public onFailed(Lcom/laiwang/protocol/upload/ErrorMsg$EStatus;)V
    ...
    .line 56
    iget-object v3, p0, Lcom/alibaba/wukong/auth/ba$1;->bD:Lcom/alibaba/wukong/auth/ba;

    iget-object v3, v3, Lcom/alibaba/wukong/auth/ba;->bF:Ljava/util/Set;
    ...
    .line 57
    .local v2, "listener":Lfgq;, "Lfgq<Lfgs;>;"
    if-eqz v2, :cond_0

    .line 58
    invoke-interface {v2, v0, v1}, Lfgq;->onException(ILjava/lang/String;)V
    ...
    .end local v2    # "listener":Lfgq;, "Lfgq<Lfgs;>;"
    :cond_1
...
.method public onProgress(JJLcom/laiwang/protocol/upload/UploaderExtra;)V
    ...
    .line 68
    .local v0, "tmp":I
    iget v2, p0, Lcom/alibaba/wukong/auth/ba$1;->progress:I
    ...
    .line 70
    iget-object v2, p0, Lcom/alibaba/wukong/auth/ba$1;->bD:Lcom/alibaba/wukong/auth/ba;

    iget-object v2, v2, Lcom/alibaba/wukong/auth/ba;->bF:Ljava/util/Set;
    ...
    .line 71
    .local v1, "listener":Lfgq;, "Lfgq<Lfgs;>;"
    if-eqz v1, :cond_2

    .line 72
    iget v6, p0, Lcom/alibaba/wukong/auth/ba$1;->progress:I
...
.method public onSuccess(Lcom/laiwang/protocol/upload/UploadResult;)V
    ...
    .line 43
    iget-object v4, p0, Lcom/alibaba/wukong/auth/ba$1;->bD:Lcom/alibaba/wukong/auth/ba;

    iget-object v4, v4, Lcom/alibaba/wukong/auth/ba;->bF:Ljava/util/Set;
    ...
    .line 45
    invoke-interface {v1, v3}, Lfgq;->onSuccess(Ljava/lang/Object;)V

    goto :goto_0

    .line 48
    .end local v1    # "listener":Lfgq;, "Lfgq<Lfgs;>;"
    :cond_1
    return-void
.end method
