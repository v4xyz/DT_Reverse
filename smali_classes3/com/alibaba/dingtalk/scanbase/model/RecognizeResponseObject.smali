...
.method public static fromIDLModel(Lcom/alibaba/dingtalk/scanbase/idl/model/RecognizeResponseModel;)Lcom/alibaba/dingtalk/scanbase/model/RecognizeResponseObject;
    ...
    .line 55
    :cond_1
    new-instance v2, Lcom/alibaba/dingtalk/scanbase/model/RecognizeResponseObject;

    invoke-direct {v2}, Lcom/alibaba/dingtalk/scanbase/model/RecognizeResponseObject;-><init>()V

    .line 56
    .local v2, "object":Lcom/alibaba/dingtalk/scanbase/model/RecognizeResponseObject;
    ...
    iget-object v4, p0, Lcom/alibaba/dingtalk/scanbase/idl/model/RecognizeResponseModel;->infos:Ljava/util/List;
    ...
    iput-object v3, v2, Lcom/alibaba/dingtalk/scanbase/model/RecognizeResponseObject;->results:Ljava/util/List;
    ...
    iget-object v3, v2, Lcom/alibaba/dingtalk/scanbase/model/RecognizeResponseObject;->results:Ljava/util/List;
...
.method public toIDLModel()Lcom/alibaba/dingtalk/scanbase/idl/model/RecognizeResponseModel;
    ...
    .prologue
    .line 67
    new-instance v1, Lcom/alibaba/dingtalk/scanbase/idl/model/RecognizeResponseModel;

    invoke-direct {v1}, Lcom/alibaba/dingtalk/scanbase/idl/model/RecognizeResponseModel;-><init>()V

    .line 69
    .local v1, "model":Lcom/alibaba/dingtalk/scanbase/idl/model/RecognizeResponseModel;
    ...
    iget-object v4, p0, Lcom/alibaba/dingtalk/scanbase/model/RecognizeResponseObject;->results:Ljava/util/List;
    ...
    iput-object v3, v1, Lcom/alibaba/dingtalk/scanbase/idl/model/RecognizeResponseModel;->infos:Ljava/util/List;
    ...
    check-cast v2, Lcom/alibaba/dingtalk/scanbase/model/CardInfoObject;

    .line 73
    .local v2, "object":Lcom/alibaba/dingtalk/scanbase/model/CardInfoObject;
    iget-object v3, v1, Lcom/alibaba/dingtalk/scanbase/idl/model/RecognizeResponseModel;->infos:Ljava/util/List;

    invoke-virtual {v2}, Lcom/alibaba/dingtalk/scanbase/model/CardInfoObject;->toIDLModel()Lcom/alibaba/dingtalk/scanbase/idl/model/CardInfo;
    ...
    .end local v2    # "object":Lcom/alibaba/dingtalk/scanbase/model/CardInfoObject;
    :cond_0
    return-object v1
.end method
