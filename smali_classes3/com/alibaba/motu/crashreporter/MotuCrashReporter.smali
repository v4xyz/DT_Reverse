...
.method public constructor <init>()V
    ...
    .line 19
    invoke-static {}, Lewy;->a()Lewy;

    move-result-object v0

    iput-object v0, p0, Lcom/alibaba/motu/crashreporter/MotuCrashReporter;->mCrashReporter:Lewy;
...
# virtual methods
.method public addCrashReportSendListener(Lexa;)V
    .locals 2
    .param p1, "sendListener"    # Lexa;
    ...
    .prologue
    .line 67
    iget-object v0, p0, Lcom/alibaba/motu/crashreporter/MotuCrashReporter;->mCrashReporter:Lewy;

    .line 1331
    iget-boolean v1, v0, Lewy;->m:Z

    if-eqz v1, :cond_0

    .line 1332
    iget-object v0, v0, Lewy;->i:Lexi;

    .line 2043
    if-eqz p1, :cond_0

    invoke-interface {p1}, Lexa;->a()Ljava/lang/String;

    move-result-object v1

    invoke-static {v1}, Lext;->b(Ljava/lang/CharSequence;)Z
    ...
    .line 2044
    iget-object v0, v0, Lexi;->h:Ljava/util/Map;
...
.method public addNativeHeaderInfo(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lext;->b(Ljava/lang/CharSequence;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {p2}, Lext;->b(Ljava/lang/CharSequence;)Z
    ...
    .line 9309
    iget-object v0, v0, Lewy;->j:Lcom/alibaba/motu/crashreporter/CatcherManager;
...
.method public enable(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/alibaba/motu/crashreporter/ReporterConfigure;)Z
    ...
    invoke-static {p2}, Lext;->a(Ljava/lang/CharSequence;)Z
...
.method public enable(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/alibaba/motu/crashreporter/ReporterConfigure;)Z
    ...
    .line 97
    :try_start_0
    new-instance v18, Leww;

    invoke-direct/range {v18 .. v18}, Leww;-><init>()V

    .line 98
    .local v18, "configuration":Leww;
    if-eqz p7, :cond_0

    .line 99
    new-instance v2, Lexd$a;
    ...
    invoke-direct {v2, v3, v4}, Lexd$a;-><init>(Ljava/lang/String;Ljava/lang/Object;)V

    move-object/from16 v0, v18

    invoke-virtual {v0, v2}, Leww;->a(Lexd$a;)V
    ...
    iget-object v0, v0, Lcom/alibaba/motu/crashreporter/MotuCrashReporter;->mCrashReporter:Lewy;
    ...
    iget-object v2, v0, Lewy;->l:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {v3, v2}, Lexc;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-boolean v2, v0, Lewy;->m:Z

    if-eqz v2, :cond_1

    move-object/from16 v0, v20

    iget-object v2, v0, Lewy;->p:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v2, v0, Lewy;->j:Lcom/alibaba/motu/crashreporter/CatcherManager;
    ...
    iget-object v2, v0, Lewy;->q:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v2, v0, Lewy;->i:Lexi;

    .line 5062
    iget-object v3, v2, Lexi;->d:Lexf;

    invoke-virtual {v3}, Lexf;->a()[Lewx;

    move-result-object v3

    .line 5063
    invoke-virtual {v2, v3}, Lexi;->a([Lewx;)V
    :try_end_5
    ...
    iget-object v3, v0, Lcom/alibaba/motu/crashreporter/MotuCrashReporter;->mCrashReporter:Lewy;

    .line 5190
    iget-boolean v2, v3, Lewy;->m:Z

    if-eqz v2, :cond_9

    iget-boolean v2, v3, Lewy;->o:Z

    if-nez v2, :cond_9

    iget-object v2, v3, Lewy;->n:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 5193
    iget-object v2, v3, Lewy;->j:Lcom/alibaba/motu/crashreporter/CatcherManager;
    ...
    :cond_6
    :goto_3
    iget-object v2, v3, Lewy;->k:Lexb;

    .line 7030
    iget-object v6, v2, Lexb;->b:Leww;

    const-string/jumbo v7, "Configuration.disableJitCompilation"

    const/4 v8, 0x1

    invoke-virtual {v6, v7, v8}, Leww;->a(Ljava/lang/String;Z)Z
    ...
    .line 7037
    iget-object v2, v2, Lexb;->d:Lexo;

    invoke-virtual {v2}, Lexo;->a()V

    .line 5195
    :cond_8
    const/4 v2, 0x1

    iput-boolean v2, v3, Lewy;->o:Z
    ...
    .line 118
    .end local v18    # "configuration":Leww;
    :goto_4
    return v2

    .line 3066
    .restart local v18    # "configuration":Leww;
    :cond_a
    :try_start_9
    invoke-static/range {p2 .. p2}, Lext;->a(Ljava/lang/CharSequence;)Z
    ...
    .line 3068
    :cond_b
    invoke-static/range {p3 .. p3}, Lext;->a(Ljava/lang/CharSequence;)Z
    ...
    iput-object v2, v0, Lewy;->b:Landroid/content/Context;

    .line 3073
    move-object/from16 v0, v20

    iget-object v2, v0, Lewy;->b:Landroid/content/Context;
    ...
    iput-object v0, v1, Lewy;->b:Landroid/content/Context;
    ...
    iget-object v5, v0, Lewy;->b:Landroid/content/Context;

    invoke-direct {v4, v5}, Lexg;-><init>(Landroid/content/Context;)V

    move-object/from16 v0, v20

    iput-object v4, v0, Lewy;->e:Lexg;

    .line 3086
    move-object/from16 v0, v20

    iget-object v4, v0, Lewy;->e:Lexg;

    new-instance v5, Lexe$a;
    ...
    invoke-direct {v5, v6, v7}, Lexe$a;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v4, v5}, Lexg;->a(Lexe$a;)V
    ...
    invoke-direct {v5, v6, v0, v7}, Lexe$a;-><init>(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-static {v0, v7}, Lext;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 3092
    invoke-static {}, Lexk;->a()Ljava/lang/String;

    move-result-object v4

    move-object/from16 v0, v20

    iput-object v4, v0, Lewy;->c:Ljava/lang/String;

    .line 3093
    move-object/from16 v0, v20

    iget-object v4, v0, Lewy;->c:Ljava/lang/String;
    ...
    .line 3094
    invoke-static/range {p1 .. p1}, Lexk;->f(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v4, v5}, Lext;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v7, v0, Lewy;->c:Ljava/lang/String;

    const/4 v10, 0x1

    invoke-direct {v5, v6, v7, v10}, Lexe$a;-><init>(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iget-object v5, v0, Lewy;->c:Ljava/lang/String;

    move-object/from16 v0, p1

    invoke-direct {v4, v0, v5}, Lexj;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    move-object/from16 v0, v20

    iput-object v4, v0, Lewy;->f:Lexj;
    ...
    iget-object v6, v0, Lewy;->e:Lexg;

    move-object/from16 v0, v20

    iget-object v7, v0, Lewy;->d:Leww;

    move-object/from16 v0, v20

    iget-object v10, v0, Lewy;->f:Lexj;

    invoke-direct {v4, v5, v6, v7, v10}, Lexf;-><init>(Landroid/content/Context;Lexg;Leww;Lexj;)V

    move-object/from16 v0, v20

    iput-object v4, v0, Lewy;->h:Lexf;
    ...
    iget-object v10, v0, Lewy;->h:Lexf;

    invoke-direct {v4, v5, v6, v7, v10}, Lexi;-><init>(Landroid/content/Context;Lexg;Leww;Lexf;)V

    move-object/from16 v0, v20

    iput-object v4, v0, Lewy;->i:Lexi;
    ...
    invoke-direct/range {v2 .. v10}, Lexh;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JLexj;)V

    move-object/from16 v0, v20

    iput-object v2, v0, Lewy;->g:Lexh;

    .line 3119
    move-object/from16 v0, v20

    iget-object v3, v0, Lewy;->g:Lexh;

    new-instance v4, Lewy$a;

    move-object/from16 v0, v20

    invoke-direct {v4, v0}, Lewy$a;-><init>(Lewy;)V

    .line 4082
    const/4 v2, 0x0

    .line 4085
    iget-object v5, v3, Lexh;->d:Lexh$a;

    iget v5, v5, Lexh$a;->n:I
    ...
    .line 4090
    :cond_10
    iget-object v5, v3, Lexh;->e:Lexh$a;

    if-eqz v5, :cond_11

    iget-object v5, v3, Lexh;->d:Lexh$a;

    iget-wide v6, v5, Lexh$a;->f:J

    iget-object v3, v3, Lexh;->e:Lexh$a;

    iget-wide v10, v3, Lexh$a;->f:J
    ...
    .line 4162
    iget-object v2, v4, Lewy$a;->a:Lewy;

    iget-object v2, v2, Lewy;->c:Ljava/lang/String;

    invoke-static {v2}, Lexk;->b(Ljava/lang/String;)Ljava/lang/Boolean;
    ...
    iget-object v4, v4, Lewy$a;->a:Lewy;

    iget-object v4, v4, Lewy;->c:Ljava/lang/String;
    ...
    iget-object v2, v2, Lewy;->b:Landroid/content/Context;

    iget-object v3, v4, Lewy$a;->a:Lewy;

    iget-object v3, v3, Lewy;->c:Ljava/lang/String;

    invoke-static {v2, v3}, Lexk;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/Boolean;
    ...
    invoke-static {}, Lexk;->b()Ljava/lang/Boolean;
    ...
    iget-object v2, v2, Lewy;->d:Leww;

    const-string/jumbo v3, "Configuration.enableUIProcessSafeGuard"

    const/4 v5, 0x0

    invoke-virtual {v2, v3, v5}, Leww;->a(Ljava/lang/String;Z)Z
    ...
    invoke-static {v2}, Lexk;->g(Landroid/content/Context;)V
    ...
    iget-object v12, v0, Lewy;->c:Ljava/lang/String;

    move-object/from16 v0, v20

    iget-object v13, v0, Lewy;->e:Lexg;

    move-object/from16 v0, v20

    iget-object v14, v0, Lewy;->d:Leww;

    move-object/from16 v0, v20

    iget-object v15, v0, Lewy;->f:Lexj;

    move-object/from16 v0, v20

    iget-object v0, v0, Lewy;->h:Lexf;
    ...
    invoke-direct/range {v10 .. v17}, Lcom/alibaba/motu/crashreporter/CatcherManager;-><init>(Landroid/content/Context;Ljava/lang/String;Lexg;Leww;Lexj;Lexf;Lexi;)V

    move-object/from16 v0, v20

    iput-object v10, v0, Lewy;->j:Lcom/alibaba/motu/crashreporter/CatcherManager;
    ...
    iget-object v6, v0, Lewy;->d:Leww;

    move-object/from16 v0, v20

    iget-object v7, v0, Lewy;->j:Lcom/alibaba/motu/crashreporter/CatcherManager;

    invoke-direct {v4, v5, v6, v7}, Lexb;-><init>(Landroid/content/Context;Leww;Lcom/alibaba/motu/crashreporter/CatcherManager;)V

    move-object/from16 v0, v20

    iput-object v4, v0, Lewy;->k:Lexb;
    ...
    iget-object v3, v0, Lewy;->p:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v3, v0, Lewy;->q:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :try_start_11
    iget-object v3, v3, Lewy;->n:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {v7, v6}, Lexc;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_12
...
.method public getMyListenerList()Ljava/util/List;
    ...
    .line 149
    iget-object v1, p0, Lcom/alibaba/motu/crashreporter/MotuCrashReporter;->mCrashReporter:Lewy;

    .line 11324
    iget-boolean v2, v1, Lewy;->m:Z

    if-eqz v2, :cond_0

    .line 11325
    iget-object v1, v1, Lewy;->j:Lcom/alibaba/motu/crashreporter/CatcherManager;
...
.method public isTaobaoApplication(Landroid/content/Context;)Z
    ...
    iget-object v0, v0, Lewy;->c:Ljava/lang/String;
...
.method public removeCrashReportSendListener(Lexa;)V
    .locals 2
    .param p1, "sendListener"    # Lexa;
...
.method public setAppVersion(Ljava/lang/String;)V
    ...
    .line 7297
    new-instance v1, Lexe$a;

    const-string/jumbo v2, "APP_VERSION"

    invoke-direct {v1, v2, p1}, Lexe$a;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v0, v1}, Lewy;->a(Lexe$a;)V
    ...
    .line 8381
    :try_start_0
    iget-object v1, v0, Lcom/alibaba/motu/crashreporter/CatcherManager$b;->i:Lcom/alibaba/motu/crashreporter/CatcherManager;

    iget-object v1, v1, Lcom/alibaba/motu/crashreporter/CatcherManager;->c:Lexg;

    const-string/jumbo v2, "APP_VERSION"

    invoke-virtual {v1, v2}, Lexg;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v3, v4}, Lexg;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iget-object v0, v0, Lcom/alibaba/motu/crashreporter/CatcherManager$b;->i:Lcom/alibaba/motu/crashreporter/CatcherManager;

    iget-object v0, v0, Lcom/alibaba/motu/crashreporter/CatcherManager;->c:Lexg;

    const-string/jumbo v3, "APP_BUILD"

    const-string/jumbo v4, ""

    invoke-virtual {v0, v3, v4}, Lexg;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public setCrashCaughtListener(Lcom/alibaba/motu/crashreporter/IUTCrashCaughtListener;)V
    ...
    invoke-virtual {v0, v1}, Lewy;->a(Lcom/alibaba/motu/crashreporter/CatcherManager$d;)V

    .line 61
    return-void
.end method

.method public setCrashCaughtListener(Lgjo;)V
    .locals 2
    .param p1, "handlerWapper"    # Lgjo;
    ...
    invoke-direct {v1, p0, p1}, Lcom/alibaba/motu/crashreporter/MotuCrashReporter$1;-><init>(Lcom/alibaba/motu/crashreporter/MotuCrashReporter;Lgjo;)V
...
.method public setCrashReportDataListener(Lewz;)V
    .locals 0
    .param p1, "crashReportDataListener"    # Lewz;
...
.method public setTTid(Ljava/lang/String;)V
    ...
    .prologue
    .line 139
    invoke-static {p1}, Lext;->a(Ljava/lang/CharSequence;)Z
