...
# virtual methods
.method public final a(Ldoj;ZLandroid/view/View;)V
    .locals 9
    .param p1, "avatar"    # Ldoj;
    ...
    invoke-direct {v8, v0, v1, v6, v7}, Ldoi;-><init>(FFFF)V

    .line 1045
    .local v8, "rotation":Ldoi;
    iput-boolean v2, v8, Ldoi;->b:Z
    ...
    invoke-virtual {v8, v0, v1}, Ldoi;->setDuration(J)V

    .line 52
    invoke-virtual {v8, v2}, Ldoi;->setFillAfter(Z)V
    ...
    invoke-virtual {v8, v0}, Ldoi;->setInterpolator(Landroid/view/animation/Interpolator;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/alibaba/android/teleconf/widget/TeleConfImageView$a;-><init>(Lcom/alibaba/android/teleconf/widget/TeleConfImageView;Ldoj;ZLandroid/view/View;B)V

    invoke-virtual {v8, v0}, Ldoi;->setAnimationListener(Landroid/view/animation/Animation$AnimationListener;)V
