...
# direct methods
.method public constructor <init>(Lcom/alibaba/android/teleconf/widget/TeleConfImageView;Ldoj;ZLandroid/view/View;)V
    .locals 0
    .param p2, "avatar"    # Ldoj;
    .param p3, "isFront"    # Z
    ...
    .line 83
    iput-object p2, p0, Lcom/alibaba/android/teleconf/widget/TeleConfImageView$c;->a:Ldoj;
...
.method public final run()V
    ...
    invoke-direct {v2, v6, v5, v0, v1}, Ldoi;-><init>(FFFF)V

    .line 91
    .local v2, "rotation":Ldoi;
    iget-object v3, p0, Lcom/alibaba/android/teleconf/widget/TeleConfImageView$c;->a:Ldoj;
    ...
    iget-object v4, p0, Lcom/alibaba/android/teleconf/widget/TeleConfImageView$c;->a:Ldoj;
    ...
    iget-object v5, p0, Lcom/alibaba/android/teleconf/widget/TeleConfImageView$c;->a:Ldoj;
    ...
    invoke-virtual {v3, v4, v5}, Lcom/alibaba/android/teleconf/widget/TeleConfImageView;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v4, v5}, Ldoi;->setDuration(J)V

    .line 101
    const/4 v3, 0x1

    invoke-virtual {v2, v3}, Ldoi;->setFillAfter(Z)V
    ...
    invoke-virtual {v2, v3}, Ldoi;->setInterpolator(Landroid/view/animation/Interpolator;)V
    ...
    invoke-virtual {v2, v3}, Ldoi;->setAnimationListener(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    .line 95
    .end local v2    # "rotation":Ldoi;
    :cond_1
    iget-object v3, p0, Lcom/alibaba/android/teleconf/widget/TeleConfImageView$c;->b:Lcom/alibaba/android/teleconf/widget/TeleConfImageView;

    sget v4, Ldjt$g;->conf_icon_offline:I
    ...
    .restart local v2    # "rotation":Ldoi;
    goto :goto_0
.end method
