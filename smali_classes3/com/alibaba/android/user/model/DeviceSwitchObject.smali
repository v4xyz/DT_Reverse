...
.method public static fromIDLModel(Ldxr;)Lcom/alibaba/android/user/model/DeviceSwitchObject;
    .locals 5
    .param p0, "model"    # Ldxr;
    ...
    iget-object v4, p0, Ldxr;->b:Ljava/lang/Boolean;
...
.method public static fromIdlList(Ljava/util/List;)Ljava/util/List;
    ...
    .prologue
    .line 52
    .local p0, "deviceSwitchModelList":Ljava/util/List;, "Ljava/util/List<Ldxr;>;"
    if-eqz p0, :cond_0
    ...
    .line 59
    .local v0, "deviceSwitchModel":Ldxr;
    if-eqz v0, :cond_3

    .line 63
    invoke-static {v0}, Lcom/alibaba/android/user/model/DeviceSwitchObject;->fromIDLModel(Ldxr;)Lcom/alibaba/android/user/model/DeviceSwitchObject;
...
.method public toIDLModel()Ldxr;
    ...
    iput-object v1, v0, Ldxr;->a:Ljava/lang/String;
    ...
    iput-object v1, v0, Ldxr;->b:Ljava/lang/Boolean;
