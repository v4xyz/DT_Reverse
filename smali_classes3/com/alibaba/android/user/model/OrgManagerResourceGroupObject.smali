...
.method public static fromIDLModel(Ldyi;)Lcom/alibaba/android/user/model/OrgManagerResourceGroupObject;
    .locals 5
    .param p0, "model"    # Ldyi;
    ...
    .line 43
    .local v1, "resource":Ldyj;
    if-eqz v1, :cond_3

    .line 46
    iget-object v3, v0, Lcom/alibaba/android/user/model/OrgManagerResourceGroupObject;->sysResources:Ljava/util/List;

    invoke-static {v1}, Lcom/alibaba/android/user/model/OrgManagerResourceObject;->fromIDLModel(Ldyj;)Lcom/alibaba/android/user/model/OrgManagerResourceObject;
    ...
    .line 51
    .end local v1    # "resource":Ldyj;
    :cond_4
    iget-object v2, p0, Ldyi;->c:Ljava/util/List;
    ...
    iget-object v3, p0, Ldyi;->c:Ljava/util/List;
    ...
    .line 54
    .restart local v1    # "resource":Ldyj;
    if-eqz v1, :cond_5
...
.method public toIDLModel()Ldyi;
    ...
    invoke-virtual {v2}, Lcom/alibaba/android/user/model/OrgManagerResourceObject;->toIDLModel()Ldyj;

    move-result-object v2

    iput-object v2, v0, Ldyi;->a:Ldyj;
    ...
    iput-object v2, v0, Ldyi;->b:Ljava/util/List;
    ...
    .line 79
    iget-object v3, v0, Ldyi;->b:Ljava/util/List;

    invoke-virtual {v1}, Lcom/alibaba/android/user/model/OrgManagerResourceObject;->toIDLModel()Ldyj;
    ...
    iput-object v2, v0, Ldyi;->c:Ljava/util/List;
    ...
    .line 91
    iget-object v3, v0, Ldyi;->c:Ljava/util/List;
