...
.method public static fromIdlModel(Ldxt;)Lcom/alibaba/android/user/model/ExtContactFieldsObject;
    .locals 5
    .param p0, "model"    # Ldxt;
    ...
    iget-object v2, p0, Ldxt;->a:Ldyf;

    invoke-static {v2}, Lcom/alibaba/android/user/model/OrgExtFieldObject;->fromIdlModel(Ldyf;)Lcom/alibaba/android/user/model/OrgExtFieldObject;
    ...
    .line 40
    iget-object v2, p0, Ldxt;->h:Ljava/util/List;
    ...
    .line 43
    .local v1, "orgExtFieldModel":Ldyf;
    if-eqz v1, :cond_1

    .line 44
    iget-object v3, v0, Lcom/alibaba/android/user/model/ExtContactFieldsObject;->extFields:Ljava/util/List;

    invoke-static {v1}, Lcom/alibaba/android/user/model/OrgExtFieldObject;->fromIdlModel(Ldyf;)Lcom/alibaba/android/user/model/OrgExtFieldObject;
    ...
    .line 49
    .end local v1    # "orgExtFieldModel":Ldyf;
    :cond_2
    iget-object v2, p0, Ldxt;->i:Ljava/lang/Boolean;
