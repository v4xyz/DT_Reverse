...
.field private y:Ldvw;

.field private z:Lbws;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->M:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->N:Lbtq;
...
.method private a(I)V
    ...
    .line 504
    iget-object v5, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->z:Lbws;
    ...
    invoke-direct {v5, v6}, Lbws;-><init>(Landroid/content/Context;)V

    iput-object v5, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->z:Lbws;
    ...
    .line 7217
    iput-object v6, v5, Lbws;->c:Ljava/lang/String;
    ...
    invoke-virtual {v6, v8, v9}, Lblv;->e(J)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v5, v6}, Lbws;->a(Ljava/lang/String;)V
    ...
    sget v7, Ldop$d;->color_water_font_white:I
    ...
    invoke-virtual {v5, p1}, Lbws;->a(I)V

    .line 512
    iget-object v5, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->j:Lcom/alibaba/android/dingtalkbase/widgets/views/MotionTrackListView;

    iget-object v6, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->z:Lbws;
    ...
    invoke-virtual {v5, v6, v7}, Lblv;->e(J)Ljava/lang/String;
    ...
    invoke-static {v5, v4, v3, v1}, Lbwr;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)Landroid/graphics/Bitmap;
    ...
    sget v7, Ldop$d;->uidic_global_color_6_5:I
...
.method private a(ZZ)V
    ...
    iget-object v5, v0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->y:Ldvw;
    ...
    iget-object v7, v0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->L:Lcom/alibaba/android/dingtalk/userbase/model/FilterObject;

    .line 3100
    new-instance v8, Ldvw$1;

    move/from16 v0, p1

    move-object/from16 v1, p0

    invoke-direct {v8, v5, v0, v1}, Ldvw$1;-><init>(Ldvw;ZLdsp;)V
    ...
    sget v6, Lcom/alibaba/android/dingtalk/search/base/BaseSearchConsts;->a:I
    ...
    .line 3145
    invoke-interface/range {v2 .. v8}, Ldoz;->a(Ljava/lang/String;Ljava/lang/Long;Ljava/lang/Integer;Ljava/lang/Integer;Lcom/alibaba/android/dingtalk/userbase/model/FilterObject;Lbsv;)V
    ...
    iget-object v2, v0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->y:Ldvw;
    ...
    iget-object v10, v0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->L:Lcom/alibaba/android/dingtalk/userbase/model/FilterObject;
    ...
    invoke-virtual/range {v2 .. v11}, Ldvw;->a(Lcom/alibaba/android/dingtalk/userbase/model/OrgNodeItemObject;Ljava/lang/String;IJZILcom/alibaba/android/dingtalk/userbase/model/FilterObject;Ldsp;)V
    ...
    invoke-virtual {v6}, Lblv;->h()Ljava/lang/Long;
...
.method private b(Z)V
    ...
    .line 252
    iget-object v6, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->b:Ldsm;

    if-eqz v6, :cond_1

    iget-object v6, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->a:Ldsm;

    if-eqz v6, :cond_1

    .line 253
    iget-object v6, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->y:Ldvw;

    .line 3068
    iget-object v3, v6, Ldvw;->c:Ljava/util/List;
    ...
    :cond_1
    :goto_1
    iget-object v6, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->c:Ldvv;

    invoke-virtual {v6}, Ldvv;->notifyDataSetChanged()V
...
.method static synthetic g(Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;)Lbtq;
    .locals 1
    .param p0, "x0"    # Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;

    .prologue
    .line 70
    iget-object v0, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->N:Lbtq;
...
.method static synthetic j(Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;)Ldvw;
    .locals 1
    .param p0, "x0"    # Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;

    .prologue
    .line 70
    iget-object v0, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->y:Ldvw;

    return-object v0
.end method

.method static synthetic k(Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;)Ldvv;
    .locals 1
    .param p0, "x0"    # Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;

    .prologue
    .line 70
    iget-object v0, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->c:Ldvv;
...
.method public final a(Z)V
    ...
    iget-object v1, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->c:Ldvv;

    invoke-virtual {v1}, Ldvv;->a()Z
...
.method public final a(ZI)V
    ...
    iget-object v1, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->K:Landroid/view/View;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->y:Ldvw;

    .line 2068
    iget-object v3, v3, Ldvw;->c:Ljava/util/List;
    ...
    invoke-direct {v1, v2, v3, v4, v5}, Ldvv;-><init>(Landroid/app/Activity;Ljava/util/List;I[Ldsm;)V

    iput-object v1, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->c:Ldvv;
    ...
    .line 2168
    iput-object v2, v1, Ldvv;->a:Lcom/alibaba/android/dingtalk/userbase/model/OrgNodeItemObject;

    .line 212
    iget-object v1, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->c:Ldvv;

    iget-object v2, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->L:Lcom/alibaba/android/dingtalk/userbase/model/FilterObject;

    iget-object v2, v2, Lcom/alibaba/android/dingtalk/userbase/model/FilterObject;->appId:Ljava/lang/String;

    .line 2172
    iput-object v2, v1, Ldvv;->b:Ljava/lang/String;
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 459
    iget-object v0, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->i:Ldso;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 135
    iget-object v1, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->G:Landroid/os/Bundle;
    ...
    iput-object v1, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->L:Lcom/alibaba/android/dingtalk/userbase/model/FilterObject;

    .line 141
    iget-object v1, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->L:Lcom/alibaba/android/dingtalk/userbase/model/FilterObject;
    ...
    iget-object v2, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->G:Landroid/os/Bundle;
    ...
    iput-object v1, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->i:Ldso;
    ...
    invoke-direct {v1, v2}, Ldvw;-><init>(Landroid/app/Activity;)V

    iput-object v1, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->y:Ldvw;
    ...
    iput-object v1, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->d:Lbqv$a;
    ...
    iget-object v2, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->d:Lbqv$a;
    ...
    iget-object v2, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->M:Landroid/content/BroadcastReceiver;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 158
    iget-object v0, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->H:Landroid/view/View;
...
.method public onDestroy()V
    ...
    iget-object v1, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->d:Lbqv$a;
    ...
    iput-object v0, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->d:Lbqv$a;
    ...
    iget-object v1, p0, Lcom/alibaba/android/user/crm/follower/CustomerFollowerFragment;->M:Landroid/content/BroadcastReceiver;
