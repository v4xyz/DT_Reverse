...
.method public final a(Lcom/alibaba/android/user/model/OrgManagerResourceGroupObject;)V
    ...
    .line 99
    :cond_0
    iget-object v0, p0, Lcom/alibaba/android/user/contact/managersetting/GrantResourcesActivity;->b:Ldsf;
    ...
    .line 2106
    invoke-virtual {v0, v1}, Ldsf;->a(Lcom/alibaba/android/user/model/OrgManagerResourceGroupObject;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 35
    sget v4, Ldop$h;->activity_grant_resources:I
    ...
    invoke-direct {v4, p0, p0}, Ldsg;-><init>(Landroid/app/Activity;Ldse$b;)V
    ...
    invoke-static {v4, v6, v10, v11}, Lbux;->a(Landroid/content/Intent;Ljava/lang/String;J)J
    ...
    invoke-static {v4, v6, v5}, Lecm;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v4, v6}, Lbux;->b(Landroid/content/Intent;Ljava/lang/String;)Ljava/io/Serializable;
    ...
    sget v6, Ldop$j;->dt_contact_subManager_assignPermission:I
    ...
    .line 57
    :cond_1
    sget v4, Ldop$g;->lv_grant_resources:I
    ...
    invoke-direct {v4, p0}, Ldsf;-><init>(Landroid/app/Activity;)V

    iput-object v4, p0, Lcom/alibaba/android/user/contact/managersetting/GrantResourcesActivity;->b:Ldsf;
    ...
    .line 60
    iget-object v6, p0, Lcom/alibaba/android/user/contact/managersetting/GrantResourcesActivity;->b:Ldsf;
    ...
    iput-object v4, v6, Ldsf;->a:Ljava/util/HashSet;

    .line 62
    :cond_3
    iget-object v4, p0, Lcom/alibaba/android/user/contact/managersetting/GrantResourcesActivity;->a:Landroid/widget/ListView;

    iget-object v5, p0, Lcom/alibaba/android/user/contact/managersetting/GrantResourcesActivity;->b:Ldsf;
    ...
    .line 66
    iget-object v4, p0, Lcom/alibaba/android/user/contact/managersetting/GrantResourcesActivity;->c:Ldse$a;

    invoke-interface {v4, v2, v3}, Ldse$a;->a(J)V
    ...
    .line 1251
    iget-object v5, v6, Ldsf;->a:Ljava/util/HashSet;
...
.method protected onDestroy()V
    ...
    .prologue
    .line 85
    iget-object v0, p0, Lcom/alibaba/android/user/contact/managersetting/GrantResourcesActivity;->c:Ldse$a;
    ...
    invoke-interface {v0}, Ldse$a;->b()V

    .line 87
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/alibaba/android/user/contact/managersetting/GrantResourcesActivity;->c:Ldse$a;
...
.method public bridge synthetic setPresenter(Lbqn;)V
    ...
    .prologue
    .line 25
    check-cast p1, Ldse$a;

    .line 3104
    iput-object p1, p0, Lcom/alibaba/android/user/contact/managersetting/GrantResourcesActivity;->c:Ldse$a;
