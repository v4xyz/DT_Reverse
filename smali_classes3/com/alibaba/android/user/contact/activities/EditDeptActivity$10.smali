...
.method public final synthetic onDataReceived(Ljava/lang/Object;)V
    ...
    invoke-static {v0, p1}, Lcom/alibaba/android/user/contact/activities/EditDeptActivity;->a(Lcom/alibaba/android/user/contact/activities/EditDeptActivity;Ldzz;)Ldzz;
    ...
    invoke-static {v0}, Lcom/alibaba/android/user/contact/activities/EditDeptActivity;->a(Lcom/alibaba/android/user/contact/activities/EditDeptActivity;)Ldzz;
    ...
    invoke-static {v3}, Lcom/alibaba/android/user/contact/activities/EditDeptActivity;->a(Lcom/alibaba/android/user/contact/activities/EditDeptActivity;)Ldzz;

    move-result-object v3

    iget-object v3, v3, Ldzz;->b:Lcom/alibaba/android/dingtalk/userbase/model/OrgDeptObject;
    ...
    iget-object v0, v0, Ldyb;->a:Ljava/lang/Boolean;
    ...
    sget v3, Ldop$j;->org_enterprise_group_created:I
    ...
    iget-object v0, v0, Ldyb;->c:Ljava/lang/Boolean;
    ...
    iget-object v3, v3, Ldzz;->f:Leaa;

    invoke-static {v0, v3}, Lcom/alibaba/android/user/contact/activities/EditDeptActivity;->a(Lcom/alibaba/android/user/contact/activities/EditDeptActivity;Leaa;)Leaa;

    .line 1240
    iget-object v0, p0, Lcom/alibaba/android/user/contact/activities/EditDeptActivity$10;->a:Lcom/alibaba/android/user/contact/activities/EditDeptActivity;

    invoke-static {v0}, Lcom/alibaba/android/user/contact/activities/EditDeptActivity;->e(Lcom/alibaba/android/user/contact/activities/EditDeptActivity;)Leaa;

    move-result-object v0

    iget-boolean v3, v0, Leaa;->b:Z
    ...
    invoke-virtual {v0}, Lcom/alibaba/android/dingtalkbase/uidic/cell/ToggleCell;->getModel()Lbtw;

    move-result-object v0

    .line 1242
    invoke-virtual {v0, v3}, Lbtw;->a(Z)V
    ...
    invoke-virtual {v4, v0}, Lcom/alibaba/android/dingtalkbase/uidic/cell/ToggleCell;->a(Lbtw;)V
    ...
    sget v3, Ldop$j;->dt_group_manage_dept_edit_external_permission_off_intro:I
    ...
    iget-object v3, v3, Ldzz;->g:Leaa;

    iput-object v3, v0, Lcom/alibaba/android/user/contact/activities/EditDeptActivity;->a:Leaa;

    .line 1251
    iget-object v0, p0, Lcom/alibaba/android/user/contact/activities/EditDeptActivity$10;->a:Lcom/alibaba/android/user/contact/activities/EditDeptActivity;

    iget-object v0, v0, Lcom/alibaba/android/user/contact/activities/EditDeptActivity;->a:Leaa;

    iget-boolean v0, v0, Leaa;->b:Z
    ...
    invoke-virtual {v3}, Lcom/alibaba/android/dingtalkbase/uidic/cell/ToggleCell;->getModel()Lbtw;

    move-result-object v3

    .line 1253
    invoke-virtual {v3, v0}, Lbtw;->a(Z)V
    ...
    invoke-virtual {v4, v3}, Lcom/alibaba/android/dingtalkbase/uidic/cell/ToggleCell;->a(Lbtw;)V
    ...
    sget v2, Ldop$j;->dt_group_manage_dept_edit_internal_permission_off_intro:I
    ...
    sget v3, Ldop$j;->org_enterprise_group_uncreated:I
    ...
    sget v3, Ldop$j;->setting_hide_dept_tips:I
    ...
    sget v2, Ldop$j;->setting_see_myself_tips:I
