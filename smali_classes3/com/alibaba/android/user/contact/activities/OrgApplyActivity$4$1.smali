.class final Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4$1;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4;
.end annotation
...
.field final synthetic b:Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4;


# direct methods
.method constructor <init>(Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4;Lcom/alibaba/android/dingtalk/userbase/model/OrgApplyObjectList;)V
    .locals 0
    .param p1, "this$1"    # Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4;

    .prologue
    .line 162
    iput-object p1, p0, Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4$1;->b:Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4;

    iput-object p2, p0, Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4$1;->a:Lcom/alibaba/android/dingtalk/userbase/model/OrgApplyObjectList;
...
.method public final run()V
    ...
    .prologue
    .line 165
    iget-object v4, p0, Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4$1;->a:Lcom/alibaba/android/dingtalk/userbase/model/OrgApplyObjectList;
    ...
    .line 173
    invoke-static {v6, v7, v4}, Ldvl;->a(JLjava/lang/String;)Ljava/util/List;
    ...
    iget-object v7, p0, Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4$1;->b:Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4;

    iget-object v7, v7, Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4;->b:Lcom/alibaba/android/user/contact/activities/OrgApplyActivity;

    sget v8, Ldop$j;->my_local_contact:I
    ...
    :cond_2
    iget-object v4, p0, Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4$1;->b:Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4;

    iget-object v4, v4, Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4;->b:Lcom/alibaba/android/user/contact/activities/OrgApplyActivity;

    new-instance v5, Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4$1$1;

    invoke-direct {v5, p0, v2}, Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4$1$1;-><init>(Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4$1;Ljava/util/ArrayList;)V
    ...
    iget-object v5, p0, Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4$1;->a:Lcom/alibaba/android/dingtalk/userbase/model/OrgApplyObjectList;
    ...
    new-instance v5, Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4$1$2;

    invoke-direct {v5, p0}, Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4$1$2;-><init>(Lcom/alibaba/android/user/contact/activities/OrgApplyActivity$4$1;)V

    invoke-virtual {v4, v3, v5}, Ldqh;->b(Ljava/util/List;Lbsv;)V
