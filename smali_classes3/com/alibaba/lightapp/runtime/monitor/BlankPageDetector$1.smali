...
.method public run()V
    ...
    invoke-virtual {v1, v2, v3}, Legr;->warnWebViewDead(Ljava/lang/String;Ljava/util/List;)V
    ...
    sget v1, Leqg$j;->dt_lightapp_relaunch_title:I

    invoke-virtual {v0, v1}, Lbwt$a;->setTitle(I)Landroid/support/v7/app/AlertDialog$Builder;

    .line 52
    sget v1, Leqg$j;->dt_lightapp_relaunch_message:I
    ...
    .line 59
    sget v1, Leqg$j;->dt_lightapp_relaunch_text:I
