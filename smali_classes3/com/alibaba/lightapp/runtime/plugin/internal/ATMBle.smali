...
# instance fields
.field private mAtmListener:Lers$c;
...
.method static synthetic access$300(Lcom/alibaba/lightapp/runtime/plugin/internal/ATMBle;Lesr;)Lorg/json/JSONObject;
    .locals 1
    .param p0, "x0"    # Lcom/alibaba/lightapp/runtime/plugin/internal/ATMBle;
    .param p1, "x1"    # Lesr;
    ...
    .prologue
    .line 30
    invoke-direct {p0, p1}, Lcom/alibaba/lightapp/runtime/plugin/internal/ATMBle;->createResultDeviceObject(Lesr;)Lorg/json/JSONObject;
...
.method private createResultDeviceObject(Lesr;)Lorg/json/JSONObject;
    .locals 8
    .param p1, "infoModel"    # Lesr;
    ...
    iget-object v3, p1, Lesr;->a:Ljava/lang/String;
    ...
    iget-object v3, p1, Lesr;->e:Ljava/lang/String;
...
.method public checkIn(Lcom/alibaba/lightapp/runtime/ActionRequest;)Lcom/alibaba/lightapp/runtime/ActionResponse;
    ...
    .line 6049
    :goto_0
    sget-object v8, Lers$d;->a:Lers;

    .line 6401
    iget-object v7, v8, Lers;->f:Lcom/alibaba/android/dingtalk/guardinterface/DoorGuardInterface;
    ...
    .line 6410
    invoke-static {v7}, Lers;->a(Lcom/alibaba/android/dingtalk/guardinterface/DeviceModelBean;)Ljava/lang/String;

    move-result-object v9

    .line 6411
    iget-object v8, v8, Lers;->e:Ljava/util/HashSet;
    ...
    invoke-virtual {v7, v1, v8, v6, v9}, Lers;->a(Lcom/alibaba/android/dingtalk/guardinterface/DeviceModelBean;Ljava/lang/Integer;Ljava/lang/Long;Lbsv;)V
...
.method public onCreate()V
    ...
    iput-object v0, p0, Lcom/alibaba/lightapp/runtime/plugin/internal/ATMBle;->mAtmListener:Lers$c;

    .line 1049
    sget-object v0, Lers$d;->a:Lers;

    .line 106
    iget-object v1, p0, Lcom/alibaba/lightapp/runtime/plugin/internal/ATMBle;->mAtmListener:Lers$c;
...
.method public onDestroy()V
    ...
    .line 125
    iget-object v2, p0, Lcom/alibaba/lightapp/runtime/plugin/internal/ATMBle;->mAtmListener:Lers$c;

    .line 2118
    if-eqz v2, :cond_3

    .line 2119
    iget-object v3, v1, Lers;->d:Ljava/util/List;

    monitor-enter v3

    .line 2120
    :try_start_0
    iget-object v1, v1, Lers;->d:Ljava/util/List;
    ...
    .line 126
    :cond_3
    iput-object v4, p0, Lcom/alibaba/lightapp/runtime/plugin/internal/ATMBle;->mAtmListener:Lers$c;
...
.method public startMonitor(Lcom/alibaba/lightapp/runtime/ActionRequest;)Lcom/alibaba/lightapp/runtime/ActionResponse;
    ...
    .line 156
    .end local v2    # "session":Levl$d;
    :goto_0
    return-object v3

    .line 143
    .restart local v2    # "session":Levl$d;
    :cond_0
    ...
    .line 4049
    :cond_1
    sget-object v3, Lers$d;->a:Lers;

    .line 146
    invoke-virtual {v3, v0}, Lers;->a(Ljava/lang/String;)Lesr;
    ...
    .line 148
    invoke-direct {p0, v1}, Lcom/alibaba/lightapp/runtime/plugin/internal/ATMBle;->createResultDeviceObject(Lesr;)Lorg/json/JSONObject;
