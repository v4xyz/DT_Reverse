...
# direct methods
.method public constructor <init>(Lcom/alibaba/lightapp/runtime/plugin/internal/JsapiLwpCall;Lfos;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 76
    .local p2, "handler":Lfos;, "Lfos<Ljava/lang/String;>;"
...
.method private postHandler(Lcom/laiwang/protocol/core/Response;Ljava/util/List;)V
    ...
    .prologue
    .line 98
    .local p2, "handlers":Ljava/util/List;, "Ljava/util/List<Lfos<Ljava/lang/String;>;>;"
    :try_start_0
    ...
    invoke-static {v12}, Lfqa;->a(Ljava/lang/String;)Lfpz;

    move-result-object v6

    .line 103
    .local v6, "handler3":Lfpz;
    ...
    .line 108
    .local v4, "handler1":Lfos;
    invoke-interface {v4}, Lfos;->getType()Ljava/lang/reflect/Type;
    ...
    invoke-interface {v4, v12}, Lfos;->onSuccess(Ljava/lang/Object;)V
    :try_end_0
    ...
    .end local v4    # "handler1":Lfos;
    .end local v6    # "handler3":Lfpz;
    ...
    .line 161
    .local v3, "handler":Lfos;
    const/4 v13, 0x0

    invoke-interface {v3, v13, v1}, Lfos;->caught(Lcom/laiwang/idl/service/ResultError;Ljava/lang/Throwable;)V

    goto :goto_1

    .line 111
    .end local v1    # "e":Ljava/lang/Exception;
    .end local v3    # "handler":Lfos;
    .end local v10    # "var10":Ljava/lang/Exception;
    .restart local v2    # "e1":Lcom/laiwang/protocol/core/Constants$Status;
    .local v4, "handler1":Lfos;
    .restart local v6    # "handler3":Lfpz;
    ...
    invoke-interface {v6, v8, v12}, Lfpz;->a([BLjava/lang/reflect/Type;)Ljava/lang/Object;
    ...
    .line 123
    .restart local v4    # "handler1":Lfos;
    ...
    invoke-interface {v4, v12, v13}, Lfos;->caught(Lcom/laiwang/idl/service/ResultError;Ljava/lang/Throwable;)V
    ...
    .line 144
    .local v5, "handler2":Lfos;
    const/4 v13, 0x0

    invoke-interface {v5, v9, v13}, Lfos;->caught(Lcom/laiwang/idl/service/ResultError;Ljava/lang/Throwable;)V

    goto :goto_5

    .line 134
    .end local v3    # "handler":Ljava/lang/Object;
    .end local v5    # "handler2":Lfos;
    :catch_1
    move-exception v11
    ...
    invoke-interface {v4, v13, v12}, Lfos;->caught(Lcom/laiwang/idl/service/ResultError;Ljava/lang/Throwable;)V
...
# virtual methods
.method public addHandler(Lfos;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 81
    .local p1, "handler":Lfos;, "Lfos<Ljava/lang/String;>;"
    iget-object v0, p0, Lcom/alibaba/lightapp/runtime/plugin/internal/JsapiLwpCall$ResponseReply;->mHandlers:Ljava/util/List;
