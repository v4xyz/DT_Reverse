...
# direct methods
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Lfos;)V
    .locals 1
    ...
    .local p4, "callback":Lfos;, "Lfos<Ljava/lang/String;>;"
    ...
    .line 32
    iput-object p4, p0, Lcom/alibaba/lightapp/runtime/plugin/internal/JsapiLwpCall;->mHandler:Lfos;
...
.method public execute()V
    ...
    iget-object v5, p0, Lcom/alibaba/lightapp/runtime/plugin/internal/JsapiLwpCall;->mHandler:Lfos;

    const/4 v6, 0x0

    invoke-interface {v5, v6, v1}, Lfos;->caught(Lcom/laiwang/idl/service/ResultError;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v5, v0}, Lfos;->setRequestBuilder(Lcom/laiwang/protocol/core/Request$Builder;)V

    .line 50
    iget-object v5, p0, Lcom/alibaba/lightapp/runtime/plugin/internal/JsapiLwpCall;->mHandler:Lfos;

    invoke-interface {v5}, Lfos;->getRequestFilterChain()Lfor;

    move-result-object v5

    iget-object v6, p0, Lcom/alibaba/lightapp/runtime/plugin/internal/JsapiLwpCall;->mHandler:Lfos;

    invoke-virtual {v5, v6}, Lfor;->a(Lfop;)V
    ...
    invoke-interface {v6}, Lfos;->getRequestBuilder()Lcom/laiwang/protocol/core/Request$Builder;
    ...
    invoke-interface {v5, v6}, Lfos;->setRequestBuilder(Lcom/laiwang/protocol/core/Request$Builder;)V
    ...
    invoke-virtual {v5, v6}, Lfor;->b(Lfop;)V

    .line 53
    iget-object v5, p0, Lcom/alibaba/lightapp/runtime/plugin/internal/JsapiLwpCall;->mHandler:Lfos;

    invoke-interface {v5}, Lfos;->getRequestBuilder()Lcom/laiwang/protocol/core/Request$Builder;
    ...
    invoke-direct {v4, p0, v5}, Lcom/alibaba/lightapp/runtime/plugin/internal/JsapiLwpCall$ResponseReply;-><init>(Lcom/alibaba/lightapp/runtime/plugin/internal/JsapiLwpCall;Lfos;)V
