...
.method private processResponse(Ljava/lang/String;Lcom/laiwang/protocol/core/Response;)V
    ...
    invoke-virtual {v0, v5, v6}, Lcom/laiwang/protocol/core/Response;->header(Ljava/lang/String;Ljava/lang/String;)Lcom/laiwang/protocol/android/be;

    .line 253
    invoke-static {v0}, Lcom/laiwang/protocol/android/LWP;->onRemoteMessage(Lcom/laiwang/protocol/android/be;)V
...
.method public send(Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Lcom/laiwang/protocol/android/bf;->a(Landroid/os/Bundle;)Lcom/laiwang/protocol/android/be;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/laiwang/protocol/android/w;->a(Lcom/laiwang/protocol/android/be;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
