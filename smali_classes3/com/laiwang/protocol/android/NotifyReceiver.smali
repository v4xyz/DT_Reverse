...
.method private receiveBundle(Landroid/os/Bundle;)Lcom/laiwang/protocol/android/bf$a;
    .locals 10
    ...
    check-cast v0, Lcom/laiwang/protocol/android/bf$a;

    .line 110
    .local v0, "chunkMessage":Lcom/laiwang/protocol/android/bf$a;
    if-nez v0, :cond_0

    .line 111
    new-instance v0, Lcom/laiwang/protocol/android/bf$a;

    .end local v0    # "chunkMessage":Lcom/laiwang/protocol/android/bf$a;
    invoke-direct {v0}, Lcom/laiwang/protocol/android/bf$a;-><init>()V

    .line 112
    .restart local v0    # "chunkMessage":Lcom/laiwang/protocol/android/bf$a;
    iget-object v7, p0, Lcom/laiwang/protocol/android/NotifyReceiver;->bundleChunkMap:Ljava/util/Map;
    ...
    .line 116
    .local v6, "total":I
    iput-object p1, v0, Lcom/laiwang/protocol/android/bf$a;->a:Landroid/os/Bundle;

    .line 117
    iput v6, v0, Lcom/laiwang/protocol/android/bf$a;->b:I

    .line 119
    .end local v6    # "total":I
    :cond_1
    invoke-virtual {v0, v5, v4}, Lcom/laiwang/protocol/android/bf$a;->a(I[B)V

    .line 120
    invoke-virtual {v0}, Lcom/laiwang/protocol/android/bf$a;->a()Z
    ...
    .local v1, "i":I
    :goto_0
    iget-object v7, v0, Lcom/laiwang/protocol/android/bf$a;->d:Ljava/util/Map;
    ...
    .line 128
    :cond_2
    iget-object v7, v0, Lcom/laiwang/protocol/android/bf$a;->a:Landroid/os/Bundle;
...
.method public onReceiveFromRemote(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    :pswitch_0
    invoke-direct {p0, p2}, Lcom/laiwang/protocol/android/NotifyReceiver;->receiveBundle(Landroid/os/Bundle;)Lcom/laiwang/protocol/android/bf$a;

    move-result-object v1

    .line 60
    .local v1, "message":Lcom/laiwang/protocol/android/bf$a;
    if-eqz v1, :cond_2

    .line 61
    invoke-virtual {v1}, Lcom/laiwang/protocol/android/bf$a;->a()Z
    ...
    .line 64
    :cond_1
    iget-object p2, v1, Lcom/laiwang/protocol/android/bf$a;->a:Landroid/os/Bundle;

    .line 66
    :cond_2
    invoke-static {p2}, Lcom/laiwang/protocol/android/bf;->a(Landroid/os/Bundle;)Lcom/laiwang/protocol/android/be;

    move-result-object v2

    .line 67
    .local v2, "msg":Lcom/laiwang/protocol/android/be;
    ...
    .end local v2    # "msg":Lcom/laiwang/protocol/android/be;
    invoke-static {v2}, Lcom/laiwang/protocol/push/PushDispatch;->dispatch(Lcom/laiwang/protocol/core/Request;)Z

    goto :goto_0

    .line 70
    .restart local v2    # "msg":Lcom/laiwang/protocol/android/be;
    :cond_3
    ...
    .line 74
    .end local v1    # "message":Lcom/laiwang/protocol/android/bf$a;
    :pswitch_1
