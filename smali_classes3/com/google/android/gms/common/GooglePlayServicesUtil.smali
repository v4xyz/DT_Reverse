...
.method private static zza(ILandroid/content/Context;Ljava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v3, p1}, Lci$d;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v4}, Lci$d;->setSmallIcon(I)Lci$d;

    move-result-object v3

    invoke-virtual {v3, v1}, Lci$d;->setTicker(Ljava/lang/CharSequence;)Lci$d;
    ...
    invoke-virtual {v1, v4, v5}, Lci$d;->setWhen(J)Lci$d;
    ...
    invoke-virtual {v1, p3}, Lci$d;->setContentIntent(Landroid/app/PendingIntent;)Lci$d;

    move-result-object v1

    invoke-virtual {v1, v0}, Lci$d;->setContentTitle(Ljava/lang/CharSequence;)Lci$d;

    move-result-object v0

    invoke-virtual {v0, v2}, Lci$d;->setContentText(Ljava/lang/CharSequence;)Lci$d;
