...
.field private static final sTabPool:Leq$a;
...
.field private mPagerAdapter:Lfn;
...
.field private final mTabViewPool:Leq$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Leq$a",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/TabLayout;->sTabPool:Leq$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v4, v5}, Leq$b;-><init>(I)V

    iput-object v4, p0, Landroid/support/design/widget/TabLayout;->mTabViewPool:Leq$a;
...
.method private createTabView(Landroid/support/design/widget/TabLayout$Tab;)Landroid/support/design/widget/TabLayout$TabView;
    ...
    .prologue
    .line 928
    iget-object v1, p0, Landroid/support/design/widget/TabLayout;->mTabViewPool:Leq$a;

    if-eqz v1, :cond_1

    iget-object v1, p0, Landroid/support/design/widget/TabLayout;->mTabViewPool:Leq$a;

    invoke-interface {v1}, Leq$a;->a()Ljava/lang/Object;
...
.method private removeTabViewAt(I)V
    ...
    invoke-interface {v1, v0}, Leq$a;->a(Ljava/lang/Object;)Z
...
.method private setupWithViewPager(Landroid/support/v4/view/ViewPager;ZZ)V
    ...
    .line 812
    invoke-virtual {p0, v0, p2}, Landroid/support/design/widget/TabLayout;->setPagerAdapter(Lfn;Z)V
    ...
    invoke-virtual {p0, v3, v1}, Landroid/support/design/widget/TabLayout;->setPagerAdapter(Lfn;Z)V
...
.method public newTab()Landroid/support/design/widget/TabLayout$Tab;
    ...
    .prologue
    .line 562
    sget-object v1, Landroid/support/design/widget/TabLayout;->sTabPool:Leq$a;
...
.method populateFromPagerAdapter()V
    ...
    .line 905
    iget-object v3, p0, Landroid/support/design/widget/TabLayout;->mPagerAdapter:Lfn;
    ...
    iget-object v4, p0, Landroid/support/design/widget/TabLayout;->mPagerAdapter:Lfn;

    invoke-virtual {v4, v2}, Lfn;->getPageTitle(I)Ljava/lang/CharSequence;
...
.method public removeAllTabs()V
    ...
    .line 650
    sget-object v3, Landroid/support/design/widget/TabLayout;->sTabPool:Leq$a;

    invoke-interface {v3, v2}, Leq$a;->a(Ljava/lang/Object;)Z
...
.method public removeTabAt(I)V
    ...
    .line 624
    sget-object v4, Landroid/support/design/widget/TabLayout;->sTabPool:Leq$a;

    invoke-interface {v4, v2}, Leq$a;->a(Ljava/lang/Object;)Z
...
.method setPagerAdapter(Lfn;Z)V
    .locals 2
    ...
    .prologue
    .line 883
    iget-object v0, p0, Landroid/support/design/widget/TabLayout;->mPagerAdapter:Lfn;
    ...
    invoke-virtual {v0, v1}, Lfn;->unregisterDataSetObserver(Landroid/database/DataSetObserver;)V

    .line 888
    :cond_0
    iput-object p1, p0, Landroid/support/design/widget/TabLayout;->mPagerAdapter:Lfn;
    ...
    invoke-virtual {p1, v0}, Lfn;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
...
.method public setTabsFromPagerAdapter(Lfn;)V
    .locals 1
    .param p1, "adapter"    # Lfn;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/design/widget/TabLayout;->setPagerAdapter(Lfn;Z)V
