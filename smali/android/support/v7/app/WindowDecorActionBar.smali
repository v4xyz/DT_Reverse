...
.field final mUpdateListener:Lgf;
...
.method public constructor <init>(Landroid/app/Activity;Z)V
    ...
    iput-object v2, p0, Landroid/support/v7/app/WindowDecorActionBar;->mHideListener:Lgd;
    ...
    iput-object v2, p0, Landroid/support/v7/app/WindowDecorActionBar;->mShowListener:Lgd;
    ...
    iput-object v2, p0, Landroid/support/v7/app/WindowDecorActionBar;->mUpdateListener:Lgf;
...
.method public constructor <init>(Landroid/app/Dialog;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/WindowDecorActionBar;->mHideListener:Lgd;
    ...
    iput-object v0, p0, Landroid/support/v7/app/WindowDecorActionBar;->mShowListener:Lgd;
    ...
    iput-object v0, p0, Landroid/support/v7/app/WindowDecorActionBar;->mUpdateListener:Lgf;
...
.method private shouldAnimateContextView()Z
    ...
    invoke-static {v0}, Landroid/support/v4/view/ViewCompat;->F(Landroid/view/View;)Z
...
.method public animateToMode(Z)V
    ...
    invoke-interface {v3, v5, v8, v9}, Landroid/support/v7/widget/DecorToolbar;->setupAnimatorToVisibility(IJ)Lfz;

    move-result-object v1

    .line 870
    .local v1, "fadeOut":Lfz;
    ...
    invoke-virtual {v3, v4, v10, v11}, Landroid/support/v7/widget/ActionBarContextView;->setupAnimatorToVisibility(IJ)Lfz;
    ...
    invoke-virtual {v2, v1, v0}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->playSequentially(Lfz;Lfz;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;

    .line 880
    invoke-virtual {v2}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->start()V

    .line 891
    .end local v0    # "fadeIn":Lfz;
    .end local v1    # "fadeOut":Lfz;
    ...
    invoke-interface {v3, v4, v10, v11}, Landroid/support/v7/widget/DecorToolbar;->setupAnimatorToVisibility(IJ)Lfz;

    move-result-object v0

    .line 875
    .restart local v0    # "fadeIn":Lfz;
    iget-object v3, p0, Landroid/support/v7/app/WindowDecorActionBar;->mContextView:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v3, v6, v8, v9}, Landroid/support/v7/widget/ActionBarContextView;->setupAnimatorToVisibility(IJ)Lfz;

    move-result-object v1

    .restart local v1    # "fadeOut":Lfz;
    goto :goto_1
...
.method public doHide(Z)V
    ...
    invoke-static {v4, v5}, Landroid/support/v4/view/ViewCompat;->c(Landroid/view/View;F)V
    ...
    invoke-static {v4}, Landroid/support/v4/view/ViewCompat;->s(Landroid/view/View;)Lfz;

    move-result-object v4

    invoke-virtual {v4, v2}, Lfz;->c(F)Lfz;

    move-result-object v0

    .line 833
    .local v0, "a":Lfz;
    iget-object v4, p0, Landroid/support/v7/app/WindowDecorActionBar;->mUpdateListener:Lgf;

    invoke-virtual {v0, v4}, Lfz;->a(Lgf;)Lfz;

    .line 834
    invoke-virtual {v1, v0}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->play(Lfz;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    ...
    invoke-virtual {v1, v4}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->play(Lfz;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    ...
    .line 840
    iget-object v4, p0, Landroid/support/v7/app/WindowDecorActionBar;->mHideListener:Lgd;

    invoke-virtual {v1, v4}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->setListener(Lgd;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    ...
    invoke-interface {v4, v5}, Lgd;->onAnimationEnd(Landroid/view/View;)V
...
.method public doShow(Z)V
    ...
    invoke-static {v4, v6}, Landroid/support/v4/view/ViewCompat;->b(Landroid/view/View;F)V
    ...
    invoke-static {v4, v2}, Landroid/support/v4/view/ViewCompat;->b(Landroid/view/View;F)V
    ...
    .line 800
    iget-object v4, p0, Landroid/support/v7/app/WindowDecorActionBar;->mShowListener:Lgd;
    ...
    invoke-static {v4}, Landroid/support/v4/view/ViewCompat;->w(Landroid/view/View;)V
...
.method public getElevation()F
    ...
    invoke-static {v0}, Landroid/support/v4/view/ViewCompat;->u(Landroid/view/View;)F
...
.method public selectTab(Landroid/support/v7/app/ActionBar$Tab;)V
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/FragmentActivity;->getSupportFragmentManager()Lbw;
    ...
    invoke-interface {v1, v2, v0}, Landroid/support/v7/app/ActionBar$TabListener;->onTabReselected(Landroid/support/v7/app/ActionBar$Tab;Lca;)V
    ...
    .line 620
    .end local v0    # "trans":Lca;
    .restart local p1    # "tab":Landroid/support/v7/app/ActionBar$Tab;
    :cond_4
    const/4 v0, 0x0

    .restart local v0    # "trans":Lca;
    goto :goto_2
    ...
    invoke-interface {v1, v2, v0}, Landroid/support/v7/app/ActionBar$TabListener;->onTabUnselected(Landroid/support/v7/app/ActionBar$Tab;Lca;)V
    ...
    invoke-interface {v1, v2, v0}, Landroid/support/v7/app/ActionBar$TabListener;->onTabSelected(Landroid/support/v7/app/ActionBar$Tab;Lca;)V
