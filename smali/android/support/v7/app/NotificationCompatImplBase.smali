...
.method public static applyStandardTemplateWithActions(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;IILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIIIZLjava/util/ArrayList;)Landroid/widget/RemoteViews;
    ...
    .prologue
    .line 191
    .local p15, "actions":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lci$a;>;"
    ...
    invoke-static {p0, v7}, Landroid/support/v7/app/NotificationCompatImplBase;->generateActionButton(Landroid/content/Context;Lci$a;)Landroid/widget/RemoteViews;
...
.method private static generateActionButton(Landroid/content/Context;Lci$a;)Landroid/widget/RemoteViews;
    .locals 6
    .param p0, "context"    # Landroid/content/Context;
    ...
    .prologue
    .line 215
    iget-object v2, p1, Lci$a;->d:Landroid/app/PendingIntent;
    ...
    iget-object v3, p1, Lci$a;->c:Ljava/lang/CharSequence;
    ...
    iget-object v3, p1, Lci$a;->d:Landroid/app/PendingIntent;
...
.method private static generateContentViewMedia(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJILjava/util/List;[IZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
    ...
    check-cast v18, Lcm$a;

    .line 98
    .local v18, "action":Lcm$a;
    move-object/from16 v0, p0

    move-object/from16 v1, v18

    invoke-static {v0, v1}, Landroid/support/v7/app/NotificationCompatImplBase;->generateMediaActionButton(Landroid/content/Context;Lcm$a;)Landroid/widget/RemoteViews;
...
.method private static generateMediaActionButton(Landroid/content/Context;Lcm$a;)Landroid/widget/RemoteViews;
    .locals 4
    .param p0, "context"    # Landroid/content/Context;
...
.method public static generateMediaBigView(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIILjava/util/List;ZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
    ...
    invoke-static {v0, v3}, Landroid/support/v7/app/NotificationCompatImplBase;->generateMediaActionButton(Landroid/content/Context;Lcm$a;)Landroid/widget/RemoteViews;
...
.method public static overrideContentViewMedia(Lch;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJILjava/util/List;[IZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
    .locals 3
