...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 532
    invoke-static {p1}, Lez;->b(Landroid/view/KeyEvent;)Z
...
.method public onCreateSupportNavigateUpTaskStack(Lcv;)V
    .locals 2
    .param p1, "builder"    # Lcv;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    ...
    invoke-interface {v0}, Lcv$a;->getSupportParentActivityIntent()Landroid/content/Intent;
    ...
    .line 1211
    iget-object v0, p1, Lcv;->b:Landroid/content/Context;
    ...
    .line 1213
    :cond_1
    invoke-virtual {p1, v0}, Lcv;->a(Landroid/content/ComponentName;)Lcv;

    .line 2162
    iget-object v0, p1, Lcv;->a:Ljava/util/ArrayList;
...
.method public onPrepareSupportNavigateUpTaskStack(Lcv;)V
    .locals 0
    .param p1, "builder"    # Lcv;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public onSupportNavigateUp()Z
    ...
    .line 402
    invoke-static {p0}, Lcv;->a(Landroid/content/Context;)Lcv;

    move-result-object v0

    .line 403
    .local v0, "b":Lcv;
    invoke-virtual {p0, v0}, Landroid/support/v7/app/AppCompatActivity;->onCreateSupportNavigateUpTaskStack(Lcv;)V

    .line 404
    invoke-virtual {p0, v0}, Landroid/support/v7/app/AppCompatActivity;->onPrepareSupportNavigateUpTaskStack(Lcv;)V
    ...
    .line 2328
    iget-object v3, v0, Lcv;->b:Landroid/content/Context;

    const/4 v4, 0x0

    invoke-static {v3, v2, v4}, Lcw;->a(Landroid/content/Context;[Landroid/content/Intent;Landroid/os/Bundle;)Z
    ...
    .line 2331
    iget-object v2, v0, Lcv;->b:Landroid/content/Context;
    ...
    :cond_1
    :try_start_0
    invoke-static {p0}, Lbj;->a(Landroid/app/Activity;)V
    :try_end_0
...
.method public supportNavigateUpTo(Landroid/content/Intent;)V
    ...
    .prologue
    .line 469
    invoke-static {p0, p1}, Lce;->b(Landroid/app/Activity;Landroid/content/Intent;)V
...
.method public supportShouldUpRecreateTask(Landroid/content/Intent;)Z
    ...
    .prologue
    .line 453
    invoke-static {p0, p1}, Lce;->a(Landroid/app/Activity;Landroid/content/Intent;)Z
