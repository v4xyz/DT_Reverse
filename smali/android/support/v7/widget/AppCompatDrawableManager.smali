...
.method private addDelegate(Ljava/lang/String;Landroid/support/v7/widget/AppCompatDrawableManager$InflateDelegate;)V
    ...
    .prologue
    .line 492
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDelegates:Lei;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDelegates:Lei;
...
.method private addDrawableToCache(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    .line 420
    .local v0, "cache":Lem;, "Lem<Ljava/lang/ref/WeakReference<Landroid/graphics/drawable/Drawable$ConstantState;>;>;"
    if-nez v0, :cond_0

    .line 421
    new-instance v0, Lem;

    .end local v0    # "cache":Lem;, "Lem<Ljava/lang/ref/WeakReference<Landroid/graphics/drawable/Drawable$ConstantState;>;>;"
    invoke-direct {v0}, Lem;-><init>()V

    .line 422
    .restart local v0    # "cache":Lem;, "Lem<Ljava/lang/ref/WeakReference<Landroid/graphics/drawable/Drawable$ConstantState;>;>;"
    iget-object v2, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDrawableCaches:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v0, p2, p3, v2}, Lem;->b(JLjava/lang/Object;)V
...
.method private createButtonColorStateList(Landroid/content/Context;ILandroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    :goto_1
    invoke-static {v0, v4}, Ldd;->a(II)I
    ...
    invoke-virtual {p3, v4, v5}, Landroid/content/res/ColorStateList;->getColorForState([II)I
...
.method private getCachedDrawable(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p2, p3, v5}, Lem;->a(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_1
    invoke-virtual {v0, p2, p3}, Lem;->b(J)V
...
.method private loadDrawableFromDelegates(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v14, v0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDelegates:Lei;
    ...
    invoke-virtual {v14}, Lei;->isEmpty()Z
    ...
    .line 311
    invoke-virtual {v14, v3}, Lei;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v14, v11}, Lei;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private tintDrawable(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 268
    :cond_0
    invoke-static {p4}, Lde;->g(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object p4

    .line 269
    invoke-static {p4, v1}, Lde;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    .line 274
    invoke-static {p4, v2}, Lde;->a(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method final getDrawable(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 200
    invoke-static {p1, p2}, Lcw;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
