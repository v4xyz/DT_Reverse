...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Laig;->a:Landroid/text/format/Time;
    ...
    iput-object v0, p0, Laig;->b:Landroid/text/format/Time;
    ...
    iput-object v0, p0, Laig;->c:Ljava/lang/StringBuilder;
    ...
    iput-object v0, p0, Laig;->d:Landroid/text/format/Time;

    .line 32
    new-instance v0, Laig$a;

    invoke-direct {v0}, Laig$a;-><init>()V

    iput-object v0, p0, Laig;->e:Laig$a;
...
.method private static a(Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;Landroid/text/format/Time;)I
    ...
    .line 214
    invoke-static {v6, v7, v8, v9}, Laig;->a([IIII)Z
    ...
    .line 296
    :cond_d
    invoke-static {p0, p1}, Laig;->b(Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;Landroid/text/format/Time;)Z
...
.method private a(Landroid/text/format/Time;Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;JJZLjava/util/TreeSet;)V
    ...
    invoke-static/range {p1 .. p1}, Laig;->a(Landroid/text/format/Time;)V

    .line 740
    invoke-static/range {p1 .. p1}, Laig;->b(Landroid/text/format/Time;)J
    ...
    iget-object v0, v0, Laig;->a:Landroid/text/format/Time;
    ...
    iget-object v0, v0, Laig;->b:Landroid/text/format/Time;
    ...
    iget-object v0, v0, Laig;->c:Ljava/lang/StringBuilder;
    ...
    iget-object v4, v0, Laig;->d:Landroid/text/format/Time;

    .line 762
    .local v4, "generated":Landroid/text/format/Time;
    move-object/from16 v0, p0

    iget-object v0, v0, Laig;->e:Laig$a;

    move-object/from16 v17, v0

    .line 2425
    .local v17, "days":Laig$a;
    const/16 v55, 0x0
    ...
    iput-object v0, v1, Laig$a;->a:Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;
    ...
    invoke-static {v0, v1, v13}, Laig;->a(III)Z
    ...
    invoke-static {v0, v1, v11}, Laig;->a(III)Z
    ...
    invoke-static {v0, v1, v12}, Laig;->a(III)Z
    ...
    invoke-static {v0, v1, v14}, Laig;->a(III)Z
    ...
    .line 850
    invoke-static/range {v44 .. v44}, Laig;->b(Landroid/text/format/Time;)J
    ...
    :cond_9
    invoke-static/range {v30 .. v30}, Laig;->a(Landroid/text/format/Time;)V
    ...
    iget-object v0, v0, Laig$a;->c:Landroid/text/format/Time;
    ...
    .line 2447
    invoke-static/range {v55 .. v55}, Laig;->a(Landroid/text/format/Time;)V
    ...
    iget-object v0, v0, Laig$a;->a:Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;

    move-object/from16 v56, v0

    invoke-static/range {v55 .. v56}, Laig$a;->a(Landroid/text/format/Time;Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;)I
    ...
    iput v0, v1, Laig$a;->b:I

    .line 2482
    :cond_f
    move-object/from16 v0, v17

    iget v0, v0, Laig$a;->b:I
    ...
    .line 978
    invoke-static {v4}, Laig;->a(Landroid/text/format/Time;)V

    .line 980
    invoke-static {v4}, Laig;->b(Landroid/text/format/Time;)J
    ...
    invoke-static {v0, v4}, Laig;->a(Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;Landroid/text/format/Time;)I
...
# virtual methods
.method public final a(Landroid/text/format/Time;Laih;)J
    .locals 12
    .param p1, "dtstart"    # Landroid/text/format/Time;
    .param p2, "recur"    # Laih;
    .annotation system Ldalvik/annotation/Throws;
    ...
    .line 62
    .line 2089
    iget-object v0, p2, Laih;->a:[Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;

    if-eqz v0, :cond_6

    .line 2090
    iget-object v9, p2, Laih;->a:[Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;
    ...
    .line 2095
    iget-object v5, p0, Laig;->a:Landroid/text/format/Time;
    ...
    .line 2096
    iget-object v4, p0, Laig;->a:Landroid/text/format/Time;
    ...
    iget-object v4, p2, Laih;->b:[J

    if-eqz v4, :cond_4

    .line 2103
    iget-object v9, p2, Laih;->b:[J
    ...
    .line 2115
    :cond_6
    iget-object v0, p2, Laih;->b:[J

    if-eqz v0, :cond_7

    iget-object v0, p2, Laih;->c:[Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;

    if-nez v0, :cond_7

    iget-object v0, p2, Laih;->d:[J

    if-nez v0, :cond_7

    .line 2118
    iget-object v5, p2, Laih;->b:[J
    ...
    .line 2131
    invoke-virtual/range {v1 .. v7}, Laig;->a(Landroid/text/format/Time;Laih;JJ)[J
...
.method public final a(Landroid/text/format/Time;Laih;JJ)[J
    .locals 31
    .param p1, "dtstart"    # Landroid/text/format/Time;
    .param p2, "recur"    # Laih;
    ...
    iget-object v3, v0, Laig;->a:Landroid/text/format/Time;
    ...
    iget-object v3, v0, Laig;->d:Landroid/text/format/Time;
    ...
    invoke-static {v3}, Laig;->b(Landroid/text/format/Time;)J
    ...
    iget-object v3, v0, Laih;->a:[Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;
    ...
    iget-object v14, v0, Laih;->a:[Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;
    ...
    invoke-direct/range {v3 .. v11}, Laig;->a(Landroid/text/format/Time;Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;JJZLjava/util/TreeSet;)V
    ...
    iget-object v13, v0, Laig;->a:Landroid/text/format/Time;
    ...
    invoke-static {v13}, Laig;->b(Landroid/text/format/Time;)J
    ...
    iget-object v3, v0, Laih;->c:[Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;
    ...
    iget-object v4, v0, Laih;->c:[Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;
    ...
    invoke-direct/range {v13 .. v21}, Laig;->a(Landroid/text/format/Time;Lcom/alibaba/alimei/sdk/calendar/common/EventRecurrence;JJZLjava/util/TreeSet;)V
    ...
    iget-object v4, v0, Laig;->a:Landroid/text/format/Time;
