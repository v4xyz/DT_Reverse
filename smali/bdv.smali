...
.method protected final a()V
    ...
    .prologue
    .line 33
    iget-object v4, p0, Lbdv;->b:Lcom/alibaba/android/ding/base/objects/DingLinkObject;
    ...
    invoke-static {v4, v5}, Lbsb;->a(Ljava/util/Map;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 38
    .local v2, "orgId":J
    iget-object v4, p0, Lbdv;->f:Lbsd;

    .line 1075
    iput-wide v2, v4, Lbsd;->g:J
    :try_end_0
    ...
    :cond_0
    :goto_0
    iget-object v4, p0, Lbdv;->c:Lcom/alibaba/dingtalk/cmailbase/favorite/FavoriteInterface;

    iget-object v5, p0, Lbdv;->d:Landroid/content/Context;

    iget-object v6, p0, Lbdv;->f:Lbsd;

    iget-object v7, p0, Lbdv;->h:Lbsv;

    invoke-virtual {v4, v5, v6, v1, v7}, Lcom/alibaba/dingtalk/cmailbase/favorite/FavoriteInterface;->a(Landroid/content/Context;Lbsd;Lcom/alibaba/android/dingtalkbase/models/dos/space/SpaceDo;Lbsv;)V
...
.method public final a(Lbsv;)V
    ...
    iget-object v0, p0, Lbdv;->a:Lcom/alibaba/android/ding/base/objects/DingAttachmentObject;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lbdv;->b:Lcom/alibaba/android/ding/base/objects/DingLinkObject;
    ...
    .line 28
    :cond_1
    invoke-virtual {p0, p1}, Lbdv;->b(Lbsv;)V
