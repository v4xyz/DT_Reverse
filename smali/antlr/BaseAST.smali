...
.method private doWorkForFindAll(Lnr;Lnn;Z)V
    .locals 1
    ...
    invoke-interface {p0, p2}, Lnn;->equalsTreePartial(Lnn;)Z
    ...
    invoke-interface {p0, p2}, Lnn;->equalsTree(Lnn;)Z
    ...
    .line 91
    :cond_1
    invoke-virtual {p1, p0}, Lnr;->a(Ljava/lang/Object;)V

    .line 94
    :cond_2
    invoke-interface {p0}, Lnn;->getFirstChild()Lnn;
    ...
    invoke-direct {v0, p1, p2, p3}, Lantlr/BaseAST;->doWorkForFindAll(Lnr;Lnn;Z)V

    .line 88
    :cond_3
    invoke-interface {p0}, Lnn;->getNextSibling()Lnn;
...
.method public equals(Lnn;)Z
    ...
    invoke-interface {p1}, Lnn;->getText()Ljava/lang/String;
    ...
    invoke-interface {p1}, Lnn;->getType()I
...
.method public equalsList(Lnn;)Z
    .locals 3
    ...
    invoke-interface {p1}, Lnn;->getNextSibling()Lnn;
    ...
    .line 124
    invoke-interface {p0, p1}, Lnn;->equals(Lnn;)Z
    ...
    invoke-interface {p1}, Lnn;->getFirstChild()Lnn;

    move-result-object v2

    invoke-interface {v1, v2}, Lnn;->equalsList(Lnn;)Z
...
.method public equalsListPartial(Lnn;)Z
    .locals 4
    ...
    invoke-interface {v2, v3}, Lnn;->equalsListPartial(Lnn;)Z
...
.method public equalsTree(Lnn;)Z
    .locals 3
    ...
    .line 180
    invoke-virtual {p0, p1}, Lantlr/BaseAST;->equals(Lnn;)Z
    ...
    .line 182
    :cond_1
    invoke-virtual {p0}, Lantlr/BaseAST;->getFirstChild()Lnn;
...
.method public equalsTreePartial(Lnn;)Z
    .locals 4
...
.method public findAll(Lnn;)Lno;
    ...
    invoke-direct {v1, v0}, Lnr;-><init>(I)V
    ...
    invoke-direct {p0, v1, p1, v0}, Lantlr/BaseAST;->doWorkForFindAll(Lnr;Lnn;Z)V

    .line 225
    new-instance v0, Lnp;

    invoke-direct {v0, v1}, Lnp;-><init>(Lnr;)V

    goto :goto_0
.end method

.method public findAllPartial(Lnn;)Lno;
    .locals 2
...
.method public getFirstChild()Lnn;
    .locals 1
...
.method public getNextSibling()Lnn;
    .locals 1
...
.method public abstract initialize(Lnh;)V
.end method

.method public abstract initialize(Lnn;)V
.end method
...
.method public setFirstChild(Lnn;)V
    .locals 0
...
.method public setNextSibling(Lnn;)V
    .locals 0
...
.method public xmlSerialize(Ljava/io/Writer;)V
    ...
    .line 469
    invoke-interface {v1}, Lnn;->getFirstChild()Lnn;
    ...
    .line 468
    :goto_1
    invoke-interface {v1}, Lnn;->getNextSibling()Lnn;
