...
.field private static mDataChannelCb:Lhl;
...
.method public static declared-synchronized init(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-static {p2}, Lho;->b(Ljava/lang/String;)V
...
.method public static declared-synchronized init(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 99
    invoke-static {p3}, Lho;->d(Ljava/lang/String;)V
...
.method private reCreateSession()V
    ...
    .line 286
    invoke-virtual {v3}, Lhr;->a()Ljava/util/List;

    move-result-object v1

    .line 287
    .local v1, "infos":Ljava/util/List;, "Ljava/util/List<Lhs;>;"
    ...
    .line 290
    invoke-virtual {v2, v7}, Lhs;->b(Ljava/lang/String;)V

    goto :goto_0

    .line 293
    .end local v0    # "i$":Ljava/util/Iterator;
    .end local v2    # "request":Lhs;
    :cond_0
    const-string/jumbo v3, "awcn.SessionCenter"
    ...
    .line 5033
    :cond_1
    sget-object v3, Lhm$b;->a:Lhm;

    .line 295
    invoke-virtual {v3}, Lhm;->a()V
...
.method private updateAccsFrameCb(Lanet/channel/entity/ConnType;)V
    ...
    .line 1038
    sget-object v4, Lhr$a;->a:Lhr;

    .line 212
    invoke-virtual {v4, p1}, Lhr;->a(Lanet/channel/entity/ConnType;)Ljava/util/List;
    ...
    .line 219
    .local v0, "accsSession":Lja;
    sget-object v4, Lanet/channel/SessionCenter;->mDataChannelCb:Lhl;

    invoke-virtual {v0, v4}, Lja;->a(Lhl;)V

    .line 215
    .end local v0    # "accsSession":Lja;
    :cond_0
...
.method public getDataChannelCb()Lhl;
    .locals 1

    .prologue
    .line 208
    sget-object v0, Lanet/channel/SessionCenter;->mDataChannelCb:Lhl;
...
.method public getInternal(Ljava/lang/String;Lanet/channel/entity/ConnType$TypeLevel;J)Lanet/channel/Session;
    ...
    invoke-interface {v5, v6}, Ljl;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v5, v6}, Ljl;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_3
    invoke-static {v3, v0}, Ljr;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    invoke-static {v5}, Lhs;->a(Ljava/lang/String;)Lhs;

    move-result-object v2

    .line 2038
    .local v2, "request":Lhs;
    sget-object v5, Lhr$a;->a:Lhr;

    .line 266
    invoke-virtual {v5, v2, p2}, Lhr;->a(Lhs;Lanet/channel/entity/ConnType$TypeLevel;)Lanet/channel/Session;
    ...
    invoke-virtual {v2, v5, p2, v6}, Lhs;->a(Landroid/content/Context;Lanet/channel/entity/ConnType$TypeLevel;Ljava/lang/String;)V
    ...
    .line 273
    invoke-virtual {v2, p3, p4}, Lhs;->a(J)V
...
.method public setDataReceiveCb(Lhl;)Z
    .locals 7
    .param p1, "frameCb"    # Lhl;
    ...
    .line 199
    sput-object p1, Lanet/channel/SessionCenter;->mDataChannelCb:Lhl;
...
.method public declared-synchronized switchEnv(Lanet/channel/entity/ENV;)V
    ...
    .line 110
    invoke-static {p1}, Lho;->a(Lanet/channel/entity/ENV;)V
    ...
    .line 1033
    sget-object v2, Lhm$b;->a:Lhm;

    .line 115
    const/4 v3, 0x1

    invoke-virtual {v2, v3}, Lhm;->a(Z)V
    :try_end_0
