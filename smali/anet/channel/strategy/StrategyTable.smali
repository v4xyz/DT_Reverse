...
.method private checkInitHost()V
    ...
    invoke-virtual {v4, v5}, Ljy;->a(Ljava/lang/String;)Z
    ...
    .line 363
    invoke-virtual {v4}, Ljy;->a()Ljava/util/Set;
...
.method private initStrategy()V
    ...
    invoke-virtual {v3, v4}, Ljy;->a(Ljava/lang/String;)Z
    ...
    .line 95
    invoke-virtual {v3}, Ljy;->a()Ljava/util/Set;
    ...
    invoke-static {}, Ljt;->b()[Ljava/lang/String;
    ...
    .line 106
    invoke-static {}, Ljr;->b()[Ljava/lang/String;
...
.method public notifyConnEvent(Ljava/lang/String;Ljj;Lanet/channel/entity/EventType;Lib;)V
    .locals 8
    ...
    .line 391
    :cond_0
    invoke-interface {p2}, Ljj;->getIp()Ljava/lang/String;
    ...
    .line 403
    invoke-virtual {v0, p2, p3, p4}, Lanet/channel/strategy/StrategyCollection;->notifyConnEvent(Ljj;Lanet/channel/entity/EventType;Lib;)V
...
.method public queryByHost(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p1}, Lkf;->b(Ljava/lang/String;)Z
...
.method public sendAmdcRequest(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v5, v1, v6, v7}, Ljy;->a(Ljava/util/Set;Ljava/lang/String;I)V
...
.method protected sendAmdcRequest(Ljava/util/Map;)V
    ...
    invoke-virtual {v1, v0, v2, v3}, Ljy;->a(Ljava/util/Set;Ljava/lang/String;I)V
...
.method public update(Ljp$c;)V
    .locals 14
    .param p1, "httpDnsResponse"    # Ljp$c;
    ...
    .line 213
    :try_start_0
    iget-object v5, p1, Ljp$c;->a:Ljava/lang/String;

    iput-object v5, p0, Lanet/channel/strategy/StrategyTable;->clientIp:Ljava/lang/String;

    .line 214
    iget v5, p1, Ljp$c;->f:I

    iput v5, p0, Lanet/channel/strategy/StrategyTable;->configVersion:I

    .line 215
    iget-object v1, p1, Ljp$c;->c:[Ljp$b;

    .line 216
    .local v1, "dnsInfos":[Ljp$b;
    if-nez v1, :cond_1

    .line 262
    .end local v1    # "dnsInfos":[Ljp$b;
    :cond_0
    :goto_0
    return-void

    .line 220
    .restart local v1    # "dnsInfos":[Ljp$b;
    :cond_1
    iget-object v6, p0, Lanet/channel/strategy/StrategyTable;->hotStrategyMap:Lanet/channel/strategy/StrategyTable$HotHostLruCache;
    ...
    .line 224
    .local v0, "dnsInfo":Ljp$b;
    if-eqz v0, :cond_2

    iget-object v5, v0, Ljp$b;->a:Ljava/lang/String;

    if-eqz v5, :cond_2

    .line 228
    iget-boolean v5, v0, Ljp$b;->m:Z
    ...
    iget-object v8, v0, Ljp$b;->a:Ljava/lang/String;
    ...
    iget-object v10, v0, Ljp$b;->a:Ljava/lang/String;
    ...
    :cond_4
    :goto_3
    invoke-virtual {v4, v0}, Lanet/channel/strategy/StrategyCollection;->update(Ljp$b;)V

    goto :goto_2

    .line 254
    .end local v0    # "dnsInfo":Ljp$b;
    .end local v4    # "sc":Lanet/channel/strategy/StrategyCollection;
    :catchall_0
    move-exception v5
    ...
    .line 241
    .restart local v0    # "dnsInfo":Ljp$b;
    .restart local v1    # "dnsInfos":[Ljp$b;
