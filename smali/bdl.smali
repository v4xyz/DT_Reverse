...
.method public constructor <init>(Landroid/content/Context;Lcom/alibaba/android/ding/base/objects/ObjectDing;Lcom/alibaba/android/ding/base/objects/DingAttachmentObject;Lcom/alibaba/android/ding/base/objects/DingLinkObject;)V
    ...
    .line 24
    iput-object p3, p0, Lbdl;->a:Lcom/alibaba/android/ding/base/objects/DingAttachmentObject;

    .line 25
    iput-object p4, p0, Lbdl;->b:Lcom/alibaba/android/ding/base/objects/DingLinkObject;

    .line 26
    const/4 v0, 0x0

    .line 27
    .local v0, "dingExtend":Lbsc;
    iget-object v2, p0, Lbdl;->g:Lcom/alibaba/android/ding/base/objects/ObjectDingContent;
    ...
    .line 28
    iget-object v7, p0, Lbdl;->g:Lcom/alibaba/android/ding/base/objects/ObjectDingContent;
    ...
    invoke-direct/range {v0 .. v6}, Lbsc;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JLjava/util/List;)V
    ...
    .restart local v0    # "dingExtend":Lbsc;
    :cond_0
    :goto_0
    iget-object v2, p0, Lbdl;->f:Lbsd;

    .line 1132
    iput-object v0, v2, Lbsd;->n:Lbsc;
    ...
    .line 34
    iget-object v8, p0, Lbdl;->g:Lcom/alibaba/android/ding/base/objects/ObjectDingContent;
    ...
    invoke-direct {v0, v2}, Lbsc;-><init>(Ljava/lang/String;)V
