...
.method public constructor <init>(Lbl$c;)V
    ...
    .line 81
    iput-object p1, p0, Lbl$d;->a:Lbl$c;
...
.method public final onCaptureSharedElementSnapshot(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;)Landroid/os/Parcelable;
    ...
    .prologue
    .line 111
    iget-object v0, p0, Lbl$d;->a:Lbl$c;

    invoke-virtual {v0, p1, p2, p3}, Lbl$c;->a(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;)Landroid/os/Parcelable;
...
.method public final onCreateSnapshotView(Landroid/content/Context;Landroid/os/Parcelable;)Landroid/view/View;
    ...
    invoke-virtual {v0, p1, p2}, Lbl$c;->a(Landroid/content/Context;Landroid/os/Parcelable;)Landroid/view/View;
...
.method public final onSharedElementsArrived(Ljava/util/List;Ljava/util/List;Landroid/app/SharedElementCallback$OnSharedElementsReadyListener;)V
    ...
    new-instance v1, Lbl$d$1;

    invoke-direct {v1, p0, p3}, Lbl$d$1;-><init>(Lbl$d;Landroid/app/SharedElementCallback$OnSharedElementsReadyListener;)V

    invoke-virtual {v0, p1, p2, v1}, Lbl$c;->a(Ljava/util/List;Ljava/util/List;Lbl$a;)V
