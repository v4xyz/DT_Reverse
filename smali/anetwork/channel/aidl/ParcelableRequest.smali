...
.method public constructor <init>(Lku;)V
    ...
    .line 41
    iput-object p1, p0, Lanetwork/channel/aidl/ParcelableRequest;->request:Lku;

    .line 42
    if-eqz p1, :cond_1

    .line 43
    invoke-interface {p1}, Lku;->a()Ljava/net/URI;
    ...
    .line 52
    invoke-interface {p1}, Lku;->h()Ljava/lang/String;
    ...
    .line 54
    invoke-interface {p1}, Lku;->d()Ljava/util/List;
    ...
    .line 55
    invoke-interface {p1}, Lku;->e()Ljava/lang/String;
    ...
    .line 56
    invoke-interface {p1}, Lku;->g()Ljava/util/List;
    ...
    .line 57
    invoke-interface {p1}, Lku;->i()Lanet/channel/request/BodyEntry;
    ...
    .line 61
    invoke-interface {p1}, Lku;->m()Ljava/lang/String;
    ...
    .line 45
    :cond_2
    invoke-interface {p1}, Lku;->b()Ljava/net/URL;
...
.method public static readFromParcel(Landroid/os/Parcel;)Lanetwork/channel/aidl/ParcelableRequest;
    ...
    invoke-direct {v1, v10, v11}, Llx;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v11, v12, v13}, Lmc;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setParams(Ljava/util/List;)V
    ...
    .prologue
    .line 252
    .local p1, "params":Ljava/util/List;, "Ljava/util/List<Lkt;>;"
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 85
    iget-object v7, p0, Lanetwork/channel/aidl/ParcelableRequest;->request:Lku;
    ...
    invoke-interface {v7}, Lku;->h()Ljava/lang/String;
    ...
    iget-object v10, p0, Lanetwork/channel/aidl/ParcelableRequest;->request:Lku;

    invoke-interface {v10}, Lku;->c()Z
    ...
    invoke-interface {v7}, Lku;->e()Ljava/lang/String;
    ...
    invoke-interface {v7}, Lku;->d()Ljava/util/List;
    ...
    invoke-interface {v7}, Lkn;->a()Ljava/lang/String;
    ...
    invoke-interface {v7}, Lkn;->b()Ljava/lang/String;
    ...
    invoke-interface {v7}, Lku;->g()Ljava/util/List;

    move-result-object v5

    .line 112
    .local v5, "params":Ljava/util/List;, "Ljava/util/List<Lkt;>;"
    ...
    invoke-interface {v4}, Lkt;->getKey()Ljava/lang/String;
    ...
    invoke-interface {v4}, Lkt;->getValue()Ljava/lang/String;
    ...
    invoke-interface {v7}, Lku;->m()Ljava/lang/String;
    ...
    .end local v5    # "params":Ljava/util/List;, "Ljava/util/List<Lkt;>;"
    ...
    .restart local v5    # "params":Ljava/util/List;, "Ljava/util/List<Lkt;>;"
