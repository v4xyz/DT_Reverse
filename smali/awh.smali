...
.field private e:Lbeo$a;


# direct methods
.method public constructor <init>(Landroid/app/Activity;Ljava/util/List;JLawh$a;)V
    .locals 1
    .param p1, "context"    # Landroid/app/Activity;
    .param p3, "originRecorderId"    # J
    .param p5, "onRecorderChangedListener"    # Lawh$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 32
    iput-object p1, p0, Lawh;->d:Landroid/app/Activity;

    .line 33
    iput-object p2, p0, Lawh;->a:Ljava/util/List;

    .line 34
    iput-wide p3, p0, Lawh;->b:J
    ...
    invoke-direct {v0, p0, p5}, Lawh$1;-><init>(Lawh;Lawh$a;)V

    iput-object v0, p0, Lawh;->e:Lbeo$a;

    .line 52
    return-void
.end method

.method static synthetic a(Lawh;J)J
    .locals 1
    .param p0, "x0"    # Lawh;
    .param p1, "x1"    # J
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 79
    iget-object v2, p0, Lawh;->d:Landroid/app/Activity;

    invoke-static {v2}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v2

    sget v5, Lavo$g;->item_edit_meeting_recorder:I
    ...
    iget-object v2, p0, Lawh;->e:Lbeo$a;

    invoke-direct {v0, p2, v2}, Lbeo;-><init>(Landroid/view/View;Lbeo$a;)V

    .line 81
    .local v0, "holder":Lbeo;
    invoke-virtual {p2, v0}, Landroid/view/View;->setTag(Ljava/lang/Object;)V

    .line 85
    :goto_0
    iget-object v2, p0, Lawh;->a:Ljava/util/List;
    ...
    iget-wide v6, p0, Lawh;->c:J

    .line 1064
    iput-object v2, v0, Lbeo;->a:Lcom/alibaba/android/dingtalk/userbase/model/UserIdentityObject;

    .line 1066
    iget-object v5, v0, Lbeo;->a:Lcom/alibaba/android/dingtalk/userbase/model/UserIdentityObject;

    if-eqz v5, :cond_1

    .line 1070
    iget-object v5, v0, Lbeo;->c:Landroid/widget/CheckBox;
    ...
    .line 1083
    iget-object v8, v0, Lbeo;->c:Landroid/widget/CheckBox;
    ...
    .line 1091
    :cond_0
    iget-object v8, v0, Lbeo;->d:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;
    ...
    .line 1092
    iget-object v2, v0, Lbeo;->e:Landroid/widget/TextView;
    ...
    .line 1097
    iget-object v2, v0, Lbeo;->f:Landroid/view/View;
    ...
    .line 1076
    :goto_3
    iget-object v2, v0, Lbeo;->c:Landroid/widget/CheckBox;

    iget-object v5, v0, Lbeo;->h:Landroid/widget/CompoundButton$OnCheckedChangeListener;
    ...
    .line 1078
    iget-object v5, v0, Lbeo;->b:Landroid/view/View;

    iget-object v2, v0, Lbeo;->a:Lcom/alibaba/android/dingtalk/userbase/model/UserIdentityObject;
