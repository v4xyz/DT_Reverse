...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lahd;->b:Ljava/lang/Object;
...
.method public static a(Ljava/lang/String;)Ladw;
    .locals 4
    ...
    iput-object v2, v1, Ladw;->a:Ljava/util/List;
...
.method public static a()Lahd;
    ...
    .prologue
    .line 38
    sget-object v1, Lahd;->b:Ljava/lang/Object;
...
.method public static a(Landroid/app/Activity;Ljava/util/List;I)Lcom/alibaba/android/dingtalkbase/widgets/views/CustomDialog;
    ...
    sget v1, Lavn$h;->dt_mail_more_contact:I
    ...
    .line 2098
    :cond_6
    sget v2, Lavn$h;->dt_mail_at_in_body:I
...
.method static synthetic a(Lahd;Ljava/util/List;)Ljava/util/List;
    .locals 6
    .param p0, "x0"    # Lahd;
    ...
    .line 3339
    iget-object v3, v0, Laek;->b:Ljava/lang/String;
    ...
    iget-object v5, v0, Laek;->b:Ljava/lang/String;
...
.method public static b(Ljava/util/List;)Ladw;
    .locals 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v4}, Ladw;-><init>()V

    .line 291
    .local v4, "reqModel":Ladw;
    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, v4, Ladw;->a:Ljava/util/List;

    .line 292
    iput-object v1, v4, Ladw;->b:Ljava/util/List;
    ...
    invoke-direct {v5}, Ladx;-><init>()V

    .line 296
    .local v5, "singleModel":Ladx;
    if-eqz v8, :cond_5
    ...
    iput-object v10, v5, Ladx;->a:Ljava/lang/Long;
    ...
    iput-object v10, v5, Ladx;->b:Ljava/lang/Long;

    .line 301
    :cond_6
    iget-object v10, v4, Ladw;->a:Ljava/util/List;

    invoke-interface {v10, v5}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    goto :goto_2

    .end local v4    # "reqModel":Ladw;
    .end local v5    # "singleModel":Ladx;
