...
.method public static a(Landroid/content/Context;Ljava/lang/String;I)Landroid/graphics/Bitmap;
    ...
    :cond_8
    :try_start_1
    new-instance v6, Lemr$a;

    invoke-direct {v6}, Lemr$a;-><init>()V

    .line 55
    .local v6, "opt":Lemr$a;
    const/4 v12, 0x1

    iput-boolean v12, v6, Lemr$a;->inJustDecodeBounds:Z

    .line 56
    move-object/from16 v0, p1

    invoke-static {v0, v6}, Lemr;->a(Ljava/lang/String;Lemr$a;)Landroid/graphics/Bitmap;

    .line 58
    iget v12, v6, Lemr$a;->outWidth:I

    const/4 v13, -0x1

    if-eq v12, v13, :cond_9

    iget v12, v6, Lemr$a;->outHeight:I
    ...
    iget v13, v6, Lemr$a;->outHeight:I
    :try_end_1
