...
.method static constructor <clinit>()V
    ...
    sput-object v0, Laip;->e:[Ljava/lang/String;
    ...
    sput-object v0, Laip;->f:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Laip;-><init>(Z)V
...
.method public constructor <init>(Z)V
    ...
    .prologue
    .line 68
    invoke-direct {p0, p1}, Laim;-><init>(Z)V
...
.method private a(JZZ)I
    ...
    iget-object v1, v0, Laip;->c:Lcom/alibaba/alimei/orm/IDatabase;

    const-string/jumbo v2, "Events"

    sget-object v3, Laip;->f:[Ljava/lang/String;
    ...
    invoke-interface/range {v1 .. v8}, Lcom/alibaba/alimei/orm/IDatabase;->query(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .line 1071
    .local v17, "syncId":Ljava/lang/String;
    invoke-static/range {v17 .. v17}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z

    move-result v10

    .line 1076
    .local v10, "emptySyncId":Z
    const/4 v1, 0x1
    ...
    .line 1079
    .local v12, "origId":Ljava/lang/String;
    const/4 v1, 0x4
    ...
    .line 7074
    .local v13, "origSyncId":Ljava/lang/String;
    ...
    iget-object v1, v0, Laip;->d:Laij;

    .line 7417
    iget-object v1, v1, Laij;->e:Lail;
    ...
    invoke-interface {v1, v2, v3, v5}, Lcom/alibaba/alimei/orm/IDatabase;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 1170
    .end local v10    # "emptySyncId":Z
    .end local v11    # "isRecurrence":Z
    .end local v12    # "origId":Ljava/lang/String;
    .end local v13    # "origSyncId":Ljava/lang/String;
    .end local v14    # "rdate":Ljava/lang/String;
    .end local v16    # "rrule":Ljava/lang/String;
    .end local v17    # "syncId":Ljava/lang/String;
    :cond_5
    :goto_2
    ...
    .line 7076
    .restart local v10    # "emptySyncId":Z
    .restart local v12    # "origId":Ljava/lang/String;
    .restart local v13    # "origSyncId":Ljava/lang/String;
    .restart local v14    # "rdate":Ljava/lang/String;
    .restart local v16    # "rrule":Ljava/lang/String;
    .restart local v17    # "syncId":Ljava/lang/String;
    :cond_6
    const/4 v1, 0x0
    ...
    .line 1122
    .restart local v11    # "isRecurrence":Z
    :cond_8
    :try_start_1
    ...
    invoke-interface {v1, v2, v0, v3, v5}, Lcom/alibaba/alimei/orm/IDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string/jumbo v3, "original_id=? AND _sync_id IS NULL"
    ...
    const-string/jumbo v2, "CalendarAlerts"
    ...
    const-string/jumbo v2, "ExtendedProperties"
...
.method private a(Landroid/database/Cursor;Landroid/content/ContentValues;Z)I
    ...
    invoke-virtual {v0, v1}, Laip;->a(Landroid/content/ContentValues;)V
    :try_end_0
    ...
    iget-object v4, v0, Laip;->c:Lcom/alibaba/alimei/orm/IDatabase;

    const-string/jumbo v5, "Calendars"

    sget-object v6, Laip;->e:[Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2}, Laip;->a(Landroid/content/ContentValues;Landroid/content/ContentValues;)V
    ...
    :cond_6
    :try_start_3
    invoke-static/range {v27 .. v27}, Laip;->c(Landroid/content/ContentValues;)J
    :try_end_3
    ...
    invoke-static {v4, v0}, Labh;->d(Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    invoke-static {v0, v1}, Laip;->b(Landroid/content/ContentValues;Landroid/content/ContentValues;)Z
    ...
    invoke-direct {v0, v4}, Laip;->a(Ljava/lang/String;)Z
    ...
    iget-object v4, v0, Laip;->d:Laij;

    invoke-virtual {v4, v6, v7}, Laij;->a(J)V
    ...
    invoke-direct {v0, v6, v7, v1}, Laip;->b(JLandroid/content/ContentValues;)V

    .line 967
    move-object/from16 v0, p0

    iget-object v4, v0, Laip;->a:Lcom/alibaba/alimei/sdk/calendar/helper/CalendarInstancesHelper;

    const/4 v8, 0x0

    move-object/from16 v0, p0

    iget-object v9, v0, Laip;->c:Lcom/alibaba/alimei/orm/IDatabase;
    ...
    invoke-virtual {v4, v5}, Laij;->a(Z)V
    ...
    .line 6391
    iget-object v4, v4, Laij;->b:Lcom/alibaba/alimei/orm/IDatabase;
    ...
    .line 6403
    sget-object v10, Laij;->a:Ljava/lang/String;
    ...
    invoke-direct {v0, v6, v7, v1, v4}, Laip;->a(JZZ)I
...
.method private a(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v4, p0, Laip;->c:Lcom/alibaba/alimei/orm/IDatabase;
...
.method private b(JLandroid/content/ContentValues;)V
    ...
    .line 513
    :cond_7
    iget-object v11, p0, Laip;->d:Laij;

    invoke-virtual {v11, v8}, Laij;->b(Landroid/content/ContentValues;)J
...
.method private static c(Landroid/content/ContentValues;)J
    ...
    invoke-direct {v4}, Laif;-><init>()V

    .line 559
    .local v4, "duration":Laif;
    const-string/jumbo v12, "duration"
    ...
    .line 561
    invoke-virtual {v4, v5}, Laif;->a(Ljava/lang/String;)V
    ...
    invoke-direct {v7, p0}, Laih;-><init>(Landroid/content/ContentValues;)V
    :try_end_0
    ...
    invoke-direct {v10}, Laig;-><init>()V

    .line 592
    .local v10, "rp":Laig;
    invoke-virtual {v10, v1, v7}, Laig;->a(Landroid/text/format/Time;Laih;)J
    ...
    .end local v10    # "rp":Laig;
    .end local v11    # "tz":Ljava/lang/String;
    :goto_1
    invoke-virtual {v4}, Laif;->a()J
...
.method private d(Landroid/content/ContentValues;)Landroid/content/ContentValues;
    ...
    .line 619
    :try_start_0
    invoke-static {p1}, Laip;->c(Landroid/content/ContentValues;)J
...
.method public final a(JLandroid/content/ContentValues;)I
    ...
    :try_start_0
    iget-object v0, p0, Laip;->c:Lcom/alibaba/alimei/orm/IDatabase;
    ...
    invoke-direct {p0, v8, p3, v0}, Laip;->a(Landroid/database/Cursor;Landroid/content/ContentValues;Z)I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public final a(Lcom/alibaba/alimei/sdk/db/calendar/entry/Events;)J
    ...
    :cond_21
    invoke-virtual {p0, v2}, Laip;->b(Landroid/content/ContentValues;)J
...
.method public final b(Landroid/content/ContentValues;)J
    ...
    invoke-virtual {v0, v5, v4}, Laip;->a(Landroid/content/ContentValues;Landroid/content/ContentValues;)V

    .line 124
    :goto_0
    move-object/from16 v0, p0

    invoke-direct {v0, v5}, Laip;->d(Landroid/content/ContentValues;)Landroid/content/ContentValues;
    ...
    invoke-static {v4, v8}, Labh;->e(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v5}, Laip;->a(Landroid/content/ContentValues;)V
    :try_end_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v4, v11}, Labh;->d(Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    invoke-virtual {v0, v8, v9}, Laip;->a(J)Ljava/lang/String;
    ...
    :cond_8
    :goto_2
    invoke-static {v5, v5}, Laip;->b(Landroid/content/ContentValues;Landroid/content/ContentValues;)Z
    ...
    invoke-virtual {v4, v5}, Laij;->a(Landroid/content/ContentValues;)J
    ...
    invoke-direct {v0, v6, v7, v5}, Laip;->b(JLandroid/content/ContentValues;)V
    ...
    iget-object v8, v0, Laip;->d:Laij;

    invoke-virtual {v8, v4}, Laij;->e(Landroid/content/ContentValues;)J
...
.method public final c(J)I
    ...
    .line 236
    iget-boolean v1, p0, Laip;->b:Z

    invoke-direct {p0, p1, p2, v1, v2}, Laip;->a(JZZ)I
    ...
    invoke-virtual {v1, v2}, Laij;->a(Z)V
