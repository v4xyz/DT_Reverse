...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/TextView;Ljava/lang/String;I)V
    ...
    iput-object v0, p0, Lagx;->e:Ljava/util/HashSet;

    .line 47
    iput-object p1, p0, Lagx;->a:Landroid/content/Context;

    .line 48
    iput-object p2, p0, Lagx;->b:Landroid/widget/TextView;

    .line 49
    iput-object p3, p0, Lagx;->c:Ljava/lang/String;
...
.method private a()Landroid/graphics/drawable/Drawable;
    ...
    sget v4, Lavn$e;->album_default:I
    ...
    iget-object v3, p0, Lagx;->a:Landroid/content/Context;
...
.method public final a(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v9, p0, Lagx;->a:Landroid/content/Context;
    ...
    :cond_2
    invoke-direct {p0}, Lagx;->a()Landroid/graphics/drawable/Drawable;
    ...
    .end local v0    # "bitmap":Landroid/graphics/Bitmap;
    :cond_3
    iget-object v9, p0, Lagx;->e:Ljava/util/HashSet;
    ...
    .line 88
    invoke-static {v9}, Lajw;->a(Lcom/alibaba/alimei/sdk/threadpool/ThreadPriority;)Lajv;

    move-result-object v7

    .line 89
    .local v7, "thread":Lajv;
    new-instance v9, Lagx$a;

    invoke-direct {v9, p0, p1}, Lagx$a;-><init>(Lagx;Ljava/lang/String;)V

    invoke-interface {v7, v9}, Lajv;->a(Ljava/lang/Runnable;)V

    goto :goto_0

    .line 91
    .end local v7    # "thread":Lajv;
    :cond_4
    invoke-direct {p0}, Lagx;->a()Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v9, p1}, Lagx;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
