...
.method public constructor <init>(Landroid/webkit/WebView;)V
    ...
    .line 26
    iput-object p1, p0, Lahs;->a:Landroid/webkit/WebView;
...
.method public final declared-synchronized a()V
    ...
    .line 130
    iget-object v0, p0, Lahs;->d:Lcom/alibaba/alimei/oauth/widget/OAuthWebViewRequest;
    ...
    iput-object v0, p0, Lahs;->d:Lcom/alibaba/alimei/oauth/widget/OAuthWebViewRequest;
    :try_end_0
...
.method public final declared-synchronized a(Lcom/alibaba/alimei/oauth/OAuthRequestClient;Lcom/alibaba/alimei/oauth/widget/OAuthWebViewObserver;)V
    ...
    :cond_1
    :try_start_1
    iput-object p1, p0, Lahs;->b:Lcom/alibaba/alimei/oauth/OAuthRequestClient;

    .line 39
    iget-object v0, p0, Lahs;->c:Laht;
    ...
    invoke-direct {v0, p0, p2}, Lahs$1;-><init>(Lahs;Lcom/alibaba/alimei/oauth/widget/OAuthWebViewObserver;)V
    ...
    iget-object v1, p0, Lahs;->a:Landroid/webkit/WebView;

    iget-object v2, p0, Lahs;->c:Laht;

    invoke-direct {v0, v1, v2}, Lcom/alibaba/alimei/oauth/widget/OAuthWebViewRequest;-><init>(Landroid/webkit/WebView;Laht;)V
    ...
    iget-object v1, p0, Lahs;->b:Lcom/alibaba/alimei/oauth/OAuthRequestClient;
...
.method declared-synchronized a(Lcom/alibaba/alimei/oauth/OAuthResponseClient;Lcom/alibaba/alimei/oauth/widget/OAuthWebViewObserver;)V
    ...
    .line 101
    :cond_1
    new-instance v1, Lahs$2;

    invoke-direct {v1, p0, p2}, Lahs$2;-><init>(Lahs;Lcom/alibaba/alimei/oauth/widget/OAuthWebViewObserver;)V

    .line 121
    .local v1, "listener":Laam;, "Laam<Lcom/alibaba/alimei/framework/model/UserAccountModel;>;"
    ...
    invoke-interface {v0, v2, v3, v1}, Lcom/alibaba/alimei/framework/account/AccountApi;->loginWithThirdAccessToken(Ljava/lang/String;Ljava/lang/String;Laam;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .end local v1    # "listener":Laam;, "Laam<Lcom/alibaba/alimei/framework/model/UserAccountModel;>;"
    :catchall_0
    move-exception v2
