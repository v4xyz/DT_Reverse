...
.method public constructor <init>(Landroid/app/Activity;Lcom/alibaba/wukong/im/Conversation;Ljava/util/List;I)V
    ...
    iput-object v0, p0, Lbkg;->f:Landroid/os/Handler;

    .line 136
    iput-object p1, p0, Lbkg;->a:Landroid/app/Activity;

    .line 137
    iput-object p3, p0, Lbkg;->b:Ljava/util/List;

    .line 138
    iput-object p2, p0, Lbkg;->d:Lcom/alibaba/wukong/im/Conversation;
    ...
    iput-object v0, p0, Lbkg;->g:Lcom/alibaba/android/dingtalk/userbase/ContactInterface;

    .line 140
    iget-object v0, p0, Lbkg;->d:Lcom/alibaba/wukong/im/Conversation;
...
.method static synthetic a(Lbkg;)Lcom/alibaba/android/dingtalk/userbase/ContactInterface;
    .locals 1
    .param p0, "x0"    # Lbkg;

    .prologue
    .line 60
    iget-object v0, p0, Lbkg;->g:Lcom/alibaba/android/dingtalk/userbase/ContactInterface;
...
.method static synthetic a(Lbkg;Lcom/alibaba/android/dingtalk/redpackets/models/RedPacketsFlowObject;)V
    .locals 6
    .param p0, "x0"    # Lbkg;
    ...
    .line 60
    .line 2280
    iget-object v0, p0, Lbkg;->a:Landroid/app/Activity;

    invoke-static {v0}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v0

    sget v1, Lbkd$e;->redpackets_comment_dialog:I
    ...
    .line 2287
    iget-object v1, p0, Lbkg;->a:Landroid/app/Activity;
    ...
    new-instance v3, Lbkg$2;

    invoke-direct {v3, p0, v0, p1}, Lbkg$2;-><init>(Lbkg;Landroid/widget/EditText;Lcom/alibaba/android/dingtalk/redpackets/models/RedPacketsFlowObject;)V
    ...
    .line 2308
    new-instance v2, Lbkg$3;

    invoke-direct {v2, p0, v1, v0}, Lbkg$3;-><init>(Lbkg;Landroid/support/v7/app/AlertDialog;Landroid/widget/EditText;)V
...
.method static synthetic b(Lbkg;)J
    .locals 2
    .param p0, "x0"    # Lbkg;

    .prologue
    .line 60
    iget-wide v0, p0, Lbkg;->e:J

    return-wide v0
.end method

.method static synthetic c(Lbkg;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Lbkg;

    .prologue
    .line 60
    iget-object v0, p0, Lbkg;->f:Landroid/os/Handler;
...
.method public final getCount()I
    ...
    .prologue
    .line 154
    iget-object v0, p0, Lbkg;->b:Ljava/util/List;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 171
    iget-object v5, p0, Lbkg;->a:Landroid/app/Activity;

    invoke-static {v5}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v5

    sget v6, Lbkd$e;->item_redpackets_picked:I
    ...
    .line 173
    new-instance v4, Lbkg$b;

    const/4 v5, 0x0

    invoke-direct {v4, v5}, Lbkg$b;-><init>(B)V

    .line 174
    .local v4, "viewHolder":Lbkg$b;
    sget v5, Lbkd$d;->picker_icon:I
    ...
    iput-object v5, v4, Lbkg$b;->b:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;

    .line 175
    sget v5, Lbkd$d;->tv_receiver_ts:I
    ...
    iput-object v5, v4, Lbkg$b;->e:Landroid/widget/TextView;

    .line 176
    sget v5, Lbkd$d;->tv_receiver_comment:I
    ...
    iput-object v5, v4, Lbkg$b;->d:Landroid/widget/TextView;

    .line 177
    sget v5, Lbkd$d;->tv_receiver_name:I
    ...
    iput-object v5, v4, Lbkg$b;->c:Landroid/widget/TextView;

    .line 178
    sget v5, Lbkd$d;->tv_right_top:I
    ...
    iput-object v5, v4, Lbkg$b;->f:Landroid/widget/TextView;

    .line 179
    sget v5, Lbkd$d;->tv_right_bottom:I
    ...
    iput-object v5, v4, Lbkg$b;->g:Landroid/widget/TextView;

    .line 180
    sget v5, Lbkd$d;->left_divider:I

    invoke-virtual {p2, v5}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v5

    iput-object v5, v4, Lbkg$b;->a:Landroid/view/View;
    ...
    .line 185
    :goto_0
    iget-object v5, v4, Lbkg$b;->a:Landroid/view/View;
    ...
    .line 186
    iget-object v5, p0, Lbkg;->b:Ljava/util/List;
    ...
    .line 190
    :cond_0
    iget-object v5, v4, Lbkg$b;->c:Landroid/widget/TextView;
    ...
    .line 191
    iget-object v5, p0, Lbkg;->g:Lcom/alibaba/android/dingtalk/userbase/ContactInterface;
    ...
    .line 193
    iget-object v5, v4, Lbkg$b;->b:Lcom/alibaba/android/dingtalkbase/widgets/AvatarImageView;

    invoke-static {v3}, Lbkg;->a(Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;)Ljava/lang/String;
    ...
    .line 211
    iget-object v5, v4, Lbkg$b;->e:Landroid/widget/TextView;
    ...
    .line 219
    iget-object v5, v4, Lbkg$b;->f:Landroid/widget/TextView;

    sget v6, Lbkd$f;->redpackets_picked:I
    ...
    iget-object v6, p0, Lbkg;->a:Landroid/app/Activity;

    invoke-virtual {v6}, Landroid/app/Activity;->getResources()Landroid/content/res/Resources;

    move-result-object v6

    sget v7, Lbkd$b;->text_color_black:I
    ...
    .line 253
    :goto_5
    iget-object v5, v4, Lbkg$b;->d:Landroid/widget/TextView;
    ...
    sget v6, Lbkd$f;->redpackets_comment:I
    ...
    sget v7, Lbkd$b;->redpackets_link_color:I
    ...
    new-instance v6, Lbkg$1;

    invoke-direct {v6, p0, v1}, Lbkg$1;-><init>(Lbkg;Lcom/alibaba/android/dingtalk/redpackets/models/RedPacketsFlowObject;)V
    ...
    .end local v4    # "viewHolder":Lbkg$b;
    ...
    check-cast v4, Lbkg$b;

    .restart local v4    # "viewHolder":Lbkg$b;
    goto/16 :goto_0
    ...
    invoke-static {v5}, Lbtf;->b(Ljava/lang/String;)Lcom/alibaba/doraemon/threadpool/Thread;

    move-result-object v5

    new-instance v6, Lbkg$a;

    iget-object v7, v4, Lbkg$b;->c:Landroid/widget/TextView;

    invoke-direct {v6, p0, v3, v7}, Lbkg$a;-><init>(Lbkg;Lcom/alibaba/android/dingtalk/userbase/model/UserProfileObject;Landroid/widget/TextView;)V
    ...
    sget v6, Lbkd$f;->redpackets_unpicked:I
    ...
    sget v7, Lbkd$b;->text_color_gray:I
    ...
    sget v9, Lbkd$f;->redpackets_yuan:I
    ...
    .line 230
    iget-object v5, v4, Lbkg$b;->g:Landroid/widget/TextView;
    ...
    sget v6, Lbkd$f;->redpackets_best:I
    ...
    sget v6, Lbkd$c;->redpackets_best_icon:I
    ...
    sget v7, Lbkd$b;->redpackets_normal_yellow:I
